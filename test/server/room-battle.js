...
describe('Simulator abstraction layer features', function () {
	describe('Battle', function () {
		describe('player identifiers', function () {
			...
			it('should not get players out of sync in rated battles on rename', async function () {
				...
				room = await Rooms.createBattle('', {p1, p2, p1team: packedTeam, p2team: packedTeam, allowRenames: false});
				p1.resetName();
