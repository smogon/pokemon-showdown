...
describe('Metal Burst', () => {
	...
	describe('[Gen 4]', () => {
		it(`should deal damage ignoring damage reducing berries consumed`, () => {
			...
			assert.bounded(abra.maxhp - abra.hp, [34 * 1.5, 40 * 1.5]);

			abra = battle.p1.active[1];
			assert.bounded(abra.maxhp - abra.hp, [34 / 2, 40 / 2]);
