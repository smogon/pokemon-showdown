...
describe('Quick Claw', function () {
	...
	it.skip(`[Gen 2] shares its activation roll with every holder on any given turn`, function () {
	...
	it.skip(`[Gen 3] causes Speed ties with every holder when activated`, function () {
