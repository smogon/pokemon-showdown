...
describe('Team Validator', () => {
	...
	it(`should force Gen 4 Arceus to have max 100 EVs in any one stat and only multiples of 10`, () => {
		let team = [
			{ species: 'arceus', ability: 'multitype', moves: ['judgment'], evs: { hp: 252, atk: 100, def: 100, spa: 100, spd: 100 } },
		];
		assert.false.legalTeam(team, 'gen4anythinggoes');

		team = [
			{ species: 'arceus', ability: 'multitype', moves: ['judgment'], evs: { hp: 99, atk: 100, def: 100, spa: 100, spd: 100, spe: 100 } },
		];
		assert.false.legalTeam(team, 'gen4anythinggoes');
