...
describe('Dex data', () => {
	...
	// Meowstic (1) + Aegislash (1) + Pumpkaboo (3) + Gourgeist (3) + Xerneas (1) + Zygarde (2) + Mimikyu (1) + Magearna (1) +
	// Alola (4) + Toxtricity (1) + Indeedee (1) + Morpeko (1) + Galar (8) + Hisui (1) + Squawkabilly (3) +
	// Tatsugiri (2) + Gimmighoul (1) + Hoopa (1)
	formes['gen9legends'] = 92 + 2 + 5 + 1 + 1 + 4 + 2 + 1 + 1 + 1 + 3 + 3 + 1 + 2 + 1 + 1 + 4 + 1 + 1 + 1 + 8 + 1 + 3 + 2 + 1 + 1;
