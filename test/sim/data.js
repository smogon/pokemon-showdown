...
describe('Dex data', function () {
	...
	it.only('should have valid Learnsets entries', function () {
		this.timeout(0);
	...
	// Rotom (5) + Shaymin (1) + Arceus (17) + Basculin (2) + Kyurem (2) + Meloetta (1) +
	// Greninja (1) + Vivillon (2) + Meowstic (1) + Hoopa (1) + Oricorio (3) + Lycanroc (2) +
	// Minior (1) + Mimikyu (1) + Necrozma (2) + Magearna (1) + Toxtricity (1) + Antique (2) +
	// Eiscue (1) + Indeedee (1) + Cramorant (2) + Morpeko (1) + Crowned (2) + Urshifu (1) +
	// Zarude (1) + Calyrex (2) + Oinkologne (1) + Ursaluna (1) + Dudunsparce (1) + Palafin (1) +
	// Maushold (1) + Squawkabilly (3) + Gimmighoul (1) + Basculegion (1) + Masterpiece (2) + Ogerpon (7)
	formes[9] = 8 + 3 + 4 + 16 + 7 + 4 + 16 + 5 + 1 + 17 + 2 +
	  2 + 1 + 1 + 2 + 1 + 1 + 3 + 2 + 1 + 1 + 2 + 1 + 1 + 2 +
	  1 + 1 + 2 + 1 + 2 + 1 + 1 + 1 + 2 + 1 + 1 + 1 + 1 + 3 +
	  1 + 1 + 2 + 7;
