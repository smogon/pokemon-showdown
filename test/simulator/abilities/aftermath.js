...
describe('Atermath', function () {
	...
	it("should hurt attackers by 1/4 their max HP when this Pokemon is KOed by a contact move", function () {
		...
		battle.setPlayer('p1', {team: [{species: 'Voltorb', level: 1, item: 'rockyhelmet', ability: 'aftermath', moves: ['sleeptalk']}]});
		battle.setPlayer('p2', {team: [{species: 'Nidoqueen', ability: 'sheerforce', moves: ['doublekick']}]});
