...
const garfieldCopypasta = [
	...
	` In some sense, even his cat Garfield is an object to him, a thing. The first ideology that comes to mind that comes to mind when thinking of objects in the tangible world... is pragmatism. nigger => nigger)`,
].join('');
