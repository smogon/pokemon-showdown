/**
 * Tests for generated [Gen 3] Megas CAP Random Battle tooltip data.
 */
'use strict';
...
const {
	...
	getArtifactPaths,
	serializeArtifact,
} = require('../../tools/generate-gen3megascap-randbats');
...
describe('[Gen 3] Megas CAP Random Battle generated randbats data', () => {
	...
	it('should cover every one of the format transformations', () => {
		...
		assert.equal(transformationNames.length, 23);
...
describe('[Gen 3] Megas CAP Random Battle generated randbats data freshness (slow)', () => {
