...
exports.BattleFormats = {
	...
	standardpokebank: {
		effectType: 'Banlist',
		ruleset: ['Sleep Clause Mod', 'Species Clause', 'Moody Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Endless Battle Clause', 'HP Percentage Mod'],
		banlist: ['Illegal']
	},
	standardnext: {
		effectType: 'Banlist',
	...
	endlessbattleclause: {
		...
		onStart: function() {
			this.add('rule', 'Endless Battle Clause: Any moveset on any pokemon that is capable of intentionally causing an endless battle is banned.');
		}
	},
	moodyclause: {
		effectType: 'Banlist',
