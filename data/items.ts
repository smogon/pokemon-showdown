	export const Items: {[itemid: string]: ItemData} = {				4915, 4096																	
					100																	
	abilityshield: {				20																	
	name: "Ability Shield",																					
	spritenum: 0, // TODO																					
	...
	this.add("-activate", target, "item: Focus Band");				100																	
	return target.hp - 1;				15																	
	}				15.00%																	
	},																					
	num: 230,																					
	gen: 2,																					
	...
	electriumz: {						this.add('-end', pokemon, 'move: Attract', '[from] item: Mental Herb');															
	name: "Electrium Z",																					
	spritenum: 634,																					
	onPlate: 'Electric',																					
	onTakeItem: false,																					
