export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	yamaskgalar: {
		...
		evoLevel: 1,
		evoMinDamage: 49,
		evoBiomes: ["minecraft:desert", "minecraft:desert_hills", "minecraft:desert_mutated"],
		evos: ["Runerigus"],
		eggGroups: ["Mineral", "Amorphous"],
	},
	cofagrigus: {
	...
	keldeo: {
		...
		color: "Yellow",
		evoLevel: 1,
		evoPartySpecies: ["Cobalion", "Virizion", "Terrakion"],
		eggGroups: ["Undiscovered"],
		tags: ["Mythical"],
