export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	avalugghisui: {
		...
		color: "Blue",
		prevo: "Bergmite",
		evoBiomes: ["ColdTaiga", "ColdTaigaHills", "ColdTaigaMutated"],
	...
	runerigus: {
		...
		prevo: "Yamask-Galar",
		evoType: "other",
		evoMinTakenDamage: 49,
		evoBiomes: ["Desert", "DesertHills", "DesertMutated"],
