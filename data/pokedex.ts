export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	hippopotas: { // updated
		...
		abilities: { 0: "Sand Stream", 1: "Dust Devil", H: "Earth Force" },
		heightm: 0.8,
		weightkg: 49.5,
		color: "Brown",
		evos: ["Hippowdon"],
	...
	gallade: { // updated
		...
		abilities: { 0: "Steadfast", 1: "Sharpness", H: "Stand Off" },
		heightm: 1.6,
		weightkg: 52,
		color: "White",
		prevo: "Kirlia",
	...
	varoom: { // updated
		...
		abilities: { 0: "Overcoat", 1: "Dust Gather", H: "Slow Start" },
		heightm: 1,
		weightkg: 35,
		color: "Gray",
		evos: ["Revavroom"],
	...
	revavroom: { // updated
		...
		abilities: { 0: "Overcoat", 1: "Dust Gather", H: "Filter" },
		heightm: 1.8,
		weightkg: 120,
		color: "Gray",
		prevo: "Varoom",
