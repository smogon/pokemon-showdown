export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	espeon: {
		...
		prevo: "Eevee",
		evoType: "levelFriendship",
		evoCondition: "during the day w/o knowing a Fairy-type move",
		eggGroups: ["Field"],
	},
	umbreon: {
		num: 197,
		...
		prevo: "Eevee",
		evoType: "levelFriendship",
		evoCondition: "at night w/o knowing a Fairy-type move",
		eggGroups: ["Field"],
	},
	murkrow: {
		num: 198,
	...
	lycanrocdusk: {
		...
		prevo: "Rockruff-Dusk",
		evoLevel: 25,
		evoCondition: "from Rockruff-Dusk during the evening",
		eggGroups: ["Field"],
	},
	wishiwashi: {
		num: 746,
	...
	toxtricity: {
		...
		prevo: "Toxel",
		evoLevel: 30,
		evoCondition: "with a Hardy, Brave, Adamant, Naughty, Docile, Impish, Lax, Hasty, Jolly, Naive, Rash, Sassy, or Quirky Nature",
		eggGroups: ["Human-Like"],
	...
	toxtricitylowkey: {
		...
		prevo: "Toxel",
		evoLevel: 30,
		evoCondition: "with a Lonely, Bold, Relaxed, Timid, Serious, Modest, Mild, Quiet, Bashful, Calm, Gentle, or Careful Nature",
		eggGroups: ["Human-Like"],
		canGigantamax: "G-Max Stun Shock",
	},
	toxtricitygmax: {
	...
	pawmot: {
		...
		prevo: "Pawmo",
		evoType: "levelExtra",
		evoCondition: "after walking 1000 steps in Let's Go",
		eggGroups: ["Field"],
	},
	tandemaus: {
		num: 924,
	...
	maushold: {
		...
		prevo: "Tandemaus",
		evoType: "levelExtra",
		evoCondition: "in battle starting at level 25",
	...
	palafin: {
		...
		prevo: "Finizen",
		evoLevel: 38,
		evoCondition: "while connected with another player in a Union Circle",
	...
	kingambit: {
		...
		prevo: "Bisharp",
		evoType: "levelExtra",
		evoCondition: "after defeating 3 Bisharp holding Leader's Crests",
		eggGroups: ["Human-Like"],
	},
	greattusk: {
		num: 984,
