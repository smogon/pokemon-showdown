...
export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	lycanrocdelta: {
		...
		evoCondition: "during the day",
		eggGroups: ["Field"],
		otherFormes: ["Lycanroc-Midnight-Delta", "Lycanroc-Dusk-Delta"],
		formeOrder: ["Lycanroc-Delta", "Lycanroc-Midnight-Delta", "Lycanroc-Dusk-Delta"],
	},
	lycanrocmidnightdelta: {
		num: 745,
		name: "Lycanroc-Midnight-Delta",
		baseSpecies: "Lycanroc-Delta",
		forme: "Midnight",
		types: ["Dark", "Fighting"],
		baseStats: {hp: 85, atk: 115, def: 75, spa: 55, spd: 75, spe: 82},
