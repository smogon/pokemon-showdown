export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	kabutops: {
		...
		evoLevel: 40,
		eggGroups: ["Water 1", "Water 3"],
		otherFormes: ["Kabutops-Revived"],
		formeOrder: ["Kabutops", "Kabutops-Revived"],
	},
	aerodactyl: {
		num: 142,
		name: "Aerodactyl",
	...
	samurott: {
		...
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Samurott-Hisui", "Samurott-Galar", "Samurott-Mega"],
		formeOrder: ["Samurott", "Samurott-Hisui", "Samurott-Galar", "Samurott-Mega"],
	},
	samurotthisui: {
		num: 503,
		name: "Samurott-Hisui",
