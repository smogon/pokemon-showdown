export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	ponytagalar: { // updated
		...
		types: ["Psychic"],
		baseStats: { hp: 50, atk: 85, def: 55, spa: 65, spd: 65, spe: 90 },
		abilities: { 0: "Pastel Veil", 1: "Anticipation", H: "Smoke and Mirrors" },
		heightm: 0.8,
		weightkg: 24,
		color: "White",
		evos: ["Rapidash-Galar"],
	...
	gyarados: { // updated
		...
		abilities: { 0: "Intimidate", 1: "Rage State", H: "Moxie" },
		heightm: 6.5,
		weightkg: 235,
		color: "Blue",
		prevo: "Magikarp",
	...
	umbreon: { // updated
		...
		abilities: { 0: "Synchronize", 1: "Immunity", H: "Eventide" },
		heightm: 1,
		weightkg: 27,
		color: "Black",
		prevo: "Eevee",
	...
	absol: { // updated
		...
		abilities: { 0: "Anticipation", 1: "Super Luck", H: "Shadow Step" },
		heightm: 1.2,
		weightkg: 47,
		color: "White",
		eggGroups: ["Field"],
	...
	weavile: { // updated
		...
		abilities: { 0: "Malice", 1: "Snow Cloak", H: "Pickpocket" },
		heightm: 1.1,
		weightkg: 34,
		color: "Black",
		prevo: "Sneasel",
