...
exports.BattleAbilities = {
	...
	"parentalbond": {
		...
		onModifyMove: function (move, pokemon, target) {
			if (move.category !== 'Status' && !move.heal && !move.selfdestruct && !move.multihit && ((target.side && target.side.active.length < 2) || move.target in {any:1, normal:1, randomNormal:1})) {
				move.multihit = 2;
