...
let BattleItems = {
	...
	"babiriberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Steel' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
	...
	"chartiberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Rock' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"chopleberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Fighting' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"cobaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Flying' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"colburberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Dark' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"enigmaberry": {
		...
		onHit(target, source, move) {
			if (move && this.getHitData(target).typeMod > 0) {
				if (target.eatItem()) {
	...
	"habanberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Dragon' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"kasibberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Ghost' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"kebiaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Poison' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"occaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Fire' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"passhoberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Water' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"payapaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Psychic' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"rindoberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Grass' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"roseliberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Fairy' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"shucaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Ground' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"tangaberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Bug' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"wacanberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Electric' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
	...
	"weaknesspolicy": {
		...
		onHitPriority: 1,
		onHit(target, source, move) {
			if (target.hp && move.category !== 'Status' && !move.damage && !move.damageCallback && this.getHitData(target).typeMod > 0 && target.useItem()) {
	...
	"yacheberry": {
		...
		onSourceModifyDamage(damage, source, target, move) {
			if (move.type === 'Ice' && this.getHitData(target).typeMod > 0 && (!target.volatiles['substitute'] || move.flags['authentic'] || (move.infiltrates && this.gen >= 6))) {
				if (target.eatItem()) {
					this.debug('-50% reduction');
					this.add('-enditem', target, this.effect, '[weaken]');
					return this.chainModify(0.5);
