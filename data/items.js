...
let BattleItems = {
	...
	"dialgiumz": {
		...
		num: -2,
		gen: 7,
		desc: "If held by a Dialga with Roar of Time, it can use Time Breaker.",
	},
	"palkiumz": {
		id: "palkiumz",
		name: "Palkium Z",
		spritenum: 0,
		onTakeItem: false,
		zMove: "Critical Space",
		zMoveFrom: "Spacial Rend",
		zMoveUser: ["Palkia"],
		num: -3,
		gen: 7,
		desc: "If held by a Palkia with Spacial Rend, it can use Critical Space.",
	},
	"mewtwoniumz": {
		id: "mewtwoniumz",
		name: "Mewtwonium Z",
		spritenum: 0,
		onTakeItem: false,
		zMove: "Ultimate Psychic Power of Relation",
		zMoveFrom: "Psystrike",
		zMoveUser: ["Mewtwo"],
		num: -4,
		gen: 7,
		desc: "If held by a Mewtwo with Psystrike, it can use Ultimate Psychic Power of Relation.",
	},
};
