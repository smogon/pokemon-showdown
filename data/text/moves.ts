export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	knockoff: {
		name: "Knock Off",
		desc: "If the target is holding an item that can be removed from it, this move's power is multiplied by 1.5. If the user has not fainted, the target loses its held item. This move cannot cause Pokemon with the Sticky Hold Ability to lose their held item, unless the user has the Mold Breaker, Turboblaze, or Teravolt Abilities. This move cannot cause a Kyogre, a Groudon, a Dialga-Origin, a Palkia-Origin, a Giratina-Origin, an Arceus, a Genesect, a Silvally, a Zacian, a Zamazenta, or an Ogerpon to lose their Blue Orb, Red Orb, Adamant Crystal, Lustrous Globe, Griseous Core, Plate, Drive, Memory, Rusted Sword, Rusted Shield, or Wellspring/Hearthflame/Cornerstone Mask respectively. It cannot cause a Paradox Pokemon to lose its Booster Energy, unless it is a Koraidon, Miraidon, Gouging Fire, Raging Bolt, Iron Boulder, or Iron Crown. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
		shortDesc: "1.5x damage if foe holds an item. Removes item.",
		gen7: {
			desc: "If the target is holding an item that can be removed from it, this move's power is multiplied by 1.5. If the user has not fainted, the target loses its held item.  If the user has not fainted, the target loses its held item. This move cannot cause Pokemon with the Sticky Hold Ability to lose their held item, unless the user has the Mold Breaker, Turboblaze, or Teravolt Abilities. This move cannot remove Z-Crystals, cause Pokemon that can Mega Evolve to lose the Mega Stone for their species, or cause a Kyogre, a Groudon, a Giratina, an Arceus, a Genesect, or a Silvally to lose their Blue Orb, Red Orb, Griseous Orb, Plate, Drive, or Memory respectively. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
		},
		gen6: {
			desc: "If the target is holding an item that can be removed from it, this move's power is multiplied by 1.5. If the user has not fainted, the target loses its held item. This move cannot cause Pokemon with the Sticky Hold Ability to lose their held item, unless the user has the Mold Breaker, Turboblaze, or Teravolt Abilities. It cannot cause Pokemon that can Mega Evolve to lose the Mega Stone for their species, or cause a Kyogre, a Groudon, a Giratina, an Arceus, or a Genesect to lose their Blue Orb, Red Orb, Griseous Orb, Plate, or Drive, respectively. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
		},
		gen5: {
			desc: "If the user has not fainted, the target loses its held item. This move cannot cause Pokemon with the Sticky Hold Ability to lose their held item (unless the user has the Mold Breaker Ability), or force a Giratina, an Arceus, or a Genesect to lose their Griseous Orb, Plate, or Drive, respectively. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
