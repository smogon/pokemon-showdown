export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	knockoff: {
		name: "Knock Off",
		desc: "If the target is holding an item that can be removed from it, this move's power is multiplied by 1.5. If the user has not fainted, the target loses its held item. This move cannot remove Mega Stones, cause Pokemon that can Mega Evolve to lose the Mega Stone for their species, cause Paradox Pokemon to lose their Booster Energy, cause Ogerpon to lose its masks, or cause a Kyogre, a Groudon, an Arceus, a Genesect, a Silvally, a Zacian, or a Zamazenta to lose their Blue Orb, Red Orb, Plate, Drive, Memory, Rusted Sword, or Rusted Shield respectively. If the target has the Sticky Hold Ability and the user does not have an Ability that ignores Abilities, this move will still receive the power boost but will not remove the held item. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
		shortDesc: "1.5x damage if foe holds an item. Removes item.",
		gen7: {
			desc: "If the target is holding an item that can be removed from it, this move's power is multiplied by 1.5. If the user has not fainted, the target loses its held item. This move cannot remove Z-Crystals, Mega Stones, cause Pokemon that can Mega Evolve to lose the Mega Stone for their species, or cause a Kyogre, a Groudon, an Arceus, a Genesect, or a Silvally to lose their Blue Orb, Red Orb, Plate, Drive, or Memory respectively. If the target has the Sticky Hold Ability and the user does not have an Ability that ignores Abilities, this move will still receive the power boost but will not remove the held item. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
		},
		gen6: {
			desc: "If the target is holding an item that can be removed from it, this move's power is multiplied by 1.5. If the user has not fainted, the target loses its held item. This move cannot remove Mega Stones, cause Pokemon that can Mega Evolve to lose the Mega Stone for their species, or cause a Kyogre, a Groudon, an Arceus, or a Genesect to lose their Blue Orb, Red Orb, Plate, or Drive, respectively. If the target has the Sticky Hold Ability and the user does not have an Ability that ignores Abilities, this move will still receive the power boost but will not remove the held item. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
		},
		gen5: {
			desc: "If the user has not fainted, the target loses its held item. This move cannot cause a Giratina, an Arceus, or a Genesect to lose their Griseous Orb, Plate, or Drive, respectively. If the target has the Sticky Hold Ability and the user does not have an Ability that ignores Abilities, the target will not lose its held item. Items lost to this move cannot be regained with Recycle or the Harvest Ability.",
