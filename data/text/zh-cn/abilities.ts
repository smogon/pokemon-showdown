export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
	...
	auraguard: {
		name: "波导防护",
		shortDesc: "受到的接触类招式伤害减半。", // NEEDS QC
	},
	baddreams: {
		name: "梦魇",
	...
	damp: {
		...
		desc: "该宝可梦在场时，大爆炸、惊爆大头、薄雾炸裂、玉石俱碎和特性引爆无法生效。", // NEEDS QC
		shortDesc: "阻止大爆炸和引爆等自爆类效果。", // NEEDS QC
		gen7: {
			desc: "该宝可梦在场期间，大爆炸、惊爆大头、玉石俱碎和特性引爆不会发动。", // NEEDS QC
			shortDesc: "在场期间阻止大爆炸/惊爆大头/玉石俱碎/引爆。", // NEEDS QC
		},
		gen6: {
			desc: "该宝可梦在场期间，大爆炸、玉石俱碎和特性引爆不会发动。", // NEEDS QC
			shortDesc: "在场期间阻止大爆炸/玉石俱碎/引爆。", // NEEDS QC
		},
		gen3: {
			desc: "该宝可梦在场期间，大爆炸和玉石俱碎不会发动。", // NEEDS QC
			shortDesc: "在场期间阻止大爆炸和玉石俱碎。", // NEEDS QC
		},
	...
	flashfire: {
		...
		gen3: {
			desc: "该宝可梦未处于冰冻状态时不受火属性招式影响。首次被火属性招式击中后，只要仍在场并保持此特性，其火属性攻击的伤害变为1.5倍。该宝可梦处于异常状态时、是火属性时、处于替身状态时，磷火不会触发此特性。", // NEEDS QC
		},
	...
	healer: {
		...
		champions: {
			desc: "每回合结束时，有50%的几率治愈队友的异常状态。", // NEEDS QC
			shortDesc: "每回合有50%的几率治愈队友的异常状态。", // NEEDS QC
		},
		gen6: {
	...
	illuminate: {
		...
		desc: "该宝可梦的命中率不会被其他宝可梦降低。该宝可梦无视目标的闪避率变化。", // NEEDS QC
		shortDesc: "命中率不会被降低，且无视对手的闪避率。", // NEEDS QC
		gen8: {
	...
	mindseye: {
		name: "心眼",
		desc: "该宝可梦的一般属性和格斗属性招式可以击中幽灵属性宝可梦。该宝可梦的命中率不会被其他宝可梦降低。该宝可梦无视目标的闪避率变化。", // NEEDS QC
		shortDesc: "一般和格斗招式可命中幽灵属性，且无视闪避率。", // NEEDS QC
	},
	minus: {
		name: "负电",
	...
	moody: {
		...
		desc: "每回合结束时，该宝可梦随机一项能力（命中率和闪避率除外）提高2级，另一项能力降低1级。", // NEEDS QC
	...
	parentalbond: {
		...
		desc: "该宝可梦的攻击招式变为攻击2次的连续攻击招式，第2次攻击的伤害变为1/4。对破灭之愿、龙箭、极巨炮、蛮干、大爆炸、搏命、投掷、预知未来、冰球、滚动、玉石俱碎、连续攻击招式、以多个目标为对象的招式和需要2回合的招式无效。", // NEEDS QC
		shortDesc: "攻击招式命中2次，第2次伤害为1/4。", // NEEDS QC
		gen8: {
			desc: "该宝可梦的攻击招式变为攻击2次的连续招式。第2次攻击的伤害变为1/4。对破灭之愿、龙箭、极巨炮、蛮干、大爆炸、搏命、投掷、预知未来、冰球、滚动、玉石俱碎、连续攻击招式、以多个对象为目标的招式、需2回合的招式、极巨招式不发动。", // NEEDS QC
		},
		gen7: {
			desc: "该宝可梦的攻击招式变为攻击2次的连续招式。第2次攻击的伤害变为1/4。对破灭之愿、蛮干、大爆炸、搏命、投掷、预知未来、冰球、滚动、玉石俱碎、连续攻击招式、以多个对象为目标的招式、需2回合的招式、Z招式不发动。", // NEEDS QC
		},
		gen6: {
			desc: "该宝可梦的攻击招式变为攻击2次的连续招式。第2次攻击的伤害变为一半。对破灭之愿、蛮干、大爆炸、搏命、投掷、预知未来、冰球、滚动、玉石俱碎、连续攻击招式、以多个对象为目标的招式、需2回合的招式不发动。", // NEEDS QC
	...
	perishbody: {
		...
		desc: "与该宝可梦直接接触时，该宝可梦和攻击方都会进入终焉之歌的效果。若攻击方已有灭亡计数，该宝可梦不会进入此效果。", // NEEDS QC
		shortDesc: "被接触时，双方进入终焉之歌的效果。", // NEEDS QC
	...
	pickup: {
		...
		desc: "每回合结束时，若该宝可梦没有携带道具，且相邻的宝可梦中至少有一只在此回合使用过道具，会随机选择其中一只，获得其最后使用的道具。以下情况不视为最后使用的道具：破裂的气球、被其他具有此特性的宝可梦捡走的道具、因虫咬、腐蚀气体、渴望、烧净、拍落、啄食、小偷而失去的道具。用投掷投掷的道具可以捡到。", // NEEDS QC
		shortDesc: "未携带道具时，捡走本回合被使用的道具。", // NEEDS QC
		gen7: {
			desc: "每回合结束时，若该宝可梦没有携带道具且相邻的宝可梦本回合使用过道具，则随机选择其中1只，获得其最后使用的道具。破裂的气球、被其他拥有此特性的宝可梦捡走的道具、因虫咬、渴望、烧净、拍落、啄食、小偷失去的道具不视为最后使用的道具。用投掷投掷的道具可以捡取。", // NEEDS QC
		},
		gen4: {
			desc: "没有对战效果。", // NEEDS QC
			shortDesc: "没有对战效果。", // NEEDS QC
	...
	pressure: {
		...
		desc: "该宝可梦成为对手招式的目标时，该招式额外消耗1点PP。对手使用封印、化为己用、太晶爆发时也额外消耗1点PP，但黏黏网不会。", // NEEDS QC
	...
	sandveil: {
		...
		shortDesc: "沙暴时闪避率变为1.25倍，且免疫沙暴伤害。", // NEEDS QC
	},
	sapsipper: {
		name: "食草",
	...
	shielddust: {
		...
		desc: "该宝可梦不受其他宝可梦攻击的追加效果影响。被防止的追加效果包括：有一定几率（即使是100%）使该宝可梦陷入麻痹、睡眠、冰冻、灼伤、中毒、混乱状态，使其畏缩，或降低其能力等级的效果，以及掷锚、诡异咒语、投掷、精神噪音、盐腌、缝影、糖浆炸弹、深渊突刺的效果。泡影的咏叹调的效果只有在该宝可梦是唯一目标时才会被防止。王者之证、锐利之牙以及特性毒手、恶臭、毒锁链附加的追加效果也会被防止。", // NEEDS QC
		shortDesc: "不受对手招式的追加效果影响。", // NEEDS QC
		gen8: {
			desc: "该宝可梦不受其他宝可梦攻击的追加效果影响。可以防止有几率（即使是100%）造成麻痹、睡眠、冰冻、灼伤、中毒、混乱、畏缩、能力下降的攻击以及掷锚、诡异咒语、投掷、缝影、深渊突刺的追加效果。该宝可梦是唯一目标时，也防止泡影的咏叹调的效果。也不受王者之证、锐利之牙以及特性毒手、恶臭附加的追加效果影响。", // NEEDS QC
		},
		gen7: {
			desc: "该宝可梦不受其他宝可梦攻击的追加效果影响。可以防止有几率（即使是100%）造成麻痹、睡眠、冰冻、灼伤、中毒、混乱、畏缩、能力下降的攻击以及掷锚、投掷、缝影、深渊突刺的追加效果。该宝可梦是唯一目标时，也防止泡影的咏叹调的效果。也不受王者之证、锐利之牙以及特性毒手、恶臭附加的追加效果影响。", // NEEDS QC
		},
		gen6: {
	...
	snowcloak: {
		...
		shortDesc: "下雪时闪避率变为1.25倍。", // NEEDS QC
		gen8: {
			desc: "天气为冰雹时，以该宝可梦为目标的招式命中率变为0.8倍。不受冰雹的伤害。", // NEEDS QC
			shortDesc: "冰雹时闪避率变为1.25倍。不受冰雹伤害。", // NEEDS QC
		},
	},
	snowwarning: {
		name: "降雪",
	...
	supersweetsyrup: {
		name: "甘露之蜜",
		shortDesc: "出场时使对手的闪避率降低1级。每场战斗1次。", // NEEDS QC
	...
	tangledfeet: {
		name: "蹒跚",
		shortDesc: "混乱期间，闪避率变为2倍。", // NEEDS QC
	},
	tanglinghair: {
		name: "卷发",
		shortDesc: "接触自己的对手速度降低1级。", // NEEDS QC
	...
	unaware: {
		...
		desc: "该宝可梦受到伤害时，无视其他宝可梦的攻击、特攻和命中率的能力等级变化；造成伤害时，无视其他宝可梦的防御、特防和闪避率的能力等级变化。", // NEEDS QC
