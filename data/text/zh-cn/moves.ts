export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	airslash: {
		name: "空气之刃", // renamed in SV (SwSh: 空气斩)
	...
	alluringvoice: {
		...
		shortDesc: "本回合提升过能力的目标必定混乱。", // NEEDS QC
	},
	allyswitch: {
		name: "交换场地",
	...
	assist: {
		name: "借助",
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
		desc: "从使用者以外的同行宝可梦学会的招式中，随机选择1个使出。但不会选择借助、碉堡、鸟嘴加农炮、打嗝、传递礼物、灼热暴冲、弹跳、庆祝、喋喋不休、巴投、格斗暴冲、仿效、双倍奉还、渴望、同命、看穿、挖洞、潜水、龙尾、挺住、佯攻、飞翔、真气拳、看我嘛、帮助、牵手、王者盾牌、魔法暴冲、掀榻榻米、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、剧毒暴冲、潜灵奇袭、守住、愤怒粉、吼叫、暗影潜袭、陷阱甲壳、写生、自由落体、梦话、化为己用、尖刺防守、聚光灯、挣扎、掉包、晶光星群、小偷、变身、戏法、吹飞、黑暗暴冲。", // NEEDS QC
		shortDesc: "随机使出同伴学会的招式。", // NEEDS QC
		gen8: {
			desc: "从使用者以外的同行宝可梦学会的招式中，随机选择1个使出。但不会选择借助、碉堡、鸟嘴加农炮、打嗝、传递礼物、弹跳、庆祝、喋喋不休、巴投、仿效、双倍奉还、渴望、同命、看穿、挖洞、潜水、龙尾、挺住、佯攻、飞翔、真气拳、看我嘛、帮助、牵手、王者盾牌、掀榻榻米、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、潜灵奇袭、守住、愤怒粉、吼叫、暗影潜袭、陷阱甲壳、写生、自由落体、梦话、化为己用、尖刺防守、聚光灯、挣扎、掉包、小偷、变身、戏法、吹飞。", // NEEDS QC
		},
		gen7: {
			desc: "从使用者以外的同行宝可梦学会的招式中，随机选择1个使出。但不会选择借助、碉堡、鸟嘴加农炮、打嗝、传递礼物、弹跳、庆祝、喋喋不休、巴投、仿效、双倍奉还、渴望、同命、看穿、挖洞、潜水、龙尾、挺住、佯攻、飞翔、真气拳、看我嘛、帮助、牵手、王者盾牌、掀榻榻米、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、潜灵奇袭、守住、愤怒粉、吼叫、暗影潜袭、陷阱甲壳、写生、自由落体、梦话、化为己用、尖刺防守、聚光灯、挣扎、掉包、小偷、变身、戏法、吹飞以及Ｚ招式。", // NEEDS QC
		},
		gen6: {
			desc: "从使用者以外的同行宝可梦学会的招式中，随机选择1个使出。但不会选择借助、打嗝、传递礼物、弹跳、庆祝、喋喋不休、巴投、仿效、双倍奉还、渴望、同命、看穿、挖洞、潜水、龙尾、挺住、佯攻、飞翔、真气拳、看我嘛、帮助、牵手、王者盾牌、掀榻榻米、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、潜灵奇袭、守住、愤怒粉、吼叫、暗影潜袭、写生、自由落体、梦话、化为己用、尖刺防守、挣扎、掉包、小偷、变身、戏法、吹飞。", // NEEDS QC
		},
		gen5: {
			desc: "从使用者以外的同行宝可梦学会的招式中，随机选择1个使出。但不会选择借助、传递礼物、喋喋不休、巴投、仿效、双倍奉还、渴望、同命、看穿、龙尾、挺住、佯攻、真气拳、看我嘛、帮助、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、守住、愤怒粉、写生、梦话、化为己用、挣扎、掉包、小偷、变身、戏法。", // NEEDS QC
		},
		gen4: {
			desc: "从使用者以外的同行宝可梦学会的招式中，随机选择1个使出。但不会选择借助、喋喋不休、仿效、双倍奉还、渴望、同命、看穿、挺住、佯攻、真气拳、看我嘛、帮助、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、守住、写生、梦话、化为己用、挣扎、掉包、小偷、戏法。", // NEEDS QC
		},
		gen3: {
			desc: "从使用者以外的同行宝可梦学会的招式中，随机选择1个使出。但不会选择借助、双倍奉还、渴望、同命、看穿、挺住、真气拳、看我嘛、帮助、挥指、模仿、镜面反射、鹦鹉学舌、守住、写生、梦话、化为己用、挣扎、小偷、戏法。", // NEEDS QC
		},
	},
	assurance: {
		name: "恶意追击",
		// Official flavor text: "如果此回合内对手 已经受到伤害的话， 招式威力会变成２倍。"
		desc: "本回合已经受到过伤害的目标，受到的威力变为2倍。但腹鼓、混乱、咒术、分担痛楚造成的直接伤害不计入。", // NEEDS QC
	...
	axekick: {
		name: "下压踢",
		desc: "有30%的几率使目标陷入混乱状态。攻击未命中时，使用者受到最大HP的1/2（向下取整）的坠落伤害。特性为魔法防守的宝可梦不受坠落伤害。", // NEEDS QC
	...
	batonpass: {
		...
		desc: "与同行的其他宝可梦交换。接替的宝可梦继承使用者的能力等级变化，以及混乱、水流环、咒术、龙声鼓舞、查封、聚气、胃液、回复封锁、扎根、寄生种子、锁定（心之眼）、电磁飘浮、终焉之歌、力量戏法、意念移物的效果和保留剩余HP的替身。接替的宝可梦的特性无法被无效化时，不继承胃液的效果。", // NEEDS QC
		shortDesc: "继承能力变化等并与同伴交换。", // NEEDS QC
		gen8: {
			desc: "与同行的其他宝可梦交换。接替的宝可梦继承使用者的能力等级变化，以及混乱、水流环、咒术、查封、聚气、胃液、回复封锁、扎根、寄生种子、锁定（心之眼）、电磁飘浮、终焉之歌、力量戏法、意念移物的效果和保留剩余HP的替身。接替的宝可梦的特性无法被无效化时，不继承胃液的效果。", // NEEDS QC
		},
		gen7: {
			desc: "与同行的其他宝可梦交换。接替的宝可梦继承使用者的能力等级变化，以及混乱、水流环、咒术、查封、聚气、胃液、回复封锁、扎根、寄生种子、锁定（心之眼）、电磁飘浮、终焉之歌、力量戏法、意念移物的效果、因黑色目光（挡路、蛛网）而无法交换的效果和保留剩余HP的替身。接替的宝可梦的特性无法被无效化时，不继承胃液的效果。接替的宝可梦是超级耿鬼时，不继承意念移物的效果。", // NEEDS QC
		},
		gen5: {
			desc: "与同行的其他宝可梦交换。接替的宝可梦继承使用者的能力等级变化，以及混乱、水流环、咒术、查封、聚气、胃液、回复封锁、扎根、寄生种子、锁定（心之眼）、电磁飘浮、终焉之歌、力量戏法、意念移物的效果、因黑色目光（挡路、蛛网）而无法交换的效果和保留剩余HP的替身。", // NEEDS QC
		},
		gen4: {
			desc: "与同行的其他宝可梦交换。接替的宝可梦继承使用者的能力等级变化，以及混乱、水流环、咒术、查封、聚气、胃液、回复封锁、扎根、寄生种子、锁定（心之眼）、电磁飘浮、玩泥巴、终焉之歌、力量戏法、玩水的效果、因黑色目光（挡路、蛛网）而使对手无法交换或自己无法交换的效果和保留剩余HP的替身。", // NEEDS QC
		},
		gen3: {
			desc: "与同行的其他宝可梦交换。接替的宝可梦继承使用者的能力等级变化，以及混乱、咒术、聚气、扎根、寄生种子、锁定（心之眼）、玩泥巴、终焉之歌、玩水的效果、因黑色目光（挡路、蛛网）而使对手无法交换或自己无法交换的效果和保留剩余HP的替身。", // NEEDS QC
		},
		gen2: {
			desc: "与同行的其他宝可梦交换。接替的宝可梦继承使用者的能力等级变化，以及混乱、咒术、变圆、聚气、识破、寄生种子、锁定（心之眼）、变小、白雾、终焉之歌的效果、因黑色目光（蛛网）而使对手无法交换或自己无法交换的效果和保留剩余HP的替身。", // NEEDS QC
		},
	},
	beakblast: {
		name: "鸟嘴加农炮",
	...
	belch: {
		...
		champions: {
			desc: "使用者没有吃过树果时失败。吃掉携带的树果、用虫咬或啄食夺取并吃掉目标的树果、吃掉被投掷投掷过来的树果均可满足条件。用自然之恩消耗树果不算吃掉树果。", // NEEDS QC
			shortDesc: "没有吃过树果时失败。", // NEEDS QC
		},
	},
	bellydrum: {
		name: "腹鼓",
	...
	bestow: {
		name: "传递礼物",
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
		desc: "将使用者的携带道具交给目标。使用者没有道具或携带Ｚ纯晶时、目标已携带道具时失败。道具是超级石且使用者或目标是能用它超级进化的宝可梦时，或道具是靛蓝色宝珠、朱红色宝珠、白金宝珠、属性板、卡带、存储碟且使用者或目标分别是盖欧卡、固拉多、骑拉帝纳、阿尔宙斯、盖诺赛克特、银伴战兽时也会失败。", // NEEDS QC
	...
	blizzard: {
		...
		gen8: {
			desc: "有10%的几率使目标陷入冰冻状态。天气为冰雹时必定命中。", // NEEDS QC
	...
	brickbreak: {
		...
		gen4: {
			...
			shortDesc: "破坏屏障，即使对目标无效。", // NEEDS QC
		},
		gen3: {
			desc: "攻击没有落空时，无论目标是否免疫，都在伤害计算前消除目标方场上的反射壁、光墙效果。", // NEEDS QC
		},

		activate: "  {POKEMON}打破了{TEAM}的屏障！", // NEEDS QC
	},
	brine: {
		name: "盐水",
	...
	burningjealousy: {
		...
		shortDesc: "本回合提升过能力的目标必定灼伤。", // NEEDS QC
	},
	burnup: {
		name: "燃尽",
	...
	chipaway: {
		name: "逐步击破",
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
		desc: "无视目标的能力等级变化（包括闪避率）进行攻击。", // NEEDS QC
	...
	conversion: {
		...
		gen4: {
			desc: "使用者的属性随机变为自己此招式和咒术以外的招式之一的原本属性（使用者当前的属性除外）。使用者的属性无法改变时，或只能选到使用者当前属性时失败。", // NEEDS QC
		},
		gen3: {
			desc: "使用者的属性随机变为自己咒术以外的招式之一的原本属性（使用者当前的属性除外）。使用者的属性无法改变时，或只能选到使用者当前属性时失败。", // NEEDS QC
		},
		gen1: {
	...
	copycat: {
		...
		desc: "使出（包括自己在内）任意宝可梦最后使用的招式。还没有招式被使用过时，或最后使用的招式是借助、碉堡、鸟嘴加农炮、巨兽弹、巨兽斩、打嗝、传递礼物、灼热暴冲、庆祝、喋喋不休、巴投、格斗暴冲、仿效、双倍奉还、渴望、同命、看穿、龙尾、极巨炮、挺住、佯攻、真气拳、看我嘛、帮助、牵手、王者盾牌、魔法暴冲、掀榻榻米、抢先一步、挥指、模仿、鹦鹉学舌、自然之力、剧毒暴冲、守住、愤怒粉、吼叫、陷阱甲壳、写生、梦话、化为己用、尖刺防守、聚光灯、挣扎、掉包、晶光星群、小偷、变身、戏法、吹飞、黑暗暴冲时失败。", // NEEDS QC
		shortDesc: "使出最后被使用过的招式。", // NEEDS QC
		gen8: {
			desc: "使出（包括自己在内）任意宝可梦最后使用的招式。极巨招式和超极巨招式按原本招式判定。还没有招式被使用过时，或最后使用的招式是借助、碉堡、鸟嘴加农炮、巨兽弹、巨兽斩、打嗝、传递礼物、庆祝、喋喋不休、巴投、仿效、双倍奉还、渴望、同命、看穿、龙尾、极巨炮、挺住、佯攻、真气拳、看我嘛、帮助、牵手、王者盾牌、掀榻榻米、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、守住、愤怒粉、吼叫、陷阱甲壳、写生、梦话、化为己用、尖刺防守、聚光灯、挣扎、掉包、小偷、变身、戏法、吹飞时失败。", // NEEDS QC
		},
		gen7: {
			desc: "使出（包括自己在内）任意宝可梦最后使用的招式。还没有招式被使用过时，或最后使用的招式是借助、碉堡、鸟嘴加农炮、打嗝、传递礼物、庆祝、喋喋不休、巴投、仿效、双倍奉还、渴望、同命、看穿、龙尾、挺住、佯攻、真气拳、看我嘛、帮助、牵手、王者盾牌、掀榻榻米、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、守住、愤怒粉、吼叫、陷阱甲壳、写生、梦话、化为己用、尖刺防守、聚光灯、挣扎、掉包、小偷、变身、戏法、吹飞或Ｚ招式时失败。", // NEEDS QC
		},
		gen6: {
			desc: "使出（包括自己在内）任意宝可梦最后使用的招式。还没有招式被使用过时，或最后使用的招式是借助、打嗝、传递礼物、庆祝、喋喋不休、巴投、仿效、双倍奉还、渴望、同命、看穿、龙尾、挺住、佯攻、真气拳、看我嘛、帮助、牵手、王者盾牌、掀榻榻米、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、守住、愤怒粉、吼叫、写生、梦话、化为己用、尖刺防守、挣扎、掉包、小偷、变身、戏法、吹飞时失败。", // NEEDS QC
		},
		gen5: {
			desc: "使出（包括自己在内）任意宝可梦最后使用的招式。还没有招式被使用过时，或最后使用的招式是借助、传递礼物、喋喋不休、巴投、仿效、双倍奉还、渴望、同命、看穿、龙尾、挺住、佯攻、真气拳、看我嘛、帮助、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、守住、愤怒粉、写生、梦话、化为己用、挣扎、掉包、小偷、变身、戏法时失败。", // NEEDS QC
		},
		gen4: {
			desc: "使出（包括自己在内）任意宝可梦最后使用的招式。还没有招式被使用过时，或最后使用的招式是借助、喋喋不休、仿效、双倍奉还、渴望、同命、看穿、挺住、佯攻、真气拳、看我嘛、帮助、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、守住、写生、梦话、化为己用、挣扎、掉包、小偷、戏法时失败。", // NEEDS QC
		},
	},
	coreenforcer: {
		name: "核心惩罚者",
	...
	covet: {
		...
		champions: {
			desc: "攻击成功且使用者没有携带道具时，夺取目标携带的道具。特性为黏着的目标未濒死时不会失去道具。道具是超级石且使用者或目标是能用它超级进化的宝可梦时无法夺取。因此招式失去的道具无法用回收利用或特性收获取回。", // NEEDS QC
		},
		gen8: {
		...
		gen7: {
			desc: "攻击成功且使用者未濒死时，若使用者没有携带道具，则夺取目标携带的道具。特性为黏着的目标只要未濒死就不会失去道具。道具是Ｚ纯晶、能用它超级进化的宝可梦所携带的超级石，或盖欧卡、固拉多、骑拉帝纳、阿尔宙斯、盖诺赛克特、银伴战兽分别携带的靛蓝色宝珠、朱红色宝珠、白金宝珠、属性板、卡带、存储碟时无法夺取，使用者是这些宝可梦且目标携带对应道具时也无法夺取。因此招式失去的道具无法用回收利用或特性收获取回。", // NEEDS QC
		},
		gen6: {
	...
	curse: {
		...
		shortDesc: "幽灵属性则施加咒术，否则速度-1、攻防+1。", // NEEDS QC
		gen4: {
	...
	cut: {
		name: "居合劈", // renamed in SV (SwSh: 居合斩)
		shortDesc: "无追加效果。", // NEEDS QC
	},
	darkestlariat: {
		name: "ＤＤ金勾臂",
	...
	defog: {
		...
		desc: "使目标的闪避率降低1级。攻击成功后，无论闪避率是否下降，目标方场上的反射壁、光墙、极光幕、神秘守护、白雾、撒菱、毒菱、隐形岩、黏黏网效果和己方场上的撒菱、毒菱、隐形岩、黏黏网效果消失。可以无视替身，但替身仍会挡下闪避率的降低。攻击成功且存在场地时，场地也会被消除。", // NEEDS QC
		shortDesc: "闪避率-1。消除双方陷阱和场地。", // NEEDS QC
		gen7: {
			...
			shortDesc: "闪避率-1。清除双方场上的陷阱。", // NEEDS QC
		},
		gen6: {
		...
		gen5: {
			...
			shortDesc: "闪避率-1。清除对方的陷阱和屏障。", // NEEDS QC
		},
	},
	destinybond: {
		name: "同命",
	...
	direclaw: {
		...
		champions: {
			desc: "有30%的几率使目标陷入睡眠、中毒或麻痹状态之一。", // NEEDS QC
			shortDesc: "30%几率使目标睡眠、中毒或麻痹。", // NEEDS QC
		},
	},
	disable: {
		name: "定身法",
		...
		gen7: {
			desc: "4回合内，使目标最后使用的招式无法使用。目标的招式已受此效果时、目标还未使用过招式时、目标已不会该招式时、该招式是Ｚ招式时失败。效果期间仍可以选择并使出Ｚ力量强化的招式。", // NEEDS QC
		},
		gen6: {
	...
	doubleteam: {
		...
		desc: "使用者的闪避率提高1级。", // NEEDS QC
		shortDesc: "自身的闪避率提高1级。", // NEEDS QC
	},
	dracometeor: {
		name: "流星群",
	...
	dragoncheer: {
		...
		shortDesc: "队友击中要害等级+1（龙则+2）。", // NEEDS QC
	...
	echoedvoice: {
		...
		desc: "每回合都有宝可梦接着使用此招式时，威力变为经过回合数的倍数（最多5倍）。", // NEEDS QC
	...
	encore: {
		...
		gen7: {
			desc: "接下来3回合内，目标被迫重复使用最后使用的招式。该招式PP耗尽时效果结束。目标已受此效果时、还未使用过招式时、该招式PP为0时、该招式是借助、仿效、再来一次、抢先一步、挥指、模仿、鹦鹉学舌、自然之力、写生、梦话、挣扎、变身或Ｚ招式时失败。效果期间仍可以选择并使出Ｚ力量强化的招式。", // NEEDS QC
		},
		gen6: {
	...
	fakeout: {
		...
		champions: {
			desc: "有100%的几率使目标畏缩。不是使用者出场后的第1回合时无法选择此招式。", // NEEDS QC
		},
	},
	faketears: {
		name: "假哭",
	...
	firstimpression: {
		...
		champions: {
			desc: "不是使用者出场后的第1回合时无法选择此招式。", // NEEDS QC
		},
	},
	fishiousrend: {
		name: "鳃咬",
	...
	fissure: {
		...
		desc: "造成与目标最大HP相同的伤害。无视命中率和闪避率的变化。此招式的命中率为（使用者的等级−目标的等级+30）%，目标的等级高于使用者时失败。对特性为结实的宝可梦无效。", // NEEDS QC
	...
	fly: {
		...
		desc: "第1回合飞上高空，第2回合攻击。飞在空中期间，只会被起风、暴风、冲天拳、击落、千箭齐发、打雷、龙卷风击中，其中起风和龙卷风的威力变为2倍。携带强力香草时，1回合内完成攻击。", // NEEDS QC
	...
	foresight: {
		name: "识破",
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
		desc: "目标在场期间，其闪避率等级为+1以上时在命中判定中被无视，且一般属性和格斗属性的攻击可以命中幽灵属性的目标。目标已受此效果或奇迹之眼、气味侦测的效果影响时失败。", // NEEDS QC
		shortDesc: "一般和格斗可命中幽灵。无视闪避率。", // NEEDS QC
		gen4: {
	...
	forestscurse: {
		name: "森林咒术", // renamed in SV (SwSh: 森林诅咒)
	...
	foulplay: {
		name: "移花接木", // renamed in SV (SwSh: 欺诈)
	...
	freezedry: {
		...
		champions: {
			desc: "无论此招式属性如何，对水属性的相性都变为效果绝佳。", // NEEDS QC
			shortDesc: "对水属性效果绝佳。", // NEEDS QC
		},
	},
	freezeshock: {
		name: "冰冻伏特",
	...
	gmaxtartness: {
		name: "超极巨酸不溜丢",
		desc: "威力与原招式的极巨招式威力相同。攻击成功后，对手方所有宝可梦的闪避率降低1级（处于替身状态也会受到效果）。", // NEEDS QC
		shortDesc: "威力由原招式决定。对手方闪避率-1。", // NEEDS QC
	},
	gmaxterror: {
		name: "超极巨幻影幽魂",
	...
	gravity: {
		...
		desc: "5回合内，场上所有宝可梦的闪避率变为0.6倍。使用时，场上所有宝可梦的弹跳、飞翔、电磁飘浮、自由落体、意念移物效果立即结束。效果期间，场上所有宝可梦无法使用弹跳、飞翔、飞身重压、飞膝踢、飞踢、电磁飘浮、自由落体、跃起、意念移物。地面属性的攻击和撒菱、毒菱、黏黏网、特性沙穴会对飞行属性宝可梦和特性为飘浮的宝可梦生效。已有此效果时失败。", // NEEDS QC
		shortDesc: "5回合内地面免疫失效，命中1.67倍。", // NEEDS QC
		gen7: {
			desc: "5回合内，场上所有宝可梦的闪避率变为0.6倍。使用时，所有宝可梦的弹跳、飞翔、电磁飘浮、自由落体、意念移物立即结束。效果期间，所有宝可梦都无法使用弹跳、飞翔、飞身重压、飞膝踢、飞踢、电磁飘浮、自由落体、跃起、意念移物。地面属性攻击、撒菱、毒菱、黏黏网和特性沙穴对飞行属性或特性为飘浮的宝可梦也能生效。效果已发动时失败。相关的Ｚ力量强化的招式仍可选择，但效果期间执行时会被阻止。", // NEEDS QC
		},
		gen6: {
			desc: "5回合内，场上所有宝可梦的闪避率变为0.6倍。使用时，场上所有宝可梦的弹跳、飞翔、电磁飘浮、自由落体、意念移物效果立即结束。效果期间，场上所有宝可梦无法使用弹跳、飞翔、飞身重压、飞膝踢、飞踢、电磁飘浮、自由落体、跃起、意念移物。地面属性的攻击和撒菱、毒菱、黏黏网、特性沙穴会对飞行属性宝可梦和特性为飘浮的宝可梦生效。已有此效果时失败。", // NEEDS QC
		},
	...
	growth: {
		...
		gen7: {
			desc: "使用者的攻击和特攻各提高1级。天气为大晴天或大日照时，各提高2级。", // NEEDS QC
		},
		gen5: {
	...
	guillotine: {
		name: "极落钳", // renamed in SV (SwSh: 断头钳)
	...
	haze: {
		...
		shortDesc: "重置所有宝可梦的能力等级变化。", // NEEDS QC
		gen1: {
			desc: "将双方宝可梦的能力等级重置为0，并消除灼伤和麻痹造成的能力下降。将剧毒计数重置为0，并消除双方宝可梦的混乱、定身法、聚气、寄生种子、光墙、白雾、反射壁的效果。消除对手的异常状态。", // NEEDS QC
	...
	healblock: {
		...
		gen7: {
			desc: "5回合内，目标在场期间无法回复HP。效果期间，回复招式和吸取招式无法使用，有回复效果的特性和道具也不会发动。受影响的宝可梦使用接棒后，接替的宝可梦也无法回复HP。分担痛楚和特性再生力不受影响。相关的Ｚ力量强化的招式在效果期间仍可选择并使出。", // NEEDS QC
		},
		gen6: {
			desc: "5回合内，目标在场期间无法回复HP。效果期间，回复类和吸取类招式无法使用，有回复效果的特性和道具也不会回复。受影响的宝可梦使用接棒后，接替的宝可梦也无法回复HP。分担痛楚和特性再生力不受影响。", // NEEDS QC
		},
	...
	healingwish: {
		...
		desc: "使用者濒死，代替出场的宝可梦HP不满或有异常状态时，其HP被完全回复，异常状态也被治愈。交换在回合结束时进行，回复先于陷阱的效果发动。此效果持续到满足条件的宝可梦交换到使用者的位置，或通过交换场地移动到该位置为止。使用者是同行最后一只未濒死的宝可梦时失败。", // NEEDS QC
		shortDesc: "自己濒死，下一只受伤宝可梦被完全回复。", // NEEDS QC
		gen7: {
			desc: "使用者濒死，接替出场的宝可梦回复全部HP并治愈异常状态。新的宝可梦在回合结束时出场，回复在陷阱生效前进行。使用者是队伍中最后一只未濒死的宝可梦时失败。", // NEEDS QC
			shortDesc: "使用者濒死。接替者完全回复。", // NEEDS QC
		},
		gen4: {
			desc: "使用者濒死，接替出场的宝可梦回复全部HP并治愈异常状态。新的宝可梦立即出场，回复在陷阱生效后进行。使用者是队伍中最后一只未濒死的宝可梦时失败。", // NEEDS QC
		},
	...
	highjumpkick: {
		...
		desc: "攻击未命中时，使用者受到最大HP的1/2（向下取整）的坠落伤害。特性为魔法防守的宝可梦不受坠落伤害。", // NEEDS QC
	...
	hurricane: {
		...
		gen7: {
			desc: "有30%的几率使目标陷入混乱状态。可以命中正在使用弹跳、飞翔、自由落体或处于自由落体效果下的目标。天气为大雨或下雨时必定命中。天气为大日照或大晴天时，命中率变为50%。", // NEEDS QC
		},
		gen5: {
			desc: "有30%的几率使目标陷入混乱状态。可以命中正在使用弹跳、飞翔、自由落体或处于自由落体效果下的目标。天气为下雨时必定命中。天气为大晴天时，命中率变为50%。", // NEEDS QC
		},
	},
	hydrocannon: {
		name: "加农水炮",
	...
	hyperfang: {
		name: "终结门牙", // renamed in SV (SwSh: 必杀门牙)
	...
	hyperspacefury: {
		...
		desc: "使用者的防御降低1级。（考虑变身后的）当前样子不是解放胡帕时无法使用。攻击成功后，本回合打破目标的碉堡、看穿、王者盾牌、守住、尖刺防守守护，其他宝可梦也可以正常攻击目标。目标方受戏法防守、掀榻榻米、快速防守、广域防守保护时，该守护本回合也被打破，其他宝可梦可以正常攻击目标方。", // NEEDS QC
	...
	imprison: {
		...
		gen7: {
			desc: "使用者在场期间，对手无法使用使用者也会的招式。效果期间仍可以选择并使出Ｚ力量强化的招式。", // NEEDS QC
		},
		gen6: {
			desc: "使用者在场期间，所有对手都无法使用与使用者相同的招式。", // NEEDS QC
		},
	...
	inferno: {
		name: "烈火深渊", // renamed in SV (SwSh: 炼狱)
	...
	infestation: {
		name: "纠缠不休", // renamed in SV (SwSh: 死缠烂打)
	...
	instruct: {
		...
		gen7: {
			desc: "目标立即再次使用最后使用的招式。目标还未使用过招式时、该招式PP为0时、目标正准备使用鸟嘴加农炮、真气拳、陷阱甲壳时，或该招式是借助、鸟嘴加农炮、打嗝、忍耐、庆祝、喋喋不休、仿效、真气拳、牵手、冰球、号令、王者盾牌、抢先一步、挥指、模仿、鹦鹉学舌、自然之力、逆鳞、花瓣舞、滚动、陷阱甲壳、写生、梦话、挣扎、大闹一番、变身、吵闹、需2回合的招式、会因反作用力无法行动的招式、Ｚ招式时失败。", // NEEDS QC
		},
	...
	knockoff: {
		...
		champions: {
			desc: "目标携带道具时，威力变为1.5倍，并使目标失去携带道具。特性为黏着的目标未濒死时不会失去道具。道具是能用它超级进化的宝可梦所携带的超级石时，威力不会提高，道具也不会被拍落。因此招式失去的道具无法用回收利用或特性收获取回。", // NEEDS QC
		},
		gen8: {
		...
		gen7: {
			desc: "目标携带道具时此招式威力变为1.5倍，且使用者未濒死的话目标失去该道具。特性为黏着的目标只要未濒死就不会失去道具。道具是Ｚ纯晶、能用它超级进化的宝可梦所携带的超级石，或盖欧卡、固拉多、骑拉帝纳、阿尔宙斯、盖诺赛克特、银伴战兽分别携带的靛蓝色宝珠、朱红色宝珠、白金宝珠、属性板、卡带、存储碟时，威力不会提高也无法夺去道具，使用者是这些宝可梦且目标携带对应道具时也一样。因此招式失去的道具无法用回收利用或特性收获取回。", // NEEDS QC
		},
		gen6: {
	...
	makeitrain: {
		...
		champions: {
			desc: "使用者的特攻降低2级。", // NEEDS QC
			shortDesc: "自身特攻-2。攻击所有对手。", // NEEDS QC
		},
	...
	mefirst: {
		...
		gen7: {
			desc: "可能的情况下，以1.5倍威力抢先使出目标本回合所选的招式。只能抢先鸟嘴加农炮、打嗝、喋喋不休、双倍奉还、渴望、真气拳、抢先一步、金属爆炸、镜面反射、陷阱甲壳、挣扎、小偷及Ｚ招式以外的攻击招式。目标先于使用者行动时失败。复制招式时无视目标的替身。", // NEEDS QC
		},
		gen6: {
	...
	metronome: {
		...
		desc: "从您先请、苹果酸、铠农炮、借助、星碎、气场轮、碉堡、鸟嘴加农炮、巨兽弹、巨兽斩、打嗝、传递礼物、灼热暴冲、扑击、木枝突刺、广域破坏、庆祝、喋喋不休、泼冷水、冷笑话、魂舞烈音爆、全开猛撞、格斗暴冲、复仇、仿效、双倍奉还、渴望、戏法防守、装饰、同命、看穿、钻石风暴、描绘、钢拳双击、电光双击、画龙点睛、巨龙威能、鼓击、极巨炮、闪电猛冲、挺住、无极光束、假跪真撞、佯攻、怒火中烧、甩肉、花朵加农炮、真气拳、看我嘛、冰冻伏特、冰冷视线、雪矛、万有引力、帮助、牵手、强力钻、异次元猛攻、异次元洞、极寒冷焰、号令、喷射拳、丛林治疗、王者盾牌、生命水滴、破灭之光、魔法暴冲、淘金潮、掀榻榻米、抢先一步、流星突击、挥指、模仿、惊爆大头、镜面反射、鹦鹉学舌、暗影之光、自然之力、自然之怒、剧毒暴冲、拦堵、上菜、根源波动、破音、光子喷涌、等离子闪电拳、鼠数儿、虫扑、力量转换、断崖之剑、守住、火焰球、延后、快速防守、愤怒之拳、愤怒粉、怒牛、大愤慨、古老之歌、复生祈祷、大灾难、盐腌、神秘之剑、断尾、陷阱甲壳、线阱、写生、梦话、捕兽夹、大声咆哮、化为己用、打鼾、雪景、暗影偷盗、辣椒精华、尖刺防守、灵魂冲击、聚光灯、阳春风暴、蒸汽爆炸、铁蹄光线、神奇蒸汽、挣扎、流星闪冲、水流连打、掉包、高科技光炮、晶光星群、小偷、千箭齐发、千波激荡、雷电囚笼、雷鸣蹴击、大扫除、起草、变身、戏法、双光束、Ｖ热焰、暗冥强击、黑暗暴冲、广域防守以外的招式中，随机选择1个使出。", // NEEDS QC
		shortDesc: "随机使出招式。", // NEEDS QC
		gen8bdsp: {
			desc: "从您先请、打嗝、扑击、喋喋不休、仿效、双倍奉还、渴望、同命、看穿、画龙点睛、挺住、佯攻、真气拳、看我嘛、帮助、生命水滴、挥指、模仿、镜面反射、自然之力、根源波动、断崖之剑、守住、延后、快速防守、愤怒粉、写生、梦话、大声咆哮、打鼾、尖刺防守、挣扎、掉包、小偷、变身、戏法、广域防守以外的招式中，随机选择1个使出。", // NEEDS QC
		},
		gen7letsgo: {
			desc: "从第1世代登场的招式（双倍奉还、模仿、鹦鹉学舌、挣扎、变身除外）中，随机选择1个使出。", // NEEDS QC
			shortDesc: "随机使出第1世代的招式。", // NEEDS QC
		},
		gen8: {
			desc: "从您先请、苹果酸、借助、星碎、气场轮、碉堡、鸟嘴加农炮、巨兽弹、巨兽斩、打嗝、传递礼物、扑击、木枝突刺、广域破坏、庆祝、喋喋不休、魂舞烈音爆、仿效、双倍奉还、渴望、戏法防守、装饰、同命、看穿、钻石风暴、钢拳双击、画龙点睛、巨龙威能、龙锤、鼓击、极巨炮、挺住、无极光束、假跪真撞、佯攻、怒火中烧、花朵加农炮、真气拳、看我嘛、冰冻伏特、冰冷视线、雪矛、万有引力、帮助、牵手、异次元猛攻、异次元洞、极寒冷焰、号令、丛林治疗、王者盾牌、生命水滴、破灭之光、掀榻榻米、抢先一步、流星突击、挥指、模仿、惊爆大头、镜面反射、鹦鹉学舌、暗影之光、自然之力、自然之怒、拦堵、根源波动、破音、光子喷涌、等离子闪电拳、断崖之剑、守住、火焰球、延后、快速防守、愤怒粉、古老之歌、神秘之剑、陷阱甲壳、写生、梦话、捕兽夹、大声咆哮、化为己用、打鼾、暗影偷盗、尖刺防守、灵魂冲击、聚光灯、蒸汽爆炸、铁蹄光线、神奇蒸汽、挣扎、流星闪冲、水流连打、掉包、高科技光炮、小偷、千箭齐发、千波激荡、雷电囚笼、雷鸣蹴击、变身、戏法、Ｖ热焰、暗冥强击、广域防守以外的招式中，随机选择1个使出。", // NEEDS QC
		},
		gen7: {
			desc: "从您先请、借助、碉堡、鸟嘴加农炮、打嗝、传递礼物、庆祝、喋喋不休、仿效、双倍奉还、渴望、戏法防守、同命、看穿、钻石风暴、画龙点睛、挺住、佯攻、花朵加农炮、真气拳、看我嘛、冰冻伏特、帮助、牵手、异次元猛攻、异次元洞、极寒冷焰、号令、王者盾牌、破灭之光、掀榻榻米、抢先一步、挥指、模仿、惊爆大头、镜面反射、鹦鹉学舌、自然之力、根源波动、光子喷涌、等离子闪电拳、断崖之剑、守住、延后、快速防守、愤怒粉、古老之歌、神秘之剑、陷阱甲壳、写生、梦话、大声咆哮、化为己用、打鼾、暗影偷盗、尖刺防守、聚光灯、蒸汽爆炸、挣扎、掉包、高科技光炮、小偷、千箭齐发、千波激荡、变身、戏法、Ｖ热焰、广域防守以外的招式中，随机选择1个使出。", // NEEDS QC
		},
		gen6: {
			desc: "从您先请、借助、打嗝、传递礼物、庆祝、喋喋不休、仿效、双倍奉还、渴望、戏法防守、同命、看穿、钻石风暴、画龙点睛、挺住、佯攻、真气拳、看我嘛、冰冻伏特、帮助、牵手、异次元猛攻、异次元洞、极寒冷焰、王者盾牌、破灭之光、掀榻榻米、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、根源波动、断崖之剑、守住、延后、快速防守、愤怒粉、古老之歌、神秘之剑、写生、梦话、大声咆哮、化为己用、打鼾、尖刺防守、蒸汽爆炸、挣扎、掉包、高科技光炮、小偷、千箭齐发、千波激荡、变身、戏法、Ｖ热焰、广域防守以外的招式中，随机选择1个使出。", // NEEDS QC
		},
		gen5: {
			desc: "从您先请、借助、传递礼物、喋喋不休、仿效、双倍奉还、渴望、同命、看穿、挺住、佯攻、真气拳、看我嘛、冰冻伏特、帮助、极寒冷焰、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、自然之力、守住、延后、快速防守、愤怒粉、古老之歌、神秘之剑、写生、梦话、大声咆哮、化为己用、打鼾、挣扎、掉包、高科技光炮、小偷、变身、戏法、Ｖ热焰、广域防守以外的招式中，随机选择1个使出。", // NEEDS QC
		},
		gen4: {
			desc: "从借助、喋喋不休、仿效、双倍奉还、渴望、同命、看穿、挺住、佯攻、真气拳、看我嘛、帮助、抢先一步、挥指、模仿、镜面反射、鹦鹉学舌、守住、写生、梦话、化为己用、挣扎、掉包、小偷、戏法以及使用者已会的招式以外的招式中，随机选择1个使出。", // NEEDS QC
		},
		gen3: {
			desc: "从双倍奉还、渴望、同命、看穿、挺住、真气拳、看我嘛、帮助、挥指、模仿、镜面反射、守住、写生、梦话、化为己用、挣扎、小偷、戏法以外的招式中，随机选择1个使出。", // NEEDS QC
		},
		gen2: {
	...
	mimic: {
		...
		gen7: {
			desc: "使用者在场期间，此招式被替换为目标最后使用的招式。复制的招式PP为该招式的最大值。目标还未使用过招式时、使用者已变身时、使用者已会该招式时、该招式是喋喋不休、模仿、写生、挣扎、变身或Ｚ招式时失败。", // NEEDS QC
		},
		gen6: {
	...
	minimize: {
		...
		desc: "使用者的闪避率提高2级。无论闪避率是否变化，在场期间受到泰山压顶、龙之俯冲、飞身重压、高温重压、重磅冲撞、极恶飞跃粉碎击、疯狂滚压、踩踏、闪电强袭攻击时，必定被命中且伤害变为2倍。", // NEEDS QC
		shortDesc: "自身的闪避率提高2级。", // NEEDS QC
		gen8: {
			desc: "使用者的闪避率提高2级。无论闪避率是否变化，在场期间受到泰山压顶、龙之俯冲、飞身重压、高温重压、重磅冲撞、极恶飞跃粉碎击、疯狂滚压、踩踏攻击时，必定被命中且伤害变为2倍。", // NEEDS QC
		},
		gen6: {
			desc: "使用者的闪避率提高2级。无论闪避率是否变化，在场期间受到泰山压顶、龙之俯冲、飞身重压、高温重压、潜灵奇袭、暗影潜袭、疯狂滚压、踩踏攻击时，必定被命中且伤害变为2倍。", // NEEDS QC
		},
		gen5: {
			desc: "使用者的闪避率提高2级。无论闪避率是否变化，在场期间受到踩踏、疯狂滚压攻击时，伤害变为2倍。", // NEEDS QC
		},
		gen4: {
			desc: "使用者的闪避率提高1级。无论闪避率是否变化，在场期间受到踩踏攻击时，威力变为2倍。", // NEEDS QC
			shortDesc: "自身的闪避率提高1级。", // NEEDS QC
		},
		gen3: {
			desc: "使用者的闪避率提高1级。无论闪避率是否变化，在场期间受到惊吓、神通力、尖刺臂、踩踏攻击时，伤害变为2倍。", // NEEDS QC
		},
		gen2: {
			desc: "使用者的闪避率提高1级。无论闪避率是否变化，在场期间受到踩踏攻击时，威力变为2倍。可以通过接棒将此效果转移给同伴。", // NEEDS QC
		},
		gen1: {
			desc: "使用者的闪避率提高1级。", // NEEDS QC
		},
	...
	miracleeye: {
		name: "奇迹之眼",
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
		desc: "目标在场期间，其闪避率等级为+1以上时在命中判定中被无视，且超能力属性的攻击可以命中恶属性的目标。目标已受此效果或识破、气味侦测的效果影响时失败。", // NEEDS QC
		shortDesc: "超能力招式可命中恶属性。无视回避。", // NEEDS QC
		gen4: {
			desc: "目标在场期间，其闪避率等级为+1以上时在命中判定中被无视，且超能力属性的攻击可以命中恶属性的目标。", // NEEDS QC
		},
	...
	mistyterrain: {
		...
		shortDesc: "5回合。地面上：免异常状态，龙招式减半。", // NEEDS QC
		gen6: {
	...
	moonblast: {
		...
		champions: {
			desc: "有10%的几率使目标的特攻降低1级。", // NEEDS QC
			shortDesc: "有10%的几率使目标的特攻降低1级。", // NEEDS QC
		},
	},
	moongeistbeam: {
		name: "暗影之光",
	...
	oblivionwing: {
		name: "归天之翼", // renamed in SV (SwSh: 死亡之翼)
	...
	odorsleuth: {
		name: "气味侦测",
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
		desc: "目标在场期间，其闪避率等级为+1以上时在命中判定中被无视，且一般属性和格斗属性的攻击可以命中幽灵属性的目标。目标已受此效果或识破、奇迹之眼的效果影响时失败。", // NEEDS QC
	...
	perishsong: {
		name: "终焉之歌", // renamed in SV (SwSh: 灭亡之歌)
	...
	psychicterrain: {
		...
		shortDesc: "5回合。地面上：超能力威力提高，免先制。", // NEEDS QC
		gen7: {
	...
	ragefist: {
		...
		champions: {
			desc: "威力为50+(X×50)。X为本场对战中使用者受到造成伤害的攻击的累计次数（即使HP没有减少也计算，最多6），离场后重置为0。连续攻击招式按每次攻击计算，但混乱的自伤不计算。", // NEEDS QC
			shortDesc: "每被击1次威力+50（最多6次）。离场重置。", // NEEDS QC
		},
	},
	ragepowder: {
		name: "愤怒粉",
	...
	recycle: {
		...
		desc: "取回使用者最后使用的道具。使用者携带着道具时、还未持有过道具时、道具是破裂的气球时、道具被特性捡拾的宝可梦捡走时、道具因虫咬、腐蚀气体、渴望、烧净、拍落、啄食、小偷而失去时失败。用投掷投掷的道具可以取回。", // NEEDS QC
		shortDesc: "取回最后使用的道具。", // NEEDS QC
		gen7: {
			desc: "取回使用者最后使用的道具。使用者携带着道具时、还未持有过道具时、道具是破裂的气球时、道具被特性捡拾的宝可梦捡走时、道具因虫咬、渴望、烧净、拍落、啄食、小偷而失去时失败。用投掷投掷的道具可以取回。", // NEEDS QC
		},
		gen4: {
	...
	reflecttype: {
		...
		desc: "使使用者的属性变为与目标当前的属性相同。目标的当前属性包含无属性和非追加属性时，无属性被无视。目标的当前属性包含无属性和由森林咒术或万圣夜追加的属性时，无属性作为一般属性复制。使用者是阿尔宙斯或银伴战兽时、已太晶化时、目标的当前属性只有无属性时失败。", // NEEDS QC
		shortDesc: "属性变为与目标相同。", // NEEDS QC
		gen8: {
			desc: "使使用者的属性变为与目标当前的属性相同。目标的当前属性包含无属性和非追加属性时，无属性被无视。目标的当前属性包含无属性和由森林咒术或万圣夜追加的属性时，无属性作为一般属性复制。使用者是阿尔宙斯或银伴战兽时、目标的当前属性只有无属性时失败。", // NEEDS QC
		},
		gen6: {
	...
	revelationdance: {
		...
		desc: "此招式的属性与使用者的第1属性相同。第1属性是无属性时，若有第2属性则为第2属性，否则为森林咒术或万圣夜追加的属性。使用者的属性只有无属性时，此招式为无属性。", // NEEDS QC
	...
	reversal: {
		name: "绝处逢生", // renamed in SV (SwSh: 起死回生)
	...
	saltcure: {
		...
		champions: {
			desc: "效果期间，每回合结束时给目标造成其最大HP的1/16（钢属性或水属性时为1/8，向下取整）的伤害。目标离场后效果结束。", // NEEDS QC
			shortDesc: "每回合损失1/16HP（钢、水为1/8）。", // NEEDS QC
		},

		start: "  {POKEMON}陷入了盐腌状态！",
		damage: "  {POKEMON}受到了盐腌的伤害！", // NEEDS QC
	},
	sandattack: {
		name: "泼沙",
	...
	sandtomb: {
		name: "流沙深渊", // renamed in SV (SwSh: 流沙地狱)
	...
	sappyseed: {
		name: "茁茁炸弹", // renamed in SV (SwSh: 茁茁轰炸)
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
	...
	scaryface: {
		name: "可怕面孔", // renamed in SV (SwSh: 鬼面)
	...
	selfdestruct: {
		name: "玉石俱碎", // renamed in SV (SwSh: 自爆)
	...
	sheercold: {
		...
		desc: "造成与目标最大HP相同的伤害。无视命中率和闪避率的变化。此招式的命中率为（使用者的等级−目标的等级+X）%（使用者是冰属性时X=30，否则X=20），目标的等级高于使用者时失败。对冰属性宝可梦和特性为结实的宝可梦无效。", // NEEDS QC
	...
	sleeptalk: {
		...
		gen7: {
			desc: "从使用者会的此招式以外的招式中，随机选择1个使出。使用者不处于睡眠状态时失败。被选中的招式不消耗PP，PP为0的招式也可以被选中。借助、鸟嘴加农炮、打嗝、忍耐、庆祝、喋喋不休、仿效、真气拳、牵手、抢先一步、挥指、模仿、鹦鹉学舌、自然之力、陷阱甲壳、写生、梦话、挣扎、吵闹和需要2回合的招式及Ｚ招式不会被选中。", // NEEDS QC
		},
		gen6: {
	...
	snatch: {
		name: "化为己用", // renamed in SV (SwSh: 抢夺)
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
	...
	stompingtantrum: {
		...
		desc: "上一回合使用者最后使用的招式（包括由其他招式调用的招式，以及通过号令、魔法反射、化为己用、特性舞者、魔法镜使出的招式）没有发挥任何原本效果而失败时（失败的飞膝踢、飞踢、惊爆大头的自伤除外），或因反作用力和自由落体以外的效果无法行动时，威力变为2倍。被碉堡、看穿、王者盾牌、守住、尖刺防守、戏法防守、掀榻榻米、快速防守、广域防守防住时，或弹跳、飞翔因重力、击落、千箭齐发的效果中断时，威力不会变为2倍。", // NEEDS QC
	...
	stuffcheeks: {
		...
		champions: {
			desc: "没有携带树果时失败。吃掉携带的树果，使使用者的防御提高2级。此效果不会被特性笨拙、紧张感或查封、魔法空间的效果阻止。", // NEEDS QC
			shortDesc: "无树果则失败。吃掉树果，防御+2。", // NEEDS QC
		},
	},
	stunspore: {
		name: "麻痹粉",
	...
	submission: {
		name: "深渊翻滚", // renamed in SV (SwSh: 地狱翻滚)
	...
	sweetscent: {
		...
		desc: "使目标的闪避率降低2级。", // NEEDS QC
		shortDesc: "使对手的闪避率降低2级。", // NEEDS QC
		gen5: {
			desc: "使目标的闪避率降低1级。", // NEEDS QC
			shortDesc: "使对手的闪避率降低1级。", // NEEDS QC
		},
		gen2: {
			shortDesc: "使目标的闪避率降低1级。", // NEEDS QC
		},
	},
	swift: {
		name: "高速星星",
	...
	switcheroo: {
		...
		champions: {
			desc: "互换使用者和目标的携带道具。使用者和目标都没有携带道具时，或试图向能用其超级进化的宝可梦交出或从其夺取超级石时失败。对特性为黏着的目标无效。", // NEEDS QC
		},
		gen8: {
		...
		gen7: {
			desc: "互换使用者和目标的携带道具。使用者和目标都没有携带道具时、任意一方携带Ｚ纯晶时、试图向能用其超级进化的宝可梦交出或从其夺取超级石时，或试图在盖欧卡、固拉多、骑拉帝纳、阿尔宙斯、盖诺赛克特、银伴战兽与分别对应的靛蓝色宝珠、朱红色宝珠、白金宝珠、属性板、卡带、存储碟的组合间交出或夺取道具时失败。对特性为黏着的目标无效。", // NEEDS QC
		},
		gen6: {
	...
	taunt: {
		...
		gen7: {
			desc: "目标在接下来的3回合内无法使用不造成伤害的招式。对特性为迟钝的宝可梦和受芳香幕保护的宝可梦无效。效果期间仍可以选择并使出Ｚ力量强化的招式。", // NEEDS QC
		},
		gen6: {
			desc: "目标在接下来的3回合内无法使用不造成伤害的招式。对特性为迟钝的宝可梦和受芳香幕保护的宝可梦无效。", // NEEDS QC
		},
	...
	telekinesis: {
		name: "意念移物",
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
		desc: "3回合内，目标在场期间无法躲避向其使出的攻击（一击必杀招式除外）。效果期间，目标在场期间不受地面属性的攻击及撒菱、毒菱、黏黏网、特性沙穴的影响。目标使用接棒时，接替的宝可梦继承此效果。目标处于扎根、击落、千箭齐发、黑色铁球的效果下时，以后者优先。目标已有此效果，或处于扎根、击落、千箭齐发的效果下时失败。目标是地鼠、三地鼠、阿罗拉地鼠、阿罗拉三地鼠、沙丘娃、噬沙堡爷或超级进化的耿鬼时无效。超级耿鬼无论如何都不会受此效果影响。", // NEEDS QC
	...
	throatchop: {
		name: "深渊突刺", // renamed in SV (SwSh: 地狱突刺)
		...
		gen7: {
			desc: "2回合内，目标无法使用声音类招式。效果期间仍可以选择并使出Ｚ力量强化的声音类招式。", // NEEDS QC
		},
	...
	toxicthread: {
		...
		champions: {
			desc: "使目标的速度降低2级，并使其陷入中毒状态。", // NEEDS QC
			shortDesc: "使目标速度降低2级并中毒。", // NEEDS QC
		},
	},
	trailblaze: {
		name: "起草",
	...
	trickortreat: {
		...
		desc: "为目标追加幽灵属性，使其拥有2～3种属性。目标已是幽灵属性时失败。被森林咒术追加属性时，此招式追加的属性会被替换（反之亦然）。", // NEEDS QC
	...
	weatherball: {
		...
		desc: "天气（乱流除外）存在时，威力变为2倍，且此招式的属性随天气变化。下雪时为冰属性，下雨或大雨时为水属性，沙暴时为岩石属性，大晴天或大日照时为火属性。携带万能伞并在下雨、大雨、大晴天或大日照中使用时，保持一般属性且威力不会翻倍。", // NEEDS QC
		shortDesc: "有天气时威力加倍且属性变化。", // NEEDS QC
		gen8: {
			desc: "天气（乱流除外）存在时，威力变为2倍，且此招式的属性随天气变化。冰雹时为冰属性，下雨或大雨时为水属性，沙暴时为岩石属性，大晴天或大日照时为火属性。携带万能伞并在下雨、大雨、大晴天或大日照中使用时，保持一般属性且威力不会翻倍。", // NEEDS QC
		},
		gen5: {
			desc: "天气存在时，威力变为2倍，且此招式的属性随天气变化。冰雹时为冰属性，下雨时为水属性，沙暴时为岩石属性，大晴天时为火属性。", // NEEDS QC
		},
		gen3: {
			desc: "天气存在时，伤害变为2倍，且此招式的属性随天气变化。冰雹时为冰属性，下雨时为水属性，沙暴时为岩石属性，大晴天时为火属性。", // NEEDS QC
			shortDesc: "有天气时伤害2倍且属性变化。", // NEEDS QC
		},

		move: "究极无敌大冲撞因天气的影响变成了{MOVE}！", // NEEDS QC
	},
	whirlpool: {
		name: "潮旋",
	...
	zippyzap: {
		name: "电电加速",
		// Official flavor text: "无法使用这个招式。 虽然忘记之后就再也想不起来了， 但还是建议忘记这个招式。"
		desc: "有100%的几率使使用者的闪避率提高1级。", // NEEDS QC
		shortDesc: "先制招式。自身闪避率提高1级。", // NEEDS QC
		gen7: {
