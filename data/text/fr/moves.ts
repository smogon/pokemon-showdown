export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	aciddownpour: {
		...
		shortDesc: "Puissance selon la Force Z de la capacité de base.", // NEEDS QC
	},
	acidspray: {
		name: "Bombe Acide",
	...
	allyswitch: {
		...
		gen8: {
			...
			shortDesc: "Le lanceur échange sa position avec son allié.", // NEEDS QC
		},
		gen6: {
	...
	amnesia: {
		...
		gen1: {
			...
			shortDesc: "Monte le Spécial du lanceur de 2 niveaux.", // NEEDS QC
		},
	},
	anchorshot: {
		name: "Ancrage",
	...
	axekick: {
		...
		desc: "A 30 % de chances de rendre la cible confuse. Si cette attaque échoue, l'utilisateur perd la moitié de ses PV max, arrondi à l'inférieur, en dégâts de chute. Les Pokémon ayant le talent Garde Magik ne subissent pas de dégâts de chute.", // NEEDS QC
	...
	barbbarrage: {
		...
		shortDesc: "50 % de psn. Puissance ×2 si la cible est empoisonnée.", // NEEDS QC
	},
	barrage: {
		name: "Pilonnage",
		// Official flavor text: "Cette capacité ne peut pas être utilisée. Il est recommandé de l’oublier, même s’il sera impossible de se la remémorer une fois oubliée."
	...
	belch: {
		...
		champions: {
			desc: "Échoue si l'utilisateur n'a pas mangé de Baie, que ce soit en mangeant celle qu'il tenait, en volant et mangeant celle d'un autre Pokémon avec Piqûre ou Picore, ou en mangeant celle qu'on lui a lancée avec Dégommage. Consommer une Baie avec Don Naturel ne compte pas.", // NEEDS QC
			shortDesc: "Échoue si le lanceur n'a pas mangé de Baie.", // NEEDS QC
		},
	},
	bellydrum: {
		name: "Cognobidon",
	...
	bestow: {
		name: "Passe-Cadeau",
		// Official flavor text: "Cette capacité ne peut pas être utilisée. Il est recommandé de l’oublier, même s’il sera impossible de se la remémorer une fois oubliée."
		desc: "La cible reçoit l'objet tenu par l'utilisateur. Échoue si l'utilisateur n'a pas d'objet ou tient un Cristal Z, si la cible tient déjà un objet, si l'objet est une Méga-Gemme et que l'utilisateur ou la cible est l'espèce pouvant méga-évoluer avec, ou si l'objet est une Gemme Bleue, une Gemme Rouge, un Orbe Platiné, une plaque, un module ou une ROM et que l'utilisateur ou la cible est respectivement Kyogre, Groudon, Giratina, Arceus, Genesect ou Silvallié.", // NEEDS QC
		shortDesc: "Donne l'objet tenu du lanceur à la cible.", // NEEDS QC
		gen6: {
			desc: "La cible reçoit l'objet tenu par l'utilisateur. Échoue si l'utilisateur n'a pas d'objet, si la cible tient déjà un objet, si l'objet est une Méga-Gemme et que l'utilisateur ou la cible est l'espèce pouvant méga-évoluer avec, ou si l'objet est une Gemme Bleue, une Gemme Rouge, un Orbe Platiné, une plaque ou un module et que l'utilisateur ou la cible est respectivement Kyogre, Groudon, Giratina, Arceus ou Genesect.", // NEEDS QC
		},
		gen5: {
			desc: "La cible reçoit l'objet tenu par l'utilisateur. Échoue si l'utilisateur n'a pas d'objet ou tient une Lettre, si la cible tient déjà un objet, ou si l'objet est un Orbe Platiné, une plaque ou un module et que l'utilisateur ou la cible est respectivement Giratina, Arceus ou Genesect.", // NEEDS QC
		},
	...
	bind: {
		...
		desc: "Empêche la cible de quitter le combat pendant quatre ou cinq tours (sept si l'utilisateur tient une Accro Griffe). Inflige à la cible des dégâts égaux à 1/8 de ses PV max (1/6 si l'utilisateur tient une Bande Étreinte), arrondi à l'inférieur, à la fin de chaque tour pendant l'effet. La cible peut tout de même être remplacée si elle tient une Carapace Mue ou utilise Relais, Eau Revoir, Dernier Mot, Queulonage, Téléport, Demi-Tour ou Change-Éclair. L'effet prend fin si l'utilisateur ou la cible quitte le terrain, ou si la cible utilise Toupie Éclat, Tour Rapide ou Clonage avec succès. Cet effet n'est pas cumulable et n'est pas réinitialisé par une nouvelle capacité de ce genre.", // NEEDS QC
		...
		gen7: {
			desc: "Empêche la cible de quitter le combat pendant quatre ou cinq tours (sept si l'utilisateur tient une Accro Griffe). Inflige à la cible des dégâts égaux à 1/8 de ses PV max (1/6 si l'utilisateur tient une Bande Étreinte), arrondi à l'inférieur, à la fin de chaque tour pendant l'effet. La cible peut tout de même être remplacée si elle tient une Carapace Mue ou utilise Relais, Dernier Mot, Demi-Tour ou Change-Éclair. L'effet prend fin si l'utilisateur ou la cible quitte le terrain, ou si la cible utilise Tour Rapide ou Clonage avec succès. Cet effet n'est pas cumulable et n'est pas réinitialisé par une nouvelle capacité de ce genre.", // NEEDS QC
		},
		gen5: {
			desc: "Empêche la cible de quitter le combat pendant quatre ou cinq tours (sept si l'utilisateur tient une Accro Griffe). Inflige à la cible des dégâts égaux à 1/16 de ses PV max (1/8 si l'utilisateur tient une Bande Étreinte), arrondi à l'inférieur, à la fin de chaque tour pendant l'effet. La cible peut tout de même être remplacée si elle tient une Carapace Mue ou utilise Relais, Demi-Tour ou Change-Éclair. L'effet prend fin si l'utilisateur ou la cible quitte le terrain, ou si la cible utilise Tour Rapide ou Clonage avec succès. Cet effet n'est pas cumulable et n'est pas réinitialisé par une nouvelle capacité de ce genre.", // NEEDS QC
		},
		gen4: {
			desc: "Empêche la cible de quitter le combat pendant deux à cinq tours (toujours cinq si l'utilisateur tient une Accro Griffe). Inflige à la cible des dégâts égaux à 1/16 de ses PV max, arrondi à l'inférieur, à la fin de chaque tour pendant l'effet. La cible peut tout de même être remplacée si elle tient une Carapace Mue ou utilise Relais ou Demi-Tour. L'effet prend fin si l'utilisateur ou la cible quitte le terrain, ou si la cible utilise Tour Rapide ou Clonage avec succès. Cet effet n'est pas cumulable et n'est pas réinitialisé par une nouvelle capacité de ce genre.", // NEEDS QC
	...
	bravebird: {
		...
		gen4: {
			...
			shortDesc: "Contrecoup de 1/3 des dégâts.", // NEEDS QC
		},
	},
	breakingswipe: {
		name: "Abattage",
	...
	brickbreak: {
		...
		shortDesc: "Détruit les écrans, sauf si la cible est immunisée.", // NEEDS QC
		gen6: {
	...
	brine: {
		...
		shortDesc: "Puissance doublée si la cible a 50 % de PV ou moins.", // NEEDS QC
	},
	brutalswing: {
		name: "Centrifugifle",
	...
	charge: {
		...
		shortDesc: "+1 Déf. Spé ; sa prochaine capacité Électrik ×2.", // NEEDS QC
		gen8: {
			...
			shortDesc: "+1 Déf. Spé. Prochaine attaque Électrik : ×2.", // NEEDS QC
		},
		gen3: {
			desc: "Si l'utilisateur utilise une attaque de type Électrik au tour suivant, sa puissance sera doublée.", // NEEDS QC
			shortDesc: "La prochaine attaque Électrik a sa puissance ×2.", // NEEDS QC
		},
	...
	collisioncourse: {
		...
		shortDesc: "Dégâts ×1,3333 si super efficace.", // NEEDS QC
	},
	combattorque: {
		name: "Crash Musclé",
		desc: "A 30 % de chances de paralyser la cible.", // NEEDS QC
	...
	comeuppance: {
		...
		shortDesc: "S'il est touché, renvoie 1,5× les dégâts.", // NEEDS QC
	},
	confide: {
		name: "Confidence",
	...
	corrosivegas: {
		...
		shortDesc: "Retire les objets des Pokémon adjacents.", // NEEDS QC
		gen8: {
	...
	counter: {
		...
		gen1: {
			...
			shortDesc: "Rend 2× les dégâts des attaques Normal/Combat.", // NEEDS QC
		},
	},
	courtchange: {
		name: "Change-Côté",
	...
	covet: {
		...
		champions: {
			desc: "Si cette attaque réussit et que l'utilisateur ne tient pas d'objet, il vole l'objet tenu par la cible. Une cible ayant le talent Glu ne perd pas son objet tant qu'elle n'est pas K.O. L'objet n'est pas volé s'il s'agit d'une Méga-Gemme et que l'utilisateur ou la cible est l'espèce pouvant méga-évoluer avec. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage ou le talent Récolte.", // NEEDS QC
		},
		gen8: {
			desc: "Si cette attaque réussit et que l'utilisateur n'est pas K.O., il vole l'objet tenu par la cible s'il n'en tient pas lui-même. Une cible ayant le talent Glu ne perd pas son objet tant qu'elle n'est pas K.O. L'objet n'est pas volé s'il s'agit d'une Gemme Bleue, d'une Gemme Rouge, d'un Orbe Platiné, d'une plaque, d'un module, d'une ROM, d'une Épée Rouillée ou d'un Bouclier Rouillé tenus respectivement par Kyogre, Groudon, Giratina, Arceus, Genesect, Silvallié, Zacian, Zamazenta, ou si l'utilisateur est l'une de ces espèces et que la cible tient l'objet correspondant. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage ou le talent Récolte.", // NEEDS QC
		},
		gen7: {
			desc: "Si cette attaque réussit et que l'utilisateur n'est pas K.O., il vole l'objet tenu par la cible s'il n'en tient pas lui-même. Une cible ayant le talent Glu ne perd pas son objet tant qu'elle n'est pas K.O. L'objet n'est pas volé s'il s'agit d'un Cristal Z, d'une Méga-Gemme tenue par l'espèce pouvant méga-évoluer avec, ou d'une Gemme Bleue, d'une Gemme Rouge, d'un Orbe Platiné, d'une plaque, d'un module ou d'une ROM tenus respectivement par Kyogre, Groudon, Giratina, Arceus, Genesect, Silvallié, ou si l'utilisateur est l'une de ces espèces et que la cible tient l'objet correspondant. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage ou le talent Récolte.", // NEEDS QC
		},
		gen6: {
			desc: "Si cette attaque réussit et que l'utilisateur n'est pas K.O., il vole l'objet tenu par la cible s'il n'en tient pas lui-même. Une cible ayant le talent Glu ne perd pas son objet tant qu'elle n'est pas K.O. L'objet n'est pas volé s'il s'agit d'une Méga-Gemme tenue par l'espèce pouvant méga-évoluer avec, ou d'une Gemme Bleue, d'une Gemme Rouge, d'un Orbe Platiné, d'une plaque ou d'un module tenus respectivement par Kyogre, Groudon, Giratina, Arceus, Genesect, ou si l'utilisateur est l'une de ces espèces et que la cible tient l'objet correspondant. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage ou le talent Récolte.", // NEEDS QC
		},
		gen5: {
			desc: "Si cette attaque réussit et que l'utilisateur n'est pas K.O., il vole l'objet tenu par la cible s'il n'en tient pas lui-même. Une cible ayant le talent Glu ne perd pas son objet tant qu'elle n'est pas K.O. L'objet n'est pas volé s'il s'agit d'une Lettre, ou d'un Orbe Platiné, d'une plaque ou d'un module tenus respectivement par Giratina, Arceus ou Genesect, ou si l'utilisateur est l'une de ces espèces et que la cible tient l'objet correspondant. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage ou le talent Récolte.", // NEEDS QC
		},
		gen4: {
			desc: "Si cette attaque réussit et que l'utilisateur ne tient pas d'objet, il vole l'objet tenu par la cible. L'objet n'est pas volé s'il s'agit d'une Lettre ou d'un Orbe Platiné, ou si la cible a le talent Multi-Type ou Glu. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage.", // NEEDS QC
		},
		gen3: {
	...
	defog: {
		...
		gen7: {
			...
			shortDesc: "-1 esquive ; retire les pièges des deux côtés.", // NEEDS QC
		},
		gen6: {
		...
		gen5: {
			...
			shortDesc: "-1 esquive ; retire pièges et écrans adverses.", // NEEDS QC
		},
	},
	destinybond: {
		name: "Lien du Destin",
	...
	direclaw: {
		...
		champions: {
			desc: "A 30 % de chances d'endormir, d'empoisonner ou de paralyser la cible.", // NEEDS QC
			shortDesc: "30 % de sommeil, poison ou paralysie.", // NEEDS QC
		},
	},
	disable: {
		name: "Entrave",
		// Official flavor text: "Empêche l’ennemi d’employer à nouveau sa dernière attaque. Dure quatre tours."
		desc: "Pendant 4 tours, la dernière capacité utilisée par la cible est mise sous entrave. Échoue si une des capacités de la cible est déjà sous entrave, si la cible n'a pas encore agi, si elle ne connaît plus cette capacité, ou s'il s'agissait d'une capacité Dynamax ou Gigamax.", // NEEDS QC
		shortDesc: "Entrave la dernière capacité de la cible 4 tours.", // NEEDS QC
		gen7: {
	...
	earthquake: {
		...
		shortDesc: "Touche les adjacents. Dégâts ×2 contre Tunnel.", // NEEDS QC
		gen4: {
			desc: "La puissance est doublée si la cible utilise Tunnel.", // NEEDS QC
			shortDesc: "Touche les Pokémon adjacents. ×2 contre Tunnel.", // NEEDS QC
		},
		gen1: {
			desc: "Aucun effet supplémentaire.", // NEEDS QC
			shortDesc: "Aucun effet supplémentaire.", // NEEDS QC
	...
	expandingforce: {
		...
		shortDesc: "Sur Champ Psychique : ×1,5 et touche les ennemis.", // NEEDS QC
	},
	explosion: {
		name: "Explosion",
		...
		gen4: {
			...
			shortDesc: "Déf. de la cible ÷2. Le lanceur est mis K.O.", // NEEDS QC
		},
		gen3: {
	...
	facade: {
		...
		shortDesc: "Puissance ×2 si brûlé, paralysé ou empoisonné.", // NEEDS QC
		gen5: {
	...
	fakeout: {
		...
		champions: {
			desc: "A 100 % de chances d'apeurer la cible. Cette capacité ne peut pas être sélectionnée si ce n'est pas le premier tour de l'utilisateur sur le terrain.", // NEEDS QC
		},
	},
	faketears: {
		name: "Croco Larme",
	...
	firepledge: {
		...
		desc: "Si un des alliés de l'utilisateur a choisi d'utiliser Aire d’Herbe ou Aire d’Eau ce tour et n'a pas encore agi, il agit immédiatement après l'utilisateur et la capacité de l'utilisateur ne fait rien. Combinée avec Aire d’Herbe, l'allié utilise Aire de Feu avec 150 de puissance et une mer de feu apparaît du côté de la cible pendant 4 tours, infligeant aux Pokémon non-Feu des dégâts égaux à 1/8 de leurs PV max, arrondi à l'inférieur, à la fin de chaque tour de l'effet, dernier tour compris. Combinée avec Aire d’Eau, l'allié utilise Aire d’Eau avec 150 de puissance et un arc-en-ciel apparaît du côté de l'utilisateur pendant 4 tours, doublant les chances d'effet secondaire, cumulable avec le talent Sérénité, sauf pour les effets qui apeurent, dont la chance ne peut être doublée qu'une fois. Utilisée en capacité combinée, cette capacité bénéficie du STAB quel que soit le type de l'utilisateur. Cette capacité ne consomme pas le Joyau Feu de l'utilisateur.", // NEEDS QC
		shortDesc: "À combiner avec Aire d'Herbe ou Aire d'Eau.", // NEEDS QC
	...
	firstimpression: {
		...
		champions: {
			desc: "Cette capacité ne peut pas être sélectionnée si ce n'est pas le premier tour de l'utilisateur sur le terrain.", // NEEDS QC
		},
	},
	fishiousrend: {
		name: "Branchicrok",
	...
	flareblitz: {
		...
		gen4: {
			...
			shortDesc: "Contrecoup 1/3. 10 % de brûler. Dégèle le lanceur.", // NEEDS QC
		},
	},
	flash: {
		name: "Flash",
	...
	flowertrick: {
		...
		desc: "Cette capacité porte toujours un coup critique, sauf si la cible est sous l'effet d'Air Veinard ou a le talent Armurbaston ou Coque Armure. Cette capacité ne vérifie pas la précision.", // NEEDS QC
	...
	focusenergy: {
		...
		gen2: {
			...
			shortDesc: "Monte le taux de critique du lanceur d'un niveau.", // NEEDS QC
		},
		gen1: {
			...
			shortDesc: "Divise par 4 le taux de critique du lanceur.", // NEEDS QC
		},
	...
	followme: {
		...
		desc: "Jusqu'à la fin du tour, toutes les attaques à cible unique du côté adverse sont redirigées vers l'utilisateur. Ces attaques sont redirigées avant de pouvoir être renvoyées par Reflet Magik ou le talent Miroir Magik, ou attirées par les talents Paratonnerre ou Lavabo. Échoue si ce n'est ni un Combat Duo ni une Bataille Royale. Cet effet est ignoré tant que l'utilisateur est sous l'effet de Chute Libre.", // NEEDS QC
	...
	foresight: {
		...
		shortDesc: "Combat et Normal touchent Spectre. Ignore l'esquive.", // NEEDS QC
		gen4: {
	...
	freezedry: {
		...
		champions: {
			desc: "L'efficacité de cette capacité contre le type Eau devient super efficace, quel que soit le type de cette capacité.", // NEEDS QC
			shortDesc: "Super efficace contre l'Eau.", // NEEDS QC
		},
	},
	freezeshock: {
		name: "Éclair Gelé",
	...
	frostbreath: {
		...
		desc: "Cette capacité porte toujours un coup critique, sauf si la cible est sous l'effet d'Air Veinard ou a le talent Armurbaston ou Coque Armure.", // NEEDS QC
	...
	fusionbolt: {
		...
		shortDesc: "Puissance ×2 après Flamme Croix ce tour.", // NEEDS QC
	},
	fusionflare: {
		name: "Flamme Croix",
		...
		shortDesc: "Puissance ×2 après Éclair Croix ce tour.", // NEEDS QC
	},
	futuresight: {
		name: "Prescience",
	...
	glaiverush: {
		...
		shortDesc: "Subit des dégâts ×2 assurés jusqu'à son prochain tour.", // NEEDS QC
	},
	glare: {
	...
	gmaxbefuddle: {
		...
		shortDesc: "Puissance selon capa. de base. Ennemis : slp/psn/par.", // NEEDS QC
	},
	gmaxcannonade: {
		...
		start: "  La violence des courants frappe {PARTY} !", // adapted from SwSh fr_common:7786 ("Les alliés subissent…" / "L’équipe ennemie subit…")
		damage: "  {POKEMON} subit la violence du tourbillon provoqué par Canonnade G-Max !",
	},
	gmaxcentiferno: {
		name: "Combustion G-Max",
		desc: "La puissance est égale à celle de la capacité Dynamax de la capacité de base. Si cette capacité réussit, chaque Pokémon du côté adverse ne peut plus quitter le combat pendant quatre ou cinq tours (sept si l'utilisateur tient une Accro Griffe), même derrière un clone. Leur inflige des dégâts égaux à 1/8 de leurs PV max (1/6 si l'utilisateur tient une Bande Étreinte), arrondi à l'inférieur, à la fin de chaque tour pendant l'effet. Ils peuvent tout de même être remplacés s'ils tiennent une Carapace Mue ou utilisent Relais, Eau Revoir, Dernier Mot, Téléport, Demi-Tour ou Change-Éclair. L'effet prend fin pour une cible si elle quitte le terrain ou utilise Tour Rapide ou Clonage avec succès. Cet effet n'est pas cumulable et n'est pas réinitialisé par une nouvelle capacité de ce genre.", // NEEDS QC
	...
	gmaxfinale: {
		...
		shortDesc: "Puissance selon capa. de base. Alliés : +1/6 PV max.", // NEEDS QC
	},
	gmaxfireball: {
		name: "Pyroball G-Max",
		desc: "La puissance est de 160, quelle que soit celle de la capacité Dynamax de la capacité de base. Cette capacité et ses effets ignorent les talents des autres Pokémon.", // NEEDS QC
	...
	gmaxmeltdown: {
		...
		shortDesc: "Puissance selon capa. de base. Ennemis : Tourmente.", // NEEDS QC
	},
	gmaxoneblow: {
	...
	gmaxreplenish: {
		...
		shortDesc: "Puissance selon capa. de base. 50 % : rend les Baies.", // NEEDS QC
	},
	gmaxresonance: {
	...
	gmaxsteelsurge: {
		name: "Percée G-Max",
		desc: "La puissance est égale à celle de la capacité Dynamax de la capacité de base. Si cette capacité réussit, elle pose un piège du côté adverse qui blesse chaque Pokémon adverse entrant au combat. Les adversaires perdent 1/32, 1/16, 1/8, 1/4 ou 1/2 de leurs PV max, arrondi à l'inférieur, selon leur faiblesse au type Acier (0,25×, 0,5×, neutre, 2× ou 4× respectivement). Peut être retiré du côté adverse si un Pokémon adverse utilise Tour Rapide ou Anti-Brume avec succès, ou est touché par Anti-Brume.", // NEEDS QC
		shortDesc: "Puissance selon capa. de base. Piège de type Acier.", // NEEDS QC

		start: "  Des morceaux d’acier acérés lévitent autour {TEAM:de} !", // SwSh fr_common:7716
		end: "  Les morceaux d’acier acérés autour {TEAM:de} ont disparu !", // SwSh fr_common:7718
		damage: "  L’acier pointu transperce {POKEMON} !",
	},
	gmaxstonesurge: {
		name: "Récif G-Max",
		desc: "La puissance est égale à celle de la capacité Dynamax de la capacité de base. Si cette capacité réussit, elle pose un piège du côté adverse qui blesse chaque Pokémon adverse entrant au combat. Les adversaires perdent 1/32, 1/16, 1/8, 1/4 ou 1/2 de leurs PV max, arrondi à l'inférieur, selon leur faiblesse au type Roche (0,25×, 0,5×, neutre, 2× ou 4× respectivement). Peut être retiré du côté adverse si un Pokémon adverse utilise Tour Rapide ou Anti-Brume avec succès, ou est touché par Anti-Brume.", // NEEDS QC
	...
	gmaxvinelash: {
		...
		start: "  Des coups de fouet frappent {PARTY} !", // adapted from SwSh fr_common:7784 ("Les alliés subissent…" / "L’équipe ennemie subit…")
	...
	gmaxvolcalith: {
		...
		start: "  {TEAM:capitalize} est encerclée par les rochers !", // SwSh fr_common:7722
	...
	gmaxwildfire: {
		...
		start: "  {TEAM:capitalize} est encerclée par les flammes !", // SwSh fr_common:7720
	...
	grasspledge: {
		...
		desc: "Si un des alliés de l'utilisateur a choisi d'utiliser Aire de Feu ou Aire d’Eau ce tour et n'a pas encore agi, il agit immédiatement après l'utilisateur et la capacité de l'utilisateur ne fait rien. Combinée avec Aire de Feu, l'allié utilise Aire de Feu avec 150 de puissance et une mer de feu apparaît du côté de la cible pendant 4 tours, infligeant aux Pokémon non-Feu des dégâts égaux à 1/8 de leurs PV max, arrondi à l'inférieur, à la fin de chaque tour de l'effet, dernier tour compris. Combinée avec Aire d’Eau, l'allié utilise Aire d’Herbe avec 150 de puissance et un marécage apparaît du côté de la cible pendant 4 tours, divisant par quatre la Vitesse de chaque Pokémon de ce côté. Utilisée en capacité combinée, cette capacité bénéficie du STAB quel que soit le type de l'utilisateur. Cette capacité ne consomme pas le Joyau Plante de l'utilisateur.", // NEEDS QC
		shortDesc: "À combiner avec Aire de Feu ou Aire d'Eau.", // NEEDS QC
	...
	gravapple: {
		...
		shortDesc: "100 % de -1 Défense. Sous Gravité : ×1,5.", // NEEDS QC
	},
	gravity: {
		name: "Gravité",
		...
		shortDesc: "5 tours : plus d'immunité au Sol, précision ×1,67.", // NEEDS QC
		gen7: {
	...
	growth: {
		...
		gen7: {
			desc: "Monte l'Attaque et l'Attaque Spéciale de l'utilisateur d'un niveau. Si la météo est Soleil ou Soleil intense, elles montent de 2 niveaux.", // NEEDS QC
		},
		gen5: {
			desc: "Monte l'Attaque et l'Attaque Spéciale de l'utilisateur d'un niveau. Si la météo est Soleil, elles montent de 2 niveaux.", // NEEDS QC
		},
		gen4: {
			desc: "Monte l'Attaque Spéciale de l'utilisateur d'un niveau.", // NEEDS QC
			shortDesc: "Monte l'Atq. Spé du lanceur d'un niveau.", // NEEDS QC
		},
		gen1: {
			desc: "Monte le Spécial de l'utilisateur d'un niveau.", // NEEDS QC
			shortDesc: "Monte le Spécial du lanceur d'un niveau.", // NEEDS QC
		},
	},
	grudge: {
		name: "Rancune",
	...
	gust: {
		...
		shortDesc: "Puissance ×2 contre Rebond, Vol et Chute Libre.", // NEEDS QC
		gen4: {
			desc: "La puissance est doublée si la cible utilise Rebond ou Vol.", // NEEDS QC
			shortDesc: "Puissance ×2 contre Rebond et Vol.", // NEEDS QC
		},
		gen2: {
			desc: "La puissance est doublée si la cible utilise Vol.", // NEEDS QC
			shortDesc: "Puissance ×2 contre Vol.", // NEEDS QC
		},
		gen1: {
			desc: "Aucun effet supplémentaire.", // NEEDS QC
			shortDesc: "Aucun effet supplémentaire.", // NEEDS QC
	...
	healingwish: {
		...
		gen7: {
			...
			shortDesc: "Le lanceur est mis K.O. Le remplaçant est soigné.", // NEEDS QC
		},
		gen4: {
	...
	helpinghand: {
		...
		shortDesc: "La capacité d'un allié adjacent est ×1,5 ce tour.", // NEEDS QC
	...
	highjumpkick: {
		...
		desc: "Si cette attaque échoue, l'utilisateur perd la moitié de ses PV max, arrondi à l'inférieur, en dégâts de chute. Les Pokémon ayant le talent Garde Magik ne subissent pas de dégâts de chute.", // NEEDS QC
		...
		gen1: {
			...
			shortDesc: "En cas d'échec, le lanceur perd 1 PV.", // NEEDS QC
		},
	...
	hurricane: {
		...
		gen5: {
			desc: "A 30 % de chances de rendre la cible confuse. Cette capacité peut toucher une cible utilisant Rebond, Vol ou Chute Libre, ou sous l'effet de Chute Libre. Si la météo est Pluie, cette capacité ne vérifie pas la précision. Si la météo est Soleil, sa précision est de 50 %.", // NEEDS QC
		},
	},
	hydrocannon: {
		name: "Hydroblast",
	...
	hydrosteam: {
		...
		shortDesc: "Au soleil : dégâts ×1,5 au lieu de la moitié.", // NEEDS QC
	},
	hydrovortex: {
	...
	infernalparade: {
		...
		shortDesc: "30 % de brûler. Puissance ×2 contre un statut.", // NEEDS QC
	},
	inferno: {
		name: "Feu d’Enfer",
	...
	kingsshield: {
		...
		gen7: {
			...
			shortDesc: "Protège des attaques. Contact : -2 Attaque.", // NEEDS QC
		},
		gen6: {
			desc: "L'utilisateur est protégé de la plupart des attaques des autres Pokémon pendant ce tour, et les Pokémon qui essaient de le toucher avec une capacité directe voient leur Attaque baisser de 2 niveaux. Les capacités de statut passent au travers de cette protection. Cette capacité a 1 chance sur X de réussir, où X commence à 1 et triple à chaque utilisation réussie. X revient à 1 si cette capacité échoue, si la dernière capacité utilisée n'est pas Détection, Ténacité, Bouclier Royal, Abri, Prévention, Pico-Défense ou Garde Large, ou si c'était une de ces capacités et que la protection a été brisée. Échoue si l'utilisateur agit en dernier ce tour.", // NEEDS QC
		},
	...
	knockoff: {
		...
		shortDesc: "Dégâts ×1,5 si la cible a un objet, et le retire.", // NEEDS QC
		champions: {
			desc: "La puissance de cette capacité est multipliée par 1,5 si la cible tient un objet, et la cible perd son objet tenu. Une cible ayant le talent Glu ne perd pas son objet tant qu'elle n'est pas K.O. La puissance n'augmente pas et l'objet n'est pas retiré s'il s'agit d'une Méga-Gemme tenue par l'espèce pouvant méga-évoluer avec. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage ou le talent Récolte.", // NEEDS QC
		},
		gen8: {
			desc: "La puissance de cette capacité est multipliée par 1,5 si la cible tient un objet, et la cible perd son objet si l'utilisateur n'est pas K.O. Une cible ayant le talent Glu ne perd pas son objet tant qu'elle n'est pas K.O. La puissance n'augmente pas et l'objet n'est pas retiré s'il s'agit d'une Gemme Bleue, d'une Gemme Rouge, d'un Orbe Platiné, d'une plaque, d'un module, d'une ROM, d'une Épée Rouillée ou d'un Bouclier Rouillé tenus respectivement par Kyogre, Groudon, Giratina, Arceus, Genesect, Silvallié, Zacian, Zamazenta, ou si l'utilisateur est l'une de ces espèces et que la cible tient l'objet correspondant. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage ou le talent Récolte.", // NEEDS QC
		},
		gen7: {
		...
		gen6: {
			desc: "La puissance de cette capacité est multipliée par 1,5 si la cible tient un objet, et la cible perd son objet si l'utilisateur n'est pas K.O. Une cible ayant le talent Glu ne perd pas son objet tant qu'elle n'est pas K.O. La puissance n'augmente pas et l'objet n'est pas retiré s'il s'agit d'une Méga-Gemme tenue par l'espèce pouvant méga-évoluer avec, ou d'une Gemme Bleue, d'une Gemme Rouge, d'un Orbe Platiné, d'une plaque ou d'un module tenus respectivement par Kyogre, Groudon, Giratina, Arceus, Genesect, ou si l'utilisateur est l'une de ces espèces et que la cible tient l'objet correspondant. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage ou le talent Récolte.", // NEEDS QC
		},
		gen5: {
			desc: "Si l'utilisateur n'est pas K.O., la cible perd son objet tenu. Une cible ayant le talent Glu ne perd pas son objet tant qu'elle n'est pas K.O. L'objet n'est pas retiré s'il s'agit d'un Orbe Platiné, d'une plaque ou d'un module tenus respectivement par Giratina, Arceus ou Genesect, ou si l'utilisateur est l'une de ces espèces et que la cible tient l'objet correspondant. Les objets perdus à cause de cette capacité ne peuvent pas être récupérés avec Recyclage ou le talent Récolte.", // NEEDS QC
			shortDesc: "Retire l'objet tenu par la cible.", // NEEDS QC
		},
		gen4: {
			desc: "La cible perd son objet tenu pour le reste du combat, sauf si l'objet est un Orbe Platiné ou si la cible a le talent Multi-Type ou Glu. Pendant l'effet, la cible ne peut obtenir aucun nouvel objet.", // NEEDS QC
	...
	lashout: {
		...
		shortDesc: "Puissance ×2 si ses stats ont baissé ce tour.", // NEEDS QC
	},
	lastresort: {
	...
	lastrespects: {
		...
		desc: "La puissance est égale à 50 + (X × 50), où X est le nombre de fois où un Pokémon de l'équipe de l'utilisateur a été mis K.O., avec un maximum de 100.", // NEEDS QC
	...
	leechseed: {
		...
		end: "  {POKEMON} est libéré de la capacité Vampigraine !", // NEEDS QC (PS-authored; modelled on SwSh fr_common:6738)
	...
	lightscreen: {
		...
		desc: "Pendant 5 tours, l'utilisateur et son équipe subissent 0,5× les dégâts des attaques spéciales, ou 0,66× en Combat Duo. Les dégâts ne sont pas réduits davantage avec Voile Aurore. Les coups critiques ignorent cet effet. L'effet est retiré du côté de l'utilisateur si lui ou un allié est touché par Casse-Brique, Psycho-Croc ou Anti-Brume. Dure 8 tours si l'utilisateur tient une Lumargile. Échoue si l'effet est déjà actif du côté de l'utilisateur.", // NEEDS QC
		shortDesc: "5 tours : dégâts spéciaux subis réduits de moitié.", // NEEDS QC
		gen6: {
			desc: "Pendant 5 tours, l'utilisateur et son équipe subissent 0,5× les dégâts des attaques spéciales, ou 0,66× en Combat Duo ou Trio. Les coups critiques ignorent cet effet. L'effet est retiré du côté de l'utilisateur si lui ou un allié est touché par Casse-Brique ou Anti-Brume. Dure 8 tours si l'utilisateur tient une Lumargile. Échoue si l'effet est déjà actif du côté de l'utilisateur.", // NEEDS QC
		},
		gen4: {
		...
		gen1: {
			...
			shortDesc: "Tant qu'actif : Spécial ×2 quand il subit des dégâts.", // NEEDS QC
	...
	magmastorm: {
		...
		gen5: {
			desc: "Empêche la cible de quitter le combat pendant quatre ou cinq tours (sept si l'utilisateur tient une Accro Griffe). Inflige à la cible des dégâts égaux à 1/16 de ses PV max (1/8 si l'utilisateur tient une Bande Étreinte), arrondi à l'inférieur, à la fin de chaque tour pendant l'effet. La cible peut tout de même être remplacée si elle tient une Carapace Mue ou utilise Relais, Demi-Tour ou Change-Éclair. L'effet prend fin si l'utilisateur ou la cible quitte le terrain, ou si la cible utilise Tour Rapide. Cet effet n'est pas cumulable et n'est pas réinitialisé par une nouvelle capacité de ce genre.", // NEEDS QC
		},
		gen4: {
			desc: "Empêche la cible de quitter le combat pendant deux à cinq tours (toujours cinq si l'utilisateur tient une Accro Griffe). Inflige à la cible des dégâts égaux à 1/16 de ses PV max, arrondi à l'inférieur, à la fin de chaque tour pendant l'effet. La cible peut tout de même être remplacée si elle tient une Carapace Mue ou utilise Relais ou Demi-Tour. L'effet prend fin si l'utilisateur ou la cible quitte le terrain, ou si la cible utilise Tour Rapide ou Clonage avec succès. Cet effet n'est pas cumulable et n'est pas réinitialisé par une nouvelle capacité de ce genre.", // NEEDS QC
			shortDesc: "Piège et blesse la cible pendant 2-5 tours.", // NEEDS QC
	...
	magnitude: {
		...
		shortDesc: "Adjacents : puissance variable, ×2 contre Tunnel.", // NEEDS QC
		gen4: {
	...
	makeitrain: {
		...
		champions: {
			desc: "Baisse l'Attaque Spéciale de l'utilisateur de 2 niveaux.", // NEEDS QC
			shortDesc: "-2 Atq. Spé du lanceur. Touche les ennemis.", // NEEDS QC
		},
	...
	maliciousmoonsault: {
		...
		shortDesc: "Dégâts ×2 si la cible a utilisé Lilliput.", // NEEDS QC
	},
	malignantchain: {
	...
	matchagotcha: {
		...
		shortDesc: "20 % de brûler. Récupère 1/2 des dégâts. Dégèle.", // NEEDS QC
	},
	maxairstream: {
		name: "Aéromax",
	...
	mefirst: {
		...
		shortDesc: "Copie l'ennemi avec ×1,5. Doit agir en premier.", // NEEDS QC
		gen8: {
	...
	mist: {
		...
		gen1: {
			...
			start: "  {POKEMON} s'estompe dans la brume!", // RB fr_msg:2409
	...
	mistyexplosion: {
		...
		shortDesc: "Lanceur K.O. Sur champ brumeux : puissance ×1,5.", // NEEDS QC
	},
	mistyterrain: {
		name: "Champ Brumeux",
	...
	moonblast: {
		...
		champions: {
			desc: "A 10 % de chances de baisser l'Attaque Spéciale de la cible d'un niveau.", // NEEDS QC
			shortDesc: "10 % de baisser l'Atq. Spé de la cible d'un niveau.", // NEEDS QC
		},
	},
	moongeistbeam: {
		name: "Rayon Spectral",
	...
	nobleroar: {
		...
		shortDesc: "-1 Attaque et Atq. Spé de la cible.", // NEEDS QC
	},
	noretreat: {
		name: "Ultime Bastion",
	...
	odorsleuth: {
		...
		gen4: {
			desc: "Tant que la cible reste au combat, son niveau d'esquive est ignoré dans les calculs de précision contre elle s'il est supérieur à 0, et les attaques de type Normal et Combat peuvent la toucher même si elle est de type Spectre.", // NEEDS QC
		},
		gen3: {
			desc: "Tant que la cible reste au combat, son niveau d'esquive est ignoré dans les calculs de précision contre elle, et les attaques de type Normal et Combat peuvent la toucher même si elle est de type Spectre.", // NEEDS QC
		},
	},
	ominouswind: {
		name: "Vent Mauvais",
	...
	petaldance: {
		...
		gen1: {
			...
			shortDesc: "Dure 3-4 tours, puis le lanceur devient confus.", // NEEDS QC
		},
	},
	phantomforce: {
		name: "Hantise",
	...
	polarflare: {
		name: null, // NEEDS TRANSLATION: CAP
		desc: "A 10 % de chances de geler la cible. Cette capacité ne peut pas dégeler une cible gelée. Si cette capacité réussit contre au moins une cible et que l'utilisateur est un Ramnarok, il prend sa forme Radiant s'il est sous sa forme Dormant, et inversement. Ce changement de forme ne se produit pas si le Ramnarok a le talent Sans Limite. La forme Radiant redevient forme Dormant quand Ramnarok quitte le combat.", // NEEDS QC
	...
	powder: {
		...
		shortDesc: "Utiliser une capacité Feu coûte 1/4 PV à la cible.", // NEEDS QC
		gen6: {
	...
	psyblade: {
		...
		shortDesc: "Sur champ électrifié : puissance ×1,5.", // NEEDS QC
	},
	psychic: {
		name: "Psyko",
	...
	psywave: {
		...
		shortDesc: "Dégâts aléatoires entre 0,5× et 1,5× son niveau.", // NEEDS QC
		gen4: {
		...
		gen2: {
			...
			shortDesc: "Dégâts aléatoires de 1 à (niveau × 1,5 − 1).", // NEEDS QC
		},
	},
	pulverizingpancake: {
	...
	pursuit: {
		...
		shortDesc: "Frappe à puissance ×2 les ennemis qui se retirent.", // NEEDS QC
		gen7: {
		...
		gen3: {
			...
			shortDesc: "Puissance ×2 si la cible visée se retire.", // NEEDS QC
		},
		gen2: {
			...
			shortDesc: "Puissance ×2 si l'ennemi se retire.", // NEEDS QC
		},
	...
	ragefist: {
		...
		champions: {
			desc: "La puissance est égale à 50 + (X × 50), où X est le nombre total de fois où l'utilisateur a été touché par une attaque infligeant des dégâts pendant le combat, même s'il n'a pas perdu de PV. X ne peut pas dépasser 6 et revient à 0 quand l'utilisateur quitte le terrain. Chaque coup d'une capacité frappant plusieurs fois est compté, mais pas les dégâts de confusion.", // NEEDS QC
			shortDesc: "+50 par coup subi (6 max). Remis à 0 au retrait.", // NEEDS QC
		},
	},
	ragepowder: {
		name: "Poudre Fureur",
	...
	recycle: {
		...
		addItem: "  {POKEMON} trouve {ITEM:indefinite} !", // SV fr_common:7195 (B2W2 fr_common:4308: "{POKEMON} ramasse l'objet: {ITEM}!")
	},
	reflect: {
		name: "Protection",
		...
		desc: "Pendant 5 tours, l'utilisateur et son équipe subissent 0,5× les dégâts des attaques physiques, ou 0,66× en Combat Duo. Les dégâts ne sont pas réduits davantage avec Voile Aurore. Les coups critiques ignorent cet effet. L'effet est retiré du côté de l'utilisateur si lui ou un allié est touché par Casse-Brique, Psycho-Croc ou Anti-Brume. Dure 8 tours si l'utilisateur tient une Lumargile. Échoue si l'effet est déjà actif du côté de l'utilisateur.", // NEEDS QC
		shortDesc: "5 tours : dégâts physiques subis réduits de moitié.", // NEEDS QC
		gen6: {
			desc: "Pendant 5 tours, l'utilisateur et son équipe subissent 0,5× les dégâts des attaques physiques, ou 0,66× en Combat Duo ou Trio. Les coups critiques ignorent cet effet. L'effet est retiré du côté de l'utilisateur si lui ou un allié est touché par Casse-Brique ou Anti-Brume. Dure 8 tours si l'utilisateur tient une Lumargile. Échoue si l'effet est déjà actif du côté de l'utilisateur.", // NEEDS QC
		},
		gen4: {
	...
	retaliate: {
		...
		shortDesc: "Puissance ×2 si un allié a été K.O. le tour d'avant.", // NEEDS QC
	},
	return: {
		name: "Retour",
		// Official flavor text: "Cette capacité ne peut pas être utilisée. Il est recommandé de l’oublier, même s’il sera impossible de se la remémorer une fois oubliée."
	...
	revenge: {
		...
		gen3: {
			...
			shortDesc: "Dégâts ×2 si le lanceur a été touché avant.", // NEEDS QC
		},
	},
	reversal: {
		name: "Contre",
	...
	risingvoltage: {
		...
		shortDesc: "×2 contre une cible au sol sur champ électrifié.", // NEEDS QC
	},
	roar: {
		name: "Hurlement",
	...
	roleplay: {
		...
		gen4: {
			desc: "Le talent de l'utilisateur devient celui de la cible. Échoue si le talent de l'utilisateur est Multi-Type ou déjà identique à celui de la cible, si le talent de la cible est Multi-Type ou Garde Mystik, ou si l'utilisateur tient un Orbe Platiné.", // NEEDS QC
		},
		gen3: {
	...
	round: {
		...
		shortDesc: "Puissance ×2 si un autre a utilisé Chant Canon ce tour.", // NEEDS QC
	},
	ruination: {
		name: "Cataclysme",
	...
	saltcure: {
		...
		champions: {
			desc: "Inflige à la cible des dégâts égaux à 1/16 de ses PV max (1/8 si la cible est de type Acier ou Eau), arrondi à l'inférieur, à la fin de chaque tour pendant l'effet. L'effet prend fin quand la cible quitte le combat.", // NEEDS QC
			shortDesc: "Inflige 1/16 des PV par tour ; 1/8 aux Acier et Eau.", // NEEDS QC
		},
	...
	sandstorm: {
		...
		shortDesc: "5 tours : tempête de sable. Roche : Déf. Spé ×1,5.", // NEEDS QC
		gen4: {
	...
	selfdestruct: {
		...
		gen4: {
			desc: "L'utilisateur est mis K.O. après avoir utilisé cette capacité, sauf si elle n'a pas de cible. La Défense de la cible est divisée par deux pendant le calcul des dégâts. Cette capacité n'est pas exécutée si un Pokémon ayant le talent Moiteur est au combat.", // NEEDS QC
			shortDesc: "Déf. de la cible réduite de moitié. Lanceur K.O.", // NEEDS QC
		},
		gen3: {
			desc: "L'utilisateur est mis K.O. après avoir utilisé cette capacité. La Défense de la cible est divisée par deux pendant le calcul des dégâts. Cette capacité n'est pas exécutée si un Pokémon ayant le talent Moiteur est au combat.", // NEEDS QC
		},
	...
	shellsidearm: {
		...
		shortDesc: "20 % d'empoisonner. Physique si plus fort.", // NEEDS QC
	},
	shellsmash: {
		name: "Exuviation",
	...
	shiftgear: {
		name: "Change-Vitesse", // renamed in SV (SwSh: Chgt Vitesse)
	...
	skillswap: {
		...
		gen4: {
			desc: "L'utilisateur échange son talent avec celui de la cible. Échoue si le talent de l'utilisateur ou de la cible est Multi-Type ou Garde Mystik, si les deux ont le même talent, ou si l'un des deux tient un Orbe Platiné.", // NEEDS QC
		},
		gen3: {
	...
	smellingsalts: {
		...
		shortDesc: "×2 contre les paralysés, mais les soigne.", // NEEDS QC
		gen4: {
		...
		gen3: {
			...
			shortDesc: "Dégâts ×2 si la cible est paralysée ; la soigne.", // NEEDS QC
		},
	},
	smog: {
		name: "Purédpois",
	...
	snowscape: {
		...
		shortDesc: "5 tours : neige. Glace : Défense ×1,5.", // NEEDS QC
	},
	soak: {
		name: "Détrempage",
	...
	spikes: {
		...
		shortDesc: "Blesse les ennemis au sol à leur entrée. 3 couches max.", // NEEDS QC
		gen8: {
	...
	stealthrock: {
		...
		desc: "Pose un piège du côté adverse qui blesse chaque Pokémon adverse entrant au combat. Échoue si l'effet est déjà actif du côté adverse. Les adversaires perdent 1/32, 1/16, 1/8, 1/4 ou 1/2 de leurs PV max, arrondi à l'inférieur, selon leur faiblesse au type Roche (0,25×, 0,5×, neutre, 2× ou 4× respectivement). Peut être retiré du côté adverse si un Pokémon utilise Grand Nettoyage, ou si un Pokémon adverse utilise Toupie Éclat, Tour Rapide ou Anti-Brume avec succès, ou est touché par Anti-Brume.", // NEEDS QC
		shortDesc: "Blesse les ennemis entrants selon leur faiblesse Roche.", // NEEDS QC
		gen8: {
			desc: "Pose un piège du côté adverse qui blesse chaque Pokémon adverse entrant au combat. Échoue si l'effet est déjà actif du côté adverse. Les adversaires perdent 1/32, 1/16, 1/8, 1/4 ou 1/2 de leurs PV max, arrondi à l'inférieur, selon leur faiblesse au type Roche (0,25×, 0,5×, neutre, 2× ou 4× respectivement). Peut être retiré du côté adverse si un Pokémon adverse utilise Tour Rapide ou Anti-Brume avec succès, ou est touché par Anti-Brume.", // NEEDS QC
		},
		gen5: {
			desc: "Pose un piège du côté adverse qui blesse chaque Pokémon adverse entrant au combat. Échoue si l'effet est déjà actif du côté adverse. Les adversaires perdent 1/32, 1/16, 1/8, 1/4 ou 1/2 de leurs PV max, arrondi à l'inférieur, selon leur faiblesse au type Roche (0,25×, 0,5×, neutre, 2× ou 4× respectivement). Peut être retiré du côté adverse si un Pokémon adverse utilise Tour Rapide avec succès, ou est touché par Anti-Brume.", // NEEDS QC
		},
	...
	stickyweb: {
		...
		shortDesc: "-1 Vitesse aux ennemis au sol à leur entrée.", // NEEDS QC
		gen8: {
	...
	strengthsap: {
		...
		shortDesc: "Récupère l'Attaque de la cible en PV ; -1 Atq.", // NEEDS QC
	},
	stringshot: {
		name: "Sécrétion",
	...
	struggle: {
		...
		gen3: {
			...
			shortDesc: "Le lanceur perd 1/4 des PV perdus par la cible.", // NEEDS QC
		},
		gen2: {
		...
		gen1: {
			...
			shortDesc: "Le lanceur perd 1/2 des PV perdus par la cible.", // NEEDS QC
		},
	},
	strugglebug: {
		name: "Survinsecte",
	...
	stuffcheeks: {
		...
		champions: {
			desc: "Échoue si l'utilisateur ne tient pas de Baie. L'utilisateur mange sa Baie et monte sa Défense de 2 niveaux. Cet effet n'est pas empêché par les talents Maladresse ou Tension, ni par les effets d'Embargo ou de Zone Magique.", // NEEDS QC
			shortDesc: "Échoue sans Baie. Mange sa Baie, +2 Défense.", // NEEDS QC
		},
	},
	stunspore: {
		name: "Para-Spore",
	...
	superpower: {
		...
		shortDesc: "-1 Attaque et Défense du lanceur.", // NEEDS QC
	},
	supersonic: {
		name: "Ultrason",
		shortDesc: "Rend la cible confuse.", // NEEDS QC
	...
	surf: {
		...
		shortDesc: "Touche les adjacents. Dégâts ×2 contre Plongée.", // NEEDS QC
		gen4: {
			desc: "La puissance est doublée si la cible utilise Plongée.", // NEEDS QC
			shortDesc: "Touche les Pokémon adjacents. ×2 contre Plongée.", // NEEDS QC
		},
		gen2: {
			desc: "Aucun effet supplémentaire.", // NEEDS QC
			shortDesc: "Aucun effet supplémentaire.", // NEEDS QC
		...
		gen3: {
			shortDesc: "Touche les ennemis. ×2 contre Plongée.", // NEEDS QC
		},
	},
	surgingstrikes: {
	...
	switcheroo: {
		...
		champions: {
			desc: "L'utilisateur échange son objet tenu avec celui de la cible. Échoue si ni l'utilisateur ni la cible ne tiennent d'objet, ou si l'utilisateur essaie de donner ou de prendre une Méga-Gemme à ou de l'espèce pouvant méga-évoluer avec. La cible est immunisée contre cette capacité si elle a le talent Glu.", // NEEDS QC
		},
		gen8: {
	...
	terrainpulse: {
		...
		shortDesc: "Sur un champ : puissance ×2 et type variable.", // NEEDS QC
	},
	thief: {
		name: "Larcin",
	...
	tickle: {
		...
		shortDesc: "-1 Attaque et Défense de la cible.", // NEEDS QC
	},
	tidyup: {
	...
	toxicthread: {
		...
		champions: {
			desc: "Baisse la Vitesse de la cible de 2 niveaux et l'empoisonne.", // NEEDS QC
			shortDesc: "-2 Vitesse de la cible et l'empoisonne.", // NEEDS QC
		},
	},
	trailblaze: {
		name: "Désherbaffe",
	...
	tripleaxel: {
		...
		shortDesc: "3 coups de plus en plus forts. Chacun peut rater.", // NEEDS QC
	},
	tripledive: {
	...
	twineedle: {
		...
		shortDesc: "Frappe 2 fois. 20 % d'empoisonner par coup.", // NEEDS QC
		gen4: {
	...
	voltswitch: {
		name: "Change-Éclair", // renamed in SV (SwSh: Change Éclair)
		// Official flavor text: "Après son attaque, le lanceur revient à toute vitesse et change de place avec un Pokémon de l’équipe prêt au combat."
		desc: "Si cette capacité réussit et que l'utilisateur n'est pas K.O., il quitte le combat, même s'il est piégé, et est immédiatement remplacé par un membre de l'équipe choisi. L'utilisateur ne quitte pas le combat s'il n'y a aucun autre membre d'équipe non K.O., ou si la cible a été remplacée grâce à un Bouton Fuite ou aux talents Repli Tactique ou Escampette.", // NEEDS QC
		shortDesc: "Le lanceur se retire après avoir blessé la cible.", // NEEDS QC
		gen6: {
	...
	wakeupslap: {
		...
		shortDesc: "×2 contre les endormis, mais les réveille.", // NEEDS QC
		gen4: {
	...
	weatherball: {
		...
		shortDesc: "Sous une météo : puissance ×2 et type variable.", // NEEDS QC
		gen8: {
		...
		gen3: {
			...
			shortDesc: "Dégâts ×2 et type variable selon la météo.", // NEEDS QC
		},
	...
	workup: {
		...
		shortDesc: "+1 Attaque et Atq. Spé du lanceur.", // NEEDS QC
	},
	worryseed: {
		name: "Soucigraine",
