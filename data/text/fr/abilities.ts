export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
	...
	aerilate: {
		...
		shortDesc: "Ses capacités de type Normal deviennent de type Vol avec une puissance ×1,2.", // NEEDS QC
		gen6: {
			...
			shortDesc: "Les capacités Normal de ce Pokémon deviennent de type Vol avec 1,3× puissance.", // NEEDS QC
		},
	},
	aftermath: {
		name: "Boom Final",
	...
	analytic: {
		...
		shortDesc: "Les attaques de ce Pokémon ont une puissance ×1,3 s'il agit en dernier.", // NEEDS QC
	},
	angerpoint: {
		name: "Colérique",
	...
	aurabreak: {
		...
		shortDesc: "Tant que ce Pokémon est au combat, Aura Ténébreuse et Aura Féérique passent à 0,75×.", // NEEDS QC

		start: "  {POKEMON} inverse toutes les auras !",
	},
	auraguard: {
		name: "Aura Protectrice",
		shortDesc: "Subit moitié moins de dégâts des capacités à contact.", // NEEDS QC
	},
	baddreams: {
		name: "Mauvais Rêve",
	...
	battery: {
		name: "Batterie",
		shortDesc: "Les attaques spéciales des alliés de ce Pokémon ont une puissance ×1,3.", // NEEDS QC
	},
	battlearmor: {
		name: "Armurbaston",
	...
	blaze: {
		...
		shortDesc: "À 1/3 des PV max ou moins, sa statistique offensive est ×1,5 avec les attaques Feu.", // NEEDS QC
		gen4: {
			...
			shortDesc: "À 1/3 ou moins de ses PV max, ses attaques Feu ont 1,5× puissance.", // NEEDS QC
		},
	},
	bulletproof: {
		name: "Pare-Balles",
	...
	darkaura: {
		...
		shortDesc: "Tant que ce Pokémon est là, les capacités Ténèbres ont une puissance ×1,33.", // NEEDS QC
	...
	dragonize: {
		...
		shortDesc: "Ses capacités de type Normal deviennent de type Dragon avec une puissance ×1,2.", // NEEDS QC
	},
	dragonsmaw: {
		name: "Dent de Dragon",
	...
	dryskin: {
		...
		shortDesc: "Soigné 1/4 par l'Eau, 1/8 par la pluie ; subit 1,25× du Feu, perd 1/8 au soleil.", // NEEDS QC
		gen7: {
	...
	fairyaura: {
		...
		shortDesc: "Tant que ce Pokémon est au combat, les capacités Fée ont une puissance ×1,33.", // NEEDS QC
	...
	flareboost: {
		...
		shortDesc: "Quand ce Pokémon est brûlé, ses attaques spéciales ont une puissance ×1,5.", // NEEDS QC
	},
	flashfire: {
		name: "Torche",
		...
		shortDesc: "Attaques Feu ×1,5 s'il est touché par une capacité Feu ; immunisé au Feu.", // NEEDS QC
		gen4: {
	...
	flowergift: {
		...
		shortDesc: "Si Ceriflor et Soleil actif : Attaque et Déf. Spé ×1,5 pour lui et les alliés.", // NEEDS QC
		gen7: {
		...
		gen4: {
			...
			shortDesc: "Sous Soleil : Attaque et Déf. Spé de ce Pokémon et de ses alliés ×1,5.", // NEEDS QC
		},
	},
	flowerveil: {
		name: "Flora-Voile",
	...
	fluffy: {
		...
		shortDesc: "Ce Pokémon subit 1/2 des dégâts de contact, mais 2× les dégâts de type Feu.", // NEEDS QC
	},
	forecast: {
		name: "Météo",
	...
	galvanize: {
		...
		shortDesc: "Ses capacités de type Normal deviennent de type Électrik avec une puissance ×1,2.", // NEEDS QC
	},
	gluttony: {
		name: "Gloutonnerie",
	...
	gorillatactics: {
		...
		shortDesc: "Attaque ×1,5, mais ce Pokémon ne peut choisir que sa première capacité.", // NEEDS QC
	},
	grasspelt: {
		name: "Toison Herbue",
	...
	guts: {
		...
		shortDesc: "Si ce Pokémon a un statut, son Attaque est ×1,5 ; ignore la baisse due à la brûlure.", // NEEDS QC
	},
	hadronengine: {
		name: "Moteur à Hadrons",
		shortDesc: "À l'entrée, invoque un Champ Électrifié ; Atq. Spé ×1,3333 sur ce champ.", // NEEDS QC
	...
	healer: {
		...
		champions: {
			desc: "Il y a 50 % de chances que le problème de statut de l'allié de ce Pokémon soit soigné à la fin de chaque tour.", // NEEDS QC
			shortDesc: "50 % de chances de soigner le statut de son allié à la fin de chaque tour.", // NEEDS QC
		},
		gen6: {
	...
	hustle: {
		...
		shortDesc: "Son Attaque est ×1,5, mais la précision de ses attaques physiques est ×0,8.", // NEEDS QC
	},
	hydration: {
		name: "Hydratation",
	...
	ironfist: {
		...
		shortDesc: "Ses attaques de poing ont une puissance ×1,2. Coup Bas exclu.", // NEEDS QC
	},
	justified: {
		name: "Cœur Noble",
	...
	megalauncher: {
		...
		shortDesc: "Ses capacités d'ondes ont une puissance ×1,5. Vibra Soin soigne 3/4 des PV.", // NEEDS QC
	},
	megasol: {
		name: "Méga-Soleil",
	...
	neuroforce: {
		...
		shortDesc: "Ses attaques super efficaces infligent des dégâts ×1,25.", // NEEDS QC
	},
	neutralizinggas: {
		name: "Gaz Inhibiteur",
	...
	normalize: {
		...
		shortDesc: "Ses capacités deviennent de type Normal avec une puissance ×1,2.", // NEEDS QC
		gen6: {
	...
	orichalcumpulse: {
		...
		shortDesc: "À l'entrée, invoque Soleil ; Attaque ×1,3333 au soleil.", // NEEDS QC
	...
	overgrow: {
		...
		shortDesc: "À 1/3 des PV ou moins, sa statistique offensive est ×1,5 avec les attaques Plante.", // NEEDS QC
		gen4: {
			...
			shortDesc: "À 1/3 ou moins de ses PV max, ses attaques Plante ont 1,5× puissance.", // NEEDS QC
		},
	},
	owntempo: {
		name: "Tempo Perso",
	...
	pixilate: {
		...
		shortDesc: "Ses capacités de type Normal deviennent de type Fée avec une puissance ×1,2.", // NEEDS QC
		gen6: {
			...
			shortDesc: "Les capacités Normal de ce Pokémon deviennent de type Fée avec 1,3× puissance.", // NEEDS QC
		},
	},
	plus: {
		name: "Plus",
	...
	powerspot: {
		...
		shortDesc: "Les capacités des alliés de ce Pokémon ont une puissance ×1,3.", // NEEDS QC
	},
	prankster: {
		name: "Farceur",
	...
	protosynthesis: {
		...
		shortDesc: "Au soleil ou via Énergie Booster : plus haute stat ×1,3 (×1,5 si Vitesse).", // NEEDS QC
	...
	punkrock: {
		...
		shortDesc: "Subit la moitié des dégâts des capacités sonores ; les siennes font ×1,3.", // NEEDS QC
	},
	purepower: {
		name: "Force Pure",
		shortDesc: "L'Attaque de ce Pokémon est doublée.", // NEEDS QC
	...
	quarkdrive: {
		...
		shortDesc: "Champ électrifié ou Énergie Booster : plus haute stat ×1,3 (×1,5 si Vitesse).", // NEEDS QC
	...
	quickfeet: {
		...
		shortDesc: "Si ce Pokémon a un statut, sa Vitesse est ×1,5 ; ignore la baisse de la paralysie.", // NEEDS QC
		gen6: {
	...
	reckless: {
		...
		shortDesc: "Ses attaques à contrecoup ou dégâts d'échec font ×1,2 ; sauf Lutte.", // NEEDS QC
	},
	refrigerate: {
		name: "Peau Gelée",
		...
		shortDesc: "Ses capacités de type Normal deviennent de type Glace avec une puissance ×1,2.", // NEEDS QC
		gen6: {
			...
			shortDesc: "Les capacités Normal de ce Pokémon deviennent de type Glace avec 1,3× puissance.", // NEEDS QC
		},
	},
	regenerator: {
		name: "Régé-Force",
	...
	rivalry: {
		...
		shortDesc: "Ses attaques font 1,25× contre le même sexe, 0,75× contre le sexe opposé.", // NEEDS QC
	},
	rkssystem: {
		name: "Système Alpha",
	...
	sandforce: {
		...
		shortDesc: "Ses attaques Sol/Roche/Acier font ×1,3 sous tempête de sable ; immunisé contre elle.", // NEEDS QC
	},
	sandrush: {
		name: "Baigne Sable",
	...
	sandveil: {
		...
		shortDesc: "Sous tempête de sable, son esquive est ×1,25 ; immunisé contre elle.", // NEEDS QC
	},
	sapsipper: {
		name: "Herbivore",
	...
	sheerforce: {
		...
		shortDesc: "Ses attaques à effet secondaire font ×1,3, mais leurs effets sont supprimés.", // NEEDS QC
		gen8: {
	...
	snowcloak: {
		...
		gen8: {
			...
			shortDesc: "Sous la grêle : esquive ×1,25 ; immunisé contre la grêle.", // NEEDS QC
		},
	},
	snowwarning: {
		name: "Alerte Neige",
	...
	solarpower: {
		...
		shortDesc: "Si Soleil est actif : Atq. Spé ×1,5, mais perd 1/8 de ses PV max par tour.", // NEEDS QC
		gen7: {
	...
	steelyspirit: {
		...
		shortDesc: "Les capacités Acier de ce Pokémon et de ses alliés ont une puissance ×1,5.", // NEEDS QC
	},
	stench: {
		name: "Puanteur",
	...
	strongjaw: {
		...
		shortDesc: "Ses attaques de mâchoire ont une puissance ×1,5. Piqûre exclu.", // NEEDS QC
	},
	sturdy: {
		name: "Fermeté",
	...
	swarm: {
		...
		shortDesc: "À 1/3 des PV ou moins, sa statistique offensive est ×1,5 avec les attaques Insecte.", // NEEDS QC
		gen4: {
			...
			shortDesc: "À 1/3 ou moins de ses PV max, ses attaques Insecte ont 1,5× puissance.", // NEEDS QC
		},
	},
	sweetveil: {
		name: "Gluco-Voile",
	...
	technician: {
		...
		shortDesc: "Ses capacités de 60 de puissance ou moins font ×1,5, Lutte compris.", // NEEDS QC
		gen4: {
			...
			shortDesc: "Ses capacités de 60 de puissance ou moins ont 1,5× puissance, sauf Lutte.", // NEEDS QC
		},
	},
	telepathy: {
		name: "Télépathe",
	...
	terashell: {
		...
		shortDesc: "Terapagos : à PV max, les attaques subies ont 0,5× d'efficacité, sauf immunité.", // NEEDS QC
	...
	torrent: {
		...
		shortDesc: "À 1/3 des PV ou moins, sa statistique offensive est ×1,5 avec les attaques Eau.", // NEEDS QC
		gen4: {
			...
			shortDesc: "À 1/3 ou moins de ses PV max, ses attaques Eau ont 1,5× puissance.", // NEEDS QC
		},
	},
	toughclaws: {
		name: "Griffe Dure",
	...
	toxicboost: {
		...
		shortDesc: "Quand il est empoisonné, ses attaques physiques ont une puissance ×1,5.", // NEEDS QC
	},
	toxicchain: {
		name: "Chaîne Toxique",
	...
	transistor: {
		...
		gen8: {
			shortDesc: "Sa stat offensive est ×1,5 quand il utilise une attaque Électrik.", // NEEDS QC
		},
	},
	triage: {
		name: "Prioguérison",
	...
	victorystar: {
		name: "Victorieux",
		shortDesc: "Les capacités de ce Pokémon et de ses alliés ont leur précision ×1,1.", // NEEDS QC
	},
	vitalspirit: {
		name: "Esprit Vital",
		shortDesc: "Ce Pokémon ne peut pas s'endormir. L'obtenir en dormant le réveille.", // NEEDS QC
