// Mechanics desc style (zh-tw): official game terminology, halfwidth numerals (1.5倍, 30%).
// Terminology: 該寶可夢 (this Pokemon), 出場時 (on switch-in), 能力等級 (stat stage),
//   進攻能力 (offensive stat), 瀕死 (fainted/KO), 接觸類招式 (contact move), 連續攻擊招式
//   (multi-hit move), 追加效果 (secondary effect), 異常狀態 (non-volatile status),
//   向下取整 (rounded down), 五捨六入 (rounded half down), 先制招式 (priority move).
// Weather states: 大晴天/下雨/沙暴/冰雹/下雪; harsh: 大日照 (Desolate Land), 大雨
//   (Primordial Sea), 亂流 (Delta Stream).
