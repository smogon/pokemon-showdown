export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
	...
	auraguard: {
		name: "波導防護",
		shortDesc: "受到的接觸類招式傷害減半。", // NEEDS QC
	},
	baddreams: {
		name: "夢魘",
	...
	healer: {
		...
		champions: {
			desc: "每回合結束時，有50%的機率治癒隊友的異常狀態。", // NEEDS QC
			shortDesc: "每回合有50%的機率治癒隊友的異常狀態。", // NEEDS QC
		},
		gen6: {
	...
	illuminate: {
		...
		desc: "該寶可夢的命中率不會被其他寶可夢降低。該寶可夢無視目標的閃避率變化。", // NEEDS QC
		shortDesc: "命中率不會被降低，且無視對手的閃避率。", // NEEDS QC
		gen8: {
	...
	infiltrator: {
		...
		desc: "該寶可夢的招式無視替身以及對手方的反射壁、光牆、神秘守護、白霧、極光幕。", // NEEDS QC
		shortDesc: "攻擊時無視替身和反射壁、光牆等。", // NEEDS QC
		gen6: {
			desc: "該寶可夢的招式無視替身以及對手方的反射壁、光牆、神秘守護、白霧。", // NEEDS QC
			shortDesc: "招式無視替身及對手的反射壁、光牆、神秘守護、白霧。", // NEEDS QC
		},
		gen5: {
			desc: "該寶可夢的招式無視對手方的反射壁、光牆、神秘守護、白霧。", // NEEDS QC
			shortDesc: "招式無視對手的反射壁、光牆、神秘守護、白霧。", // NEEDS QC
		},
	},
	innardsout: {
		name: "飛出的內在物",
	...
	mindseye: {
		name: "心眼",
		desc: "該寶可夢的一般屬性和格鬥屬性招式可以擊中幽靈屬性寶可夢。該寶可夢的命中率不會被其他寶可夢降低。該寶可夢無視目標的閃避率變化。", // NEEDS QC
		shortDesc: "一般和格鬥招式可命中幽靈屬性，且無視閃避率。", // NEEDS QC
	},
	minus: {
		name: "負電",
	...
	moody: {
		...
		desc: "每回合結束時，該寶可夢隨機一項能力（命中率和閃避率除外）提高2級，另一項能力降低1級。", // NEEDS QC
	...
	multitype: {
		name: "多屬性",
		shortDesc: "阿爾宙斯的屬性隨攜帶的石板變化。", // NEEDS QC
		gen7: {
			shortDesc: "是阿爾宙斯時，屬性隨攜帶的石板或Z純晶變化。", // NEEDS QC
		},
		gen6: {
			shortDesc: "阿爾宙斯的屬性隨攜帶的石板變化。", // NEEDS QC
		},
		gen4: {
			desc: "若該寶可夢是阿爾宙斯，其屬性隨攜帶的石板變化。該寶可夢不會因其他寶可夢的攻擊而失去攜帶的道具。", // NEEDS QC
		},
	},
	mummy: {
		name: "木乃伊",
	...
	sandveil: {
		...
		shortDesc: "沙暴時閃避率變為1.25倍，且免疫沙暴傷害。", // NEEDS QC
	},
	sapsipper: {
		name: "食草",
	...
	snowcloak: {
		...
		shortDesc: "下雪時閃避率變為1.25倍。", // NEEDS QC
		gen8: {
			desc: "天氣為冰雹時，以該寶可夢為目標的招式命中率變為0.8倍。不受冰雹的傷害。", // NEEDS QC
			shortDesc: "冰雹時閃避率變為1.25倍。不受冰雹傷害。", // NEEDS QC
		},
	},
	snowwarning: {
		name: "降雪",
	...
	supersweetsyrup: {
		name: "甘露之蜜",
		shortDesc: "出場時使對手的閃避率降低1級。每場戰鬥1次。", // NEEDS QC
	...
	tangledfeet: {
		name: "蹣跚",
		shortDesc: "混亂期間，閃避率變為2倍。", // NEEDS QC
	},
	tanglinghair: {
		name: "捲髮",
		shortDesc: "接觸自己的對手速度降低1級。", // NEEDS QC
	...
	unaware: {
		...
		desc: "該寶可夢受到傷害時，無視其他寶可夢的攻擊、特攻和命中率的能力等級變化；造成傷害時，無視其他寶可夢的防禦、特防和閃避率的能力等級變化。", // NEEDS QC
	...
	persistent: {
		name: null, // NEEDS TRANSLATION: CAP
		desc: "由該寶可夢發動的重力、回復封鎖、魔法空間、神秘守護、順風、戲法空間、奇妙空間的效果時間延長2回合。", // NEEDS QC
