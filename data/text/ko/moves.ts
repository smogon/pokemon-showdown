export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	assist: {
		name: "조수",
		// Official flavor text: "사용할 수 없는 기술입니다. 다시 배우게 할 수 없지만 기술을 잊게 하는 것을 권장합니다."
		desc: "파티의 다른 포켓몬이 지닌 기술 중 하나를 무작위로 골라 쓴다. 조수, 토치카, 부리캐논, 트림, 기프트패스, 번액셀, 뛰어오르기, 축하, 수다, 배대뒤치기, 파이트액셀, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 구멍파기, 다이빙, 드래곤테일, 버티기, 페인트, 공중날기, 힘껏펀치, 날따름, 도우미, 손에손잡기, 킹실드, 매지컬액셀, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 포이즌액셀, 고스트다이브, 방어, 분노가루, 울부짖기, 섀도다이브, 트랩셸, 스케치, 프리폴, 잠꼬대, 가로채기, 니들가드, 스포트라이트, 발버둥, 바꿔치기, 테라클러스터, 도둑질, 변신, 트릭, 날려버리기, 다크액셀은 고르지 않는다.", // NEEDS QC
		shortDesc: "파티의 다른 포켓몬의 기술을 무작위로 쓴다.", // NEEDS QC
		gen8: {
			desc: "파티의 다른 포켓몬이 지닌 기술 중 하나를 무작위로 골라 쓴다. 조수, 토치카, 부리캐논, 트림, 기프트패스, 뛰어오르기, 축하, 수다, 배대뒤치기, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 구멍파기, 다이빙, 드래곤테일, 버티기, 페인트, 공중날기, 힘껏펀치, 날따름, 도우미, 손에손잡기, 킹실드, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 고스트다이브, 방어, 분노가루, 울부짖기, 섀도다이브, 트랩셸, 스케치, 프리폴, 잠꼬대, 가로채기, 니들가드, 스포트라이트, 발버둥, 바꿔치기, 도둑질, 변신, 트릭, 날려버리기는 고르지 않는다.", // NEEDS QC
		},
		gen7: {
			desc: "파티의 다른 포켓몬이 지닌 기술 중 하나를 무작위로 골라 쓴다. 조수, 토치카, 부리캐논, 트림, 기프트패스, 뛰어오르기, 축하, 수다, 배대뒤치기, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 구멍파기, 다이빙, 드래곤테일, 버티기, 페인트, 공중날기, 힘껏펀치, 날따름, 도우미, 손에손잡기, 킹실드, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 고스트다이브, 방어, 분노가루, 울부짖기, 섀도다이브, 트랩셸, 스케치, 프리폴, 잠꼬대, 가로채기, 니들가드, 스포트라이트, 발버둥, 바꿔치기, 도둑질, 변신, 트릭, 날려버리기, 그리고 Z기술은 고르지 않는다.", // NEEDS QC
		},
		gen6: {
			desc: "파티의 다른 포켓몬이 지닌 기술 중 하나를 무작위로 골라 쓴다. 조수, 트림, 기프트패스, 뛰어오르기, 축하, 수다, 배대뒤치기, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 구멍파기, 다이빙, 드래곤테일, 버티기, 페인트, 공중날기, 힘껏펀치, 날따름, 도우미, 손에손잡기, 킹실드, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 고스트다이브, 방어, 분노가루, 울부짖기, 섀도다이브, 스케치, 프리폴, 잠꼬대, 가로채기, 니들가드, 발버둥, 바꿔치기, 도둑질, 변신, 트릭, 날려버리기는 고르지 않는다.", // NEEDS QC
		},
		gen5: {
			desc: "파티의 다른 포켓몬이 지닌 기술 중 하나를 무작위로 골라 쓴다. 조수, 기프트패스, 수다, 배대뒤치기, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 드래곤테일, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 방어, 분노가루, 스케치, 잠꼬대, 가로채기, 발버둥, 바꿔치기, 도둑질, 변신, 트릭은 고르지 않는다.", // NEEDS QC
		},
		gen4: {
			desc: "파티의 다른 포켓몬이 지닌 기술 중 하나를 무작위로 골라 쓴다. 조수, 수다, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 방어, 스케치, 잠꼬대, 가로채기, 발버둥, 바꿔치기, 도둑질, 트릭은 고르지 않는다.", // NEEDS QC
		},
		gen3: {
			desc: "파티의 다른 포켓몬이 지닌 기술 중 하나를 무작위로 골라 쓴다. 조수, 카운터, 탐내기, 길동무, 판별, 버티기, 힘껏펀치, 날따름, 도우미, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 방어, 스케치, 잠꼬대, 가로채기, 발버둥, 도둑질, 트릭은 고르지 않는다.", // NEEDS QC
		},
	},
	assurance: {
		name: "승부굳히기",
	...
	attract: {
		...
		endFromItem: "  {POKEMON:topic} {ITEM:directional} 헤롱헤롱 상태가 나았다!",
	...
	auroraveil: {
		...
		desc: "5턴 동안 자신과 파티 전원이 물리와 특수 공격으로 받는 데미지가 0.5배(더블배틀에서는 0.66배)가 된다. 리플렉터와 빛의장막으로 데미지가 더 줄어들지는 않는다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기, 사이코팽, 안개제거에 맞으면 효과가 사라진다. 깨트리기와 사이코팽은 데미지 계산 전에 효과를 없앤다. 빛의점토를 지니고 있으면 8턴 동안 지속된다. 날씨가 눈이 아니면 실패한다.", // NEEDS QC
		shortDesc: "5턴간 받는 데미지 절반. 눈일 때만 쓸 수 있다.", // NEEDS QC
		gen8: {
			desc: "5턴 동안 자신과 파티 전원이 물리와 특수 공격으로 받는 데미지가 0.5배(더블배틀에서는 0.66배)가 된다. 리플렉터와 빛의장막으로 데미지가 더 줄어들지는 않는다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기, 사이코팽, 안개제거에 맞으면 효과가 사라진다. 깨트리기와 사이코팽은 데미지 계산 전에 효과를 없앤다. 빛의점토를 지니고 있으면 8턴 동안 지속된다. 날씨가 싸라기눈이 아니면 실패한다.", // NEEDS QC
	...
	batonpass: {
		...
		gen7: {
			desc: "파티의 다른 포켓몬과 교체한다. 교체해 나온 포켓몬은 자신의 능력 랭크 변화와 혼란, 아쿠아링, 저주, 금제, 기충전, 위액, 회복봉인, 뿌리박기, 씨뿌리기, 록온(마음의눈), 전자부유, 멸망의노래, 파워트릭, 텔레키네시스의 효과, 검은눈빛(블록, 거미집)에 의해 교체할 수 없게 된 효과, 그리고 남은 HP 그대로의 대타를 이어받는다. 이어받는 포켓몬의 특성이 영향을 받지 않는 특성이라면 위액의 효과는 이어받지 않는다. 이어받는 포켓몬이 메가진화한 팬텀이라면 텔레키네시스의 효과는 이어받지 않는다.", // NEEDS QC
		},
		gen5: {
	...
	belch: {
		...
		champions: {
			desc: "나무열매를 먹지 않았다면 실패한다. 지닌 나무열매를 먹거나, 벌레먹기와 쪼아대기로 다른 포켓몬의 나무열매를 빼앗아 먹거나, 내던지기로 던져진 나무열매를 먹으면 조건이 충족된다. 자연의은혜로 소모한 나무열매는 먹은 것으로 치지 않는다.", // NEEDS QC
			shortDesc: "나무열매를 먹지 않았다면 실패한다.", // NEEDS QC
		},
	},
	bellydrum: {
		name: "배북",
	...
	bestow: {
		...
		takeItem: "  {POKEMON:topic} {SOURCE:directional}부터 {ITEM:object} 받았다!",
	},
	bide: {
		name: "참기",
		// Official flavor text: "사용할 수 없는 기술입니다. 다시 배우게 할 수 없지만 기술을 잊게 하는 것을 권장합니다."
		...
		gen1: {
			desc: "2~3턴 동안 이 기술에 속박되어, 기술을 쓴 뒤 두 번째 또는 세 번째 턴에 그동안 잃은 HP의 2배의 데미지를 상대에게 준다. 타입 상성에 의한 무효를 무시하며, 상대가 구멍파기나 공중날기를 쓰는 중이라도 피할 수 없다. 효과 도중 자신은 교체할 수 있다. 교체하거나 움직일 수 없게 되면 효과가 사라진다. 효과 도중 상대가 교체하거나 이상한빛, 텍스처, 기충전, 뱀눈초리, 흑안개, 씨뿌리기, 빛의장막, 흉내내기, 흰안개, 독가스, 독가루, HP회복, 리플렉터, 잠자기, 알낳기, 튀어오르기, 저리가루, 대타출동, 초음파, 순간이동, 전기자석파, 맹독, 변신을 쓰면, 이전에 자신이 받은 데미지가 합계에 더해진다.", // NEEDS QC
		},
	...
	bind: {
		...
		gen3: {
			desc: "2~5턴 동안 상대를 교체할 수 없게 만든다. 효과가 지속되는 동안 매 턴 종료 시 상대는 최대 HP의 1/16(버림)의 데미지를 받는다. 배턴터치를 쓰면 교체할 수 있다. 자신이나 상대가 배틀에서 벗어나거나 상대가 고속스핀, 대타출동에 성공하면 효과가 사라진다. 이 효과는 중복되지 않으며, 같은 계열의 기술을 다시 써도 지속 시간이 늘어나지 않는다.", // NEEDS QC
		},
		gen1: {
	...
	brickbreak: {
		name: "깨트리기", // renamed in SV (SwSh: 깨트리다)
	...
	conversion: {
		...
		typeChange: "  {SOURCE:conjunctive} 같은 타입이 되었다!", // NEEDS QC; wording follows the official Reflect Type line (SV 7683)
	},
	conversion2: {
		name: "텍스처2",
	...
	copycat: {
		...
		desc: "자신을 포함해 어떤 포켓몬이든 마지막으로 쓴 기술을 따라 쓴다. 아직 아무 기술도 쓰이지 않았거나, 마지막 기술이 조수, 토치카, 부리캐논, 거수탄, 거수참, 트림, 기프트패스, 번액셀, 축하, 수다, 배대뒤치기, 파이트액셀, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 드래곤테일, 다이맥스포, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 손에손잡기, 킹실드, 매지컬액셀, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 따라하기, 자연의힘, 포이즌액셀, 방어, 분노가루, 울부짖기, 트랩셸, 스케치, 잠꼬대, 가로채기, 니들가드, 스포트라이트, 발버둥, 바꿔치기, 테라클러스터, 도둑질, 변신, 트릭, 날려버리기, 다크액셀이었다면 실패한다.", // NEEDS QC
		shortDesc: "배틀에서 마지막으로 쓰인 기술을 따라 쓴다.", // NEEDS QC
		gen8: {
			desc: "자신을 포함해 어떤 포켓몬이든 마지막으로 쓴 기술을 따라 쓴다. 다이맥스 기술은 원래 기술을 기준으로 판정한다. 아직 아무 기술도 쓰이지 않았거나, 마지막 기술이 조수, 토치카, 부리캐논, 거수탄, 거수참, 트림, 기프트패스, 축하, 수다, 배대뒤치기, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 드래곤테일, 다이맥스포, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 손에손잡기, 킹실드, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 방어, 분노가루, 울부짖기, 트랩셸, 스케치, 잠꼬대, 가로채기, 니들가드, 스포트라이트, 발버둥, 바꿔치기, 도둑질, 변신, 트릭, 날려버리기였다면 실패한다.", // NEEDS QC
		},
		gen7: {
			desc: "자신을 포함해 어떤 포켓몬이든 마지막으로 쓴 기술을 따라 쓴다. 아직 아무 기술도 쓰이지 않았거나, 마지막 기술이 조수, 토치카, 부리캐논, 트림, 기프트패스, 축하, 수다, 배대뒤치기, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 드래곤테일, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 손에손잡기, 킹실드, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 방어, 분노가루, 울부짖기, 트랩셸, 스케치, 잠꼬대, 가로채기, 니들가드, 스포트라이트, 발버둥, 바꿔치기, 도둑질, 변신, 트릭, 날려버리기 또는 Z기술이었다면 실패한다.", // NEEDS QC
		},
		gen6: {
			desc: "자신을 포함해 어떤 포켓몬이든 마지막으로 쓴 기술을 따라 쓴다. 아직 아무 기술도 쓰이지 않았거나, 마지막 기술이 조수, 트림, 기프트패스, 축하, 수다, 배대뒤치기, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 드래곤테일, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 손에손잡기, 킹실드, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 방어, 분노가루, 울부짖기, 스케치, 잠꼬대, 가로채기, 니들가드, 발버둥, 바꿔치기, 도둑질, 변신, 트릭, 날려버리기였다면 실패한다.", // NEEDS QC
		},
		gen5: {
			desc: "자신을 포함해 어떤 포켓몬이든 마지막으로 쓴 기술을 따라 쓴다. 아직 아무 기술도 쓰이지 않았거나, 마지막 기술이 조수, 기프트패스, 수다, 배대뒤치기, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 드래곤테일, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 방어, 분노가루, 스케치, 잠꼬대, 가로채기, 발버둥, 바꿔치기, 도둑질, 변신, 트릭이었다면 실패한다.", // NEEDS QC
		},
		gen4: {
			desc: "자신을 포함해 어떤 포켓몬이든 마지막으로 쓴 기술을 따라 쓴다. 아직 아무 기술도 쓰이지 않았거나, 마지막 기술이 조수, 수다, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 방어, 스케치, 잠꼬대, 가로채기, 발버둥, 바꿔치기, 도둑질, 트릭이었다면 실패한다.", // NEEDS QC
		},
	},
	coreenforcer: {
		name: "코어퍼니셔",
		...
		shortDesc: "먼저 행동한 상대의 특성을 무효로 만든다.", // NEEDS QC
		gen8: {
	...
	counter: {
		...
		gen2: {
			desc: "이 턴에 물리 공격으로 잃은 HP의 2배의 데미지를 상대에게 준다. 잠재파워는 노말타입으로 취급하며, 연속 공격 기술은 마지막 공격만 계산한다. 자신이 먼저 행동하거나, 이 턴에 물리 공격을 받지 않았거나, 그 공격으로 HP를 잃지 않았다면 실패한다. 상대가 땅가르기나 뿔드릴을 쓰고 빗나갔다면 이 기술은 65535의 데미지를 준다.", // NEEDS QC
		},
		gen1: {
			desc: "배틀에서 마지막으로 쓰인 기술이 준 데미지의 2배를 상대에게 준다. 타입 상성에 의한 무효를 무시한다. 자신이 먼저 행동하거나, 상대 쪽의 마지막 기술이 카운터거나, 위력이 0이거나, 노말 또는 격투타입이 아니라면 실패한다. 어느 한쪽의 마지막 기술이 데미지를 주지 않았고 그 기술이 이상한빛, 텍스처, 기충전, 뱀눈초리, 흑안개, 씨뿌리기, 빛의장막, 흉내내기, 흰안개, 독가스, 독가루, HP회복, 리플렉터, 잠자기, 알낳기, 튀어오르기, 저리가루, 대타출동, 초음파, 순간이동, 전기자석파, 맹독, 변신이 아니라면 실패한다.", // NEEDS QC
	...
	covet: {
		name: "탐내기", // renamed in SV (SwSh: 탐내다)
		...
		champions: {
			desc: "이 공격이 성공하고 자신이 도구를 지니고 있지 않다면 상대가 지닌 도구를 빼앗는다. 특성이 점착인 상대는 기절하지 않는 한 도구를 잃지 않는다. 도구가 메가스톤이고 자신이나 상대가 그것으로 메가진화할 수 있는 포켓몬이라면 빼앗지 못한다. 이 기술로 잃은 도구는 리사이클로 되찾거나 특성 수확으로 되살릴 수 없다.", // NEEDS QC
		},
		gen8: {
			desc: "이 공격이 성공하고 자신이 기절하지 않았다면, 자신이 도구를 지니고 있지 않을 때 상대가 지닌 도구를 빼앗는다. 특성이 점착인 상대는 기절하지 않는 한 도구를 잃지 않는다. 가이오가와 쪽빛구슬, 그란돈과 주홍구슬, 기라티나와 백금옥, 아르세우스와 플레이트, 게노세크트와 카세트, 실버디와 메모리, 자시안과 녹슨검, 자마젠타와 녹슨방패는 해당 포켓몬이 지닌 경우 빼앗지 못하며, 자신이 그 포켓몬이고 상대가 해당 도구를 지닌 경우도 마찬가지다. 이 기술로 잃은 도구는 리사이클로 되찾거나 특성 수확으로 되살릴 수 없다.", // NEEDS QC
		},
		gen7: {
		...
		gen4: {
			desc: "이 공격이 성공하고 자신이 도구를 지니고 있지 않다면 상대가 지닌 도구를 빼앗는다. 도구가 메일이나 백금옥이거나, 상대의 특성이 멀티타입이나 점착이라면 빼앗지 못한다. 이 기술로 잃은 도구는 리사이클로 되찾을 수 없다.", // NEEDS QC
		},
		gen3: {
			desc: "이 공격이 성공하고 자신이 도구를 지니고 있지 않다면 상대가 지닌 도구를 빼앗는다. 도구가 메일이나 의문열매거나, 상대의 특성이 점착이라면 빼앗지 못한다. 이 기술로 잃은 도구는 리사이클로 되찾을 수 없다.", // NEEDS QC
		},
	},
	crabhammer: {
		name: "집게해머",
	...
	dig: {
		...
		gen4: {
			desc: "1턴째에 땅속으로 파고들어 2턴째에 공격한다. 1턴째에는 지진과 매그니튜드를 제외한 모든 공격을 피하지만 그 두 기술은 위력이 2배가 되어 명중하며, 날씨의 영향도 받지 않는다. 파워풀허브를 지니고 있으면 1턴 만에 공격한다.", // NEEDS QC
		},
		gen3: {
			desc: "1턴째에 땅속으로 파고들어 2턴째에 공격한다. 1턴째에는 지진과 매그니튜드를 제외한 모든 공격을 피하지만 그 두 기술은 위력이 2배가 되어 명중하며, 날씨의 영향도 받지 않는다.", // NEEDS QC
		},
		gen2: {
	...
	direclaw: {
		...
		champions: {
			desc: "30%의 확률로 상대를 잠듦, 독 또는 마비 상태 중 하나로 만든다.", // NEEDS QC
			shortDesc: "30%의 확률로 잠듦, 독 또는 마비로 만든다.", // NEEDS QC
		},
	},
	disable: {
		name: "사슬묶기",
	...
	dive: {
		...
		gen4: {
			desc: "1턴째에 물속으로 잠수해 2턴째에 공격한다. 1턴째에는 파도타기와 바다회오리를 제외한 모든 공격을 피하지만 그 두 기술은 위력이 2배가 되어 명중하며, 날씨의 영향도 받지 않는다. 파워풀허브를 지니고 있으면 1턴 만에 공격한다.", // NEEDS QC
		},
		gen3: {
			desc: "1턴째에 물속으로 잠수해 2턴째에 공격한다. 1턴째에는 파도타기와 바다회오리를 제외한 모든 공격을 피하지만 그 두 기술은 위력이 2배가 되어 명중하며, 날씨의 영향도 받지 않는다.", // NEEDS QC
		},
	...
	encore: {
		...
		end: "  {POKEMON}의 앙코르 상태가 풀렸다!", // SV/Champions; SwSh: 앵콜 상태가 풀렸다
	},
	endeavor: {
		name: "죽기살기",
	...
	entrainment: {
		...
		gen8: {
			desc: "상대의 특성이 자신의 특성과 같아진다. 상대의 특성이 혼연일체, 유대변화, 절대안깸, 탈, 그대로꿀꺽미사일, 아이스페이스, 멀티타입, 스웜체인지, AR시스템, 어군, 리밋실드, 배틀스위치, 게으름, 달마모드이거나 자신과 같다면, 또는 자신의 특성이 혼연일체, 유대변화, 절대안깸, 탈, 플라워기프트, 기분파, 그대로꿀꺽미사일, 꼬르륵스위치, 아이스페이스, 일루전, 괴짜, 멀티타입, 화학변화가스, 스웜체인지, 과학의힘, 리시버, AR시스템, 어군, 리밋실드, 배틀스위치, 트레이스, 달마모드라면 실패한다.", // NEEDS QC
		},
		gen7: {
			desc: "상대의 특성이 자신의 특성과 같아진다. 상대의 특성이 유대변화, 절대안깸, 탈, 멀티타입, 스웜체인지, AR시스템, 어군, 리밋실드, 배틀스위치, 게으름, 달마모드이거나 자신과 같다면, 또는 자신의 특성이 유대변화, 절대안깸, 탈, 플라워기프트, 기분파, 일루전, 괴짜, 멀티타입, 스웜체인지, 과학의힘, 리시버, AR시스템, 어군, 리밋실드, 배틀스위치, 트레이스, 달마모드라면 실패한다.", // NEEDS QC
		},
		gen6: {
			desc: "상대의 특성이 자신의 특성과 같아진다. 상대의 특성이 멀티타입, 배틀스위치, 게으름이거나 자신과 같다면, 또는 자신의 특성이 플라워기프트, 기분파, 일루전, 괴짜, 멀티타입, 배틀스위치, 트레이스, 달마모드라면 실패한다.", // NEEDS QC
		},
		gen5: {
			desc: "상대의 특성이 자신의 특성과 같아진다. 상대의 특성이 멀티타입, 게으름이거나 자신과 같다면, 또는 자신의 특성이 플라워기프트, 기분파, 일루전, 괴짜, 멀티타입, 트레이스, 달마모드라면 실패한다.", // NEEDS QC
		},
	},
	eruption: {
		name: "분화",
	...
	fakeout: {
		...
		champions: {
			desc: "100%의 확률로 상대를 풀죽게 한다. 배틀에 나온 첫 턴이 아니면 선택할 수 없다.", // NEEDS QC
		},
	},
	faketears: {
		name: "거짓울음",
	...
	feint: {
		...
		gen5: {
			desc: "이 기술이 성공하면 이 턴 동안 상대의 판별이나 방어의 효과를 뚫어, 다른 포켓몬도 상대를 공격할 수 있게 된다. 상대가 적이고 그 진영이 패스트가드나 와이드가드로 보호받고 있다면 그 효과도 이 턴 동안 뚫린다.", // NEEDS QC
		},
		gen4: {
	...
	firstimpression: {
		...
		champions: {
			desc: "배틀에 나온 첫 턴이 아니면 선택할 수 없다.", // NEEDS QC
		},
	},
	fishiousrend: {
		name: "아가미물기",
	...
	followme: {
		...
		gen6: {
			desc: "이 턴이 끝날 때까지 상대 진영의 단일 대상 공격이 범위 안이라면 모두 자신에게 유도된다. 이 유도는 매직코트나 특성 매직미러로 되받아치거나 특성 피뢰침이나 마중물이 끌어당기기 전에 적용된다. 더블배틀이나 트리플배틀이 아니면 실패한다. 자신이 프리폴의 효과를 받는 동안에는 무시된다.", // NEEDS QC
		},
		gen4: {
	...
	freezedry: {
		...
		champions: {
			desc: "이 기술의 타입과 관계없이 물타입에게 효과가 뛰어나다.", // NEEDS QC
			shortDesc: "물타입에게 효과가 뛰어나다.", // NEEDS QC
		},
	},
	freezeshock: {
		name: "프리즈볼트",
	...
	gmaxdepletion: {
		...
		shortDesc: "위력은 원래 기술에 따른다. 상대: 마지막 기술 PP-2.", // NEEDS QC
	...
	grasspledge: {
		...
		desc: "아군이 이 턴에 불꽃의맹세나 물의맹세를 선택했고 아직 행동하지 않았다면, 그 아군은 자신 바로 다음에 행동하고 자신의 기술은 아무 일도 일으키지 않는다. 불꽃의맹세와 조합하면 아군이 위력 150의 불꽃의맹세를 쓰고, 4턴 동안 상대 진영이 불바다가 되어 매 턴 종료 시(마지막 턴 포함) 불꽃타입이 아닌 포켓몬이 최대 HP의 1/8(버림)의 데미지를 받는다. 물의맹세와 조합하면 아군이 위력 150의 풀의맹세를 쓰고, 4턴 동안 상대 진영이 습지초원이 되어 그 진영의 포켓몬의 스피드가 1/4이 된다. 조합해서 쓰면 자신의 타입과 관계없이 타입 일치 보정을 받는다. 풀주얼은 소모하지 않는다.", // NEEDS QC
	...
	growth: {
		...
		shortDesc: "공격과 특공 +1(쾌청에서는 +2).", // NEEDS QC
		gen7: {
	...
	gust: {
		...
		gen4: {
			desc: "상대가 뛰어오르기나 공중날기를 쓰는 중이라면 위력이 2배가 된다.", // NEEDS QC
	...
	haze: {
		...
		shortDesc: "모든 랭크 변화를 없앤다.", // NEEDS QC
		gen1: {
			desc: "양쪽 포켓몬의 랭크 변화를 0으로 되돌리고, 화상과 마비에 의한 능력 감소를 없앤다. 맹독 카운트를 0으로 되돌리고, 양쪽 포켓몬의 혼란, 사슬묶기, 기충전, 씨뿌리기, 빛의장막, 흰안개, 리플렉터의 효과를 없앤다. 상대의 상태 이상을 없앤다.", // NEEDS QC
	...
	healblock: {
		...
		start: "  {POKEMON:topic} 회복 동작을 봉인당했다!",
	...
	knockoff: {
		...
		champions: {
			desc: "상대가 도구를 지니고 있다면 위력이 1.5배가 되며, 상대는 그 도구를 잃는다. 특성이 점착인 상대는 기절하지 않는 한 도구를 잃지 않는다. 그것으로 메가진화할 수 있는 포켓몬이 지닌 메가스톤은 위력이 오르지 않고 도구도 잃게 하지 못한다. 이 기술로 잃은 도구는 리사이클로 되찾거나 특성 수확으로 되살릴 수 없다.", // NEEDS QC
		},
		gen8: {
			desc: "상대가 도구를 지니고 있다면 위력이 1.5배가 되며, 자신이 기절하지 않았다면 상대는 그 도구를 잃는다. 특성이 점착인 상대는 기절하지 않는 한 도구를 잃지 않는다. 가이오가와 쪽빛구슬, 그란돈과 주홍구슬, 기라티나와 백금옥, 아르세우스와 플레이트, 게노세크트와 카세트, 실버디와 메모리, 자시안과 녹슨검, 자마젠타와 녹슨방패는 해당 포켓몬이 지닌 경우 위력이 오르지 않고 도구도 잃게 하지 못하며, 자신이 그 포켓몬이고 상대가 해당 도구를 지닌 경우도 마찬가지다. 이 기술로 잃은 도구는 리사이클로 되찾거나 특성 수확으로 되살릴 수 없다.", // NEEDS QC
		},
		gen7: {
		...
		gen4: {
			desc: "상대는 배틀이 끝날 때까지 지닌 도구를 잃는다. 도구가 백금옥이거나 상대의 특성이 멀티타입이나 점착이라면 잃지 않는다. 효과가 지속되는 동안 상대는 어떤 방법으로도 새 도구를 얻을 수 없다.", // NEEDS QC
			shortDesc: "상대는 도구를 잃고 새로 얻지 못한다.", // NEEDS QC
		},
		gen3: {
			desc: "상대는 배틀이 끝날 때까지 지닌 도구를 잃는다. 특성이 점착이라면 잃지 않는다. 효과가 지속되는 동안 상대는 어떤 방법으로도 새 도구를 얻을 수 없다.", // NEEDS QC
		},
	...
	lightscreen: {
		...
		desc: "5턴 동안 자신과 파티 전원이 특수 공격으로 받는 데미지가 0.5배(더블배틀에서는 0.66배)가 된다. 오로라베일로 데미지가 더 줄어들지는 않는다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기, 사이코팽, 안개제거에 맞으면 효과가 사라진다. 빛의점토를 지니고 있으면 8턴 동안 지속된다. 자신 진영에 이미 효과가 발동 중이라면 실패한다.", // NEEDS QC
		shortDesc: "5턴 동안 받는 특수 데미지가 절반이 된다.", // NEEDS QC
		gen6: {
			desc: "5턴 동안 자신과 파티 전원이 특수 공격으로 받는 데미지가 0.5배(더블배틀이나 트리플배틀에서는 0.66배)가 된다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기나 안개제거에 맞으면 효과가 사라진다. 빛의점토를 지니고 있으면 8턴 동안 지속된다. 자신 진영에 이미 효과가 발동 중이라면 실패한다.", // NEEDS QC
		},
		gen4: {
			desc: "5턴 동안 자신과 파티 전원이 특수 공격으로 받는 데미지가 1/2(자신 진영에 여러 포켓몬이 나와 있으면 2/3)이 된다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기나 안개제거에 맞으면 효과가 사라진다. 빛의점토를 지니고 있으면 8턴 동안 지속된다. 자신 진영에 이미 효과가 발동 중이라면 실패한다.", // NEEDS QC
		},
		gen3: {
			desc: "5턴 동안 자신과 파티 전원이 특수 공격으로 받는 데미지가 1/2(자신 진영에 여러 포켓몬이 나와 있으면 2/3)이 된다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기에 맞으면 효과가 사라진다. 자신 진영에 이미 효과가 발동 중이라면 실패한다.", // NEEDS QC
		},
		gen2: {
	...
	lockon: {
		...
		start: "  {SOURCE:topic} 목표를 {POKEMON:directional} 결정했다!",
	},
	lovelykiss: {
		name: "악마의키스",
		shortDesc: "상대를 잠듦 상태로 만든다.", // NEEDS QC
	...
	magiccoat: {
		...
		move: "{POKEMON:topic} {MOVE:object} 되받아쳤다!", // NEEDS QC; adapted from SV 6837 / Champions MajicMirror `{0}의 {1}[P2] 되받아쳤다!` (official subject is the original user)
	},
	magicpowder: {
		name: "마법가루",
	...
	magnitude: {
		...
		activate: "  매그니튜드{NUMBER}!", // SV 8643 `매그니튜드4!` (no space, single !); was "매그니튜드 {NUMBER}!!"
	},
	makeitrain: {
		name: "골드러시",
		...
		champions: {
			desc: "자신의 특수공격을 2단계 떨어뜨린다.", // NEEDS QC
			shortDesc: "자신의 특공 -2. 상대 전체를 공격한다.", // NEEDS QC
		},
	...
	maxflare: {
		...
		shortDesc: "위력은 원래 기술에 따른다. 날씨: 쾌청.", // NEEDS QC
	},
	maxflutterby: {
		name: "다이웜",
	...
	maxguard: {
		...
		activate: "  {POKEMON:topic} 공격으로부터 몸을 지켰다!",
	},
	maxhailstorm: {
		name: "다이아이스",
	...
	mefirst: {
		name: "선취",
		// Official flavor text: "사용할 수 없는 기술입니다. 다시 배우게 할 수 없지만 기술을 잊게 하는 것을 권장합니다."
		desc: "상대가 이 턴에 쓰려고 선택한 기술을 위력 1.5배로 먼저 쓴다. 그 기술은 부리캐논, 트림, 번액셀, 파이트액셀, 앙갚음, 카운터, 탐내기, 힘껏펀치, 매지컬액셀, 선취, 메탈버스트, 미러코트, 포이즌액셀, 트랩셸, 발버둥, 도둑질, 다크액셀이 아닌 공격 기술이어야 한다. 상대가 자신보다 먼저 행동하면 실패한다. 기술을 복사할 때 상대의 대타는 무시한다.", // NEEDS QC
		shortDesc: "상대의 기술을 1.5배로 먼저 쓴다.", // NEEDS QC
		gen8: {
			desc: "상대가 이 턴에 쓰려고 선택한 기술을 위력 1.5배로 먼저 쓴다. 그 기술은 부리캐논, 트림, 수다, 카운터, 탐내기, 힘껏펀치, 선취, 메탈버스트, 미러코트, 트랩셸, 발버둥, 도둑질이 아닌 공격 기술이어야 한다. 상대가 자신보다 먼저 행동하면 실패한다. 기술을 복사할 때 상대의 대타는 무시한다.", // NEEDS QC
		},
		gen7: {
			desc: "상대가 이 턴에 쓰려고 선택한 기술을 위력 1.5배로 먼저 쓴다. 그 기술은 부리캐논, 트림, 수다, 카운터, 탐내기, 힘껏펀치, 선취, 메탈버스트, 미러코트, 트랩셸, 발버둥, 도둑질, Z기술이 아닌 공격 기술이어야 한다. 상대가 자신보다 먼저 행동하면 실패한다. 기술을 복사할 때 상대의 대타는 무시한다.", // NEEDS QC
		},
		gen6: {
			desc: "상대가 이 턴에 쓰려고 선택한 기술을 위력 1.5배로 먼저 쓴다. 그 기술은 트림, 수다, 카운터, 탐내기, 힘껏펀치, 선취, 메탈버스트, 미러코트, 발버둥, 도둑질이 아닌 공격 기술이어야 한다. 상대가 자신보다 먼저 행동하면 실패한다. 기술을 복사할 때 상대의 대타는 무시한다.", // NEEDS QC
		},
		gen5: {
			desc: "상대가 이 턴에 쓰려고 선택한 기술을 위력 1.5배로 먼저 쓴다. 그 기술은 수다, 카운터, 탐내기, 힘껏펀치, 선취, 메탈버스트, 미러코트, 발버둥, 도둑질이 아닌 공격 기술이어야 한다. 상대가 자신보다 먼저 행동하면 실패한다. 기술을 복사할 때 상대의 대타는 무시한다.", // NEEDS QC
		},
		gen4: {
			desc: "상대가 이 턴에 쓰려고 선택한 기술을 위력 1.5배로 먼저 쓴다. 그 기술은 수다, 카운터, 탐내기, 힘껏펀치, 선취, 미러코트, 발버둥, 도둑질이 아닌 공격 기술이어야 한다. 상대가 자신보다 먼저 행동하면 실패한다. 기술을 복사할 때 상대의 대타는 무시한다.", // NEEDS QC
		},
	},
	megadrain: {
		name: "메가드레인",
	...
	metronome: {
		...
		desc: "무작위 기술을 골라 쓴다. 당신먼저, 사과산, 아머캐논, 조수, 아스트랄비트, 오라휠, 토치카, 부리캐논, 거수탄, 거수참, 트림, 기프트패스, 번액셀, 바디프레스, 가지찌르기, 와이드브레이커, 축하, 수다, 찬물끼얹기, 썰렁개그, 소울비트, 엑셀브레이크, 파이트액셀, 앙갚음, 흉내쟁이, 카운터, 탐내기, 트릭가드, 데코레이션, 길동무, 판별, 다이아스톰, 배껴그리기, 더블펀처, 전광쌍격, 화룡점정, 드래곤에너지, 드럼어택, 다이맥스포, 라이트닝드라이브, 버티기, 무한다이빔, 사죄의찌르기, 페인트, 타오르는분노, 제살깎기, 플뢰르캐논, 힘껏펀치, 날따름, 프리즈볼트, 얼어붙는시선, 블리자드랜스, G의힘, 도우미, 손에손잡기, 하이퍼드릴, 이차원러시, 이차원홀, 콜드플레어, 지휘, 제트펀치, 정글힐, 킹실드, 생명의물방울, 파멸의빛, 매지컬액셀, 골드러시, 마룻바닥세워막기, 선취, 스타어설트, 손가락흔들기, 흉내내기, 깜짝헤드, 미러코트, 따라하기, 섀도레이, 자연의힘, 자연의분노, 포이즌액셀, 블로킹, 한판내기, 근원의파동, 오버드라이브, 포톤가이저, 플라스마피스트, 찍찍베기, 달려들기, 파워시프트, 단애의칼, 방어, 화염볼, 순서미루기, 패스트가드, 분노의주먹, 분노가루, 레이징불, 대격분, 옛노래, 회생의기도, 카타스트로피, 소금절이, 신비의칼, 꼬리자르기, 트랩셸, 스레드트랩, 스케치, 잠꼬대, 집게덫, 바크아웃, 가로채기, 코골기, 설경, 섀도스틸, 하바네로엑기스, 니들가드, 소울크래시, 스포트라이트, 봄의폭풍, 스팀버스트, 철제광선, 원더스팀, 발버둥, 메테오드라이브, 수류연타, 바꿔치기, 테크노버스터, 테라클러스터, 도둑질, 사우전드애로, 사우전드웨이브, 썬더프리즌, 천둥차기, 정리정돈, 개척하기, 변신, 트릭, 트윈빔, V제너레이트, 암흑강타, 다크액셀, 와이드가드는 고르지 않는다.", // NEEDS QC
		shortDesc: "무작위 기술을 쓴다.", // NEEDS QC
		gen8bdsp: {
			desc: "무작위 기술을 골라 쓴다. 당신먼저, 트림, 바디프레스, 수다, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 화룡점정, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 생명의물방울, 손가락흔들기, 흉내내기, 미러코트, 자연의힘, 근원의파동, 단애의칼, 방어, 순서미루기, 패스트가드, 분노가루, 스케치, 잠꼬대, 바크아웃, 코골기, 니들가드, 발버둥, 바꿔치기, 도둑질, 변신, 트릭, 와이드가드는 고르지 않는다.", // NEEDS QC
		},
		gen7letsgo: {
			desc: "1세대에 등장한 기술 중에서 무작위로 골라 쓴다. 카운터, 흉내내기, 따라하기, 발버둥, 변신은 고르지 않는다.", // NEEDS QC
			shortDesc: "1세대 기술을 무작위로 쓴다.", // NEEDS QC
		},
		gen8: {
			desc: "무작위 기술을 골라 쓴다. 당신먼저, 사과산, 조수, 아스트랄비트, 오라휠, 토치카, 부리캐논, 거수탄, 거수참, 트림, 기프트패스, 바디프레스, 가지찌르기, 와이드브레이커, 축하, 수다, 소울비트, 흉내쟁이, 카운터, 탐내기, 트릭가드, 데코레이션, 길동무, 판별, 다이아스톰, 더블펀처, 화룡점정, 드래곤에너지, 드래곤해머, 드럼어택, 다이맥스포, 버티기, 무한다이빔, 사죄의찌르기, 페인트, 타오르는분노, 플뢰르캐논, 힘껏펀치, 날따름, 프리즈볼트, 얼어붙는시선, 블리자드랜스, G의힘, 도우미, 손에손잡기, 이차원러시, 이차원홀, 콜드플레어, 지휘, 정글힐, 킹실드, 생명의물방울, 파멸의빛, 마룻바닥세워막기, 선취, 스타어설트, 손가락흔들기, 흉내내기, 깜짝헤드, 미러코트, 따라하기, 섀도레이, 자연의힘, 자연의분노, 블로킹, 근원의파동, 오버드라이브, 포톤가이저, 플라스마피스트, 단애의칼, 방어, 화염볼, 순서미루기, 패스트가드, 분노가루, 옛노래, 신비의칼, 트랩셸, 스케치, 잠꼬대, 집게덫, 바크아웃, 가로채기, 코골기, 섀도스틸, 니들가드, 소울크래시, 스포트라이트, 스팀버스트, 철제광선, 원더스팀, 발버둥, 메테오드라이브, 수류연타, 바꿔치기, 테크노버스터, 도둑질, 사우전드애로, 사우전드웨이브, 썬더프리즌, 천둥차기, 변신, 트릭, V제너레이트, 암흑강타, 와이드가드는 고르지 않는다.", // NEEDS QC
		},
		gen7: {
			desc: "무작위 기술을 골라 쓴다. 당신먼저, 조수, 토치카, 부리캐논, 트림, 기프트패스, 축하, 수다, 흉내쟁이, 카운터, 탐내기, 트릭가드, 길동무, 판별, 다이아스톰, 화룡점정, 버티기, 페인트, 플뢰르캐논, 힘껏펀치, 날따름, 프리즈볼트, 도우미, 손에손잡기, 이차원러시, 이차원홀, 콜드플레어, 지휘, 킹실드, 파멸의빛, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 깜짝헤드, 미러코트, 따라하기, 자연의힘, 근원의파동, 포톤가이저, 플라스마피스트, 단애의칼, 방어, 순서미루기, 패스트가드, 분노가루, 옛노래, 신비의칼, 트랩셸, 스케치, 잠꼬대, 바크아웃, 가로채기, 코골기, 섀도스틸, 니들가드, 스포트라이트, 스팀버스트, 발버둥, 바꿔치기, 테크노버스터, 도둑질, 사우전드애로, 사우전드웨이브, 변신, 트릭, V제너레이트, 와이드가드는 고르지 않는다.", // NEEDS QC
		},
		gen6: {
			desc: "무작위 기술을 골라 쓴다. 당신먼저, 조수, 트림, 기프트패스, 축하, 수다, 흉내쟁이, 카운터, 탐내기, 트릭가드, 길동무, 판별, 다이아스톰, 화룡점정, 버티기, 페인트, 힘껏펀치, 날따름, 프리즈볼트, 도우미, 손에손잡기, 이차원러시, 이차원홀, 콜드플레어, 킹실드, 파멸의빛, 마룻바닥세워막기, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 근원의파동, 단애의칼, 방어, 순서미루기, 패스트가드, 분노가루, 옛노래, 신비의칼, 스케치, 잠꼬대, 바크아웃, 가로채기, 코골기, 니들가드, 스팀버스트, 발버둥, 바꿔치기, 테크노버스터, 도둑질, 사우전드애로, 사우전드웨이브, 변신, 트릭, V제너레이트, 와이드가드는 고르지 않는다.", // NEEDS QC
		},
		gen5: {
			desc: "무작위 기술을 골라 쓴다. 당신먼저, 조수, 기프트패스, 수다, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 버티기, 페인트, 힘껏펀치, 날따름, 프리즈볼트, 도우미, 콜드플레어, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 자연의힘, 방어, 순서미루기, 패스트가드, 분노가루, 옛노래, 신비의칼, 스케치, 잠꼬대, 바크아웃, 가로채기, 코골기, 발버둥, 바꿔치기, 테크노버스터, 도둑질, 변신, 트릭, V제너레이트, 와이드가드는 고르지 않는다.", // NEEDS QC
		},
		gen4: {
			desc: "무작위 기술을 골라 쓴다. 조수, 수다, 흉내쟁이, 카운터, 탐내기, 길동무, 판별, 버티기, 페인트, 힘껏펀치, 날따름, 도우미, 선취, 손가락흔들기, 흉내내기, 미러코트, 따라하기, 방어, 스케치, 잠꼬대, 가로채기, 발버둥, 바꿔치기, 도둑질, 트릭과 이미 지니고 있는 기술은 고르지 않는다.", // NEEDS QC
		},
		gen3: {
			desc: "무작위 기술을 골라 쓴다. 카운터, 탐내기, 길동무, 판별, 버티기, 힘껏펀치, 날따름, 도우미, 손가락흔들기, 흉내내기, 미러코트, 방어, 스케치, 잠꼬대, 가로채기, 발버둥, 도둑질, 트릭은 고르지 않는다.", // NEEDS QC
		},
		gen2: {
	...
	moonblast: {
		...
		champions: {
			desc: "10%의 확률로 상대의 특수공격을 1단계 떨어뜨린다.", // NEEDS QC
			shortDesc: "10%의 확률로 상대의 특수공격을 1단계 떨어뜨린다.", // NEEDS QC
		},
	},
	moongeistbeam: {
		name: "섀도레이",
	...
	poisonfang: {
		...
		gen5: {
			...
			shortDesc: "30%의 확률로 상대를 맹독 상태로 만든다.", // NEEDS QC
		},
	},
	poisongas: {
		name: "독가스",
	...
	poisonsting: {
		...
		gen1: {
			...
			shortDesc: "20%의 확률로 상대를 독 상태로 만든다.", // NEEDS QC
		},
	},
	poisontail: {
		name: "포이즌테일",
	...
	powder: {
		...
		desc: "상대가 이 턴에 불꽃타입 기술을 쓰면 그 기술은 실행되지 않고 상대는 최대 HP의 1/4(0.5는 올림)을 잃는다. 불꽃타입 기술이 특성 시작의바다로 막힌 경우에는 발동하지 않는다.", // NEEDS QC
		shortDesc: "상대가 불꽃 기술을 쓰면 최대 HP의 1/4을 잃는다.", // NEEDS QC
		gen6: {
			desc: "상대가 이 턴에 불꽃타입 기술을 쓰면 그 기술은 실행되지 않고 상대는 최대 HP의 1/4(0.5는 올림)을 잃는다. 이 효과는 불꽃타입 기술이 특성 시작의바다로 막히기 전에 발동한다.", // NEEDS QC
		},
	...
	protect: {
		...
		start: "  {POKEMON:topic} 방어 태세에 들어갔다!",
		block: "  {POKEMON:topic} 공격으로부터 몸을 지켰다!",
	},
	psybeam: {
		name: "환상빔",
	...
	ragefist: {
		...
		champions: {
			desc: "위력은 배틀에서 자신이 공격 기술에 맞은 총횟수(HP를 잃지 않았더라도)를 X라 할 때 50+(X×50)이다. X는 6을 넘지 않으며 배틀에서 벗어나면 0으로 돌아간다. 연속 공격 기술은 매 공격을 세지만 혼란에 의한 데미지는 세지 않는다.", // NEEDS QC
			shortDesc: "맞은 횟수마다 위력 +50(최대 6회). 교체 시 초기화.", // NEEDS QC
		},
	},
	ragepowder: {
		name: "분노가루",
	...
	ragingbull: {
		name: "레이징불",
		desc: "공격이 빗나가지 않았다면 데미지 계산 전에 상대 진영의 리플렉터, 빛의장막, 오로라베일의 효과를 없앤다. 자신이 팔데아켄타로스라면 모습에 따라 타입이 변한다. 팔데아켄타로스 컴뱃이라면 격투타입, 팔데아켄타로스 블레이즈라면 불꽃타입, 팔데아켄타로스 워터라면 물타입이 된다.", // NEEDS QC
	...
	recycle: {
		...
		desc: "마지막으로 사용한 도구를 되찾는다. 도구를 지니고 있거나, 도구를 지닌 적이 없거나, 도구가 터진 풍선이거나, 특성이 픽업인 포켓몬이 주워 갔거나, 벌레먹기, 부식가스, 탐내기, 불태우기, 탁쳐서떨구기, 쪼아대기, 도둑질로 잃었다면 실패한다. 내던지기로 던진 도구는 되찾을 수 있다.", // NEEDS QC
		shortDesc: "마지막으로 사용한 도구를 되찾는다.", // NEEDS QC
		gen7: {
			desc: "마지막으로 사용한 도구를 되찾는다. 도구를 지니고 있거나, 도구를 지닌 적이 없거나, 도구가 터진 풍선이거나, 특성이 픽업인 포켓몬이 주워 갔거나, 벌레먹기, 탐내기, 불태우기, 탁쳐서떨구기, 쪼아대기, 도둑질로 잃었다면 실패한다. 내던지기로 던진 도구는 되찾을 수 있다.", // NEEDS QC
		},
		gen4: {
			desc: "자신 자리에서 마지막으로 사용된 도구를 되찾는다. 그 도구를 사용한 포켓몬이 자신이 아니어도 된다. 도구를 지니고 있거나, 자신 자리에서 사용된 도구가 없거나, 도구가 탐내기, 탁쳐서떨구기, 도둑질로 잃은 것이라면 실패한다. 내던지기로 던진 도구는 되찾을 수 있다.", // NEEDS QC
		},
	...
	reflect: {
		...
		desc: "5턴 동안 자신과 파티 전원이 물리 공격으로 받는 데미지가 0.5배(더블배틀에서는 0.66배)가 된다. 오로라베일로 데미지가 더 줄어들지는 않는다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기, 사이코팽, 안개제거에 맞으면 효과가 사라진다. 빛의점토를 지니고 있으면 8턴 동안 지속된다. 자신 진영에 이미 효과가 발동 중이라면 실패한다.", // NEEDS QC
		shortDesc: "5턴 동안 받는 물리 데미지가 절반이 된다.", // NEEDS QC
		gen6: {
			desc: "5턴 동안 자신과 파티 전원이 물리 공격으로 받는 데미지가 0.5배(더블배틀이나 트리플배틀에서는 0.66배)가 된다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기나 안개제거에 맞으면 효과가 사라진다. 빛의점토를 지니고 있으면 8턴 동안 지속된다. 자신 진영에 이미 효과가 발동 중이라면 실패한다.", // NEEDS QC
		},
		gen4: {
			desc: "5턴 동안 자신과 파티 전원이 물리 공격으로 받는 데미지가 1/2(자신 진영에 여러 포켓몬이 나와 있으면 2/3)이 된다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기나 안개제거에 맞으면 효과가 사라진다. 빛의점토를 지니고 있으면 8턴 동안 지속된다. 자신 진영에 이미 효과가 발동 중이라면 실패한다.", // NEEDS QC
		},
		gen3: {
			desc: "5턴 동안 자신과 파티 전원이 물리 공격으로 받는 데미지가 1/2(자신 진영에 여러 포켓몬이 나와 있으면 2/3)이 된다. 급소에 맞으면 이 효과를 무시한다. 자신이나 아군이 깨트리기에 맞으면 효과가 사라진다. 자신 진영에 이미 효과가 발동 중이라면 실패한다.", // NEEDS QC
		},
		gen2: {
	...
	reflecttype: {
		...
		shortDesc: "자신의 타입이 상대와 같아진다.", // NEEDS QC
		gen8: {
			desc: "자신의 타입이 상대의 현재 타입과 같아진다. 상대의 타입에 무타입과 다른 타입이 있다면 무타입은 무시한다. 무타입과 숲의저주나 핼러윈으로 추가된 타입이 있다면 무타입은 노말타입으로 복사된다. 자신이 아르세우스나 실버디거나, 상대가 무타입뿐이라면 실패한다.", // NEEDS QC
		},
		gen6: {
	...
	roleplay: {
		...
		gen5: {
			desc: "자신의 특성이 상대의 특성으로 변한다. 자신의 특성이 멀티타입이거나 이미 상대와 같다면, 또는 상대의 특성이 플라워기프트, 기분파, 일루전, 괴짜, 멀티타입, 트레이스, 불가사의부적, 달마모드라면 실패한다.", // NEEDS QC
		},
		gen4: {
			desc: "자신의 특성이 상대의 특성으로 변한다. 자신의 특성이 멀티타입이거나 이미 상대와 같다면, 상대의 특성이 멀티타입이나불가사의부적이라면, 또는 자신이 백금옥을 지니고 있다면 실패한다.", // NEEDS QC
		},
		gen3: {
	...
	saltcure: {
		...
		champions: {
			desc: "효과가 지속되는 동안 매 턴 종료 시 상대는 최대 HP의 1/16(강철타입이나 물타입이라면 1/8)(버림)의 데미지를 받는다. 상대가 배틀에서 벗어나면 효과가 사라진다.", // NEEDS QC
			shortDesc: "매 턴 HP 1/16(강철·물타입은 1/8)의 데미지.", // NEEDS QC
		},
	...
	searingshot: {
		...
		// Official flavor text: "새빨간 불꽃으로 자신의 주위에 있는 포켓몬을 공격한다. 화상 상태로 만들 때가 있다."
		desc: "30%의 확률로 상대를 화상 상태로 만든다.", // NEEDS QC
		shortDesc: "30%의 확률로 이웃한 포켓몬을 화상시킨다.", // NEEDS QC
	},
	searingsunrazesmash: {
		name: "선샤인스매셔",
		// Official flavor text: "사용할 수 없는 기술입니다. 다시 배우게 할 수 없지만 기술을 잊게 하는 것을 권장합니다."
	...
	shadowforce: {
		...
		gen5: {
			desc: "이 기술이 성공하면 이 턴 동안 상대의 판별과 방어의 효과를 뚫어, 다른 포켓몬도 상대를 공격할 수 있게 된다. 상대가 상대 진영의 포켓몬이고 그 진영이 패스트가드나 와이드가드로 보호받고 있다면 그 효과도 이 턴 동안 뚫려, 다른 포켓몬도 상대 진영을 공격할 수 있게 된다. 1턴째에 모습을 감추고 2턴째에 공격한다. 1턴째에는 모든 공격을 피한다. 파워풀허브를 지니고 있으면 1턴 만에 공격한다.", // NEEDS QC
		},
	...
	simplebeam: {
		...
		gen6: {
			desc: "상대의 특성이 단순으로 변한다. 상대의 특성이 멀티타입, 단순, 배틀스위치, 게으름이라면 실패한다.", // NEEDS QC
		},
		gen5: {
			desc: "상대의 특성이 단순으로 변한다. 상대의 특성이 멀티타입, 단순, 게으름이라면 실패한다.", // NEEDS QC
		},
	},
	sing: {
		name: "노래하기",
	...
	skillswap: {
		...
		gen6: {
			desc: "자신과 상대의 특성을 맞바꾼다. 어느 한쪽의 특성이 일루전, 멀티타입, 배틀스위치, 불가사의부적이라면 실패한다.", // NEEDS QC
		},
		gen5: {
			desc: "자신과 상대의 특성을 맞바꾼다. 어느 한쪽의 특성이 일루전, 멀티타입, 불가사의부적이라면, 또는 양쪽의 특성이 같다면 실패한다.", // NEEDS QC
		},
		gen4: {
			desc: "자신과 상대의 특성을 맞바꾼다. 어느 한쪽의 특성이 멀티타입이나불가사의부적이라면, 양쪽의 특성이 같다면, 또는 어느 한쪽이 백금옥을 지니고 있다면 실패한다.", // NEEDS QC
		},
		gen3: {
	...
	skyuppercut: {
		...
		gen4: {
			desc: "이 기술은 뛰어오르기나 공중날기를 쓰는 중인 상대도 맞힐 수 있다.", // NEEDS QC
	...
	stuffcheeks: {
		...
		champions: {
			desc: "나무열매를 지니고 있지 않으면 실패한다. 지닌 나무열매를 먹고 자신의 방어를 2단계 올린다. 특성 서투름이나 긴장감, 금제나 매직룸의 효과로도 막을 수 없다.", // NEEDS QC
			shortDesc: "나무열매가 없으면 실패. 먹고 방어 +2.", // NEEDS QC
		},
	},
	stunspore: {
		name: "저리가루",
	...
	sunnyday: {
		...
		desc: "5턴 동안 날씨가 쾌청이 된다. 효과가 지속되는 동안 불꽃타입 공격의 데미지가 1.5배, 물타입 공격의 데미지가 0.5배가 된다. 뜨거운바위를 지니고 있으면 8턴 동안 지속된다. 날씨가 이미 쾌청이라면 실패한다.", // NEEDS QC
		shortDesc: "5턴 동안 햇살을 강하게 해 불꽃 기술을 강화.", // NEEDS QC
		gen3: {
			desc: "5턴 동안 날씨가 쾌청이 된다. 효과가 지속되는 동안 불꽃타입 공격의 데미지가 1.5배, 물타입 공격의 데미지가 0.5배가 된다. 날씨가 이미 쾌청이라면 실패한다.", // NEEDS QC
		},
		gen2: {
			desc: "날씨가 이미 쾌청이라도 5턴 동안 날씨가 쾌청이 된다. 효과가 지속되는 동안 불꽃타입 공격의 데미지가 1.5배, 물타입 공격의 데미지가 0.5배가 된다.", // NEEDS QC
		},
	},
	sunsteelstrike: {
		name: "메테오드라이브",
	...
	swift: {
		...
		shortDesc: "명중 판정을 하지 않는다. 상대를 공격한다.", // NEEDS QC
		gen1: {
			desc: "명중 판정을 하지 않으며, 상대가 구멍파기나 공중날기를 쓰는 중이라도 명중한다.", // NEEDS QC
	...
	switcheroo: {
		...
		champions: {
			desc: "자신과 상대가 지닌 도구를 맞바꾼다. 양쪽 모두 도구를 지니고 있지 않거나, 메가스톤을 그것으로 메가진화할 수 있는 포켓몬에게 건네거나 빼앗으려 하면 실패한다. 상대의 특성이 점착이라면 효과가 없다.", // NEEDS QC
		},
		gen8: {
	...
	telekinesis: {
		name: "텔레키네시스",
		// Official flavor text: "사용할 수 없는 기술입니다. 다시 배우게 할 수 없지만 기술을 잊게 하는 것을 권장합니다."
		desc: "3턴 동안 상대는 배틀에 나와 있는 한 일격필살 기술을 제외한 자신의 모든 공격을 피할 수 없게 된다. 효과가 지속되는 동안 상대는 땅타입 기술과 압정뿌리기, 독압정, 끈적끈적네트, 특성 개미지옥의 효과를 받지 않는다. 상대가 배턴터치를 쓰면 교체해 나온 포켓몬이 효과를 이어받는다. 뿌리박기, 떨어뜨리기, 사우전드애로, 검은철구의 효과를 받으면 그쪽이 우선된다. 상대가 이미 이 효과나 뿌리박기, 떨어뜨리기, 사우전드애로의 효과를 받고 있다면 실패한다. 상대가 디그다, 닥트리오, 알로라디그다, 알로라닥트리오, 모래꿍, 모래성이당이거나 메가진화한 팬텀이라면 이 기술이 통하지 않는다. 메가진화한 팬텀은 어떤 방법으로도 이 효과를 받지 않는다.", // NEEDS QC
	...
	terastarstorm: {
		name: "테라클러스터",
		desc: "자신이 테라파고스 스텔라라면 이 기술의 타입이 스텔라가 되고, 모든 상대를 공격하며, 랭크 변화를 포함해 공격이 특수공격보다 높다면 물리 공격이 된다.", // NEEDS QC
		shortDesc: "테라파고스 스텔라: 스텔라타입, 상대 전체 공격.", // NEEDS QC
	},
	terrainpulse: {
		name: "대지의파동",
	...
	thief: {
		...
		shortDesc: "도구가 없다면 상대의 도구를 빼앗는다.", // NEEDS QC
		champions: {
			desc: "이 공격이 성공하고 자신이 도구를 지니고 있지 않다면 상대가 지닌 도구를 빼앗는다. 특성이 점착인 상대는 기절하지 않는 한 도구를 잃지 않는다. 메가스톤은 자신이나 상대가 그것으로 메가진화할 수 있는 포켓몬이라면 빼앗지 못한다. 이 기술로 잃은 도구는 리사이클로 되찾거나 특성 수확으로 되살릴 수 없다.", // NEEDS QC
		},
		gen8: {
			desc: "이 공격이 성공하고 자신이 기절하지 않았다면, 자신이 도구를 지니고 있지 않을 때 상대가 지닌 도구를 빼앗는다. 특성이 점착인 상대는 기절하지 않는 한 도구를 잃지 않는다. 가이오가와 쪽빛구슬, 그란돈과 주홍구슬, 기라티나와 백금옥, 아르세우스와 플레이트, 게노세크트와 카세트, 실버디와 메모리, 자시안과 녹슨검, 자마젠타와 녹슨방패는 해당 포켓몬이 지닌 경우 빼앗지 못하며, 자신이 그 포켓몬이고 상대가 해당 도구를 지닌 경우도 마찬가지다. 이 기술로 잃은 도구는 리사이클로 되찾거나 특성 수확으로 되살릴 수 없다.", // NEEDS QC
		},
	...
	thunder: {
		...
		gen4: {
			desc: "30%의 확률로 상대를 마비 상태로 만든다. 상대가 뛰어오르기나 공중날기를 쓰는 중이라도 명중한다. 날씨가 비가 되어 있으면 명중 판정을 하지 않는다. 쾌청이 되어 있으면 명중률이 50%가 된다.", // NEEDS QC
		},
		gen2: {
	...
	toxicthread: {
		...
		champions: {
			desc: "상대의 스피드를 2단계 떨어뜨리고 독 상태로 만든다.", // NEEDS QC
			shortDesc: "상대의 스피드를 2단계 낮추고 독으로 만든다.", // NEEDS QC
		},
	},
	trailblaze: {
		name: "개척하기",
	...
	transform: {
		...
		gen1: {
			desc: "상대로 변신한다. 상대의 현재 능력치, 랭크 변화, 타입, 기술, 개체값, 종족, 모습을 복사한다. 자신의 레벨과 HP는 그대로 유지되며 복사한 기술의 PP는 각각 5가 된다. 이 기술은 구멍파기나 공중날기를 쓰는 중인 상대도 맞힐 수 있다.", // NEEDS QC
		},

		transform: "{POKEMON:topic} {SPECIES:directional} 변신했다!", // Champions Hensin / SV 7075 keep a literal 로 after the particle tag; PS :directional emits 으로/로 itself
	},
	triattack: {
		name: "트라이어택",
	...
	twister: {
		...
		shortDesc: "20%의 확률로 상대를 풀죽게 한다.", // NEEDS QC
		gen4: {
			desc: "20%의 확률로 상대를 풀죽게 한다. 상대가 뛰어오르기나 공중날기를 쓰는 중이라면 위력이 2배가 된다.", // NEEDS QC
		},
		gen2: {
	...
	worryseed: {
		...
		gen6: {
			desc: "상대의 특성이 불면으로 변한다. 상대의 특성이 불면, 멀티타입, 배틀스위치, 게으름이라면 실패한다.", // NEEDS QC
		},
		gen5: {
			desc: "상대의 특성이 불면으로 변한다. 상대의 특성이 불면, 멀티타입, 게으름이라면 실패한다.", // NEEDS QC
		},
		gen4: {
			desc: "상대의 특성이 불면으로 변한다. 상대의 특성이 멀티타입이나게으름이라면, 또는 상대가 백금옥을 지니고 있다면 실패한다.", // NEEDS QC
		},
	},
	wrap: {
		name: "김밥말이",
