export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
	...
	aerilate: {
		...
		shortDesc: "Le sue mosse di tipo Normale diventano di tipo Volante con 1,2× più potenza.", // NEEDS QC
		gen6: {
			...
			shortDesc: "Le mosse Normale di questo Pokémon diventano di tipo Volante con 1,3× potenza.", // NEEDS QC
		},
	},
	aftermath: {
		name: "Scoppio",
	...
	analytic: {
		...
		desc: "La potenza delle mosse di questo Pokémon è moltiplicata per 1,3 se agisce per ultimo nel turno. Non influisce su Desiderio Fatale e Divinazione.", // NEEDS QC
		shortDesc: "Gli attacchi di questo Pokémon hanno 1,3× più potenza se agisce per ultimo.", // NEEDS QC
	},
	angerpoint: {
		name: "Grancollera",
	...
	aurabreak: {
		...
		shortDesc: "Finché questo Pokémon è in campo, Auratetra e Aurafolletto passano a 0,75×.", // NEEDS QC

		start: "  {POKEMON} inverte gli effetti di tutte le aure!",
	},
	auraguard: {
		name: "Ondascudo",
		shortDesc: "Dimezza i danni subiti dalle mosse da contatto.", // NEEDS QC
	},
	baddreams: {
		name: "Sogniamari",
	...
	battery: {
		name: "Batteria",
		shortDesc: "Gli attacchi speciali degli alleati di questo Pokémon hanno 1,3× più potenza.", // NEEDS QC
	},
	battlearmor: {
		name: "Lottascudo",
	...
	blaze: {
		...
		shortDesc: "A 1/3 dei PS max o meno, la statistica offensiva è ×1,5 con gli attacchi Fuoco.", // NEEDS QC
		gen4: {
			...
			shortDesc: "A 1/3 o meno dei PS max, i suoi attacchi Fuoco hanno 1,5× potenza.", // NEEDS QC
		},
	},
	bulletproof: {
		name: "Antiproiettile",
	...
	darkaura: {
		...
		shortDesc: "Finché è in campo, le mosse di tipo Buio hanno 1,33× più potenza.", // NEEDS QC
	...
	dragonize: {
		...
		shortDesc: "Le sue mosse di tipo Normale diventano di tipo Drago con 1,2× più potenza.", // NEEDS QC
	},
	dragonsmaw: {
		name: "Dragomascelle",
	...
	dryskin: {
		...
		shortDesc: "Curato 1/4 dall'Acqua, 1/8 dalla pioggia; subisce 1,25× dal Fuoco, -1/8 col sole.", // NEEDS QC
		gen7: {
	...
	fairyaura: {
		...
		shortDesc: "Finché è in campo, le mosse di tipo Folletto hanno 1,33× più potenza.", // NEEDS QC
	...
	flareboost: {
		...
		shortDesc: "Quando è scottato, i suoi attacchi speciali hanno 1,5× più potenza.", // NEEDS QC
	},
	flashfire: {
		name: "Fuocardore",
		...
		shortDesc: "Attacchi Fuoco ×1,5 se colpito da una mossa Fuoco; immune al Fuoco.", // NEEDS QC
		gen4: {
	...
	flowergift: {
		...
		shortDesc: "Se Cherrim e Sole intenso attivo: Attacco e Dif. Sp. ×1,5 per lui e gli alleati.", // NEEDS QC
		gen7: {
		...
		gen4: {
			...
			shortDesc: "Con Sole intenso: Attacco e Dif. Sp. suoi e degli alleati ×1,5.", // NEEDS QC
		},
	},
	flowerveil: {
		name: "Fiorvelo",
	...
	fluffy: {
		...
		shortDesc: "Subisce 1/2 danni dalle mosse da contatto, ma 2× dalle mosse di tipo Fuoco.", // NEEDS QC
	},
	forecast: {
		name: "Previsioni",
	...
	galvanize: {
		...
		shortDesc: "Le sue mosse di tipo Normale diventano di tipo Elettro con 1,2× più potenza.", // NEEDS QC
	},
	gluttony: {
		name: "Voracità",
	...
	gorillatactics: {
		...
		shortDesc: "Attacco ×1,5, ma può scegliere solo la sua prima mossa.", // NEEDS QC
	},
	grasspelt: {
		name: "Peloderba",
	...
	guts: {
		...
		shortDesc: "Con un problema di stato, Attacco ×1,5; ignora la riduzione da scottatura.", // NEEDS QC
	},
	hadronengine: {
		name: "Motore Adronico",
		shortDesc: "All'entrata evoca un Campo Elettrico; Att. Sp. ×1,3333 su quel campo.", // NEEDS QC
	...
	healer: {
		...
		champions: {
			desc: "C'è il 50% di probabilità che il problema di stato dell'alleato di questo Pokémon venga curato alla fine di ogni turno.", // NEEDS QC
			shortDesc: "50% di probabilità di curare lo stato dell'alleato a fine turno.", // NEEDS QC
		},
		gen6: {
	...
	hustle: {
		...
		shortDesc: "Il suo Attacco è ×1,5, ma la precisione degli attacchi fisici è ×0,8.", // NEEDS QC
	},
	hydration: {
		name: "Idratazione",
	...
	ironfist: {
		...
		shortDesc: "Gli attacchi di pugno hanno 1,2× più potenza. Sbigoattacco escluso.", // NEEDS QC
	},
	justified: {
		name: "Giustizia",
	...
	magician: {
		...
		desc: "Se questo Pokémon non ha strumenti, ruba quello del Pokémon che colpisce con un attacco. Non influisce su Desiderio Fatale e Divinazione. Se un attacco colpisce più bersagli, lo strumento viene rubato al Pokémon più veloce, considerando l'effetto di Distortozona e dando priorità agli avversari rispetto agli alleati.", // NEEDS QC
	...
	megalauncher: {
		name: "Megalancio",
		// Official flavor text: "Potenzia le mosse “pulsar”, Forzasfera e Curapulsar."
		desc: "Le mosse pulsar di questo Pokémon hanno la potenza moltiplicata per 1,5. Curapulsar fa recuperare 3/4 dei PS max del bersaglio, con 0,5 arrotondato per difetto.", // NEEDS QC
		shortDesc: "Le sue mosse pulsar hanno 1,5× più potenza. Curapulsar cura 3/4 dei PS.", // NEEDS QC
	},
	megasol: {
		name: "Megasolar",
	...
	neuroforce: {
		...
		shortDesc: "I suoi attacchi superefficaci infliggono 1,25× più danni.", // NEEDS QC
	},
	neutralizinggas: {
		name: "Gas Reagente",
	...
	normalize: {
		...
		shortDesc: "Le sue mosse diventano di tipo Normale con 1,2× più potenza.", // NEEDS QC
		gen6: {
	...
	orichalcumpulse: {
		...
		shortDesc: "All'entrata evoca Sole intenso; Attacco ×1,3333 col sole.", // NEEDS QC
	...
	overgrow: {
		...
		shortDesc: "A 1/3 dei PS o meno, la statistica offensiva è ×1,5 con gli attacchi Erba.", // NEEDS QC
		gen4: {
			...
			shortDesc: "A 1/3 o meno dei PS max, i suoi attacchi Erba hanno 1,5× potenza.", // NEEDS QC
		},
	},
	owntempo: {
		name: "Mente Locale",
	...
	parentalbond: {
		...
		desc: "Le mosse offensive di questo Pokémon colpiscono due volte. Il secondo colpo ha i danni ridotti a 1/4. Non influisce su Desiderio Fatale, Dragofrecce, Cannone Dynamax, Rimonta, Esplosione, Azzardo, Lancio, Divinazione, Palla Gelo, Rotolamento e Autodistruzione, sulle mosse multicolpo, su quelle con più bersagli e su quelle eseguite in due turni.", // NEEDS QC
		shortDesc: "Le sue mosse offensive colpiscono due volte; il secondo colpo fa 1/4 dei danni.", // NEEDS QC
		gen8: {
			desc: "Le mosse offensive di questo Pokémon colpiscono due volte. I danni del secondo colpo sono ridotti a 1/4. Non influenza Desiderio Fatale, Dragofrecce, Cannone Dynamax, Rimonta, Esplosione, Azzardo, Lancio, Divinazione, Palla Gelo, Rotolamento o Autodistruzione, le mosse multicolpo, le mosse con più bersagli, le mosse in due turni o le mosse Dynamax.", // NEEDS QC
		},
		gen7: {
			desc: "Le mosse offensive di questo Pokémon colpiscono due volte. I danni del secondo colpo sono ridotti a 1/4. Non influenza Desiderio Fatale, Rimonta, Esplosione, Azzardo, Lancio, Divinazione, Palla Gelo, Rotolamento o Autodistruzione, le mosse multicolpo, le mosse con più bersagli, le mosse in due turni o le mosse Z.", // NEEDS QC
		},
		gen6: {
			desc: "Le mosse offensive di questo Pokémon colpiscono due volte. I danni del secondo colpo sono dimezzati. Non influenza Desiderio Fatale, Rimonta, Esplosione, Azzardo, Lancio, Divinazione, Palla Gelo, Rotolamento o Autodistruzione, le mosse multicolpo, le mosse con più bersagli, le mosse in due turni.", // NEEDS QC
	...
	pixilate: {
		...
		shortDesc: "Le sue mosse di tipo Normale diventano di tipo Folletto con 1,2× più potenza.", // NEEDS QC
		gen6: {
			...
			shortDesc: "Le mosse Normale di questo Pokémon diventano di tipo Folletto con 1,3× potenza.", // NEEDS QC
		},
	},
	plus: {
		name: "Più",
	...
	powerspot: {
		...
		desc: "Gli alleati di questo Pokémon hanno la potenza delle mosse moltiplicata per 1,3. Influisce su Desiderio Fatale e Divinazione, anche se chi le ha usate non è più in campo.", // NEEDS QC
		shortDesc: "Le mosse degli alleati di questo Pokémon hanno 1,3× più potenza.", // NEEDS QC
	},
	prankster: {
		name: "Burla",
	...
	protosynthesis: {
		...
		shortDesc: "Col sole o con Capsula energetica: statistica più alta ×1,3 (×1,5 se Velocità).", // NEEDS QC
	...
	punkrock: {
		...
		shortDesc: "Subisce metà dei danni dalle mosse sonore; le sue fanno ×1,3.", // NEEDS QC
	},
	purepower: {
		name: "Forzapura",
		shortDesc: "L'Attacco di questo Pokémon raddoppia.", // NEEDS QC
	...
	quarkdrive: {
		...
		shortDesc: "Campo Elettrico o Capsula energetica: statistica più alta ×1,3 (×1,5 se Velocità).", // NEEDS QC
	...
	quickfeet: {
		...
		shortDesc: "Con un problema di stato, Velocità ×1,5; ignora la riduzione da paralisi.", // NEEDS QC
		gen6: {
	...
	reckless: {
		...
		shortDesc: "Gli attacchi con contraccolpo o danni da fallimento fanno ×1,2; non Scontro.", // NEEDS QC
	},
	refrigerate: {
		name: "Pellegelo",
		...
		shortDesc: "Le sue mosse di tipo Normale diventano di tipo Ghiaccio con 1,2× più potenza.", // NEEDS QC
		gen6: {
			...
			shortDesc: "Le mosse Normale di questo Pokémon diventano di tipo Ghiaccio con 1,3× potenza.", // NEEDS QC
		},
	},
	regenerator: {
		name: "Rigenergia",
	...
	rivalry: {
		...
		shortDesc: "I suoi attacchi fanno 1,25× contro lo stesso sesso, 0,75× contro l'opposto.", // NEEDS QC
	},
	rkssystem: {
	...
	sandforce: {
		...
		shortDesc: "Attacchi Terra/Roccia/Acciaio ×1,3 nella tempesta di sabbia; immune a essa.", // NEEDS QC
	},
	sandrush: {
		name: "Remasabbia",
	...
	sandveil: {
		...
		shortDesc: "Nella tempesta di sabbia, la sua elusione è ×1,25; immune a essa.", // NEEDS QC
	},
	sapsipper: {
		name: "Mangiaerba",
	...
	sheerforce: {
		...
		shortDesc: "Gli attacchi con effetti secondari fanno ×1,3, ma gli effetti vengono rimossi.", // NEEDS QC
		gen8: {
	...
	snowcloak: {
		...
		gen8: {
			...
			shortDesc: "Con la grandine: elusione ×1,25; immune alla grandine.", // NEEDS QC
		},
	},
	snowwarning: {
		name: "Scendineve",
	...
	solarpower: {
		...
		shortDesc: "Se Sole intenso è attivo: Att. Sp. ×1,5, ma perde 1/8 dei PS max ogni turno.", // NEEDS QC
		gen7: {
	...
	steelyspirit: {
		...
		desc: "Le mosse di tipo Acciaio di questo Pokémon e dei suoi alleati hanno la potenza moltiplicata per 1,5. Influisce su Desiderio Fatale anche se chi l'ha usata non è più in campo.", // NEEDS QC
		shortDesc: "Le mosse Acciaio sue e degli alleati fanno 1,5× più danni.", // NEEDS QC
	},
	stench: {
		name: "Tanfo",
	...
	strongjaw: {
		...
		shortDesc: "Gli attacchi di morso hanno 1,5× più potenza. Coleomorso escluso.", // NEEDS QC
	},
	sturdy: {
		name: "Vigore",
	...
	swarm: {
		...
		shortDesc: "A 1/3 dei PS o meno, la statistica offensiva è ×1,5 con gli attacchi Coleottero.", // NEEDS QC
		gen4: {
			...
			shortDesc: "A 1/3 o meno dei PS max, i suoi attacchi Coleottero hanno 1,5× potenza.", // NEEDS QC
		},
	},
	sweetveil: {
		name: "Dolcevelo",
	...
	technician: {
		...
		shortDesc: "Le sue mosse con potenza 60 o meno fanno ×1,5, Scontro compresa.", // NEEDS QC
		gen4: {
			...
			shortDesc: "Le sue mosse con 60 o meno di potenza hanno 1,5× potenza, tranne Scontro.", // NEEDS QC
		},
	},
	telepathy: {
		name: "Telepatia",
	...
	torrent: {
		...
		shortDesc: "A 1/3 dei PS o meno, la statistica offensiva è ×1,5 con gli attacchi Acqua.", // NEEDS QC
		gen4: {
			...
			shortDesc: "A 1/3 o meno dei PS max, i suoi attacchi Acqua hanno 1,5× potenza.", // NEEDS QC
		},
	},
	toughclaws: {
		name: "Unghiedure",
	...
	toxicboost: {
		...
		shortDesc: "Quando è avvelenato, i suoi attacchi fisici hanno 1,5× più potenza.", // NEEDS QC
	},
	toxicchain: {
		name: "Catena Tossica",
	...
	transistor: {
		...
		gen8: {
			shortDesc: "La sua statistica offensiva è ×1,5 quando usa un attacco Elettro.", // NEEDS QC
		},
	},
	triage: {
		name: "Primacura",
	...
	unburden: {
		...
		shortDesc: "Velocità ×2 se perde lo strumento; persa se esce o riceve strumento/abilità.", // NEEDS QC
	},
	unnerve: {
		name: "Agitazione",
