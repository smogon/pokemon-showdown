export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	aurasphere: {
		name: "Sferapulsar", // renamed in SV (SwSh: Forzasfera)
		shortDesc: "Non verifica la precisione.", // NEEDS QC
	},
	aurawheel: {
		name: "Ruota d’Aura",
	...
	auroraveil: {
		...
		start: "  La resistenza {TEAM:di} agli attacchi fisici e speciali aumenta grazie a Velaurora!",
		end: "  L’effetto di Velaurora {TEAM:su} è finito!",
	},
	autotomize: {
		name: "Sganciapesi",
	...
	barbbarrage: {
		...
		shortDesc: "50% di avvelenare. Potenza ×2 su bersagli avvelenati.", // NEEDS QC
	},
	barrage: {
		name: "Sferattacco", // renamed in SV (SwSh: Attacco Pioggia)
		// Official flavor text: "Questa mossa non può essere usata. È consigliabile farla dimenticare al Pokémon. Tuttavia, una volta dimenticata, non potrà più essere ricordata."
		desc: "Colpisce da due a cinque volte. Ha il 35% di probabilità di colpire due o tre volte e il 15% di colpire quattro o cinque volte. Se uno dei colpi rompe il sostituto del bersaglio, questo subisce i danni dei colpi restanti. Se chi la usa ha l’abilità Abillegame, questa mossa colpisce sempre cinque volte.", // NEEDS QC
		shortDesc: "Colpisce da 2 a 5 volte in un turno.", // NEEDS QC
		gen4: {
	...
	belch: {
		...
		champions: {
			desc: "Fallisce se chi la usa non ha mangiato una bacca, mangiando quella che teneva, rubandone e mangiandone una con Coleomorso o Spennata, o mangiandone una lanciatagli con Lancio. Consumare una bacca con Dononaturale non conta.", // NEEDS QC
			shortDesc: "Fallisce se chi la usa non ha mangiato una bacca.", // NEEDS QC
		},
	},
	bellydrum: {
		name: "Panciamburo",
	...
	brickbreak: {
		...
		activate: "  {POKEMON} infrange le protezioni {TEAM:di}!", // NEEDS QC
	},
	brine: {
		name: "Acquadisale",
	...
	charge: {
		...
		shortDesc: "+1 Dif. Sp.; la prossima mossa Elettro fa ×2.", // NEEDS QC
		gen8: {
	...
	clangoroussoulblaze: {
		...
		shortDesc: "Chi la usa: +1 Att., Dif., Att. Sp., Dif. Sp., Vel.", // NEEDS QC
	},
	clearsmog: {
		name: "Pulifumo",
	...
	collisioncourse: {
		...
		shortDesc: "Danni ×1,3333 se superefficace.", // NEEDS QC
	},
	combattorque: {
		name: "Turborissa",
		desc: "Ha il 30% di probabilità di paralizzare il bersaglio.", // NEEDS QC
	...
	comeuppance: {
		...
		shortDesc: "Se viene colpito, restituisce danni ×1,5.", // NEEDS QC
	},
	confide: {
		name: "Confidenza",
	...
	corrosivegas: {
		...
		shortDesc: "Elimina gli strumenti dei Pokémon adiacenti.", // NEEDS QC
		gen8: {
	...
	cottonspore: {
		name: "Cotonspora", // renamed in SV (SwSh: Cottonspora)
	...
	counter: {
		...
		gen1: {
			...
			shortDesc: "Restituisce danni ×2 alle mosse Normale/Lotta.", // NEEDS QC
		},
	},
	courtchange: {
		name: "Cambiocampo",
	...
	covet: {
		...
		champions: {
			desc: "Se questo attacco va a segno e chi la usa non ha strumenti, ruba lo strumento del bersaglio. Un bersaglio con l’abilità Antifurto non perde il suo strumento se non è KO. Lo strumento non viene rubato se è una megapietra e chi la usa o il bersaglio è la specie che può megaevolversi con essa. Gli strumenti persi con questa mossa non possono essere recuperati con Riciclo o l’abilità Coglibacche.", // NEEDS QC
		},
		gen8: {
			desc: "Se questo attacco va a segno e chi la usa non è KO, ruba lo strumento del bersaglio se non ne ha uno. Un bersaglio con l’abilità Antifurto non perde il suo strumento se non è KO. Lo strumento non viene rubato se è Gemma blu, Gemma rossa, Grigiosfera, una lastra, un modulo, una ROM, Spada rovinata o Scudo rovinato tenuti rispettivamente da Kyogre, Groudon, Giratina, Arceus, Genesect, Silvally, Zacian, Zamazenta, o se chi la usa è una di queste specie e il bersaglio ha lo strumento corrispondente. Gli strumenti persi con questa mossa non possono essere recuperati con Riciclo o l’abilità Coglibacche.", // NEEDS QC
		},
		gen7: {
			desc: "Se questo attacco va a segno e chi la usa non è KO, ruba lo strumento del bersaglio se non ne ha uno. Un bersaglio con l’abilità Antifurto non perde il suo strumento se non è KO. Lo strumento non viene rubato se è un Cristallo Z, una megapietra tenuta dalla specie che può megaevolversi con essa, o Gemma blu, Gemma rossa, Grigiosfera, una lastra, un modulo o una ROM tenuti rispettivamente da Kyogre, Groudon, Giratina, Arceus, Genesect, Silvally, o se chi la usa è una di queste specie e il bersaglio ha lo strumento corrispondente. Gli strumenti persi con questa mossa non possono essere recuperati con Riciclo o l’abilità Coglibacche.", // NEEDS QC
		},
		gen6: {
			desc: "Se questo attacco va a segno e chi la usa non è KO, ruba lo strumento del bersaglio se non ne ha uno. Un bersaglio con l’abilità Antifurto non perde il suo strumento se non è KO. Lo strumento non viene rubato se è una megapietra tenuta dalla specie che può megaevolversi con essa, o Gemma blu, Gemma rossa, Grigiosfera, una lastra o un modulo tenuti rispettivamente da Kyogre, Groudon, Giratina, Arceus, Genesect, o se chi la usa è una di queste specie e il bersaglio ha lo strumento corrispondente. Gli strumenti persi con questa mossa non possono essere recuperati con Riciclo o l’abilità Coglibacche.", // NEEDS QC
		},
		gen5: {
			desc: "Se questo attacco va a segno e chi la usa non è KO, ruba lo strumento del bersaglio se non ne ha uno. Un bersaglio con l’abilità Antifurto non perde il suo strumento se non è KO. Lo strumento non viene rubato se è un Messaggio, o Grigiosfera, una lastra o un modulo tenuti rispettivamente da Giratina, Arceus o Genesect, o se chi la usa è una di queste specie e il bersaglio ha lo strumento corrispondente. Gli strumenti persi con questa mossa non possono essere recuperati con Riciclo o l’abilità Coglibacche.", // NEEDS QC
		},
		gen4: {
	...
	craftyshield: {
		...
		start: "  {TEAM:capitalize} è protetta da Truccodifesa!",
	...
	destinybond: {
		...
		desc: "Fino alla prossima azione di chi la usa, se un attacco avversario lo manda KO, anche quell’avversario va KO, a meno che l’attacco non sia Desiderio Fatale o Divinazione. Fallisce se chi la usa l’ha già usata con successo nell’azione precedente, senza contare le mosse usate tramite l’abilità Sincrodanza.", // NEEDS QC
		shortDesc: "Se un nemico lo manda KO, va KO anche lui.", // NEEDS QC
		gen6: {
			desc: "Fino al prossimo turno di chi la usa, se l’attacco di un avversario lo manda KO, anche quell’avversario va KO, a meno che l’attacco non fosse Desiderio Fatale o Divinazione.", // NEEDS QC
		},
		gen2: {
	...
	direclaw: {
		...
		champions: {
			desc: "Ha il 30% di probabilità di addormentare, avvelenare o paralizzare il bersaglio.", // NEEDS QC
			shortDesc: "30% di sonno, veleno o paralisi.", // NEEDS QC
		},
	},
	disable: {
		name: "Inibitore",
		// Official flavor text: "Per quattro turni impedisce al bersaglio di riutilizzare l’ultima mossa usata."
		desc: "Per 4 turni, l’ultima mossa usata dal bersaglio viene bloccata. Fallisce se una mossa del bersaglio è già bloccata, se il bersaglio non ha ancora agito, se non conosce più quella mossa o se era una mossa Dynamax o Gigamax.", // NEEDS QC
		shortDesc: "Blocca per 4 turni l’ultima mossa del bersaglio.", // NEEDS QC
		gen7: {
	...
	doomdesire: {
		name: "Desiderio Fatale", // renamed in SV (SwSh: Obbliderio)
		...
		activate: "  {TARGET} subisce Desiderio Fatale!", // Gen 3 (FRLG it_msg:8975): "[B_DEF_NAME_WITH_PREFIX] subisce [B_BUFF1]!"
	},
	doubleedge: {
		name: "Sdoppiatore",
	...
	earthquake: {
		...
		shortDesc: "Colpisce gli adiacenti. Danni ×2 su Fossa.", // NEEDS QC
		gen4: {
			desc: "La potenza raddoppia se il bersaglio sta usando Fossa.", // NEEDS QC
			shortDesc: "Colpisce i Pokémon adiacenti. Potenza ×2 su Fossa.", // NEEDS QC
		},
		gen1: {
			desc: "Nessun effetto aggiuntivo.", // NEEDS QC
			shortDesc: "Nessun effetto aggiuntivo.", // NEEDS QC
	...
	expandingforce: {
		...
		shortDesc: "Su Campo Psichico: ×1,5 e colpisce i nemici.", // NEEDS QC
	},
	explosion: {
		name: "Esplosione",
	...
	extremeevoboost: {
		...
		shortDesc: "Chi la usa: +2 Att., Dif., Att. Sp., Dif. Sp., Vel.", // NEEDS QC
	},
	extremespeed: {
		name: "Extrarapido",
	...
	facade: {
		...
		shortDesc: "Potenza ×2 se scottato, paralizzato o avvelenato.", // NEEDS QC
		gen5: {
	...
	fakeout: {
		...
		champions: {
			desc: "Ha il 100% di probabilità di far tentennare il bersaglio. Non può essere selezionata se non è il primo turno di chi la usa in campo.", // NEEDS QC
		},
	},
	faketears: {
		name: "Falselacrime",
	...
	feint: {
		...
		shortDesc: "Annulla Individua, Protezione, Anticipo e Bodyguard.", // NEEDS QC
		gen6: {
	...
	firepledge: {
		...
		shortDesc: "Combinata con Erbapatto o Acquapatto: effetto extra.", // NEEDS QC
	...
	firstimpression: {
		...
		champions: {
			desc: "Non può essere selezionata se non è il primo turno di chi la usa in campo.", // NEEDS QC
		},
	},
	fishiousrend: {
		name: "Branchiomorso",
	...
	flareblitz: {
		...
		shortDesc: "Contraccolpo 33%. 10% di scottare. Scongela.", // NEEDS QC
		gen4: {
	...
	freezedry: {
		...
		champions: {
			desc: "L’efficacia di questa mossa contro il tipo Acqua diventa superefficace, indipendentemente dal tipo della mossa.", // NEEDS QC
			shortDesc: "Superefficace contro l’Acqua.", // NEEDS QC
		},
	},
	freezeshock: {
		name: "Elettrogelo",
	...
	fusionbolt: {
		...
		shortDesc: "Potenza ×2 dopo Incrofiamma in questo turno.", // NEEDS QC
	},
	fusionflare: {
		name: "Incrofiamma",
		...
		shortDesc: "Potenza ×2 dopo Incrotuono in questo turno.", // NEEDS QC
	},
	futuresight: {
		name: "Divinazione",
		// Official flavor text: "Due turni dopo l’utilizzo di questa mossa, il bersaglio viene attaccato con energia psichica."
		desc: "Infligge danni due turni dopo l’uso. Alla fine di quel turno, i danni vengono calcolati in quel momento e inflitti al Pokémon nella posizione che il bersaglio aveva quando la mossa è stata usata. Se chi la usa non è più in campo, i danni vengono calcolati in base al suo Attacco Speciale naturale, ai suoi tipi e al suo livello, senza bonus da strumento o abilità. Fallisce se questa mossa o Desiderio Fatale è già in effetto per la posizione del bersaglio.", // NEEDS QC
		shortDesc: "Colpisce due turni dopo l’uso.", // NEEDS QC
		gen4: {
			desc: "Infligge due turni dopo l’uso danni senza tipo che non possono essere un brutto colpo. I danni vengono calcolati contro il bersaglio al momento dell’uso e inflitti alla fine dell’ultimo turno al Pokémon nella posizione originale del bersaglio. Fallisce se questa mossa o Desiderio Fatale è già in corso per la posizione del bersaglio.", // NEEDS QC
		},
		gen2: {
		...
		activate: "  {TARGET} subisce Divinazione!", // Gen 3 (FRLG it_msg:8975): "[B_DEF_NAME_WITH_PREFIX] subisce [B_BUFF1]!"
	},
	gastroacid: {
		name: "Gastroacido",
	...
	glaiverush: {
		...
		shortDesc: "Subisce danni ×2 sicuri fino al suo prossimo turno.", // NEEDS QC
	},
	glare: {
		name: "Sguardo Feroce",
	...
	gmaxsteelsurge: {
		...
		desc: "La potenza è pari a quella della mossa Dynamax della mossa di base. Se questa mossa va a segno, piazza una trappola nella parte avversaria che ferisce ogni avversario che entra in campo. Gli avversari perdono 1/32, 1/16, 1/8, 1/4 o 1/2 dei loro PS max, arrotondato per difetto, in base alla loro debolezza al tipo Acciaio (×0,25, ×0,5, neutra, ×2 o ×4 rispettivamente). Può essere rimossa dalla parte avversaria se un avversario usa Rapigiro o Scacciabruma con successo, o viene colpito da Scacciabruma.", // NEEDS QC
		shortDesc: "Potenza da mossa base. Trappola di tipo Acciaio.", // NEEDS QC

		start: "  {TEAM:capitalize} è circondata da schegge di metallo affilate sospese in aria!",
		end: "  {TEAM:capitalize} non è più circondata da schegge di metallo!",
		damage: "  Schegge di metallo affilato colpiscono {POKEMON}!",
	},
	gmaxstonesurge: {
		name: "Gigarocciagetto",
		desc: "La potenza è pari a quella della mossa Dynamax della mossa di base. Se questa mossa va a segno, piazza una trappola nella parte avversaria che ferisce ogni avversario che entra in campo. Gli avversari perdono 1/32, 1/16, 1/8, 1/4 o 1/2 dei loro PS max, arrotondato per difetto, in base alla loro debolezza al tipo Roccia (×0,25, ×0,5, neutra, ×2 o ×4 rispettivamente). Può essere rimossa dalla parte avversaria se un avversario usa Rapigiro o Scacciabruma con successo, o viene colpito da Scacciabruma.", // NEEDS QC
	...
	grasspledge: {
		...
		shortDesc: "Combinata con Fiammapatto o Acquapatto: effetto extra.", // NEEDS QC
	...
	gravapple: {
		...
		shortDesc: "100% di -1 Difesa. Con Gravità: ×1,5.", // NEEDS QC
	},
	gravity: {
		name: "Gravità",
		...
		shortDesc: "5 turni: niente immunità al Terra, precisione ×1,67.", // NEEDS QC
		gen7: {
	...
	growth: {
		...
		gen7: {
			desc: "Aumenta l’Attacco e l’Attacco Speciale di chi la usa di un livello. Con Sole intenso o Sole accecante, aumentano di 2 livelli.", // NEEDS QC
		},
		gen5: {
	...
	guardswap: {
		...
		shortDesc: "Scambia i cambi di Dif. e Dif. Sp. col bersaglio.", // NEEDS QC
	},
	guillotine: {
		name: "Ghigliottina",
	...
	gust: {
		...
		shortDesc: "Potenza ×2 contro Rimbalzo, Volo e Cadutalibera.", // NEEDS QC
		gen4: {
	...
	healpulse: {
		name: "Curapulsar", // renamed in SV (SwSh: Ondasana)
	...
	helpinghand: {
		...
		shortDesc: "La mossa di un alleato adiacente fa ×1,5 nel turno.", // NEEDS QC
	...
	hurricane: {
		...
		gen7: {
			desc: "Ha il 30% di probabilità di confondere il bersaglio. Questa mossa può colpire un bersaglio che sta usando Rimbalzo, Volo o Cadutalibera, o sotto l’effetto di Cadutalibera. Con Acquazzone o Pioggia, questa mossa non verifica la precisione. Con Sole accecante o Sole intenso, la sua precisione è del 50%.", // NEEDS QC
		},
		gen5: {
	...
	hydrosteam: {
		...
		shortDesc: "Col sole: danni ×1,5 invece che dimezzati.", // NEEDS QC
	},
	hydrovortex: {
	...
	infernalparade: {
		...
		shortDesc: "30% di scottare. Potenza ×2 contro chi ha uno stato.", // NEEDS QC
	},
	inferno: {
		name: "Marchiatura",
	...
	knockoff: {
		...
		shortDesc: "Danni ×1,5 se il bersaglio ha uno strumento, che perde.", // NEEDS QC
		champions: {
			desc: "La potenza è moltiplicata per 1,5 se il bersaglio ha uno strumento, e il bersaglio lo perde. Un bersaglio con l’abilità Antifurto non perde il suo strumento se non è KO. Questa mossa non aumenta di potenza né rimuove lo strumento se è una megapietra tenuta dalla specie che può megaevolversi con essa. Gli strumenti persi con questa mossa non possono essere recuperati con Riciclo o l’abilità Coglibacche.", // NEEDS QC
		},
		gen8: {
		...
		gen7: {
			desc: "La potenza di questa mossa è moltiplicata per 1,5 se il bersaglio ha uno strumento, e il bersaglio perde il suo strumento se chi la usa non è KO. Un bersaglio con l’abilità Antifurto non perde il suo strumento se non è KO. La potenza non aumenta e lo strumento non viene rimosso se è un Cristallo Z, una megapietra tenuta dalla specie che può megaevolversi con essa, o Gemma blu, Gemma rossa, Grigiosfera, una lastra, un modulo o una ROM tenuti rispettivamente da Kyogre, Groudon, Giratina, Arceus, Genesect, Silvally, o se chi la usa è una di queste specie e il bersaglio ha lo strumento corrispondente. Gli strumenti persi con questa mossa non possono essere recuperati con Riciclo o l’abilità Coglibacche.", // NEEDS QC
		},
		gen6: {
			desc: "La potenza di questa mossa è moltiplicata per 1,5 se il bersaglio ha uno strumento, e il bersaglio perde il suo strumento se chi la usa non è KO. Un bersaglio con l’abilità Antifurto non perde il suo strumento se non è KO. La potenza non aumenta e lo strumento non viene rimosso se è una megapietra tenuta dalla specie che può megaevolversi con essa, o Gemma blu, Gemma rossa, Grigiosfera, una lastra o un modulo tenuti rispettivamente da Kyogre, Groudon, Giratina, Arceus, Genesect, o se chi la usa è una di queste specie e il bersaglio ha lo strumento corrispondente. Gli strumenti persi con questa mossa non possono essere recuperati con Riciclo o l’abilità Coglibacche.", // NEEDS QC
		},
		gen5: {
			desc: "Se chi la usa non è KO, il bersaglio perde il suo strumento. Un bersaglio con l’abilità Antifurto non perde il suo strumento se non è KO. Lo strumento non viene rimosso se è Grigiosfera, una lastra o un modulo tenuti rispettivamente da Giratina, Arceus o Genesect, o se chi la usa è una di queste specie e il bersaglio ha lo strumento corrispondente. Gli strumenti persi con questa mossa non possono essere recuperati con Riciclo o l’abilità Coglibacche.", // NEEDS QC
	...
	laserfocus: {
		...
		shortDesc: "Brutti colpi sicuri fino alla fine del prossimo turno.", // NEEDS QC
	...
	lashout: {
		...
		shortDesc: "Potenza ×2 se le sue stat sono calate nel turno.", // NEEDS QC
	},
	lastresort: {
		name: "Ultimascelta",
	...
	lastrespects: {
		name: "Omaggio ai KO",
		desc: "La potenza è pari a 50 + (X × 50), dove X è il numero totale di volte in cui un Pokémon della squadra di chi la usa è andato KO, fino a un massimo di 100.", // NEEDS QC
	...
	lightscreen: {
		...
		gen1: {
			...
			shortDesc: "Finché è in campo, Speciale ×2 quando subisce danni.", // NEEDS QC
			start: "  {POKEMON} è immune agli attacchi speciali",
		},

		start: "  La resistenza {TEAM:di} agli attacchi speciali aumenta grazie a Schermoluce!",
		end: "  L’effetto di Schermoluce {TEAM:su} è finito!",
	},
	...
	luckychant: {
		...
		end: "  L’effetto di Fortuncanto {TEAM:su} è finito!",
	},
	luminacrash: {
		name: "Fotocollisione",
		desc: "Ha il 100% di probabilità di ridurre la Difesa Speciale del bersaglio di 2 livelli.", // NEEDS QC
	...
	magmastorm: {
		...
		gen4: {
			desc: "Impedisce al bersaglio di essere sostituito da due a cinque turni (sempre cinque se chi la usa ha una Presartiglio). Infligge al bersaglio danni pari a 1/16 dei suoi PS max, arrotondato per difetto, alla fine di ogni turno durante l’effetto. Il bersaglio può comunque essere sostituito se ha una Disfoguscio o usa Staffetta o Retromarcia. L’effetto finisce se chi la usa o il bersaglio lascia il campo, o se il bersaglio usa Rapigiro o Sostituto con successo. Questo effetto non è cumulabile né azzerabile usando questa o un’altra mossa intrappolante.", // NEEDS QC
			shortDesc: "Intrappola e ferisce il bersaglio per 2-5 turni.", // NEEDS QC
		},
	...
	magnitude: {
		...
		shortDesc: "Adiacenti. Potenza variabile; ×2 su Fossa.", // NEEDS QC
		gen4: {
	...
	makeitrain: {
		...
		champions: {
			desc: "Riduce l’Attacco Speciale di chi la usa di 2 livelli.", // NEEDS QC
			shortDesc: "-2 Att. Sp. di chi la usa. Colpisce i nemici.", // NEEDS QC
		},
	...
	maliciousmoonsault: {
		...
		shortDesc: "Danni ×2 se il bersaglio ha usato Minimizzato.", // NEEDS QC
	},
	malignantchain: {
		name: "Intossicatena",
	...
	maxflare: {
		...
		shortDesc: "Potenza da mossa base. Evoca il Sole intenso.", // NEEDS QC
	},
	maxflutterby: {
		name: "Dynainsetto",
	...
	maxrockfall: {
		...
		desc: "La potenza è pari a quella della mossa Dynamax della mossa di base. Se questa mossa va a segno, inizia l’effetto di Tempesta di sabbia. Questo effetto non si verifica se chi la usa non è dynamaxizzato. Se questa mossa viene usata come mossa di base, infligge danni con potenza 0.", // NEEDS QC
		shortDesc: "Potenza da mossa base. Evoca la tempesta di sabbia.", // NEEDS QC
	},
	maxstarfall: {
		name: "Dynafata",
	...
	mefirst: {
		...
		shortDesc: "Copia il nemico con ×1,5. Deve agire per primo.", // NEEDS QC
		gen8: {
	...
	metalburst: {
		...
		shortDesc: "Se viene colpito, restituisce i danni ×1,5.", // NEEDS QC
		gen6: {
	...
	mist: {
		...
		end: "  La nebbia intorno {TEAM:a} si è diradata!",
	...
	mistyexplosion: {
		...
		shortDesc: "Va KO. Su Campo Nebbioso: potenza ×1,5.", // NEEDS QC
	},
	mistyterrain: {
		name: "Campo Nebbioso",
	...
	moonblast: {
		...
		champions: {
			desc: "Ha il 10% di probabilità di ridurre l’Attacco Speciale del bersaglio di un livello.", // NEEDS QC
			shortDesc: "10% di ridurre l’Att. Sp. del bersaglio di 1.", // NEEDS QC
		},
	},
	moongeistbeam: {
		name: "Raggio d’Ombra",
	...
	moonlight: {
		...
		desc: "Chi la usa recupera metà dei suoi PS max se Vento misterioso è attivo, se non c’è alcun tempo atmosferico o se ha un Superombrello; 2/3 dei suoi PS max se il tempo è Sole accecante o Sole intenso; e 1/4 dei suoi PS max se il tempo è Acquazzone, Pioggia, tempesta di sabbia o neve, il tutto arrotondato per difetto da 0,5.", // NEEDS QC
		shortDesc: "Cura chi la usa in base al tempo atmosferico.", // NEEDS QC
		gen8: {
			desc: "Chi la usa recupera metà dei suoi PS max se Vento misterioso è attivo, se non c’è alcun tempo atmosferico o se ha un Superombrello; 2/3 dei suoi PS max se il tempo è Sole accecante o Sole intenso; e 1/4 dei suoi PS max se il tempo è grandine, Acquazzone, Pioggia o tempesta di sabbia, il tutto arrotondato per difetto da 0,5.", // NEEDS QC
		},
		gen7: {
			desc: "Chi la usa recupera metà dei suoi PS max se Vento misterioso è attivo o se non c’è alcun tempo atmosferico; 2/3 dei suoi PS max se il tempo è Sole accecante o Sole intenso; e 1/4 dei suoi PS max se il tempo è grandine, Acquazzone, Pioggia o tempesta di sabbia, il tutto arrotondato per difetto da 0,5.", // NEEDS QC
		},
		gen5: {
			desc: "Chi la usa recupera metà dei suoi PS max se non c’è alcun tempo atmosferico; 2/3 dei suoi PS max se il tempo è Sole intenso; e 1/4 dei suoi PS max se il tempo è grandine, Pioggia o tempesta di sabbia, il tutto arrotondato per difetto da 0,5.", // NEEDS QC
		},
		gen4: {
			desc: "Chi la usa recupera metà dei suoi PS max se non c’è alcun tempo atmosferico; 2/3 dei suoi PS max se il tempo è Sole intenso; e 1/4 dei suoi PS max se il tempo è grandine, Pioggia o tempesta di sabbia, il tutto arrotondato per difetto.", // NEEDS QC
		},
		gen2: {
			desc: "Chi la usa recupera metà dei suoi PS max se non c’è alcun tempo atmosferico; tutti i suoi PS se il tempo è Sole intenso; e 1/4 dei suoi PS max se il tempo è Pioggia o tempesta di sabbia, il tutto arrotondato per difetto.", // NEEDS QC
		},
	},
	morningsun: {
		name: "Mattindoro",
	...
	naturepower: {
		...
		shortDesc: "Mossa in base al terreno (Tripletta di base).", // NEEDS QC
		gen6: {
	...
	psyblade: {
		...
		shortDesc: "Su Campo Elettrico: potenza ×1,5.", // NEEDS QC
	},
	psychic: {
		name: "Psichico",
	...
	psywave: {
		...
		shortDesc: "Danni casuali da ×0,5 a ×1,5 del suo livello.", // NEEDS QC
		gen4: {
		...
		gen2: {
			...
			shortDesc: "Danni casuali da 1 a (livello × 1,5 − 1).", // NEEDS QC
		},
	},
	pulverizingpancake: {
	...
	pursuit: {
		...
		shortDesc: "Colpisce a potenza ×2 i nemici in uscita.", // NEEDS QC
		gen7: {
	...
	quickguard: {
		...
		start: "  {TEAM:capitalize} è protetta da Anticipo!",
	...
	ragefist: {
		...
		champions: {
			desc: "La potenza è pari a 50 + (X × 50), dove X è il numero totale di volte in cui chi la usa è stato colpito da un attacco che infligge danni durante la lotta, anche se non ha perso PS. X non può superare 6 e torna a 0 quando chi la usa lascia il campo. Ogni colpo di una mossa multicolpo viene contato, ma non i danni da confusione.", // NEEDS QC
			shortDesc: "+50 potenza/colpo subito (max 6). Si azzera se esce.", // NEEDS QC
		},
	},
	ragepowder: {
		name: "Polverabbia",
	...
	reflect: {
		...
		start: "  La resistenza {TEAM:di} agli attacchi fisici aumenta grazie a Riflesso!",
		end: "  L’effetto di Riflesso {TEAM:su} è finito!",
	},
	reflecttype: {
		name: "Riflettipo",
	...
	retaliate: {
		...
		shortDesc: "Potenza ×2 se un alleato è andato KO al turno prima.", // NEEDS QC
	},
	return: {
		name: "Ritorno",
		// Official flavor text: "Questa mossa non può essere usata. È consigliabile farla dimenticare al Pokémon. Tuttavia, una volta dimenticata, non potrà più essere ricordata."
	...
	risingvoltage: {
		...
		shortDesc: "×2 su un bersaglio a terra su Campo Elettrico.", // NEEDS QC
	},
	roar: {
		name: "Boato",
	...
	round: {
		...
		shortDesc: "Potenza ×2 se un altro ha usato Coro nel turno.", // NEEDS QC
	},
	ruination: {
		name: "Catastrofe",
		desc: "Infligge al bersaglio danni pari a metà dei suoi PS attuali, arrotondato per difetto, ma non meno di 1 PS.", // NEEDS QC
	...
	saltcure: {
		...
		champions: {
			desc: "Infligge al bersaglio danni pari a 1/16 dei suoi PS max (1/8 se il bersaglio è di tipo Acciaio o Acqua), arrotondato per difetto, alla fine di ogni turno durante l’effetto. L’effetto finisce quando il bersaglio lascia il campo.", // NEEDS QC
			shortDesc: "Infligge 1/16 dei PS a turno; 1/8 ad Acciaio e Acqua.", // NEEDS QC
		},
	...
	sandstorm: {
		...
		shortDesc: "5 turni: tempesta di sabbia. Roccia: Dif. Sp. ×1,5.", // NEEDS QC
		gen4: {
	...
	sandtomb: {
		...
		gen3: {
			desc: "Impedisce al bersaglio di essere sostituito da due a cinque turni. Infligge al bersaglio danni pari a 1/16 dei suoi PS max, arrotondato per difetto, alla fine di ogni turno durante l’effetto. Il bersaglio può comunque essere sostituito se usa Staffetta. L’effetto finisce se chi la usa o il bersaglio lascia il campo, o se il bersaglio usa Rapigiro o Sostituto con successo. Questo effetto non è cumulabile né azzerabile usando questa o un’altra mossa intrappolante.", // NEEDS QC
		},
	...
	smellingsalts: {
		...
		shortDesc: "×2 contro i paralizzati, ma li cura.", // NEEDS QC
		gen4: {
	...
	snowscape: {
		...
		shortDesc: "5 turni: neve. Ghiaccio: Difesa ×1,5.", // NEEDS QC
	},
	soak: {
		name: "Inondazione",
	...
	solarbeam: {
		...
		gen7: {
			desc: "Questo attacco si carica nel primo turno e viene eseguito nel secondo. La potenza è dimezzata se il tempo è grandine, Acquazzone, Pioggia o tempesta di sabbia. Se chi la usa ha una Vigorerba o il tempo è Sole accecante o Sole intenso, la mossa si completa in un turno.", // NEEDS QC
		},
		gen5: {
			desc: "Questo attacco si carica nel primo turno e viene eseguito nel secondo. La potenza è dimezzata se il tempo è grandine, Pioggia o tempesta di sabbia. Se chi la usa ha una Vigorerba o il tempo è Sole intenso, la mossa si completa in un turno.", // NEEDS QC
		},
		gen4: {
			desc: "Questo attacco si carica nel primo turno e viene eseguito nel secondo. I danni sono dimezzati se il tempo è grandine, Pioggia o tempesta di sabbia. Se chi la usa ha una Vigorerba o il tempo è Sole intenso, la mossa si completa in un turno.", // NEEDS QC
		},
		gen3: {
			desc: "Questo attacco si carica nel primo turno e viene eseguito nel secondo. I danni sono dimezzati se il tempo è grandine, Pioggia o tempesta di sabbia. Se il tempo è Sole intenso, la mossa si completa in un turno.", // NEEDS QC
		},
		gen2: {
	...
	spikes: {
		...
		shortDesc: "Ferisce i nemici a terra che entrano. Max 3 strati.", // NEEDS QC
		gen8: {
		...
		start: "  Ai piedi {TEAM:di} c’è una trappola di punte!",
		end: "  Ai piedi {TEAM:di} non c’è più la trappola di punte!",
	...
	stealthrock: {
		...
		end: "  Levitoroccia non ha più effetto {TEAM:su}!",
	...
	stickyweb: {
		...
		shortDesc: "-1 Velocità ai nemici a terra che entrano.", // NEEDS QC
		gen8: {
		...
		start: "  Una Rete Vischiosa viene stesa ai piedi {TEAM:di}!",
		end: "  La Rete Vischiosa ai piedi {TEAM:di} svanisce!",
	...
	stuffcheeks: {
		...
		champions: {
			desc: "Fallisce se chi la usa non ha una bacca. Chi la usa mangia la sua bacca e aumenta la sua Difesa di 2 livelli. Questo effetto non è impedito dalle abilità Impaccio o Agitazione, né dagli effetti di Divieto o Magicozona.", // NEEDS QC
			shortDesc: "Fallisce senza bacca. La mangia: +2 Difesa.", // NEEDS QC
		},
	},
	stunspore: {
		name: "Paralizzante",
	...
	surf: {
		...
		shortDesc: "Colpisce gli adiacenti. Danni ×2 su Sub.", // NEEDS QC
		gen4: {
			desc: "La potenza raddoppia se il bersaglio sta usando Sub.", // NEEDS QC
			shortDesc: "Colpisce i Pokémon adiacenti. ×2 contro Sub.", // NEEDS QC
		},
		gen2: {
			desc: "Nessun effetto aggiuntivo.", // NEEDS QC
			shortDesc: "Nessun effetto aggiuntivo.", // NEEDS QC
		...
		gen3: {
			shortDesc: "Colpisce i nemici. ×2 contro Sub.", // NEEDS QC
		},
	},
	surgingstrikes: {
		name: "Idroraffica",
	...
	switcheroo: {
		...
		champions: {
			desc: "Chi la usa scambia il proprio strumento con quello del bersaglio. Fallisce se né chi la usa né il bersaglio hanno strumenti, o se chi la usa prova a dare o prendere una megapietra a o dalla specie che può megaevolversi con essa. Il bersaglio è immune a questa mossa se ha l’abilità Antifurto.", // NEEDS QC
		},
		gen8: {
	...
	tailwind: {
		...
		start: "  Comincia a soffiare Ventoincoda {TEAM:su}!",
		end: "  Ventoincoda non soffia più {TEAM:su}!",
	},
	takedown: {
		name: "Riduttore",
	...
	toxicspikes: {
		...
		start: "  Ai piedi {TEAM:di} c’è una trappola di punte velenose!",
		end: "  Ai piedi {TEAM:di} non c’è più la trappola di punte velenose!",
	},
	toxicthread: {
		name: "Velenotela",
		...
		champions: {
			desc: "Riduce la Velocità del bersaglio di 2 livelli e lo avvelena.", // NEEDS QC
			shortDesc: "-2 Velocità del bersaglio e lo avvelena.", // NEEDS QC
		},
	},
	trailblaze: {
		name: "Apripista",
	...
	wakeupslap: {
		...
		shortDesc: "×2 contro chi dorme, ma lo sveglia.", // NEEDS QC
		gen4: {
	...
	waterpledge: {
		...
		shortDesc: "Combinata con Fiammapatto o Erbapatto: effetto extra.", // NEEDS QC

		activate: "  {POKEMON} attende {TARGET}...",
		start: "  Appare un arcobaleno {TEAM:su}!",
		end: "  L’arcobaleno {TEAM:su} scompare!",
	},
	waterpulse: {
		name: "Idropulsar",
	...
	weatherball: {
		...
		shortDesc: "Con un tempo attivo: potenza ×2 e tipo variabile.", // NEEDS QC
		gen8: {
			desc: "La potenza raddoppia se un tempo atmosferico diverso da Vento misterioso è attivo, e il tipo di questa mossa cambia di conseguenza: tipo Ghiaccio con la grandine, tipo Acqua con Acquazzone o Pioggia, tipo Roccia con la tempesta di sabbia e tipo Fuoco con Sole accecante o Sole intenso. Se chi la usa ha un Superombrello e usa questa mossa con Acquazzone, Pioggia, Sole accecante o Sole intenso, resta di tipo Normale e la potenza non raddoppia.", // NEEDS QC
		},
		gen5: {
			desc: "La potenza raddoppia se un tempo atmosferico è attivo, e il tipo di questa mossa cambia di conseguenza: tipo Ghiaccio con la grandine, tipo Acqua con Pioggia, tipo Roccia con la tempesta di sabbia e tipo Fuoco con Sole intenso.", // NEEDS QC
		},
		gen3: {
			desc: "I danni raddoppiano se un tempo atmosferico è attivo, e il tipo di questa mossa cambia di conseguenza: tipo Ghiaccio con la grandine, tipo Acqua con Pioggia, tipo Roccia con la tempesta di sabbia e tipo Fuoco con Sole intenso.", // NEEDS QC
	...
	wideguard: {
		...
		start: "  {TEAM:capitalize} è protetta da Bodyguard!",
	...
	zapcannon: {
		name: "Elettrocannone", // renamed in SV (SwSh: Falcecannone)
	...
	zippyzap: {
		...
		shortDesc: "Agisce per primo. Aumenta la sua elusione di 1.", // NEEDS QC
		gen7: {
