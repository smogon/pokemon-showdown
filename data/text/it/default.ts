export const DefaultText: { [id: IDEntry]: DefaultText } = {
	default: {
		...
		startTeamEffect: "  ({EFFECT} ora agisce {TEAM:su}!)", // NEEDS QC
		endTeamEffect: "  ({EFFECT} non agisce più {TEAM:su}!)", // NEEDS QC
	...
	ui: {
		...
		moveTarget: "Dove deve mirare {POKEMON} con **{MOVE}**?", // NEEDS QC
