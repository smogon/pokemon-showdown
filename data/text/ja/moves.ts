export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	acid: {
		...
		gen3: {
			desc: "10%の確率で相手の防御を1段階下げる。", // NEEDS QC
			shortDesc: "10%の確率で相手の防御を1段階下げる。", // NEEDS QC
		},
		gen1: {
			desc: "33%の確率で相手の防御を1段階下げる。", // NEEDS QC
	...
	amnesia: {
		...
		gen1: {
			...
			shortDesc: "自分のとくしゅが2段階上がる。", // NEEDS QC
		},
	},
	anchorshot: {
		name: "アンカーショット",
	...
	aromaticmist: {
		...
		shortDesc: "味方の特防が1段階上がる。", // NEEDS QC
	},
	assist: {
		name: "ねこのて",
		// Official flavor text: "この技は 使えません 思い出すことが できなくなりますが 技を 忘れることを おすすめします"
		...
		gen7: {
			desc: "自分以外のパーティのポケモンが覚えている技の中から、ランダムに1つが選ばれて使われる。ただし、ねこのて・トーチカ・くちばしキャノン・ゲップ・ギフトパス・とびはねる・おいわい・おしゃべり・ともえなげ・まねっこ・カウンター・ほしがる・みちづれ・みきり・あなをほる・ダイビング・ドラゴンテール・こらえる・フェイント・そらをとぶ・きあいパンチ・このゆびとまれ・てだすけ・てをつなぐ・キングシールド・たたみがえし・さきどり・ゆびをふる・ものまね・ミラーコート・オウムがえし・しぜんのちから・ゴーストダイブ・まもる・いかりのこな・ほえる・シャドーダイブ・トラップシェル・スケッチ・フリーフォール・ねごと・よこどり・ニードルガード・スポットライト・わるあがき・すりかえ・どろぼう・へんしん・トリック・ふきとばし、およびＺワザは選ばれない。", // NEEDS QC
		},
		gen6: {
	...
	aurorabeam: {
		...
		gen1: {
			desc: "33%の確率で相手の攻撃を1段階下げる。", // NEEDS QC
	...
	beatup: {
		...
		gen4: {
			desc: "タイプなしのダメージを与える。自分と、パーティにいるひんし・状態異常でないポケモン1匹につき1回ずつ攻撃する。各攻撃のダメージ計算では、参加するポケモンの攻撃種族値を攻撃、相手の防御種族値を防御として使い、能力ランクなど攻撃や防御を補正する効果は無視する。すべての攻撃は自分が行ったものとして扱われる。", // NEEDS QC
		},
		gen3: {
			desc: "タイプなしのダメージを与える。パーティにいるひんし・状態異常でないポケモン1匹につき1回ずつ攻撃し、条件を満たすポケモンがいない場合は失敗する。各攻撃のダメージ計算では、参加するポケモンの攻撃種族値を攻撃、相手の防御種族値を防御として使い、能力ランクなど攻撃や防御を補正する効果は無視する。すべての攻撃は自分が行ったものとして扱われる。", // NEEDS QC
		},
		gen2: {
			desc: "タイプなしのダメージを与える。パーティにいるひんし・状態異常でないポケモン1匹につき1回ずつ攻撃する。各攻撃のダメージ計算では、参加するポケモンのレベルと攻撃種族値、相手の防御種族値を使い、能力ランクなど攻撃や防御を補正する効果は無視する。参加できるポケモンがいない場合は失敗する。", // NEEDS QC
		},
	...
	belch: {
		...
		champions: {
			desc: "自分がきのみを食べていなければ失敗する。持たせたきのみを食べるか、むしくい・ついばむで相手のきのみを奪って食べるか、なげつけるで投げつけられたきのみを食べると条件を満たす。しぜんのめぐみできのみを消費しても、食べたことにはならない。", // NEEDS QC
			shortDesc: "きのみを食べていないと失敗する。", // NEEDS QC
		},
	},
	bellydrum: {
		name: "はらだいこ",
		...
		gen2: {
			desc: "ひんしになる場合や、攻撃がすでに+6の場合を除き、最大HPの1/2（切り捨て）を失う。HPが足りなかった場合は、攻撃が2段階上がる。そうでない場合、攻撃のランクが+6未満の間は2段階ずつ上げ、この処理の前の攻撃の実数値が999だった場合はランクを1段階下げて繰り返しを終える。", // NEEDS QC
		},
	...
	bestow: {
		name: "ギフトパス",
		// Official flavor text: "この技は 使えません 思い出すことが できなくなりますが 技を 忘れることを おすすめします"
		desc: "自分の持ち物を相手に渡す。自分が道具を持っていない場合やＺクリスタルを持っている場合、相手がすでに道具を持っている場合は失敗する。また、道具がメガストーンで自分か相手がそれでメガシンカできる種族の場合や、道具があいいろのたま・べにいろのたま・はっきんだま・プレート・カセット・メモリで自分か相手がそれぞれカイオーガ・グラードン・ギラティナ・アルセウス・ゲノセクト・シルヴァディの場合も失敗する。", // NEEDS QC
	...
	bide: {
		name: "がまん",
		// Official flavor text: "この技は 使えません 思い出すことが できなくなりますが 技を 忘れることを おすすめします"
		desc: "2ターンの間この技に固定され、2ターン後、その間に攻撃で受けたダメージの2倍を、最後に自分を攻撃したポケモンに与える。最後に攻撃したポケモンが場にいない場合は、相手のポケモンからランダムに選んで攻撃する。この技の使用中に行動できなくなると、効果は終わる。必中だが、タイプ相性による無効は貫通しない。", // NEEDS QC
	...
	bind: {
		...
		gen4: {
			...
			shortDesc: "2〜5ターンしめつけてダメージを与える。", // NEEDS QC
		},
		gen3: {
	...
	blizzard: {
		...
		gen8: {
			desc: "10%の確率で相手をこおり状態にする。天気があられの場合、必中になる。", // NEEDS QC
	...
	brickbreak: {
		...
		shortDesc: "相手に無効でなければ壁を壊す。", // NEEDS QC
		gen6: {
		...
		activate: "  かべが こわれた！", // RS/E/FRLG: 「かべが こわれた！」 (The wall shattered!); no gen4+ string exists
	},
	brine: {
		name: "しおみず",
	...
	bubble: {
		...
		gen1: {
			desc: "33%の確率で相手の素早さを1段階下げる。", // NEEDS QC
	...
	ceaselessedge: {
		name: "ひけん・ちえなみ",
		desc: "攻撃が成功すると、相手側の場にまきびしを仕掛け、交代で出てきた相手のポケモンにダメージを与える。ひこうタイプや特性がふゆうのポケモンには効果がない。最大3回まで重ねて仕掛けられ、ダメージは1回で最大HPの1/8、2回で1/6、3回で1/4（いずれも切り捨て）。いずれかのポケモンがおかたづけを使うか、相手側のポケモンがキラースピン・こうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
	...
	coaching: {
		...
		shortDesc: "味方の攻撃と防御が1段階上がる。", // NEEDS QC
	},
	coil: {
		name: "とぐろをまく",
	...
	copycat: {
		...
		gen7: {
			desc: "（自分を含む）いずれかのポケモンが最後に使った技を使う。まだ技が使われていない場合や、最後に使われた技がねこのて・トーチカ・くちばしキャノン・ゲップ・ギフトパス・おいわい・おしゃべり・ともえなげ・まねっこ・カウンター・ほしがる・みちづれ・みきり・ドラゴンテール・こらえる・フェイント・きあいパンチ・このゆびとまれ・てだすけ・てをつなぐ・キングシールド・たたみがえし・さきどり・ゆびをふる・ものまね・ミラーコート・オウムがえし・しぜんのちから・まもる・いかりのこな・ほえる・トラップシェル・スケッチ・ねごと・よこどり・ニードルガード・スポットライト・わるあがき・すりかえ・どろぼう・へんしん・トリック・ふきとばし、またはＺワザの場合は失敗する。", // NEEDS QC
		},
		gen6: {
	...
	covet: {
		...
		champions: {
			desc: "攻撃が成功して自分が道具を持っていない場合、相手の持ち物を奪う。特性がねんちゃくの相手は、ひんしになっていなければ道具を失わない。道具がメガストーンで、自分か相手がそれでメガシンカできる種族の場合は奪えない。この技で失われた道具は、リサイクルや特性しゅうかくでは取り戻せない。", // NEEDS QC; first sentence per Champions WAZAINFO_SYN_168
		},
		gen8: {
		...
		gen7: {
			desc: "攻撃が成功して自分がひんしになっておらず、自分が道具を持っていない場合、相手の持ち物を奪う。特性がねんちゃくの相手は、ひんしにならない限り道具を失わない。Ｚクリスタル、メガシンカできる種族が持つメガストーン、およびカイオーガ・グラードン・ギラティナ・アルセウス・ゲノセクト・シルヴァディが持つ、それぞれあいいろのたま・べにいろのたま・はっきんだま・プレート・カセット・メモリは奪えず、自分がそれらの種族で相手が対応する道具を持っている場合も奪えない。この技で失われた道具は、リサイクルや特性しゅうかくでは取り戻せない。", // NEEDS QC
		},
		gen6: {
	...
	crushgrip: {
		...
		gen4: {
			desc: "威力は、120×（相手の残りHP÷相手の最大HP）+1（切り捨て）。", // NEEDS QC
		},
	},
	curse: {
		name: "のろい",
		...
		gen4: {
			desc: "自分がゴーストタイプでない場合、自分の素早さを1段階下げ、攻撃と防御を1段階ずつ上げる。ゴーストタイプの場合、（ひんしになっても）最大HPの1/2（切り捨て）を失う代わりに、相手が場にいる間、毎ターン終了時に相手の最大HPの1/4（切り捨て）を失わせる。相手がバトンタッチを使った場合、交代先も効果を受け続ける。対象がいない場合や、相手がすでに効果を受けている場合、みがわり状態の場合は失敗する。", // NEEDS QC
		},
		gen2: {
			desc: "自分がゴーストタイプでない場合、攻撃と防御が両方+6の場合を除き、自分の素早さを1段階下げ、攻撃と防御を1段階ずつ上げる。ゴーストタイプの場合、（ひんしになっても）最大HPの1/2（切り捨て）を失う代わりに、相手が場にいる間、毎ターン終了時に相手の最大HPの1/4（切り捨て）を失わせる。相手がバトンタッチを使った場合、交代先も効果を受け続ける。相手がすでに効果を受けている場合や、みがわり状態の場合は失敗する。", // NEEDS QC
		},
	...
	defensecurl: {
		...
		gen2: {
			desc: "自分の防御を1段階上げる。場にいる間、自分のころがるの威力が2倍になる（重複しない）。この効果はバトンタッチで引き継げる。", // NEEDS QC
		},
		gen1: {
	...
	diamondstorm: {
		...
		gen6: {
			desc: "攻撃ごとに50%の確率で自分の防御が1段階上がる。", // NEEDS QC
	...
	direclaw: {
		...
		champions: {
			desc: "30%の確率で相手をねむり・どく・まひのいずれかの状態にする。", // NEEDS QC
			shortDesc: "30%でねむり・どく・まひのいずれかにする。", // NEEDS QC
		},
	},
	disable: {
		name: "かなしばり",
		...
		gen7: {
			desc: "4ターンの間、相手が最後に使った技をかなしばり状態にする。相手の技がすでにかなしばり状態の場合、相手がまだ技を使っていない場合、その技を覚えていない場合、その技がＺワザだった場合は失敗する。効果中もＺパワーで強化された技は選択して使える。", // NEEDS QC
		},
		gen6: {
	...
	doomdesire: {
		...
		activate: "  {TARGET}は はめつのねがいの 攻撃を受けた！", // RS: [B_DEF]は [B_BUFF1]の こうげきを うけた！ (kanji modernized)
	},
	doubleedge: {
		name: "すてみタックル",
	...
	electricterrain: {
		...
		shortDesc: "5ターン。地上：でんき技強化、ねむらない。", // NEEDS QC
		gen7: {
	...
	electroball: {
		...
		gen5: {
			desc: "威力は、（自分の現在の素早さ÷相手の現在の素早さ）（切り捨て）によって決まる。4以上なら150、3なら120、2なら80、1なら60、1未満なら40。相手の現在の素早さが0の場合は1として扱う。", // NEEDS QC
		},
	},
	electrodrift: {
		name: "イナズマドライブ",
	...
	encore: {
		...
		gen7: {
			desc: "次の3ターンの間、相手は最後に使った技を繰り返し使う。その技のPPがなくなると効果は終わる。相手がすでにこの効果を受けている場合、まだ技を使っていない場合、その技のPPが0の場合、その技がねこのて・まねっこ・アンコール・さきどり・ゆびをふる・ものまね・オウムがえし・しぜんのちから・スケッチ・ねごと・わるあがき・へんしんまたはＺワザの場合は失敗する。効果中もＺパワーで強化された技は選択して使える。", // NEEDS QC
		},
		gen6: {
	...
	explosion: {
		...
		gen4: {
			desc: "技を使った後、自分はひんしになる。ただし、対象がいない場合はひんしにならない。ダメージ計算時、相手の防御を半分として計算する。特性がしめりけのポケモンが場にいると、この技は実行されない。", // NEEDS QC
			shortDesc: "計算時、相手の防御半分。自分はひんし。", // NEEDS QC
		},
		gen3: {
			desc: "技を使った後、自分はひんしになる。ダメージ計算時、相手の防御を半分として計算する。特性がしめりけのポケモンが場にいると、この技は実行されない。", // NEEDS QC
		},
		gen2: {
			desc: "技を使った後、自分はひんしになる。ダメージ計算時、相手の防御を半分として計算する。", // NEEDS QC
		},
		gen1: {
			desc: "技を使った後、自分はひんしになる。ただし、この技で相手のみがわりを壊した場合はひんしにならない。ダメージ計算時、相手の防御を半分として計算する。", // NEEDS QC
		},
	},
	extrasensory: {
		name: "じんつうりき",
	...
	facade: {
		...
		shortDesc: "やけど・どく・まひのとき威力2倍。", // NEEDS QC
		gen5: {
	...
	fakeout: {
		...
		champions: {
			desc: "100%の確率で相手をひるませる。登場して最初のターンでなければ選択できない。", // NEEDS QC; 「登場して最初に」 per Champions WAZAINFO_SYN_252
		},
	},
	faketears: {
		name: "うそなき",
	...
	fellstinger: {
		...
		gen6: {
			desc: "この技で相手をひんしにすると、自分の攻撃が2段階上がる。", // NEEDS QC
	...
	firstimpression: {
		...
		champions: {
			desc: "登場して最初のターンでなければ選択できない。", // NEEDS QC
		},
	},
	fishiousrend: {
		name: "エラがみ",
	...
	fissure: {
		...
		gen1: {
			desc: "相手に65535のダメージを与える。相手の素早さが自分より高い場合は失敗する。", // NEEDS QC
	...
	flail: {
		...
		gen4: {
			desc: "威力は、（自分の残りHP×64÷自分の最大HP）（切り捨て）をXとすると、Xが43〜48なら20、22〜42なら40、13〜21なら80、6〜12なら100、2〜5なら150、0か1なら200。", // NEEDS QC
		},
		gen3: {
			desc: "威力は、X=（自分の残りHP×48÷自分の最大HP）（切り捨て）として、Xが33〜48なら20、17〜32なら40、10〜16なら80、5〜9なら100、2〜4なら150、0〜1なら200。", // NEEDS QC
		},
		gen2: {
			desc: "威力は、（自分の残りHP×48÷自分の最大HP）（切り捨て）をXとすると、Xが33〜48なら20、17〜32なら40、10〜16なら80、5〜9なら100、2〜4なら150、0か1なら200。この技はダメージの乱数幅がなく、急所に当たらない。", // NEEDS QC
		},
	},
	flameburst: {
		name: "はじけるほのお",
	...
	floralhealing: {
		...
		shortDesc: "対象の最大HPの1/2を回復する。", // NEEDS QC
	},
	flowershield: {
		name: "フラワーガード",
	...
	focusenergy: {
		...
		gen2: {
			desc: "自分の急所ランクを1段階上げる。すでに効果を受けている場合は失敗する。この効果はバトンタッチで引き継げる。", // NEEDS QC
			shortDesc: "自分の急所ランクが1段階上がる。", // NEEDS QC
		},
		gen1: {
	...
	freezedry: {
		...
		champions: {
			desc: "この技のタイプにかかわらず、みずタイプに対する相性が効果ばつぐんになる。", // NEEDS QC
			shortDesc: "みずタイプに効果ばつぐん。", // NEEDS QC
		},
	},
	freezeshock: {
		name: "フリーズボルト",
	...
	frustration: {
		name: "やつあたり",
		// Official flavor text: "この技は 使えません 思い出すことが できなくなりますが 技を 忘れることを おすすめします"
		desc: "威力は（（255−自分のなかよし度）×2/5）（切り捨て、最低1）。", // NEEDS QC
		shortDesc: "なかよし度が低いほど威力が上がる（最大102）。", // NEEDS QC
	},
	furyattack: {
		name: "みだれづき",
	...
	futuresight: {
		...
		activate: "  {TARGET}は みらいよちの 攻撃を受けた！", // RS: [B_DEF]は [B_BUFF1]の こうげきを うけた！ (kanji modernized)
	},
	gastroacid: {
		name: "いえき",
	...
	gmaxcannonade: {
		...
		shortDesc: "威力は元の技による。相手側に4ターン1/6ダメージ。", // NEEDS QC
	...
	gmaxsteelsurge: {
		name: "キョダイコウジン",
		desc: "威力は元の技のダイマックス技の威力に等しい。攻撃が成功すると、相手側の場にはがねの設置技を仕掛け、交代で出てきた相手のポケモンにダメージを与える。ダメージは相手のはがねタイプに対する相性で決まり、0.25倍・0.5倍・等倍・2倍・4倍に対してそれぞれ最大HPの1/32・1/16・1/8・1/4・1/2（切り捨て）。相手側のポケモンがこうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
	...
	gmaxstonesurge: {
		name: "キョダイガンジン",
		desc: "威力は元の技のダイマックス技の威力に等しい。攻撃が成功すると、相手側の場にいわの設置技を仕掛け、交代で出てきた相手のポケモンにダメージを与える。ダメージは相手のいわタイプに対する相性で決まり、0.25倍・0.5倍・等倍・2倍・4倍に対してそれぞれ最大HPの1/32・1/16・1/8・1/4・1/2（切り捨て）。相手側のポケモンがこうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
	...
	grassyterrain: {
		...
		shortDesc: "5ターン。地上：くさ技強化、毎ターン1/16回復。", // NEEDS QC
		gen7: {
	...
	gravity: {
		...
		gen7: {
			desc: "5ターンの間、場にいるすべてのポケモンの回避率が0.6倍になる。使用時、すべてのポケモンのとびはねる・そらをとぶ・でんじふゆう・フリーフォール・テレキネシスがすぐに終わる。効果中、すべてのポケモンはとびはねる・そらをとぶ・フライングプレス・とびひざげり・とびげり・でんじふゆう・フリーフォール・はねる・テレキネシスを使えない。じめんタイプの攻撃、まきびし・どくびし・ねばねばネット・特性ありじごくが、ひこうタイプや特性ふゆうのポケモンにも効果を発揮する。すでに効果が発動中の場合は失敗する。該当するＺパワーで強化された技は選択できるが、効果中は実行時に防がれる。", // NEEDS QC
		},
		gen6: {
			desc: "5ターンの間、場にいるすべてのポケモンの回避率が0.6倍になる。使用時、場にいるすべてのポケモンのとびはねる・そらをとぶ・でんじふゆう・フリーフォール・テレキネシスの効果がすぐに終わる。効果の間、場にいるすべてのポケモンはとびはねる・そらをとぶ・フライングプレス・とびひざげり・とびげり・でんじふゆう・フリーフォール・はねる・テレキネシスを使えない。じめんタイプの攻撃やまきびし・どくびし・ねばねばネット、特性ありじごくが、ひこうタイプや特性ふゆうのポケモンにも効くようになる。すでにこの効果がある場合は失敗する。", // NEEDS QC
		},
	...
	growth: {
		...
		gen7: {
			desc: "自分の攻撃と特攻を1段階ずつ上げる。天気がにほんばれ・おおひでりのときは2段階ずつ上げる。", // NEEDS QC
		},
		gen5: {
			desc: "自分の攻撃と特攻を1段階ずつ上げる。天気がにほんばれのときは2段階ずつ上げる。", // NEEDS QC
		},
		gen4: {
			desc: "自分の特攻を1段階上げる。", // NEEDS QC
			shortDesc: "自分の特攻が1段階上がる。", // NEEDS QC
		},
		gen1: {
			desc: "自分のとくしゅを1段階上げる。", // NEEDS QC
			shortDesc: "自分のとくしゅが1段階上がる。", // NEEDS QC
		},
	},
	grudge: {
		name: "おんねん",
	...
	gyroball: {
		...
		gen5: {
			desc: "威力は、（25×相手の現在の素早さ÷自分の現在の素早さ）+1（切り捨て、最大150）。自分の現在の素早さが0の場合は1として扱う。", // NEEDS QC
		},
	},
	hail: {
		name: "あられ",
	...
	haze: {
		...
		// Only used in Gen 1
		activate: "  全ての ステータスが 元に 戻った！", // Champions BTL_STRID_STD_RankReset; replaces RB gen1 「すべての ステータスが もとに もどった！」
	},
	headbutt: {
		name: "ずつき",
	...
	healblock: {
		...
		gen7: {
			desc: "5ターンの間、相手は場にいる限りHPを回復できない。効果中、回復技と吸収技は使えず、回復効果のある特性や道具も発動しない。効果を受けたポケモンがバトンタッチを使うと、交代先も回復できないままになる。いたみわけと特性さいせいりょくは影響を受けない。該当するＺパワーで強化された技は効果中も選択して使える。", // NEEDS QC
		},
		gen6: {
			desc: "5ターンの間、相手は場にいる間HPを回復できなくなる。効果の間、回復技とHP吸収技は使えず、回復効果のある特性や道具でも回復しない。効果を受けているポケモンがバトンタッチを使った場合、交代先も回復できないままになる。いたみわけと特性さいせいりょくは影響を受けない。", // NEEDS QC
		},
	...
	healpulse: {
		...
		shortDesc: "対象の最大HPの1/2を回復する。", // NEEDS QC
		gen5: {
			desc: "対象の最大HPの1/2（四捨五入）を回復する。", // NEEDS QC
		},
	},
	heartstamp: {
		name: "ハートスタンプ",
	...
	hiddenpowerbug: {
		name: "めざめるパワー（むし）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerdark: {
		name: "めざめるパワー（あく）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerdragon: {
		name: "めざめるパワー（ドラゴン）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerelectric: {
		name: "めざめるパワー（でんき）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerfighting: {
		name: "めざめるパワー（かくとう）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerfire: {
		name: "めざめるパワー（ほのお）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerflying: {
		name: "めざめるパワー（ひこう）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerghost: {
		name: "めざめるパワー（ゴースト）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowergrass: {
		name: "めざめるパワー（くさ）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerground: {
		name: "めざめるパワー（じめん）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerice: {
		name: "めざめるパワー（こおり）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerpoison: {
		name: "めざめるパワー（どく）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerpsychic: {
		name: "めざめるパワー（エスパー）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerrock: {
		name: "めざめるパワー（いわ）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowersteel: {
		name: "めざめるパワー（はがね）", // NEEDS QC; PS construct, no official name
	},
	hiddenpowerwater: {
		name: "めざめるパワー（みず）", // NEEDS QC; PS construct, no official name
	},
	highhorsepower: {
		name: "１０まんばりき",
		shortDesc: "追加効果なし。", // NEEDS QC
	...
	hurricane: {
		...
		gen7: {
			desc: "30%の確率で相手をこんらん状態にする。とびはねる・そらをとぶ・フリーフォールを使っている相手や、フリーフォールの効果を受けている相手にも当たる。天気があめ・おおあめの場合、必中になる。天気がにほんばれ・おおひでりの場合、命中率が50%になる。", // NEEDS QC
		},
		gen5: {
			desc: "30%の確率で相手をこんらん状態にする。とびはねる・そらをとぶ・フリーフォールを使っている相手や、フリーフォールの効果を受けている相手にも当たる。天気があめの場合、必中になる。天気がにほんばれの場合、命中率が50%になる。", // NEEDS QC
		},
	},
	hydrocannon: {
		name: "ハイドロカノン",
	...
	hyperspacefury: {
		...
		desc: "自分の防御を1段階下げる。（へんしんも考慮した）現在の姿がときはなたれしフーパでなければ使えない。攻撃が成功すると、このターンの間、相手のトーチカ・みきり・キングシールド・まもる・ニードルガードの守りを破り、他のポケモンも相手を通常どおり攻撃できるようになる。相手側がトリックガード・たたみがえし・ファストガード・ワイドガードで守られている場合、その守りもこのターンの間破られ、他のポケモンも相手側を通常どおり攻撃できる。", // NEEDS QC
		shortDesc: "ときはなたれしフーパ専用。防御-1。守り貫通。", // NEEDS QC
		gen6: {
			desc: "自分の防御を1段階下げる。（へんしんを含めて）現在の姿がときはなたれしフーパでない場合は使えない。この技が成功すると、このターンの間、相手のみきり・キングシールド・まもる・ニードルガードを破り、他のポケモンも相手を普通に攻撃できるようになる。相手側がトリックガード・たたみがえし・ファストガード・ワイドガードで守られている場合、その守りもこのターンの間破られる。", // NEEDS QC
		},
	...
	imprison: {
		...
		gen7: {
			desc: "自分が場にいる間、自分も覚えている技を相手は使えない。効果中もＺパワーで強化された技は選択して使える。", // NEEDS QC
		},
		gen6: {
			desc: "自分が場にいる間、相手はすべて、自分も覚えている技を使えなくなる。", // NEEDS QC
		},
	...
	instruct: {
		...
		gen7: {
			desc: "相手は最後に使った技をすぐにもう一度使う。相手がまだ技を使っていない場合、その技のPPが0の場合、相手がくちばしキャノン・きあいパンチ・トラップシェルを準備中の場合、その技がねこのて・くちばしキャノン・ゲップ・がまん・おいわい・おしゃべり・まねっこ・きあいパンチ・てをつなぐ・アイスボール・さいはい・キングシールド・さきどり・ゆびをふる・ものまね・オウムがえし・しぜんのちから・げきりん・はなびらのまい・ころがる・トラップシェル・スケッチ・ねごと・わるあがき・あばれる・へんしん・さわぐ、2ターン技、反動で動けなくなる技、Ｚワザの場合は失敗する。", // NEEDS QC
		},
	...
	ironhead: {
		...
		shortDesc: "30%の確率で相手をひるませる。", // NEEDS QC
		champions: {
			desc: "20%の確率で相手をひるませる。", // NEEDS QC; Champions WAZAINFO_SYN_127 「２０％の確率で相手をひるませる。」
			shortDesc: "20%の確率で相手をひるませる。", // NEEDS QC
		},
	},
	irontail: {
	...
	kingsshield: {
		...
		gen8: {
			desc: "このターンの間、他のポケモンからのほとんどの技を防ぎ、自分に直接攻撃をしようとした相手の攻撃を1段階下げる。変化技は防げない。この技の成功率は1/Xで、Xは1から始まり、成功するたびに3倍になる。失敗した場合や、最後に使った技がトーチカ・みきり・こらえる・キングシールド・ダイウォール・ブロッキング・まもる・ファストガード・ニードルガード・ワイドガード以外だった場合、またはそれらの技を使って守りが破られた場合、Xは1に戻る。このターンの最後に行動する場合は失敗する。", // NEEDS QC
		},
		gen7: {
			desc: "このターンの間、他のポケモンからのほとんどの技を防ぎ、自分に直接攻撃をしようとした相手の攻撃を2段階下げる。変化技は防げない。この技の成功率は1/Xで、Xは1から始まり、成功するたびに3倍になる。失敗した場合や、最後に使った技がトーチカ・みきり・こらえる・キングシールド・まもる・ファストガード・ニードルガード・ワイドガード以外だった場合、またはそれらの技を使って守りが破られた場合、Xは1に戻る。このターンの最後に行動する場合は失敗する。", // NEEDS QC
			shortDesc: "攻撃技を防ぐ。接触した相手の攻撃-2。", // NEEDS QC
		},
		gen6: {
			desc: "このターンの間、他のポケモンからのほとんどの技を防ぎ、自分に直接攻撃をしようとした相手の攻撃を2段階下げる。変化技は防げない。この技の成功率は1/Xで、Xは1から始まり、成功するたびに3倍になる。失敗した場合や、最後に使った技がみきり・こらえる・キングシールド・まもる・ファストガード・ニードルガード・ワイドガード以外だった場合、またはそれらの技を使って守りが破られた場合、Xは1に戻る。このターンの最後に行動する場合は失敗する。", // NEEDS QC
		},
	},
	knockoff: {
		name: "はたきおとす",
		...
		champions: {
			desc: "相手が道具を持っていると威力が1.5倍になり、相手の道具を失わせる。特性がねんちゃくの相手は、ひんしになっていなければ道具を失わない。メガシンカできる種族が持つメガストーンに対しては威力が上がらず、道具も失わせない。この技で失われた道具は、リサイクルや特性しゅうかくでは取り戻せない。", // NEEDS QC; first sentence per Champions WAZAINFO_SYN_282
		},
		gen8: {
		...
		gen7: {
			desc: "相手が道具を持っている場合、この技の威力は1.5倍になり、自分がひんしになっていなければ相手はその道具を失う。特性がねんちゃくの相手は、ひんしにならない限り道具を失わない。Ｚクリスタル、メガシンカできる種族が持つメガストーン、およびカイオーガ・グラードン・ギラティナ・アルセウス・ゲノセクト・シルヴァディが持つ、それぞれあいいろのたま・べにいろのたま・はっきんだま・プレート・カセット・メモリに対しては威力が上がらず、道具も失わせられない。自分がそれらの種族で相手が対応する道具を持っている場合も同様。この技で失われた道具は、リサイクルや特性しゅうかくでは取り戻せない。", // NEEDS QC
		},
		gen6: {
	...
	leechseed: {
		...
		end: "  {POKEMON}は やどりぎのタネを 吹き飛ばした！", // RS: [B_ATK]は やどりぎのタネを ふきとばした！ (shed LEECH SEED); kanji per Champions KousokuSpin 「吹き飛ばした」
	...
	lightscreen: {
		...
		gen2: {
			desc: "5ターンの間、自分と味方の特防が2倍になる。急所に当たった場合は軽減されない。自分の側ですでに効果が発動中の場合は失敗する。", // NEEDS QC
	...
	magnitude: {
		...
		activate: "  マグニチュード{NUMBER}！", // SV/LZA (HGSS had 「！！」)
	},
	makeitrain: {
		name: "ゴールドラッシュ",
		...
		champions: {
			desc: "自分の特攻を2段階下げる。", // NEEDS QC; Champions wazainfo_syn: 「自分の特攻を２段階下げる。」
			shortDesc: "自分の特攻-2。相手全体攻撃。", // NEEDS QC
		},
	...
	maxrockfall: {
		...
		shortDesc: "威力は元の技による。すなあらしにする。", // NEEDS QC
	},
	maxstarfall: {
		name: "ダイフェアリー",
	...
	mefirst: {
		...
		gen7: {
			desc: "相手がこのターンに選んだ技を、可能であれば威力1.5倍で先取りして使う。対象にできるのは、くちばしキャノン・ゲップ・おしゃべり・カウンター・ほしがる・きあいパンチ・さきどり・メタルバースト・ミラーコート・トラップシェル・わるあがき・どろぼうとＺワザ以外の攻撃技のみ。相手が自分より先に行動する場合は失敗する。技のコピーにおいて、相手のみがわりを無視する。", // NEEDS QC
		},
		gen6: {
	...
	metronome: {
		...
		gen8bdsp: {
			desc: "おさきにどうぞ・ゲップ・ボディプレス・おしゃべり・まねっこ・カウンター・ほしがる・みちづれ・みきり・ガリョウテンセイ・こらえる・フェイント・きあいパンチ・このゆびとまれ・てだすけ・いのちのしずく・ゆびをふる・ものまね・ミラーコート・しぜんのちから・こんげんのはどう・だんがいのつるぎ・まもる・さきおくり・ファストガード・いかりのこな・スケッチ・ねごと・バークアウト・いびき・ニードルガード・わるあがき・すりかえ・どろぼう・へんしん・トリック・ワイドガード以外の技から、ランダムに1つが選ばれて使われる。", // NEEDS QC
		},
		gen7letsgo: {
			desc: "第1世代で登場した技のうち、カウンター・ものまね・オウムがえし・わるあがき・へんしん以外から、ランダムに1つが選ばれて使われる。", // NEEDS QC
			shortDesc: "第1世代の技からランダムに1つ使う。", // NEEDS QC
		},
		gen8: {
		...
		move: "指を振ったら {MOVE}がでた！", // LZA:6607 (SV:8661 has a stray space before が)
	},
	mightycleave: {
		name: "パワフルエッジ",
		shortDesc: "まもる系を（壊さずに）貫通する。", // NEEDS QC
	...
	mimic: {
		...
		gen7: {
			desc: "場にいる間、この技が相手の最後に使った技に置き換わる。コピーした技のPPはその技の最大値になる。相手がまだ技を使っていない場合、自分がへんしんしている場合、自分がすでにその技を覚えている場合、その技がおしゃべり・ものまね・スケッチ・わるあがき・へんしん、Ｚワザの場合は失敗する。", // NEEDS QC
		},
		gen6: {
	...
	mist: {
		...
		gen1: {
			...
			start: "  {POKEMON}は しろい きりに つつまれた！", // RB:2409 (gen 2 text is Crystal's)
			block: "  しかしうまく決まらなかった！！",
		},
	...
	moonblast: {
		...
		champions: {
			desc: "10%の確率で相手の特攻を1段階下げる。", // NEEDS QC; Champions wazainfo_syn: 「１０％の確率で相手の特攻を１段階下げる。」
			shortDesc: "10%の確率で相手の特攻を1段階下げる。", // NEEDS QC
		},
	},
	moongeistbeam: {
		name: "シャドーレイ",
	...
	naturepower: {
		...
		gen6: {
			desc: "フィールドに応じて別の技を呼び出して使う。通常はトライアタック、エレキフィールドでは１０まんボルト、ミストフィールドではムーンフォース、グラスフィールドではエナジーボールになる。", // NEEDS QC
		},
		gen5: {
			desc: "フィールドに応じて別の技を呼び出して使う。通常のフィールドではじしんになる。", // NEEDS QC
			shortDesc: "フィールドで技が変わる。（じしん）", // NEEDS QC
		},
		gen4: {
			desc: "フィールドに応じて別の技を呼び出して使う。通常のフィールドではトライアタックになる。", // NEEDS QC
			shortDesc: "フィールドで技が変わる。（トライアタック）", // NEEDS QC
		},
		gen3: {
			desc: "フィールドに応じて別の技を呼び出して使う。通常のフィールドではスピードスターになる。", // NEEDS QC
	...
	pikapapow: {
		name: "ピカピカサンダー",
		// Official flavor text: "この技は 使えません 思い出すことが できなくなりますが 技を 忘れることを おすすめします"
		desc: "威力は（自分のなかよし度×2/5）（切り捨て、最低1）。", // NEEDS QC
		shortDesc: "なかよし度最大で威力102。必中。", // NEEDS QC
	},
	pinmissile: {
		name: "ミサイルばり",
	...
	polarflare: {
		...
		shortDesc: "10%でこおりにする。Ramnarokは姿が変わる。", // NEEDS QC
	},
	pollenpuff: {
		name: "かふんだんご",
	...
	pulverizingpancake: {
		name: "ほんきをだす　こうげき", // the internal fullwidth space (U+3000) is part of the official name (SV:18647)
		shortDesc: "追加効果なし。", // NEEDS QC
	},
	punishment: {
		name: "おしおき",
	...
	ragefist: {
		...
		champions: {
			desc: "威力は50+(X×50)。Xはこの対戦で自分がダメージを与える攻撃を受けた延べ回数（HPが減らなかった場合も数える、最大6）。場を離れると0に戻る。連続攻撃技は1発ごとに数えるが、こんらんによる自傷ダメージは数えない。", // NEEDS QC; Champions wazainfo_syn: 「技のダメージを受けるたび 威力が５０上がる。最大威力３５０。手持ちに戻ると 威力は元に戻る。」
			shortDesc: "被弾ごとに威力+50（最大6回）。交代でリセット。", // NEEDS QC
		},
	},
	ragepowder: {
		name: "いかりのこな",
	...
	recover: {
		...
		gen1: {
			desc: "自分の最大HPの1/2（切り捨て）を回復する。（自分の最大HP − 残りHP + 1）が256で割り切れる場合は失敗する。", // NEEDS QC
		},
	},
	recycle: {
		name: "リサイクル",
	...
	return: {
		...
		// Official flavor text: "この技は 使えません 思い出すことが できなくなりますが 技を 忘れることを おすすめします"
		desc: "威力は（自分のなかよし度×2/5）（切り捨て、最低1）。", // NEEDS QC
		shortDesc: "なかよし度が高いほど威力が上がる（最大102）。", // NEEDS QC
	},
	revelationdance: {
		name: "めざめるダンス",
	...
	saltcure: {
		...
		shortDesc: "毎ターンHP1/8減（はがね・みずは1/4）。", // NEEDS QC
		champions: {
			desc: "効果の間、毎ターン終了時に相手の最大HPの1/16（はがね・みずタイプの場合は1/8、切り捨て）のダメージを与える。相手が場を離れると効果は終わる。", // NEEDS QC; Champions wazainfo_syn: 「相手をしおづけ状態にする。」
			shortDesc: "毎ターンHP1/16減（はがね・みずは1/8）。", // NEEDS QC
		},

		start: "  {POKEMON}は しおづけに なった！",
		damage: "  {POKEMON}は しおづけの ダメージを 受けた！", // NEEDS QC (games use the generic damage line)
	},
	sandattack: {
		name: "すなかけ",
	...
	sandstorm: {
		...
		shortDesc: "5ターン、すなあらしにする。いわの特防1.5倍。", // NEEDS QC
		gen4: {
	...
	secretpower: {
		...
		gen6: {
			desc: "30%の確率で、フィールドに応じた追加効果を相手に与える。通常はまひ状態、エレキフィールドではまひ状態、ミストフィールドでは特攻を1段階下げ、グラスフィールドではねむり状態にする。", // NEEDS QC
		},
		gen5: {
			desc: "30%の確率で、フィールドに応じた追加効果を相手に与える。通常のフィールドでは命中率を1段階下げる。追加効果の確率は特性てんのめぐみの影響を受けない。", // NEEDS QC
			shortDesc: "フィールドで効果が変わる。（30%で命中-1）", // NEEDS QC
		},
		gen4: {
			desc: "30%の確率で、フィールドに応じた追加効果を相手に与える。通常のフィールドではまひ状態にする。", // NEEDS QC
			shortDesc: "フィールドに応じた追加効果（通常30%まひ）。", // NEEDS QC
		},
	},
	secretsword: {
	...
	shoreup: {
		...
		shortDesc: "HPを半分回復。すなあらしなら2/3回復。", // NEEDS QC
	},
	signalbeam: {
		name: "シグナルビーム",
		// Official flavor text: "この技は 使えません 思い出すことが できなくなりますが 技を 忘れることを おすすめします"
	...
	sleeptalk: {
		...
		gen7: {
			desc: "この技以外の自分が覚えている技から、ランダムに1つが選ばれて使われる。自分がねむり状態でなければ失敗する。選ばれた技のPPは消費されず、PPが0の技も選ばれる。ねこのて・くちばしキャノン・ゲップ・がまん・おいわい・おしゃべり・まねっこ・きあいパンチ・てをつなぐ・さきどり・ゆびをふる・ものまね・オウムがえし・しぜんのちから・トラップシェル・スケッチ・ねごと・わるあがき・さわぐと2ターン技・Ｚワザは選ばれない。", // NEEDS QC
		},
		gen6: {
	...
	smackdown: {
		...
		desc: "とびはねる・そらをとぶ・フリーフォールで飛び上がっている相手や、フリーフォールの効果を受けている相手にも当たる。とびはねる・そらをとぶ・でんじふゆう・テレキネシスの効果を受けている相手に当てると、その効果は終わる。相手が（このターンにはねやすめを使っていない）ひこうタイプか特性ふゆうのポケモンの場合、場にいる間、じめんタイプの攻撃と特性ありじごくが効くようになる。効果の間、相手はでんじふゆうを使えず、相手へのテレキネシスも失敗する。", // NEEDS QC
	...
	spikes: {
		...
		desc: "相手側の場にまきびしを仕掛け、交代で出てきた相手のポケモンにダメージを与える。ひこうタイプや特性がふゆうのポケモンには効果がない。最大3回まで重ねて仕掛けられ、ダメージは1回で最大HPの1/8、2回で1/6、3回で1/4（いずれも切り捨て）。いずれかのポケモンがおかたづけを使うか、相手側のポケモンがキラースピン・こうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
		shortDesc: "交代で出た地上の相手にダメージ。最大3回。", // NEEDS QC
		gen8: {
			desc: "相手側の場にまきびしを仕掛け、交代で出てきた相手のポケモンにダメージを与える。ひこうタイプや特性がふゆうのポケモンには効果がない。最大3回まで重ねて仕掛けられ、ダメージは1回で最大HPの1/8、2回で1/6、3回で1/4（いずれも切り捨て）。相手側のポケモンがこうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
		},
		gen5: {
			desc: "相手側の場にまきびしを仕掛け、交代で出てきた相手のポケモンにダメージを与える。ひこうタイプや特性がふゆうのポケモンには効果がない。最大3回まで重ねて仕掛けられ、ダメージは1回で最大HPの1/8、2回で1/6、3回で1/4（いずれも切り捨て）。相手側のポケモンがこうそくスピンを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
		},
		gen3: {
			desc: "相手側の場にまきびしを仕掛け、交代で出てきた相手のポケモンにダメージを与える。ひこうタイプや特性がふゆうのポケモンには効果がない。最大3回まで重ねて仕掛けられ、ダメージは1回で最大HPの1/8、2回で1/6、3回で1/4（いずれも切り捨て）。相手側のポケモンがこうそくスピンを成功させると、取り除かれる。", // NEEDS QC
		},
		gen2: {
			desc: "相手側の場にまきびしを仕掛け、交代で出てきた相手のポケモンは最大HPの1/8（切り捨て）を失う。ひこうタイプのポケモンには効果がない。すでに相手側にこの効果がある場合は失敗する。相手側のポケモンがこうそくスピンを成功させると、取り除かれる。", // NEEDS QC
	...
	stealthrock: {
		...
		desc: "相手側の場にステルスロックを仕掛け、交代で出てきた相手のポケモンにダメージを与える。すでに相手側にこの効果がある場合は失敗する。ダメージは相手のいわタイプに対する相性で決まり、0.25倍・0.5倍・等倍・2倍・4倍に対してそれぞれ最大HPの1/32・1/16・1/8・1/4・1/2（切り捨て）。いずれかのポケモンがおかたづけを使うか、相手側のポケモンがキラースピン・こうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
		shortDesc: "交代で出た相手にいわ相性のダメージ。", // NEEDS QC
		gen8: {
			desc: "相手側の場にステルスロックを仕掛け、交代で出てきた相手のポケモンにダメージを与える。すでに相手側にこの効果がある場合は失敗する。ダメージは相手のいわタイプに対する相性で決まり、0.25倍・0.5倍・等倍・2倍・4倍に対してそれぞれ最大HPの1/32・1/16・1/8・1/4・1/2（切り捨て）。相手側のポケモンがこうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
		},
		gen5: {
			desc: "相手側の場にステルスロックを仕掛け、交代で出てきた相手のポケモンにダメージを与える。すでに相手側にこの効果がある場合は失敗する。ダメージは相手のいわタイプに対する相性で決まり、0.25倍・0.5倍・等倍・2倍・4倍に対してそれぞれ最大HPの1/32・1/16・1/8・1/4・1/2（切り捨て）。相手側のポケモンがこうそくスピンを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
		},
	...
	stickyweb: {
		...
		desc: "相手側の場にねばねばネットを仕掛け、交代で出てきた相手のポケモンの素早さを1段階下げる。ひこうタイプや特性がふゆうのポケモンには効果がない。すでに相手側にこの効果がある場合は失敗する。いずれかのポケモンがおかたづけを使うか、相手側のポケモンがキラースピン・こうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
		shortDesc: "交代で出た地上の相手の素早さ-1。", // NEEDS QC
		gen8: {
			desc: "相手側の場にねばねばネットを仕掛け、交代で出てきた相手のポケモンの素早さを1段階下げる。ひこうタイプや特性がふゆうのポケモンには効果がない。すでに相手側にこの効果がある場合は失敗する。相手側のポケモンがこうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
		},
	...
	stoneaxe: {
		name: "がんせきアックス",
		desc: "攻撃が成功すると、相手側の場にステルスロックを仕掛け、交代で出てきた相手のポケモンにダメージを与える。ダメージは相手のいわタイプに対する相性で決まり、0.25倍・0.5倍・等倍・2倍・4倍に対してそれぞれ最大HPの1/32・1/16・1/8・1/4・1/2（切り捨て）。いずれかのポケモンがおかたづけを使うか、相手側のポケモンがキラースピン・こうそくスピン・きりばらいを成功させるかきりばらいを受けると、取り除かれる。", // NEEDS QC
	...
	strengthsap: {
		...
		shortDesc: "相手の攻撃の数値分HPを回復し、攻撃-1。", // NEEDS QC
	},
	stringshot: {
		name: "いとをはく",
	...
	stuffcheeks: {
		...
		champions: {
			desc: "きのみを持っていない場合は失敗する。持っているきのみを食べ、自分の防御を2段階上げる。この効果は、特性ぶきよう・きんちょうかんや、さしおさえ・マジックルームの効果でも防がれない。", // NEEDS QC; Champions wazainfo_syn: 「持っているきのみを食べる。自分の防御を２段階上げる。きのみを持っていないと この技は使えない。」
			shortDesc: "きのみがないと失敗。きのみを食べて防御+2。", // NEEDS QC
		},
	},
	stunspore: {
		name: "しびれごな",
	...
	substitute: {
		...
		gen1: {
			desc: "自分の最大HPの1/4（切り捨て）を消費して、自分の身代わりとなるみがわりを作る。みがわりのHPは作るのに使ったHP+1で、十分なダメージを受けるか、一度に255のダメージを受けるか、自分が交代・ひんしになると消える。みがわりが壊れるまで、相手のすべての攻撃のダメージはみがわりが受け、相手による状態異常や能力ランクの変化からも自分を守る。ただし、その効果がかなしばり・やどりぎのタネ・ねむり・主効果のまひ・追加効果のこんらんで、みがわりが壊れなかった場合は防げない。みがわりの陰にいる間も状態異常のダメージは通常どおり受けるが、こんらんによるダメージは代わりに相手のみがわりに与えられる。連続攻撃技の途中でみがわりが壊れた場合、攻撃は終わる。みがわりを作るだけのHPがない場合や、すでにみがわりがある場合は失敗する。残りHPがちょうど最大HPの1/4の場合、みがわりを作った後ひんしになる。", // NEEDS QC
			shortDesc: "最大HPの1/4を使ってみがわりを作る。", // NEEDS QC
		},
	...
	switcheroo: {
		...
		champions: {
			desc: "自分と相手の持ち物を入れ替える。自分も相手も道具を持っていない場合や、メガストーンをそれでメガシンカできる種族に渡そうとしたり奪おうとした場合は失敗する。特性がねんちゃくの相手には効かない。", // NEEDS QC; Champions wazainfo_syn: 「相手と自分の持っている道具を入れ替える。」
		},
		gen8: {
		...
		gen7: {
			desc: "自分と相手の持ち物を入れ替える。自分も相手も道具を持っていない場合、どちらかがＺクリスタルを持っている場合、メガストーンをそれでメガシンカできる種族に渡そうとしたり奪おうとした場合、カイオーガ・グラードン・ギラティナ・アルセウス・ゲノセクト・シルヴァディと、それぞれあいいろのたま・べにいろのたま・はっきんだま・プレート・カセット・メモリの組み合わせで道具を渡そうとしたり奪おうとした場合は失敗する。特性がねんちゃくの相手には効かない。", // NEEDS QC
		},
		gen6: {
	...
	taunt: {
		...
		gen7: {
			desc: "相手は次の3ターンの間、ダメージを与えない技を使えなくなる。特性がどんかんのポケモンや、アロマベールで守られているポケモンには効かない。効果中もＺパワーで強化された技は選択して使える。", // NEEDS QC
		},
		gen6: {
			desc: "相手は次の3ターンの間、ダメージを与えない技を使えなくなる。特性がどんかんのポケモンや、アロマベールで守られているポケモンには効かない。", // NEEDS QC
		},
	...
	teleport: {
		...
		desc: "成功して自分がひんしになっていない場合、交代できない状態でも必ず交代し、選んだ控えのポケモンとすぐに入れ替わる。控えにひんしでないポケモンがいない場合は交代しない。", // NEEDS QC
	...
	thief: {
		...
		shortDesc: "道具を持っていなければ相手から奪う。", // NEEDS QC
		champions: {
			desc: "攻撃が成功して自分が道具を持っていない場合、相手の持ち物を奪う。特性がねんちゃくの相手は、ひんしになっていなければ道具を失わない。メガストーンは、自分または相手がそれでメガシンカできる種族の場合は奪えない。この技で失われた道具は、リサイクルや特性しゅうかくでは取り戻せない。", // NEEDS QC; Champions wazainfo_syn: 「自分が道具を持っていない場合 相手の道具を奪う。」
		},
		gen8: {
			desc: "攻撃が成功して自分がひんしになっておらず、自分が道具を持っていない場合、相手の持ち物を奪う。特性がねんちゃくの相手は、ひんしにならない限り道具を失わない。カイオーガ・グラードン・ギラティナ・アルセウス・ゲノセクト・シルヴァディ・ザシアン・ザマゼンタが持つ、それぞれあいいろのたま・べにいろのたま・はっきんだま・プレート・カセット・メモリ・くちたけん・くちたたては奪えず、自分がそれらの種族で相手が対応する道具を持っている場合も奪えない。この技で失われた道具は、リサイクルや特性しゅうかくでは取り戻せない。", // NEEDS QC
		},
	...
	throatchop: {
		...
		gen7: {
			desc: "2ターンの間、相手は音の技を使えなくなる。効果中もＺパワーで強化された音の技は選択して使える。", // NEEDS QC
		},
	...
	toxicspikes: {
		...
		desc: "相手側の場にどくびしを仕掛け、交代で出てきた相手のポケモンをどく状態にする。ひこうタイプや特性がふゆうのポケモンには効果がない。最大2回まで重ねて仕掛けられ、1回でどく状態、2回でもうどく状態にする。いずれかのポケモンがおかたづけを使うか、相手側のポケモンがキラースピン・こうそくスピン・きりばらいを成功させるかきりばらいを受けるか、地面にいるどくタイプのポケモンが交代で出てくると、取り除かれる。しんぴのまもりは交代時のどくを防ぐが、みがわりは防がない。", // NEEDS QC
		shortDesc: "交代で出た地上の相手をどくにする。最大2回。", // NEEDS QC
		gen8: {
			desc: "相手側の場にどくびしを仕掛け、交代で出てきた相手のポケモンをどく状態にする。ひこうタイプや特性がふゆうのポケモンには効果がない。最大2回まで重ねて仕掛けられ、1回でどく状態、2回でもうどく状態にする。相手側のポケモンがこうそくスピン・きりばらいを成功させるかきりばらいを受けるか、地面にいるどくタイプのポケモンが交代で出てくると、取り除かれる。しんぴのまもりは交代時のどくを防ぐが、みがわりは防がない。", // NEEDS QC
		},
		gen5: {
			desc: "相手側の場にどくびしを仕掛け、交代で出てきた相手のポケモンをどく状態にする。ひこうタイプや特性がふゆうのポケモンには効果がない。最大2回まで重ねて仕掛けられ、1回でどく状態、2回でもうどく状態にする。相手側のポケモンがこうそくスピンを成功させるかきりばらいを受けるか、地面にいるどくタイプのポケモンが交代で出てくると、取り除かれる。しんぴのまもりは交代時のどくを防ぐが、みがわりは防がない。", // NEEDS QC
		},
		gen4: {
			desc: "相手側の場にどくびしを仕掛け、交代で出てきた相手のポケモンをどく状態にする。ひこうタイプや特性がふゆうのポケモンには効果がない。最大2回まで重ねて仕掛けられ、1回でどく状態、2回でもうどく状態にする。相手側のポケモンがこうそくスピンを成功させるかきりばらいを受けるか、地面にいるどくタイプのポケモンが交代で出てくると、取り除かれる。しんぴのまもりは交代時のどくを防ぎ、みがわりを出したまま交代で出てきた場合も防がれる。", // NEEDS QC
		},
	...
	toxicthread: {
		...
		champions: {
			desc: "相手の素早さを2段階下げ、どく状態にする。", // NEEDS QC; Champions wazainfo_syn: 「相手の素早さを２段階下げる。相手をどく状態にする。」
			shortDesc: "相手の素早さを2段階下げ、どくにする。", // NEEDS QC
		},
	},
	trailblaze: {
		name: "くさわけ",
	...
	uproar: {
		...
		gen4: {
			...
			shortDesc: "3〜6ターン続く。その間だれもねむれない。", // NEEDS QC
		},
		gen3: {
			...
			shortDesc: "2〜5ターン続く。その間だれもねむれない。", // NEEDS QC
		},
