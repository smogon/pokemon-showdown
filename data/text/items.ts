export const ItemsText: { [id: IDEntry]: ItemText } = {
	...
	dracoplate: { // updated
		name: "Draco Plate",
		shortDesc: "Holder's Dragon-type attacks have 1.3x power. Judgment is Dragon type.",
	},
	dragalgite: {
		name: "Dragalgite",
	...
	dreadplate: { // updated
		name: "Dread Plate",
		shortDesc: "Holder's Dark-type attacks have 1.3x power. Judgment is Dark type.",
	},
	dreamball: {
		name: "Dream Ball",
	...
	dubiousdisc: { // updated
		name: "Dubious Disc",
		shortDesc: "Evolves Porygon2 into Porygon-Z when used.",
	},
	durinberry: {
		name: "Durin Berry",
		shortDesc: "Cannot be eaten by the holder. No effect when eaten with Bug Bite or Pluck.",
	...
	earthplate: { // updated
		name: "Earth Plate",
		shortDesc: "Holder's Ground-type attacks have 1.3x power. Judgment is Ground type.",
	},
	eelektrossite: {
		name: "Eelektrossite",
	...
	firestone: { // updated
		name: "Fire Stone",
		desc: "Evolves Vulpix into Ninetales, Growlithe into Arcanine, Hisuian Growlithe into Hisuian Arcanine, Eevee into Flareon, Pansear into Simisear, Capsakid into Scovillain, and Pramblo into Glashulimp when used.",
		shortDesc: "Evolves certain species of Pokemon when used.",
	},
	firiumz: {
		name: "Firium Z",
	...
	fistplate: { // updated
		name: "Fist Plate",
		shortDesc: "Holder's Fighting-type attacks have 1.3x power. Judgment is Fighting type.",
	},
	flameorb: {
		name: "Flame Orb",
	...
	flameplate: { // updated
		name: "Flame Plate",
		shortDesc: "Holder's Fire-type attacks have 1.3x power. Judgment is Fire type.",
	},
	floatstone: {
		name: "Float Stone",
	...
	icestone: { // updated
		name: "Ice Stone",
		desc: "Evolves Rattata into Kaskadian Raticate, Alolan Sandshrew into Alolan Sandslash, Alolan Vulpix into Alolan Ninetales, Eevee into Glaceon, Galarian Darumaka into Galarian Darmanitan, Crabrawler into Crabominable, and Cetoddle into Cetitan when used.",
		shortDesc: "Evolves certain species of Pokemon when used.",
		gen7: {
	...
	icicleplate: { // updated
		name: "Icicle Plate",
		shortDesc: "Holder's Ice-type attacks have 1.3x power. Judgment is Ice type.",
	},
	iciumz: {
		name: "Icium Z",
	...
	insectplate: { // updated
		name: "Insect Plate",
		shortDesc: "Holder's Bug-type attacks have 1.3x power. Judgment is Bug type.",
	},
	ironball: {
		name: "Iron Ball",
	...
	ironplate: { // updated
		name: "Iron Plate",
		shortDesc: "Holder's Steel-type attacks have 1.3x power. Judgment is Steel type.",
	},
	jabocaberry: {
		name: "Jaboca Berry",
	...
	leafstone: { // updated
		name: "Leaf Stone",
		desc: "Evolves Gloom into Vileplume, Weepinbell into Victreebel, Hisuian Voltorb into Hisuian Electrode, Exeggcute into Exeggutor or Alolan Exeggutor, Eevee into Leafeon, Nuzleaf into Shiftry, Pansage into Simisage, and Kaskadian Gurdurr into Kaskadian Conkeldurr when used.",
		shortDesc: "Evolves certain species of Pokemon when used.",
		gen7: {
	...
	lightball: { // updated
		name: "Light Ball",
		desc: "If held by a Pikachu or Pichu, its Attack and Special Attack are doubled. If held by a Raichu, Emolga, or Guruchi, its Attack and Special Attack are multiplied by 1.5.",
	...
	meadowplate: { // updated
		name: "Meadow Plate",
		shortDesc: "Holder's Grass-type attacks have 1.3x power. Judgment is Grass type.",
	},
	medichamite: {
		name: "Medichamite",
	...
	metalcoat: { // updated
		name: "Metal Coat",
		desc: "Holder's Steel-type attacks have 1.2x power. Evolves Onix into Steelix when traded, and Scyther into Scizor when used.",
	...
	mindplate: { // updated
		name: "Mind Plate",
		shortDesc: "Holder's Psychic-type attacks have 1.3x power. Judgment is Psychic type.",
	},
	miracleseed: {
		name: "Miracle Seed",
	...
	moonstone: { // updated
		name: "Moon Stone",
		desc: "Evolves Nidorina into Nidoqueen, Nidorino into Nidoking, Clefairy into Clefable, Jigglypuff into Wigglytuff, Eevee into Umbreon, Skitty into Delcatty, and Munna into Musharna when used.",
		shortDesc: "Evolves certain species of Pokemon when used.",
	},
	muscleband: {
		name: "Muscle Band",
	...
	pixieplate: { // updated
		name: "Pixie Plate",
		shortDesc: "Holder's Fairy-type attacks have 1.3x power. Judgment is Fairy type.",
	},
	plumefossil: {
		name: "Plume Fossil",
	...
	prismscale: { // updated
		name: "Prism Scale",
		shortDesc: "Evolves Feebas into Milotic when used with high Friendship.",
	},
	protectivepads: {
	...
	shinystone: { // updated
		name: "Shiny Stone",
		desc: "Evolves Eevee into Sylveon, Togetic into Togekiss, Roselia into Roserade, Minccino into Cinccino, and Skideer into Yuleigh when used.",
		shortDesc: "Evolves certain species of Pokemon when used.",
	},
	shockdrive: {
		name: "Shock Drive",
	...
	skyplate: { // updated
		name: "Sky Plate",
		shortDesc: "Holder's Flying-type attacks have 1.3x power. Judgment is Flying type.",
	},
	slowbronite: {
		name: "Slowbronite",
	...
	splashplate: { // updated
		name: "Splash Plate",
		shortDesc: "Holder's Water-type attacks have 1.3x power. Judgment is Water type.",
	},
	spookyplate: { // updated
		name: "Spooky Plate",
		shortDesc: "Holder's Ghost-type attacks have 1.3x power. Judgment is Ghost type.",
	},
	sportball: {
		name: "Sport Ball",
	...
	sunstone: { // updated
		name: "Sun Stone",
		desc: "Evolves Gloom into Bellossom, Eevee into Espeon, Sunkern into Sunflora, Cottonee into Whimsicott, Petilil into Lilligant, and Helioptile into Heliolisk when used.",
		shortDesc: "Evolves certain species of Pokemon when used.",
	},
	swampertite: {
		name: "Swampertite",
	...
	thunderstone: { // updated
		name: "Thunder Stone",
		desc: "Evolves Pikachu into Raichu or Alolan Raichu, Magneton into Magnezone, Eevee into Jolteon, Eelektrik into Eelektross, Mienfoo into Mineflux, Charjabug into Vikavolt, and Tadbulb into Bellibolt when used.",
		shortDesc: "Evolves certain species of Pokemon when used.",
		gen7: {
	...
	toxicplate: { // updated
		name: "Toxic Plate",
		shortDesc: "Holder's Poison-type attacks have 1.3x power. Judgment is Poison type.",
	},
	tr00: {
		name: "TR00",
	...
	zapplate: { // updated
		name: "Zap Plate",
		shortDesc: "Holder's Electric-type attacks have 1.3x power. Judgment is Electric type.",
	},
	zoomlens: {
		name: "Zoom Lens",
	...
	coffeegeistcappuccino: {
		...
		desc: "Raises holder's Sp. Def and Speed by 1 stage when at 1/4 max HP or less. After 5 turns, the holder's stat stages gained from its Coffeegeist Cappuccino are reverted and the holder moves last among Pokemon using the same or greater priority move for 2 turns. Single use.",
		shortDesc: "+1 Sp. Def and Speed at 1/4 max HP for 5 turns, -0.1 priority afterwards.",
	},
	energychannelizer: {
		name: "Energy Channelizer",
		shortDesc: "Holder's Energy Weathergies last 8 turns instead of 5.",
	},
	energynullifier: {
	...
	flatunovan: {
		name: "Flat Unovan",
		desc: "Raises holder's accuracy and Speed by 1 stage when at 1/4 max HP or less. After 5 turns, the holder's stat stages gained from its Flat Unovan are reverted and the holder moves last among Pokemon using the same or greater priority move for 2 turns. Single use.",
		shortDesc: "+1 accuracy and Speed at 1/4 max HP for 5 turns, -0.1 priority afterwards.",
	},
	frostorb: {
		name: "Frost Orb",
		shortDesc: "At the end of every turn, this item attempts to give the holder frostbite.",
	},
	keybone: {
		name: "Keybone",
		shortDesc: "Evolves Catteraxe into Catatomb when held and fainting 9 times.",
	},
	miststone: {
		name: "Mist Stone",
		desc: "Evolves Eevee into Enigmeon, Stantler into Wyrdeer, Petilil into Hisuian Lilligant, White-Striped Basculin into Basculegion, Rufflet into Hisuian Braviary, Goomy into Hisuian Sliggoo, and Bergmite into Hisuian Avalugg when used.",
		shortDesc: "Evolves certain species of Pokemon when used.",
	},
	mystictamroastdoppio: {
		name: "Mystic Tamroast Doppio",
		desc: "Raises holder's Sp. Atk and Speed by 1 stage when at 1/4 max HP or less. After 5 turns, the holder's stat stages gained from its Mystic Tamroast Doppio are reverted and the holder moves last among Pokemon using the same or greater priority move for 2 turns. Single use.",
		shortDesc: "+1 Sp. Atk and Speed at 1/4 max HP for 5 turns, -0.1 priority afterwards.",
	},
	peatblock: {
		name: "Peat Block",
		shortDesc: "Evolves Ursaring into Ursaluna when used at night.",
	},
	pikaspresso: {
		name: "Pikaspresso",
		desc: "Raises holder's Speed by 2 stages when at 1/4 max HP or less. After 5 turns, the holder's stat stages gained from its Pikaspresso are reverted and the holder moves last among Pokemon using the same or greater priority move for 2 turns. Single use.",
		shortDesc: "+2 Speed at 1/4 max HP for 5 turns, -0.1 priority afterwards.",
	},
	portableturbine: {
		name: "Portable Turbine",
		shortDesc: "Holder's Clearing Weathergies last 8 turns instead of 5.",
	},
	razorhook: {
		name: "Razor Hook",
		desc: "Holder's attacks without a chance to make the target flinch gain a 10% chance to make the target flinch. Evolves Gligar into Gliscor and Sneasel into Weavile when used at night.",
		shortDesc: "Holder's attacks without a chance to flinch gain a 10% chance to flinch.",
	},
	sandygastmocha: {
		name: "Sandygast Mocha",
		desc: "Raises holder's Defense and Speed by 1 stage when at 1/4 max HP or less. After 5 turns, the holder's stat stages gained from its Sandygast Mocha are reverted and the holder moves last among Pokemon using the same or greater priority move for 2 turns. Single use.",
		shortDesc: "+1 Def and Speed at 1/4 max HP for 5 turns, -0.1 priority afterwards.",
	},
	volatilespray: {
		name: "Volatile Spray",
		shortDesc: "Holder's Irritant Weathergies last 8 turns instead of 5.",
	},
	weatherballoon: {
		name: "Weather Balloon",
		shortDesc: "Holder's Climate Weathergies last 8 turns instead of 5.",
	},
	weathervane: {
		name: "Weather Vane",
	...
	whirligig: {
		name: "Whirligig",
		desc: "If held by a Castform, this item changes its forme to Castform-Whirly. It remains in this form throughout the entire battle.",
		shortDesc: "If held by a Castform, this item changes its forme to Castform-Whirly.",
	},
	worcanecoldbrew: {
		name: "Worcane Cold Brew",
		desc: "Raises holder's Attack and Speed by 1 stage when at 1/4 max HP or less. After 5 turns, the holder's stat stages gained from its Worcane Cold Brew are reverted and the holder moves last among Pokemon using the same or greater priority move for 2 turns. Single use.",
