export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	alluringvoice: {
		name: "Lockstimme",
		desc: "Hat eine Chance von 100 %, das Ziel zu verwirren, wenn einer seiner Statuswerte in dieser Runde erhöht wurde.", // NEEDS QC
	...
	armthrust: {
		...
		desc: "Trifft zwei- bis fünfmal. Trifft mit einer Chance von 35 % zwei- oder dreimal und mit einer Chance von 15 % vier- oder fünfmal. Zerbricht einer der Treffer den Delegator des Ziels, erleidet es den Schaden der restlichen Treffer. Hat der Anwender die Fähigkeit Wertelink, trifft diese Attacke immer fünfmal. Trägt der Anwender einen Gezinkten Würfel, trifft diese Attacke 4- oder 5-mal.", // NEEDS QC
	...
	assist: {
		...
		gen7: {
			desc: "Setzt eine zufällig gewählte Attacke ein, die ein Teammitglied kennt. Kann nicht Zuschuss, Bunker, Schnabelkanone, Rülpser, Offerte, Sprungfeder, Ehrentag, Geschwätz, Überkopfwurf, Imitator, Konter, Bezirzer, Abgangsbund, Scanner, Schaufler, Taucher, Drachenrute, Ausdauer, Offenlegung, Fliegen, Power-Punch, Spotlight, Rechte Hand, Händchenhalten, Königsschild, Tatami-Schild, Egotrip, Metronom, Mimikry, Spiegelcape, Spiegeltrick, Natur-Kraft, Phantomkraft, Schutzschild, Wutpulver, Brüller, Schemenkraft, Panzerfalle, Nachahmer, Freier Fall, Schlafrede, Übernahme, Schutzstacheln, Rampenlicht, Verzweifler, Wechseldich, Raub, Wandler, Trickbetrug, Wirbelwind oder eine Z-Attacke wählen.", // NEEDS QC
		},
		gen6: {
	...
	auroraveil: {
		...
		desc: "5 Runden lang erleiden der Anwender und sein Team 0,5-fachen Schaden durch physische und spezielle Angriffe, bzw. 0,66-fachen in Doppelkämpfen; der Schaden wird durch Reflektor oder Lichtschild nicht weiter verringert. Volltreffer ignorieren diesen Schutz. Der Effekt endet für die Seite des Anwenders, wenn er oder ein Mitstreiter von Durchbruch, Psychobeißer oder Auflockern getroffen wird. Durchbruch und Psychobeißer entfernen den Effekt vor der Schadensberechnung. Hält 8 Runden an, wenn der Anwender ein Lichtlehm trägt. Schlägt fehl, wenn es nicht schneit.", // NEEDS QC
		shortDesc: "5 Runden: halber Schaden fürs Team. Nur bei Schnee.", // NEEDS QC
		gen8: {
			desc: "5 Runden lang erleiden der Anwender und sein Team 0,5-fachen Schaden durch physische und spezielle Angriffe, bzw. 0,66-fachen in Doppelkämpfen; der Schaden wird durch Reflektor oder Lichtschild nicht weiter verringert. Volltreffer ignorieren diesen Schutz. Der Effekt endet für die Seite des Anwenders, wenn er oder ein Mitstreiter von Durchbruch, Psychobeißer oder Auflockern getroffen wird. Durchbruch und Psychobeißer entfernen den Effekt vor der Schadensberechnung. Hält 8 Runden an, wenn der Anwender ein Lichtlehm trägt. Schlägt fehl, wenn es nicht hagelt.", // NEEDS QC
	...
	batonpass: {
		...
		desc: "Der Anwender wird gegen ein anderes Pokémon seines Teams ausgewechselt. Das gewählte Pokémon erbt die Statusveränderungen des Anwenders sowie die Effekte von Verwirrung, Wasserring, Fluch, Drachenschrei, Itemsperre, Energiefokus, Magensäfte, Heilblockade, Verwurzler, Egelsamen, Zielschuss (Willensleser), Magnetflug, Abgesang, Krafttrick und Telekinese sowie einen Delegator mit seinen verbleibenden KP. Der Effekt von Magensäfte wird nicht übertragen, wenn der Nachfolger eine Fähigkeit hat, die nicht beeinflusst werden kann.", // NEEDS QC
	...
	belch: {
		...
		champions: {
			desc: "Schlägt fehl, wenn der Anwender keine Beere gegessen hat – die getragene, eine mit Käferbiss oder Pflücker gestohlene und gegessene oder eine mit Schleuder auf ihn geworfene. Das Verzehren einer Beere durch Beerenkräfte zählt nicht.", // NEEDS QC
			shortDesc: "Schlägt fehl, wenn der Anwender keine Beere aß.", // NEEDS QC
		},
	},
	bellydrum: {
		name: "Bauchtrommel",
	...
	bide: {
		...
		gen2: {
			...
			shortDesc: "Wartet 2-3 Runden, gibt 2× erlittenen Schaden zurück.", // NEEDS QC
		},
		gen1: {
	...
	bodypress: {
		...
		shortDesc: "Greift mit der Verteidigung statt des Angriffs an.", // NEEDS QC
	},
	bodyslam: {
		name: "Bodyslam",
	...
	brickbreak: {
		...
		shortDesc: "Zerstört Barrieren, außer das Ziel ist immun.", // NEEDS QC
		gen6: {
		...
		gen4: {
			...
			shortDesc: "Zerstört Barrieren, selbst wenn das Ziel immun ist.", // NEEDS QC
		},
		gen3: {
	...
	burningjealousy: {
		...
		desc: "Hat eine Chance von 100 %, das Ziel zu verbrennen, wenn einer seiner Statuswerte in dieser Runde erhöht wurde.", // NEEDS QC
	...
	charge: {
		...
		gen8: {
			...
			shortDesc: "+1 Sp.-Vert. Nächste Elektro-Attacke mit 2× Stärke.", // NEEDS QC
		},
		gen3: {
			desc: "Setzt der Anwender in der nächsten Runde einen Angriff vom Typ Elektro ein, wird dessen Stärke verdoppelt.", // NEEDS QC
			shortDesc: "Nächste Elektro-Attacke des Anwenders: 2× Stärke.", // NEEDS QC
		},
	...
	collisioncourse: {
		...
		shortDesc: "Schaden ×1,3333, wenn sehr effektiv.", // NEEDS QC
	},
	combattorque: {
		name: "Raufturbo",
		desc: "Hat eine Chance von 30 %, das Ziel zu paralysieren.", // NEEDS QC
	...
	comeuppance: {
		...
		shortDesc: "Wird er getroffen, zahlt er 1,5× zurück.", // NEEDS QC
	},
	confide: {
	...
	conversion2: {
		name: "Umwandlung 2", // renamed in SV (SwSh: Umwandlung2)
		...
		shortDesc: "Wird resistent gegen die letzte Attacke des Ziels.", // NEEDS QC
		gen4: {
			...
			shortDesc: "Wird resistent gegen die zuletzt erlittene Attacke.", // NEEDS QC
		},
		gen3: {
		...
		gen2: {
			...
			shortDesc: "Wird resistent gegen die letzte Attacke des Gegners.", // NEEDS QC
		},
	},
	copycat: {
		name: "Imitator",
	...
	counter: {
		...
		gen1: {
			...
			shortDesc: "Gibt bei Normal-/Kampf-Attacken 2× Schaden zurück.", // NEEDS QC
		},
	},
	courtchange: {
		name: "Seitenwechsel",
	...
	defensecurl: {
		...
		desc: "Erhöht die Verteidigung des Anwenders um eine Stufe. Solange der Anwender im Kampf bleibt, wird die Stärke von Frostbeule und Walzer verdoppelt (dieser Effekt ist nicht kumulierbar).", // NEEDS QC
	...
	direclaw: {
		...
		champions: {
			desc: "Hat eine Chance von 30 %, das Ziel einzuschläfern, zu vergiften oder zu paralysieren.", // NEEDS QC
			shortDesc: "30 % Chance auf Schlaf, Gift oder Paralyse.", // NEEDS QC
		},
	},
	disable: {
		name: "Aussetzer",
	...
	earthquake: {
		...
		gen4: {
			...
			shortDesc: "Trifft alle Nachbarn. 2× Stärke gegen Schaufler.", // NEEDS QC
		},
		gen1: {
			desc: "Hat keinen zusätzlichen Effekt.", // NEEDS QC
			shortDesc: "Hat keinen zusätzlichen Effekt.", // NEEDS QC
		...
		gen2: {
			shortDesc: "2× Stärke gegen Schaufler.", // NEEDS QC
		},
	},
	echoedvoice: {
		name: "Widerhall",
	...
	encore: {
		...
		gen7: {
			desc: "In seinen nächsten 3 Runden muss das Ziel seine zuletzt eingesetzte Attacke wiederholen. Gehen die AP der Attacke aus, endet der Effekt. Schlägt fehl, wenn das Ziel bereits unter diesem Effekt steht, noch nicht gehandelt hat, die Attacke 0 AP hat oder die Attacke Zuschuss, Imitator, Zugabe, Egotrip, Metronom, Mimikry, Spiegeltrick, Natur-Kraft, Nachahmer, Schlafrede, Verzweifler, Wandler oder eine Z-Attacke ist. Mit Z-Kraft verstärkte Attacken können während des Effekts weiterhin gewählt und eingesetzt werden.", // NEEDS QC
		},
		gen6: {
	...
	expandingforce: {
		...
		shortDesc: "Im Psychofeld: ×1,5 und trifft beide Gegner.", // NEEDS QC
	},
	explosion: {
		name: "Explosion",
		...
		gen4: {
			...
			shortDesc: "Halbiert Vert. des Ziels. Der Anwender wird besiegt.", // NEEDS QC
		},
		gen3: {
	...
	fakeout: {
		...
		champions: {
			desc: "Hat eine Chance von 100 %, das Ziel zurückschrecken zu lassen. Diese Attacke kann nur in der ersten Runde des Anwenders auf dem Feld gewählt werden.", // NEEDS QC
		},
	},
	faketears: {
		name: "Trugträne",
	...
	feint: {
		...
		shortDesc: "Hebt Schutzschild, Scanner, Rapid-/Rundumschutz auf.", // NEEDS QC
		gen6: {
	...
	firstimpression: {
		...
		champions: {
			desc: "Diese Attacke kann nur in der ersten Runde des Anwenders auf dem Feld gewählt werden.", // NEEDS QC
		},
	},
	fishiousrend: {
		name: "Kiemenbiss",
	...
	focusenergy: {
		...
		gen1: {
			...
			shortDesc: "Viertelt die Volltrefferquote des Anwenders.", // NEEDS QC
		},
	...
	freezedry: {
		...
		champions: {
			desc: "Die Effektivität dieser Attacke gegen den Typ Wasser wird zu sehr effektiv, unabhängig vom Typ der Attacke.", // NEEDS QC
			shortDesc: "Sehr effektiv gegen Wasser.", // NEEDS QC
		},
	},
	freezeshock: {
		name: "Frostvolt",
	...
	gmaxcannonade: {
		...
		start: "  {PARTY:capitalize} sind von einem Wasserwirbel umgeben!", // adapted from SwSh de_common:7786
	...
	gmaxsteelsurge: {
		...
		end: "  Die Stahlsplitter um {PARTY} sind verschwunden!", // adapted from SwSh de_common:7718
	...
	gmaxstunshock: {
		...
		shortDesc: "Stärke je nach Basis-Attacke. Gegner: Gift/Paralyse.", // NEEDS QC
	},
	gmaxsweetness: {
	...
	gmaxvinelash: {
		...
		start: "  {PARTY:capitalize} sind heftigen Peitschenhieben ausgesetzt!", // adapted from SwSh de_common:7784
	...
	gmaxvolcalith: {
		...
		start: "  {PARTY:capitalize} sind von Steinbrocken umgeben!", // adapted from SwSh de_common:7722
	...
	gmaxwildfire: {
		...
		start: "  {PARTY:capitalize} wurden in Flammen gehüllt!", // adapted from SwSh de_common:7720
	...
	gravapple: {
		...
		shortDesc: "100 % Chance auf -1 Vert. Bei Erdanziehung ×1,5.", // NEEDS QC
	},
	gravity: {
		name: "Erdanziehung",
		...
		shortDesc: "5 Runden: keine Boden-Immunität, Gen. ×1,67.", // NEEDS QC
		gen7: {
	...
	growth: {
		...
		gen7: {
			desc: "Erhöht den Angriff und den Spezial-Angriff des Anwenders um je eine Stufe. Ist das Wetter Sonne oder Gleißende Sonne, steigen sie um je 2 Stufen.", // NEEDS QC
		},
		gen5: {
	...
	gust: {
		...
		shortDesc: "2× Stärke bei Sprungfeder, Fliegen, Freier Fall.", // NEEDS QC
		gen4: {
			desc: "Die Stärke wird verdoppelt, wenn das Ziel Sprungfeder oder Fliegen einsetzt.", // NEEDS QC
			shortDesc: "2× Stärke gegen Sprungfeder und Fliegen.", // NEEDS QC
		},
		gen2: {
			desc: "Die Stärke wird verdoppelt, wenn das Ziel Fliegen einsetzt.", // NEEDS QC
			shortDesc: "2× Stärke gegen Fliegen.", // NEEDS QC
		},
		gen1: {
			desc: "Hat keinen zusätzlichen Effekt.", // NEEDS QC
			shortDesc: "Hat keinen zusätzlichen Effekt.", // NEEDS QC
	...
	haze: {
		...
		shortDesc: "Hebt alle Statusveränderungen auf.", // NEEDS QC
		gen1: {
			desc: "Setzt die Statusveränderungen beider Pokémon auf 0 zurück und hebt die Wertesenkungen durch Verbrennung und Paralyse auf. Setzt Toxin-Zähler auf 0 zurück und entfernt bei beiden Pokémon die Effekte von Verwirrung, Aussetzer, Energiefokus, Egelsamen, Lichtschild, Weißnebel und Reflektor. Entfernt das Statusproblem des Gegners.", // NEEDS QC
	...
	helpinghand: {
		...
		shortDesc: "Die Attacke eines Partners wird ×1,5 verstärkt.", // NEEDS QC
	...
	hiddenpower: {
		name: "Kraftreserve",
		// Official flavor text: "Diese Attacke kann nicht eingesetzt werden. Du solltest dein Pokémon sie vergessen lassen. Beachte aber, dass es sich danach nicht wieder an sie erinnern kann."
		desc: "Der Typ dieser Attacke hängt von den DVs des Anwenders ab und kann jeder Typ außer Fee und Normal sein.", // NEEDS QC
		...
		gen5: {
			...
			shortDesc: "Stärke und Typ hängen von den DVs ab.", // NEEDS QC
		},
	},
	hiddenpowerbug: {
	...
	highjumpkick: {
		...
		shortDesc: "Verfehlt sie, kostet es die Hälfte der max. KP.", // NEEDS QC
		gen4: {
	...
	hydrosteam: {
		...
		shortDesc: "Bei Sonne ×1,5 statt halbiert.", // NEEDS QC
	},
	hydrovortex: {
	...
	hyperspacefury: {
		...
		shortDesc: "Nur Hoopa (Entfesselt): -1 Vert.; bricht Schutz.", // NEEDS QC
		gen6: {
	...
	knockoff: {
		...
		shortDesc: "×1,5 gegen Item-Träger. Entfernt das Item.", // NEEDS QC
		champions: {
			desc: "Die Stärke wird mit 1,5 multipliziert, wenn das Ziel ein Item trägt, und das Ziel verliert sein Item. Ein Ziel mit der Fähigkeit Klebekörper verliert sein Item nicht, solange es nicht kampfunfähig ist. Diese Attacke wird weder stärker noch entfernt sie das Item, wenn es ein Mega-Stein ist, der von der Art getragen wird, die sich damit mega-entwickeln kann. Durch diese Attacke verlorene Items können nicht mit Aufbereitung oder der Fähigkeit Reiche Ernte zurückgeholt werden.", // NEEDS QC
		},
		gen8: {
	...
	lashout: {
		...
		desc: "Die Stärke wird verdoppelt, wenn einer der Statuswerte des Anwenders in dieser Runde gesenkt wurde.", // NEEDS QC
	...
	lightscreen: {
		...
		gen1: {
			...
			shortDesc: "Solange aktiv: 2× Spezial bei erlittenem Schaden.", // NEEDS QC
			start: "  {POKEMON} ist gegen SPEZIAL-ATTACKEN immun!",
		},

		start: "  Lichtschild stärkt {TEAM} gegen Spezial-Attacken!",
		end: "  {TEAM:capitalize} verlieren den Schutz von Lichtschild!", // NEEDS QC; official (Champions BTL_STRID_STD_HikariNoKabeOff): "Lichtschild auf deiner Seite hört auf zu wirken!" — not reproducible from {TEAM}
	},
	...
	luckychant: {
		...
		end: "  Beschwörung von {TEAM} hört auf zu wirken!", // adapted from SV de_common:8691 // NEEDS QC; official (SV de_common:8691): "Beschwörung deines Teams hört auf zu wirken!" — not reproducible from {TEAM}
	},
	luminacrash: {
		name: "Lichteinschlag",
		desc: "Hat eine Chance von 100 %, die Spezial-Verteidigung des Ziels um 2 Stufen zu senken.", // NEEDS QC
	...
	magnitude: {
		...
		shortDesc: "Trifft Nachbarn. Zufällige Stärke; 2× gegen Schaufler.", // NEEDS QC
		gen4: {
	...
	makeitrain: {
		...
		champions: {
			desc: "Senkt den Spezial-Angriff des Anwenders um 2 Stufen.", // NEEDS QC
			shortDesc: "-2 Sp.-Ang. des Anwenders. Trifft die Gegner.", // NEEDS QC
		},
	...
	matchagotcha: {
		...
		shortDesc: "20 % Verbrennung. Heilt 50 % Schaden. Taut Gegner auf.", // NEEDS QC
	},
	maxairstream: {
		name: "Dyna-Düse",
	...
	mefirst: {
		...
		shortDesc: "Kopiert Attacke des Ziels ×1,5; nur wenn schneller.", // NEEDS QC
		gen8: {
	...
	metronome: {
		...
		gen8bdsp: {
			desc: "Setzt eine zufällig gewählte Attacke ein, außer Galanterie, Rülpser, Body Press, Geschwätz, Imitator, Konter, Bezirzer, Abgangsbund, Scanner, Zenitstürmer, Ausdauer, Offenlegung, Power-Punch, Spotlight, Rechte Hand, Lebenstropfen, Metronom, Mimikry, Spiegelcape, Natur-Kraft, Ursprungswoge, Abgrundsklinge, Schutzschild, Verzögerung, Rapidschutz, Wutpulver, Nachahmer, Schlafrede, Standpauke, Schnarcher, Schutzstacheln, Verzweifler, Wechseldich, Raub, Wandler, Trickbetrug oder Rundumschutz.", // NEEDS QC
		},
		gen7letsgo: {
			desc: "Setzt eine zufällig gewählte Attacke aus der 1. Generation ein, außer Konter, Mimikry, Spiegeltrick, Verzweifler oder Wandler.", // NEEDS QC
			shortDesc: "Setzt eine zufällige Attacke der 1. Generation ein.", // NEEDS QC
		},
		gen8: {
	...
	mindreader: {
		...
		shortDesc: "Seine nächste Attacke verfehlt das Ziel nicht.", // NEEDS QC
		gen4: {
			desc: "Bis zum Ende der nächsten Runde kann das Ziel den Attacken des Anwenders nicht ausweichen, selbst mitten in einer Zwei-Runden-Attacke. Wird dieser Effekt gegen das Ziel gestartet, enden dieser und der Effekt von Zielschuss für jedes andere Pokémon gegen dieses Ziel. Verlässt das Ziel das Feld mit Stafette, bleibt der Nachfolger unter diesem Effekt. Verlässt der Anwender das Feld mit Stafette, wird der Effekt für den Nachfolger gegen dasselbe Ziel neu gestartet. Der Effekt endet, wenn der Anwender oder das Ziel das Feld verlässt.", // NEEDS QC
		},
		gen2: {
			desc: "Die nächste Genauigkeitsprüfung gegen das Ziel gelingt. Das Ziel weicht Erdbeben, Geofissur und Intensität dennoch aus, wenn es Fliegen einsetzt. Verlässt das Ziel das Feld mit Stafette, bleibt der Nachfolger unter diesem Effekt. Dieser Effekt endet, wenn das Ziel das Feld verlässt oder eine Genauigkeitsprüfung gegen es durchgeführt wird.", // NEEDS QC
			shortDesc: "Die nächste Attacke verfehlt das Ziel nicht.", // NEEDS QC
	...
	mirrorshot: {
		...
		shortDesc: "30 % Chance auf -1 Genauigkeit des Ziels.", // NEEDS QC
	},
	mist: {
		name: "Weißnebel",
		...
		shortDesc: "5 Runden: Schützt das Team vor Statussenkungen.", // NEEDS QC
		gen2: {
		...
		gen1: {
			...
			start: "  {POKEMON} ist eingenebelt!",
			block: "  Die Attacke schlug fehl!",
		},
	...
	mistyexplosion: {
		...
		shortDesc: "Wird besiegt. Im Nebelfeld: ×1,5 Stärke.", // NEEDS QC
	},
	mistyterrain: {
		name: "Nebelfeld",
	...
	moonblast: {
		...
		champions: {
			desc: "Hat eine Chance von 10 %, den Spezial-Angriff des Ziels um eine Stufe zu senken.", // NEEDS QC
			shortDesc: "10 % Chance auf -1 Sp.-Ang. des Ziels.", // NEEDS QC
		},
	},
	moongeistbeam: {
		name: "Schattenstrahl",
	...
	mudslap: {
		...
		shortDesc: "100 % Chance auf -1 Genauigkeit des Ziels.", // NEEDS QC
	},
	mudsport: {
		name: "Lehmsuhler",
		// Official flavor text: "Diese Attacke kann nicht eingesetzt werden. Du solltest dein Pokémon sie vergessen lassen. Beachte aber, dass es sich danach nicht wieder an sie erinnern kann."
	...
	nightdaze: {
		...
		shortDesc: "40 % Chance auf -1 Genauigkeit des Ziels.", // NEEDS QC
	},
	nightmare: {
		name: "Nachtmahr",
		// Official flavor text: "Diese Attacke kann nicht eingesetzt werden. Du solltest dein Pokémon sie vergessen lassen. Beachte aber, dass es sich danach nicht wieder an sie erinnern kann."
	...
	octazooka: {
		...
		desc: "Hat eine Chance von 50 %, die Genauigkeit des Ziels um eine Stufe zu senken.", // NEEDS QC
		shortDesc: "50 % Chance auf -1 Genauigkeit des Ziels.", // NEEDS QC
	},
	octolock: {
		name: "Octoklammer",
	...
	orderup: {
		...
		shortDesc: "Je Nigiragi-Form: +1 Ang., Vert. oder Init.", // NEEDS QC
	},
	originpulse: {
		name: "Ursprungswoge",
	...
	populationbomb: {
		name: "Mäuseplage",
		desc: "Trifft zehnmal. Diese Attacke prüft die Genauigkeit bei jedem Treffer, und der Angriff endet, wenn das Ziel einem ausweicht. Zerbricht einer der Treffer den Delegator des Ziels, erleidet es den Schaden der restlichen Treffer. Hat der Anwender die Fähigkeit Wertelink, trifft diese Attacke immer zehnmal. Trägt der Anwender einen Gezinkten Würfel, trifft sie zufällig vier- bis zehnmal, ohne die Genauigkeit zwischen den Treffern zu prüfen.", // NEEDS QC
	...
	psyblade: {
		...
		shortDesc: "Im Elektrofeld: ×1,5 Stärke.", // NEEDS QC
	},
	psychic: {
		name: "Psychokinese",
	...
	psywave: {
		...
		gen2: {
			...
			shortDesc: "Zufälliger Schaden von 1 bis (Level × 1,5 − 1).", // NEEDS QC
		},
	},
	pulverizingpancake: {
	...
	punishment: {
		...
		shortDesc: "60 Stärke, +20 pro Statuswert-Erhöhung des Ziels.", // NEEDS QC
	},
	purify: {
		name: "Läuterung",
	...
	pursuit: {
		...
		gen3: {
			...
			shortDesc: "2× Stärke gegen das auswechselnde Ziel.", // NEEDS QC
		},
		gen2: {
			...
			shortDesc: "2× Stärke, wenn der Gegner auswechselt.", // NEEDS QC
		},
	...
	ragefist: {
		...
		champions: {
			desc: "Die Stärke beträgt 50 + (X × 50), wobei X die Gesamtzahl der Treffer durch schädigende Angriffe ist, die der Anwender im Kampf erlitten hat, selbst ohne KP-Verlust. X kann höchstens 6 betragen und wird auf 0 zurückgesetzt, wenn der Anwender das Feld verlässt. Jeder Treffer einer mehrfach treffenden Attacke zählt, Verwirrungsschaden jedoch nicht.", // NEEDS QC
			shortDesc: "+50 Stärke pro Treffer, max. 6. Reset bei Wechsel.", // NEEDS QC
		},
	},
	ragepowder: {
		name: "Wutpulver",
	...
	ragingbull: {
		name: "Rasender Stier",
		desc: "Verfehlt dieser Angriff nicht, enden die Effekte von Reflektor, Lichtschild und Auroraschleier auf der Seite des Ziels vor der Schadensberechnung. Ist die aktuelle Form des Anwenders ein Paldea-Tauros, ändert sich der Typ dieser Attacke entsprechend: Typ Kampf bei der Gefechtvariante, Typ Feuer bei der Flammenvariante und Typ Wasser bei der Flutenvariante.", // NEEDS QC
	...
	reflect: {
		...
		end: "  Reflektor von {TEAM} hört auf zu wirken!", // adapted from SV de_common:8667
	},
	reflecttype: {
		name: "Typenspiegel",
	...
	revenge: {
		...
		gen3: {
			...
			shortDesc: "2× Schaden, wenn der Anwender getroffen wurde.", // NEEDS QC
		},
	},
	reversal: {
		name: "Gegenschlag",
	...
	safeguard: {
		...
		start: "  {TEAM:capitalize} werden von einem Schleier umhüllt!", // adapted from SV de_common:8677
	...
	saltcure: {
		...
		champions: {
			desc: "Fügt dem Ziel am Ende jeder Runde des Effekts Schaden in Höhe von 1/16 seiner maximalen KP zu (1/8 bei Zielen vom Typ Stahl oder Wasser), abgerundet. Der Effekt endet, wenn das Ziel den Kampf verlässt.", // NEEDS QC
			shortDesc: "1/16 der max. KP pro Runde; 1/8 bei Stahl/Wasser.", // NEEDS QC
		},

		start: "  {POKEMON} wurde eingepökelt!",
		damage: "  {POKEMON} wurde durch Pökelsalz verletzt!", // NEEDS QC
	},
	sandattack: {
		name: "Sandwirbel",
	...
	sandstorm: {
		...
		shortDesc: "5 Runden Sandsturm; Gestein: Sp.-Vert. ×1,5.", // NEEDS QC
		gen4: {
	...
	scaleshot: {
		...
		desc: "Trifft zwei- bis fünfmal. Senkt nach dem letzten Treffer die Verteidigung des Anwenders um eine Stufe und erhöht seine Initiative um eine Stufe. Trifft mit einer Chance von 35 % zwei- oder dreimal und mit einer Chance von 15 % vier- oder fünfmal. Zerbricht einer der Treffer den Delegator des Ziels, erleidet es den Schaden der restlichen Treffer. Hat der Anwender die Fähigkeit Wertelink, trifft diese Attacke immer fünfmal. Trägt der Anwender einen Gezinkten Würfel, trifft diese Attacke 4- oder 5-mal.", // NEEDS QC
	...
	sheercold: {
		...
		shortDesc: "K.O.-Attacke; nicht gegen Eis oder höheres Level.", // NEEDS QC
		gen6: {
			desc: "Fügt dem Ziel Schaden in Höhe seiner maximalen KP zu. Ignoriert Genauigkeits- und Fluchtwert-Modifikatoren. Die Genauigkeit dieses Angriffs beträgt (Level des Anwenders - Level des Ziels + 30) %, und er schlägt fehl, wenn das Ziel ein höheres Level hat. Pokémon mit der Fähigkeit Robustheit sind immun.", // NEEDS QC
			shortDesc: "K.O. mit einem Treffer. Nicht bei höherem Ziel-Level.", // NEEDS QC
		},
	...
	smellingsalts: {
		...
		gen3: {
			...
			shortDesc: "2× Schaden bei Paralyse; heilt sie.", // NEEDS QC
		},
	},
	smog: {
		name: "Smog",
	...
	snowscape: {
		...
		shortDesc: "5 Runden Schnee; Eis: Verteidigung ×1,5.", // NEEDS QC
	},
	soak: {
		name: "Überflutung",
	...
	solarbeam: {
		...
		gen8: {
			desc: "Dieser Angriff lädt sich in der ersten Runde auf und wird in der zweiten ausgeführt. Die Stärke wird halbiert, wenn das Wetter Hagelsturm, Strömender Regen, Regen oder Sandsturm ist und der Anwender keinen Allzweckschirm trägt. Trägt der Anwender ein Energiekraut oder ist das Wetter Gleißende Sonne oder Sonne, wird die Attacke in einer Runde ausgeführt. Trägt der Anwender einen Allzweckschirm und ist das Wetter Gleißende Sonne oder Sonne, benötigt die Attacke dennoch eine Runde zum Aufladen.", // NEEDS QC
		},
		gen7: {
	...
	spectralthief: {
		...
		shortDesc: "Stiehlt erst die Statuswert-Erhöhungen des Ziels.", // NEEDS QC
	...
	spikes: {
		...
		end: "  Die Stacheln, die um {TEAM} herumlagen, sind verschwunden!", // adapted from SV de_common:8695
	...
	stickyweb: {
		...
		end: "  Das Klebenetz um {TEAM} ist wieder verschwunden!", // adapted from SV de_common:8757
	...
	stuffcheeks: {
		...
		champions: {
			desc: "Schlägt fehl, wenn der Anwender keine Beere trägt. Der Anwender isst seine Beere und erhöht seine Verteidigung um 2 Stufen. Dieser Effekt wird weder durch die Fähigkeiten Tollpatsch oder Anspannung noch durch die Effekte von Itemsperre oder Magieraum verhindert.", // NEEDS QC
			shortDesc: "Schlägt ohne Beere fehl. Isst Beere; +2 Vert.", // NEEDS QC
		},
	},
	stunspore: {
		name: "Stachelspore",
	...
	supercellslam: {
		...
		shortDesc: "Verfehlt sie, kostet das die halben max. KP.", // NEEDS QC
	...
	surf: {
		...
		gen4: {
			...
			shortDesc: "Trifft alle Nachbarn. 2× Stärke gegen Taucher.", // NEEDS QC
		},
		gen2: {
			desc: "Hat keinen zusätzlichen Effekt.", // NEEDS QC
			shortDesc: "Hat keinen zusätzlichen Effekt.", // NEEDS QC
		...
		gen3: {
			shortDesc: "Trifft alle Gegner. 2× Stärke gegen Taucher.", // NEEDS QC
		},
	},
	surgingstrikes: {
		name: "Trefferschwall",
	...
	switcheroo: {
		...
		champions: {
			desc: "Der Anwender tauscht sein getragenes Item mit dem des Ziels. Schlägt fehl, wenn weder Anwender noch Ziel ein Item tragen oder wenn der Anwender versucht, einen Mega-Stein der Art zu geben oder abzunehmen, die sich damit mega-entwickeln kann. Das Ziel ist gegen diese Attacke immun, wenn es die Fähigkeit Klebekörper hat.", // NEEDS QC
		},
		gen8: {
	...
	syrupbomb: {
		...
		shortDesc: "3 Runden lang: -1 Init. des Ziels pro Runde.", // NEEDS QC
	...
	tailwind: {
		...
		end: "  Der Rückenwind für {TEAM} hat sich gelegt!", // adapted from SV de_common:8687
	},
	takedown: {
		name: "Bodycheck",
	...
	thief: {
		...
		gen6: {
			desc: "War dieser Angriff erfolgreich und ist der Anwender nicht kampfunfähig, stiehlt er das getragene Item des Ziels, sofern er selbst keines trägt. Ein Ziel mit der Fähigkeit Klebekörper verliert sein Item nicht, solange es nicht kampfunfähig ist. Das Item wird nicht gestohlen, wenn es ein Mega-Stein ist, der von der Art getragen wird, die sich damit mega-entwickeln kann, oder Blauer Edelstein, Roter Edelstein, Platinum-Orb, eine Tafel oder ein Modul, jeweils getragen von Kyogre, Groudon, Giratina, Arceus oder Genesect, oder wenn der Anwender eine dieser Arten ist und das Ziel das jeweilige Item trägt. Durch diese Attacke verlorene Items können nicht mit Aufbereitung oder der Fähigkeit Reiche Ernte zurückgeholt werden.", // NEEDS QC
		},
		gen5: {
			desc: "War dieser Angriff erfolgreich und ist der Anwender nicht kampfunfähig, stiehlt er das getragene Item des Ziels, sofern er selbst keines trägt. Ein Ziel mit der Fähigkeit Klebekörper verliert sein Item nicht, solange es nicht kampfunfähig ist. Das Item wird nicht gestohlen, wenn es ein Brief ist oder Platinum-Orb, eine Tafel oder ein Modul, jeweils getragen von Giratina, Arceus oder Genesect, oder wenn der Anwender eine dieser Arten ist und das Ziel das jeweilige Item trägt. Durch diese Attacke verlorene Items können nicht mit Aufbereitung oder der Fähigkeit Reiche Ernte zurückgeholt werden.", // NEEDS QC
		},
	...
	tickle: {
		...
		shortDesc: "-1 Angriff und Verteidigung des Ziels.", // NEEDS QC
	},
	tidyup: {
		name: "Aufräumen",
	...
	toxic: {
		...
		shortDesc: "Vergiftet schwer. Trifft von Gift-Typen immer.", // NEEDS QC
		gen5: {
	...
	toxicspikes: {
		...
		end: "  Die giftigen Stacheln, die um {TEAM} herumlagen, sind verschwunden!", // adapted from SV de_common:8699
	},
	toxicthread: {
		name: "Giftfaden",
		...
		champions: {
			desc: "Senkt die Initiative des Ziels um 2 Stufen und vergiftet es.", // NEEDS QC
			shortDesc: "-2 Initiative des Ziels und vergiftet es.", // NEEDS QC
		},
	},
	trailblaze: {
		name: "Wegbereiter",
	...
	transform: {
		...
		desc: "Der Anwender verwandelt sich in das Ziel. Kopiert werden die aktuellen Statuswerte, Statusveränderungen, Typen, Attacken, die Fähigkeit, das Gewicht, das Geschlecht und das Aussehen des Ziels. Level und KP des Anwenders bleiben gleich, und jede kopierte Attacke erhält nur 5 AP, mit einem Maximum von je 5 AP. Der Anwender kann seine Form nicht mehr wechseln, falls er dazu in der Lage wäre. Diese Attacke schlägt fehl, wenn sie einen Delegator trifft, wenn Anwender oder Ziel bereits verwandelt sind oder einer von beiden hinter einem Trugbild steht.", // NEEDS QC
		shortDesc: "Kopiert Werte, Attacken, Typen, Fähigkeit des Ziels.", // NEEDS QC
		gen4: {
	...
	waterpledge: {
		...
		start: "  Für {TEAM} erscheint ein Regenbogen am Himmel!", // adapted from SV de_common:8709
		end: "  Der Regenbogen für {TEAM} ist verschwunden!", // adapted from SV de_common:8711
	},
	waterpulse: {
		name: "Aquawelle",
	...
	weatherball: {
		...
		desc: "Die Stärke wird verdoppelt, wenn ein anderes Wetter als Luftströmungen aktiv ist, und der Typ dieser Attacke ändert sich entsprechend: Typ Eis bei Schnee, Typ Wasser bei Strömendem Regen oder Regen, Typ Gestein bei Sandsturm und Typ Feuer bei Gleißender Sonne oder Sonne. Trägt der Anwender einen Allzweckschirm und setzt diese Attacke bei Strömendem Regen, Regen, Gleißender Sonne oder Sonne ein, bleibt sie vom Typ Normal und ihre Stärke wird nicht verdoppelt.", // NEEDS QC
		...
		gen3: {
			...
			shortDesc: "Bei Wetter: 2× Schaden und passender Typ.", // NEEDS QC
		},
