export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
	...
	aerilate: {
		...
		gen6: {
			...
			shortDesc: "Normal-Attacken dieses Pokémon werden zum Typ Flug mit 1,3× Stärke.", // NEEDS QC
		},
	},
	aftermath: {
		name: "Finalschlag",
	...
	aurabreak: {
		...
		shortDesc: "Solange es im Kampf ist, wirken Dunkelaura und Feenaura mit 0,75×.", // NEEDS QC

		start: "  {POKEMON} kehrt die Wirkung aller Aura-Fähigkeiten um!",
	},
	auraguard: {
		name: "Aura-Abwehr",
		shortDesc: "Erleidet nur halben Schaden durch Kontaktattacken.", // NEEDS QC
	},
	baddreams: {
		name: "Alptraum",
	...
	battlebond: {
		...
		gen8: {
			...
			shortDesc: "Nach einem K.O.: wird zu Ash-Quajutsu, Wasser-Shuriken: 20 Stärke, trifft 3×.", // NEEDS QC
		},
	...
	blaze: {
		...
		gen4: {
			...
			shortDesc: "Bei 1/3 oder weniger der max. KP: 1,5× Stärke für Feuer-Attacken.", // NEEDS QC
		},
	},
	bulletproof: {
		name: "Kugelsicher",
	...
	dryskin: {
		...
		shortDesc: "Wasser heilt 1/4, Regen 1/8; Feuer trifft mit 1,25×, Sonne kostet 1/8 KP.", // NEEDS QC
		gen7: {
	...
	flashfire: {
		...
		shortDesc: "Feuer-Angriffe ×1,5 nach Treffer durch Feuer-Attacke; immun gegen Feuer.", // NEEDS QC
		gen4: {
	...
	flowergift: {
		...
		shortDesc: "Kinoso bei Sonne: Angriff und Sp.-Vert. ×1,5 für es und Mitstreiter.", // NEEDS QC
		gen7: {
		...
		gen4: {
			...
			shortDesc: "Bei Sonne: 1,5× Angriff und Sp.-Vert. für dieses Pokémon und Mitstreiter.", // NEEDS QC
		},
	},
	flowerveil: {
		name: "Blütenhülle",
	...
	gorillatactics: {
		...
		shortDesc: "Angriff ×1,5, aber es kann nur seine erste Attacke wählen.", // NEEDS QC
	},
	grasspelt: {
		name: "Pflanzenpelz",
	...
	guts: {
		...
		shortDesc: "Mit Statusproblem: Angriff ×1,5; ignoriert die Verbrennungs-Schwächung.", // NEEDS QC
	},
	hadronengine: {
		name: "Hadronen-Motor",
		shortDesc: "Erzeugt beim Einwechseln ein Elektrofeld; darauf Sp.-Ang. ×1,3333.", // NEEDS QC
	...
	healer: {
		...
		champions: {
			desc: "Es besteht eine Chance von 50 %, dass das Statusproblem des Mitstreiters dieses Pokémon am Ende jeder Runde geheilt wird.", // NEEDS QC
			shortDesc: "50 % Chance, das Statusproblem des Mitstreiters pro Runde zu heilen.", // NEEDS QC
		},
		gen6: {
	...
	hustle: {
		...
		shortDesc: "Sein Angriff ist ×1,5, die Genauigkeit physischer Angriffe aber ×0,8.", // NEEDS QC
	},
	hydration: {
		name: "Hydration",
	...
	klutz: {
		...
		desc: "Das getragene Item dieses Pokémon hat keine Wirkung. Dieses Pokémon kann Schleuder nicht erfolgreich einsetzen. Machoschiene, Machtkette, Machtband, Machtgurt, Machtreif, Machtlinse und Machtgewicht behalten ihre Wirkung.", // NEEDS QC
		shortDesc: "Sein Item ist wirkungslos (außer Machoschiene). Schleuder unbrauchbar.", // NEEDS QC
	},
	leafguard: {
		name: "Floraschild",
	...
	minus: {
		...
		shortDesc: "Hat ein Mitstreiter diese Fähigkeit oder Plus: Sp.-Ang. ×1,5.", // NEEDS QC
		gen4: {
	...
	orichalcumpulse: {
		...
		shortDesc: "Erzeugt beim Einwechseln Sonne; bei Sonne Angriff ×1,3333.", // NEEDS QC
	...
	overgrow: {
		...
		gen4: {
			...
			shortDesc: "Bei 1/3 oder weniger der max. KP: 1,5× Stärke für Pflanzen-Attacken.", // NEEDS QC
		},
	},
	owntempo: {
		name: "Tempomacher",
	...
	pixilate: {
		...
		gen6: {
			...
			shortDesc: "Normal-Attacken dieses Pokémon werden zum Typ Fee mit 1,3× Stärke.", // NEEDS QC
		},
	},
	plus: {
		name: "Plus",
		...
		shortDesc: "Hat ein Mitstreiter diese Fähigkeit oder Minus: Sp.-Ang. ×1,5.", // NEEDS QC
		gen4: {
	...
	protosynthesis: {
		...
		shortDesc: "Bei Sonne oder mit Energiekapsel: höchster Wert ×1,3 (×1,5 bei Init.).", // NEEDS QC
	...
	quarkdrive: {
		...
		shortDesc: "Bei Elektrofeld oder mit Energiekapsel: höchster Wert ×1,3 (×1,5 bei Init.).", // NEEDS QC
	...
	quickfeet: {
		...
		shortDesc: "Mit Statusproblem: Initiative ×1,5; ignoriert die Paralyse-Halbierung.", // NEEDS QC
		gen6: {
	...
	refrigerate: {
		...
		gen6: {
			...
			shortDesc: "Normal-Attacken dieses Pokémon werden zum Typ Eis mit 1,3× Stärke.", // NEEDS QC
		},
	},
	regenerator: {
		name: "Belebekraft",
	...
	sandforce: {
		...
		shortDesc: "Boden-/Gesteins-/Stahl-Angriffe ×1,3 bei Sandsturm; immun gegen ihn.", // NEEDS QC
	},
	sandrush: {
		name: "Sandscharrer",
	...
	sandveil: {
		...
		shortDesc: "Bei Sandsturm ist sein Fluchtwert ×1,25; immun gegen ihn.", // NEEDS QC
	},
	sapsipper: {
		name: "Vegetarier",
	...
	snowcloak: {
		...
		gen8: {
			...
			shortDesc: "Bei Hagel: 1,25× Fluchtwert; immun gegen Hagel.", // NEEDS QC
		},
	},
	snowwarning: {
		name: "Hagelalarm",
	...
	solarpower: {
		...
		shortDesc: "Bei Sonne: Sp.-Ang. ×1,5, verliert aber 1/8 der max. KP pro Runde.", // NEEDS QC
		gen7: {
	...
	swarm: {
		...
		gen4: {
			...
			shortDesc: "Bei 1/3 oder weniger der max. KP: 1,5× Stärke für Käfer-Attacken.", // NEEDS QC
		},
	},
	sweetveil: {
		name: "Zuckerhülle",
	...
	technician: {
		...
		shortDesc: "Attacken mit 60 Stärke oder weniger: ×1,5, auch Verzweifler.", // NEEDS QC
		gen4: {
			...
			shortDesc: "Attacken mit 60 oder weniger Stärke: 1,5× Stärke, außer Verzweifler.", // NEEDS QC
		},
	},
	telepathy: {
		name: "Telepathie",
	...
	torrent: {
		...
		gen4: {
			...
			shortDesc: "Bei 1/3 oder weniger der max. KP: 1,5× Stärke für Wasser-Attacken.", // NEEDS QC
		},
	},
	toughclaws: {
		name: "Krallenwucht",
	...
	transistor: {
		...
		gen8: {
			shortDesc: "1,5× Offensivwert beim Einsatz von Elektro-Attacken.", // NEEDS QC
		},
	},
	triage: {
		name: "Heilwandel",
