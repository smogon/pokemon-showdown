...
export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
	...
	auraguard: {
		...
		shortDesc: "Recibe la mitad de daño de los movimientos de contacto.", // NEEDS QC
	},
	baddreams: {
		name: "Mal Sueño",
	...
	desolateland: {
		...
		shortDesc: "Al entrar, empieza una sol abrasador que dura mientras la habilidad esté activa.", // NEEDS QC
	},
	disguise: {
		name: "Disfraz",
	...
	healer: {
		...
		champions: {
			desc: "Al final de cada turno, hay un 50% de probabilidad de curar el problema de estado de un aliado.", // NEEDS QC
			shortDesc: "50% de curar el estado de un aliado al final de cada turno.", // NEEDS QC
		},
		gen6: {
	...
	klutz: {
		...
		desc: "El objeto que lleva este Pokémon no tiene efecto. No puede usar Lanzamiento. Brazal Firme, Tobillera Recia, Banda Recia, Cinto Recio, Brazal Recio, Lente Recia, Pesa Recia conservan su efecto.", // NEEDS QC
