...
export const MovesText: { [id: IDEntry]: MoveText } = {
	...
	acid: {
		...
		shortDesc: "10% de bajar 1 nivel la Def. Esp. de los rivales.", // NEEDS QC
		gen3: {
	...
	acupressure: {
		...
		shortDesc: "+2 a una característica al azar suya o de un aliado.", // NEEDS QC
		gen4: {
	...
	airslash: {
		...
		desc: "30% de probabilidad de amedrentar al objetivo.", // NEEDS QC
		shortDesc: "30% de amedrentar al objetivo.", // NEEDS QC
	},
	alloutpummeling: {
	...
	auroraveil: {
		...
		start: "  ¡Velo Aurora ha aumentado la resistencia {TEAM:de} ante los ataques físicos y especiales!",
	...
	belch: {
		...
		champions: {
			desc: "Falla si el usuario no ha comido una baya: una que llevara, una robada y comida con Picadura o Picoteo, o una lanzada con Lanzamiento. Consumir una baya con Don Natural no cuenta.", // NEEDS QC
			shortDesc: "Falla si el usuario no ha comido una baya.", // NEEDS QC
		},
	},
	bellydrum: {
		name: "Tambor",
	...
	bite: {
		...
		shortDesc: "30% de amedrentar al objetivo.", // NEEDS QC
		gen1: {
			desc: "10% de probabilidad de amedrentar al objetivo.", // NEEDS QC
			shortDesc: "10% de amedrentar al objetivo.", // NEEDS QC
		},
	},
	bitterblade: {
		name: "Espada Lamento",
	...
	brickbreak: {
		...
		activate: "  ¡{POKEMON} ha destrozado las protecciones {TEAM:de}!", // NEEDS QC
	},
	brine: {
		name: "Salmuera",
	...
	counter: {
		...
		gen1: {
			...
			shortDesc: "Devuelve 2× el daño de ataques Normal/Lucha.", // NEEDS QC
		},
	},
	courtchange: {
	...
	covet: {
		...
		desc: "Si acierta y el usuario no se ha debilitado, roba el objeto del objetivo si él no lleva ninguno. Un objetivo con la habilidad Viscosidad no pierde su objeto si no se ha debilitado. El objeto no se roba si es Prisma Azul, Prisma Rojo, Gran Diamansfera, Gran Lustresfera, Gran Griseosfera, una tabla, un cartucho, un disco, Espada Oxidada, Escudo Oxidado, Energía Potenciadora o una máscara llevados, respectivamente, por Kyogre, Groudon, Dialga, Palkia, Giratina, Arceus, Genesect, Silvally, Zacian, Zamazenta, un Pokémon Paradoja u Ogerpon, ni si el usuario es una de esas especies y el objetivo lleva el objeto correspondiente. Aquí, los Pokémon Paradoja son todas las especies con las habilidades Paleosíntesis y Carga Cuark, salvo Flamariete, Electrofuria, Ferromole, Ferrotesta. Los objetos perdidos así no pueden recuperarse con Reciclaje ni la habilidad Cosecha.", // NEEDS QC
		shortDesc: "Si no lleva objeto, roba el del objetivo.", // NEEDS QC
		champions: {
			desc: "Si acierta y el usuario no lleva objeto, roba el objeto del objetivo. Un objetivo con la habilidad Viscosidad no pierde su objeto si no se ha debilitado. El objeto no se roba si es una megapiedra y el usuario o el objetivo es la especie que puede megaevolucionar con ella. Los objetos perdidos así no pueden recuperarse con Reciclaje ni la habilidad Cosecha.", // NEEDS QC
		},
		gen8: {
	...
	darkpulse: {
		...
		desc: "20% de probabilidad de amedrentar al objetivo.", // NEEDS QC
		shortDesc: "20% de amedrentar al objetivo.", // NEEDS QC
	},
	darkvoid: {
		name: "Brecha Negra",
	...
	direclaw: {
		...
		champions: {
			desc: "30% de probabilidad de dormir, envenenar o paralizar al objetivo.", // NEEDS QC
			shortDesc: "30% de dormir, envenenar o paralizar.", // NEEDS QC
		},
	},
	disable: {
		name: "Anulación",
	...
	doodle: {
		...
		shortDesc: "Usuario y aliado copian la habilidad del objetivo.", // NEEDS QC
	},
	doomdesire: {
		name: "Deseo Oculto",
	...
	doubleironbash: {
		...
		desc: "Golpea 2 veces. Si el primer golpe rompe el sustituto del objetivo, el segundo daña al Pokémon. Cada golpe tiene un 30% de probabilidad de amedrentar al objetivo.", // NEEDS QC
		shortDesc: "Golpea 2 veces. 30% de amedrentar.", // NEEDS QC
	},
	doublekick: {
		name: "Doble Patada",
	...
	dragonrush: {
		...
		desc: "20% de probabilidad de amedrentar al objetivo. El daño se duplica y no se comprueba la precisión si el objetivo usó Reducción desde que entró en combate.", // NEEDS QC
		shortDesc: "20% de amedrentar al objetivo.", // NEEDS QC
		gen5: {
			desc: "20% de probabilidad de amedrentar al objetivo.", // NEEDS QC
		},
	...
	fakeout: {
		...
		desc: "100% de probabilidad de amedrentar al objetivo. Falla si no es el primer turno del usuario en combate.", // NEEDS QC
		shortDesc: "Actúa primero y amedrenta. Solo el primer turno.", // NEEDS QC
		champions: {
			desc: "100% de probabilidad de amedrentar al objetivo. No puede seleccionarse si no es el primer turno del usuario en combate.", // NEEDS QC
		},
	},
	faketears: {
		name: "Llanto Falso",
	...
	feint: {
		...
		shortDesc: "Anula Detección, Protección, Anticipo y Vasta Guardia.", // NEEDS QC
		gen6: {
	...
	fierywrath: {
		...
		desc: "20% de probabilidad de amedrentar al objetivo.", // NEEDS QC
		shortDesc: "20% de amedrentar a los rivales.", // NEEDS QC
	},
	filletaway: {
		name: "Deslome",
	...
	firefang: {
		...
		desc: "10% de probabilidad de quemar al objetivo y 10% de amedrentarlo.", // NEEDS QC
		shortDesc: "10% de quemar. 10% de amedrentar.", // NEEDS QC
		gen4: {
	...
	firepledge: {
		...
		shortDesc: "Combinado con otro voto tiene efectos extra.", // NEEDS QC
	...
	firstimpression: {
		...
		champions: {
			desc: "No puede seleccionarse si no es el primer turno del usuario en combate.", // NEEDS QC
		},
	},
	fishiousrend: {
		name: "Branquibocado",
	...
	followme: {
		...
		desc: "Hasta el final del turno, los ataques de un solo objetivo del bando rival se redirigen al usuario, antes de que puedan devolverse con Capa Mágica o la habilidad Espejo Mágico, o atraerse con Pararrayos o Colector. Falla si no es un combate doble o un Battle Royale. Se ignora mientras el usuario está bajo Caída Libre.", // NEEDS QC
	...
	foresight: {
		name: "Profecía",
		// Official flavor text: "Este movimiento no se puede usar, por lo que sería mejor olvidarlo, aunque eso implique que no se pueda recordar posteriormente."
		desc: "Mientras el objetivo siga en combate, su evasión se ignora en las comprobaciones de precisión si es mayor que 0, y los ataques de tipo Normal y Lucha pueden golpearlo aunque sea de tipo Fantasma. Falla si ya está afectado por este efecto o por Gran Ojo o Rastreo.", // NEEDS QC
	...
	freezedry: {
		...
		champions: {
			desc: "Su eficacia contra el tipo Agua pasa a ser supereficaz, sin importar el tipo del movimiento.", // NEEDS QC
			shortDesc: "Supereficaz contra Agua.", // NEEDS QC
		},
	},
	freezeshock: {
		name: "Rayo Gélido",
	...
	futuresight: {
		...
		gen2: {
			desc: "Dos turnos después de usarse, inflige daño sin tipo que no puede ser crítico. El daño se calcula contra el objetivo al usarse y se inflige al final del último turno al Pokémon que ocupe la posición original del objetivo. Falla si este movimiento ya está en curso en esa posición.", // NEEDS QC
		},

		start: "  ¡{POKEMON} ha previsto un ataque!",
		activate: "  ¡{TARGET} tomó el ataque de Premonición!", // Emerald es_msg:14164 "¡X tomó el ataque de Y!" (gen 3 only)
	},
	gastroacid: {
		name: "Bilis",
	...
	gmaxbefuddle: {
		name: "Gigaestupor",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, cada rival queda dormido, envenenado o paralizado (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Pot. según mov. base. Rivales: sueño/veneno/parálisis.", // NEEDS QC
	},
	gmaxcannonade: {
		name: "Gigacañonazo",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, durante 4 turnos los rivales que no sean de tipo Agua pierden 1/6 de sus PS máximos (redondeado hacia abajo) al final de cada turno, incluido el último.", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: -1/6 PS, 4 turnos.", // NEEDS QC

		start: "  ¡{TEAM:capitalize} se ve arrastrado por la corriente!", // SV es_common:9053 (bando→lado per Champions)
		damage: "  ¡{POKEMON} sufre al verse arrastrado por la corriente de Gigacañonazo!",
	},
	gmaxcentiferno: {
		name: "Gigacienfuegos",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, los rivales no pueden cambiarse durante 4 o 5 turnos (7 con Garra Garfio) y pierden 1/8 de sus PS máximos (1/6 con Banda Atadura, redondeado hacia abajo) cada turno (incluso tras un sustituto). Pueden cambiarse con Muda Concha o usando Relevo, Viraje, Última Palabra, Teletransporte, Ida y Vuelta, Voltiocambio. El efecto termina para un objetivo si deja el campo o usa con éxito Giro Rápido o Sustituto. No es acumulable ni se reinicia.", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: atados 4-5 turnos.", // NEEDS QC
	},
	gmaxchistrike: {
		name: "Gigapuñición",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, el índice de golpe crítico de los aliados sube 1 nivel (incluso tras un sustituto).", // NEEDS QC
	...
	gmaxcuddle: {
		name: "Gigaternura",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, cada rival queda enamorado (incluso tras un sustituto). No afecta a un objetivo del mismo sexo que el usuario, sin sexo o ya enamorado.", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: enamorados.", // NEEDS QC
	},
	gmaxdepletion: {
		name: "Gigadesgaste",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, el último movimiento usado de cada rival pierde 2 PP (incluso tras un sustituto).", // NEEDS QC
	...
	gmaxfinale: {
		name: "Gigacolofón",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, los aliados recuperan 1/6 de sus PS máximos (incluso tras un sustituto).", // NEEDS QC
	...
	gmaxfoamburst: {
		name: "Gigaespuma",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, la Velocidad de los rivales baja 2 niveles (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: -2 Velocidad.", // NEEDS QC
	},
	gmaxgoldrush: {
		name: "Gigamonedas",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, los rivales quedan confusos (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Potencia según el mov. base. Rivales: confusión.", // NEEDS QC
	},
	gmaxgravitas: {
		name: "Gigabóveda",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, se activa el efecto de Gravedad.", // NEEDS QC
	...
	gmaxmalodor: {
		...
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, los rivales quedan envenenados (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: envenenados.", // NEEDS QC
	},
	gmaxmeltdown: {
		name: "Gigafundido",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, cada rival queda bajo el efecto de Tormento (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: bajo Tormento.", // NEEDS QC
	},
	gmaxoneblow: {
		name: "Gigagolpe Brusco",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Atraviesa todas las protecciones, incluida Maxibarrera.", // NEEDS QC
	...
	gmaxreplenish: {
		name: "Gigarreciclaje",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, hay un 50% de probabilidad de que los aliados recuperen sus bayas (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Potencia según mov. base. 50% de recuperar las bayas.", // NEEDS QC
	},
	gmaxresonance: {
		name: "Gigamelodía",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, se activa Velo Aurora en el bando del usuario.", // NEEDS QC
	...
	gmaxsnooze: {
		name: "Gigasopor",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, hay un 50% de probabilidad de que el objetivo quede bajo el efecto de Bostezo (incluso tras un sustituto).", // NEEDS QC
	...
	gmaxsteelsurge: {
		...
		end: "  Las piezas de acero que rodeaban a {TEAM} han desaparecido.", // SV es_common:8985 (bando→lado per Champions)
	...
	gmaxstunshock: {
		name: "Gigadescarga",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, cada rival queda envenenado o paralizado (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: veneno o parálisis.", // NEEDS QC
	},
	gmaxsweetness: {
		name: "Giganéctar",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, se curan los problemas de estado de los aliados (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Potencia según mov. base. Aliados: estados curados.", // NEEDS QC
	},
	gmaxtartness: {
		name: "Gigacorrosión",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, la evasión de los rivales baja 1 nivel (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: -1 evasión.", // NEEDS QC
	},
	gmaxterror: {
		name: "Gigaaparición",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, los rivales no pueden cambiarse (incluso tras un sustituto). Pueden cambiarse con Muda Concha o usando Relevo, Viraje, Última Palabra, Teletransporte, Ida y Vuelta, Voltiocambio. El efecto termina si el usuario o el objetivo dejan el campo.", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: atrapados.", // NEEDS QC
	},
	gmaxvinelash: {
		name: "Gigalianas",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, durante 4 turnos los rivales que no sean de tipo Planta pierden 1/6 de sus PS máximos (redondeado hacia abajo) al final de cada turno, incluido el último.", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: -1/6 PS, 4 turnos.", // NEEDS QC

		start: "  ¡{TEAM:capitalize} se ve avasallado por violentos latigazos!", // SV es_common:9051 (bando→lado per Champions)
		damage: "  ¡Los violentos golpes de Gigalianas hieren a {POKEMON}!",
	},
	gmaxvolcalith: {
		name: "Gigarroca Ígnea",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, durante 4 turnos los rivales que no sean de tipo Roca pierden 1/6 de sus PS máximos (redondeado hacia abajo) al final de cada turno, incluido el último.", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: -1/6 PS, 4 turnos.", // NEEDS QC

		start: "  ¡{TEAM:capitalize} se ve rodeado por las rocas!", // SV es_common:8989 (bando→lado per Champions)
		damage: "  ¡Las piedras desprendidas por Gigarroca Ígnea han herido a {POKEMON}!",
	},
	gmaxvoltcrash: {
		name: "Gigatronada",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, los rivales quedan paralizados (incluso tras un sustituto).", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: paralizados.", // NEEDS QC
	},
	gmaxwildfire: {
		name: "Gigallamarada",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, durante 4 turnos los rivales que no sean de tipo Fuego pierden 1/6 de sus PS máximos (redondeado hacia abajo) al final de cada turno, incluido el último.", // NEEDS QC
		shortDesc: "Potencia según mov. base. Rivales: -1/6 PS, 4 turnos.", // NEEDS QC

		start: "  ¡{TEAM:capitalize} se ve rodeado por las llamas!", // SV es_common:8987 (bando→lado per Champions)
		damage: "  ¡El fuego de Gigallamarada ha quemado a {POKEMON}!",
	},
	gmaxwindrage: {
		name: "Gigahuracán",
		desc: "Su potencia es la del Maximovimiento del movimiento base. Si acierta, terminan los efectos de los campos eléctrico, de hierba, de niebla y psíquico; los de Reflejo, Pantalla de Luz, Velo Aurora, Velo Sagrado, Neblina, Gigatrampa Acero, Púas, Púas Tóxicas, Trampa Rocas, Red Viscosa en el bando del objetivo; y los de Gigatrampa Acero, Púas, Púas Tóxicas, Trampa Rocas, Red Viscosa en el del usuario.", // NEEDS QC
	...
	grasspledge: {
		...
		activate: "#waterpledge",
		start: "  ¡Ha aparecido un pantano alrededor {TEAM:de}!",
	...
	growth: {
		...
		desc: "Sube 1 nivel el Ataque y el Ataque Especial del usuario (2 niveles con sol o sol abrasador). Con Parasol Multiuso, solo sube 1 nivel aunque haga sol.", // NEEDS QC
	...
	guardswap: {
		...
		shortDesc: "Intercambia los cambios de Def. y Def. Esp.", // NEEDS QC
	},
	guillotine: {
		name: "Guillotina",
	...
	haze: {
		...
		shortDesc: "Elimina todos los cambios de características.", // NEEDS QC
		gen1: {
			desc: "Restablece a 0 los niveles de características de ambos Pokémon y elimina las reducciones debidas a quemadura y parálisis. Restablece a 0 los contadores de Tóxico y elimina los efectos de la confusión, Anulación, Foco Energía, Drenadoras, Pantalla de Luz, Neblina y Reflejo de ambos Pokémon. Elimina el problema de estado del rival.", // NEEDS QC
			shortDesc: "Elimina cambios de caract. Cura el estado rival.", // NEEDS QC
		},
	...
	hurricane: {
		...
		desc: "30% de probabilidad de confundir al objetivo. Puede golpear a objetivos usando Bote, Vuelo, Caída Libre o bajo el efecto de Caída Libre. No puede fallar si llueve o hay diluvio. Con sol o sol abrasador, su precisión es del 50%. Contra un objetivo con Parasol Multiuso, sigue siendo del 70%.", // NEEDS QC
	...
	icefang: {
		...
		desc: "10% de probabilidad de congelar al objetivo y 10% de amedrentarlo.", // NEEDS QC
		shortDesc: "10% de congelar. 10% de amedrentar.", // NEEDS QC
	},
	icehammer: {
		name: "Martillo Hielo",
	...
	laserfocus: {
		...
		shortDesc: "Sus golpes son críticos hasta el turno siguiente.", // NEEDS QC
	...
	lashout: {
		...
		shortDesc: "Potencia doble si le bajaron una caract. este turno.", // NEEDS QC
	},
	lastresort: {
		name: "Última Baza",
	...
	lightscreen: {
		...
		gen1: {
			...
			shortDesc: "Mientras está activo, Especial ×2 al recibir daño.", // NEEDS QC
			start: "  ¡{POKEMON} está protegido contra ataques especiales!",
		},

		start: "  ¡Pantalla de Luz ha aumentado la resistencia {TEAM:de} ante los ataques especiales!",
	...
	luckychant: {
		...
		start: "  ¡Conjuro protege {TEAM:a} de los golpes críticos!",
	...
	magneticflux: {
		...
		desc: "Sube 1 nivel la Defensa y la Defensa Especial del usuario y sus aliados con las habilidades Más o Menos.", // NEEDS QC
	...
	magnetrise: {
		...
		desc: "Durante 5 turnos, el usuario es inmune a los ataques de tipo Tierra y a los efectos de Púas, Púas Tóxicas, Red Viscosa y la habilidad Trampa Arena mientras siga en combate. Si usa Relevo, su reemplazo hereda el efecto. Arraigo, Antiaéreo, Mil Flechas y Bola Férrea tienen prioridad sobre este movimiento. Falla si el usuario ya tiene este efecto o los de Arraigo, Antiaéreo, Mil Flechas.", // NEEDS QC
		shortDesc: "5 turnos: el usuario es inmune al tipo Tierra.", // NEEDS QC
		gen5: {
			desc: "Durante 5 turnos, el usuario es inmune a los ataques de tipo Tierra y a los efectos de Púas, Púas Tóxicas y la habilidad Trampa Arena mientras siga en combate. Si usa Relevo, su reemplazo hereda el efecto. Arraigo, Antiaéreo y Bola Férrea tienen prioridad sobre este movimiento. Falla si el usuario ya tiene este efecto o los de Arraigo, Antiaéreo.", // NEEDS QC
		},
		gen4: {
			desc: "Durante 5 turnos, el usuario es inmune a los ataques de tipo Tierra y a los efectos de Púas, Púas Tóxicas y la habilidad Trampa Arena mientras siga en combate. Si usa Relevo, su reemplazo hereda el efecto. Arraigo y Bola Férrea tienen prioridad sobre este movimiento. Falla si el usuario ya tiene este efecto o el de Arraigo.", // NEEDS QC
		},
	...
	makeitrain: {
		...
		champions: {
			desc: "Baja 2 niveles el Ataque Especial del usuario.", // NEEDS QC
			shortDesc: "-2 At. Esp. del usuario. Golpea a los rivales.", // NEEDS QC
		},
	...
	meanlook: {
		...
		shortDesc: "Impide que el objetivo se cambie.", // NEEDS QC
		gen7: {
			desc: "Impide que el objetivo se cambie. Puede cambiarse igualmente si lleva Muda Concha o usa Relevo, Última Palabra, Ida y Vuelta, Voltiocambio. Si el objetivo deja el campo con Relevo, su reemplazo sigue atrapado. El efecto termina si el usuario deja el campo.", // NEEDS QC
		},
		gen5: {
			desc: "Impide que el objetivo se cambie. Puede cambiarse igualmente si lleva Muda Concha o usa Relevo, Ida y Vuelta, Voltiocambio. Si el objetivo deja el campo con Relevo, su reemplazo sigue atrapado. El efecto termina si el usuario deja el campo.", // NEEDS QC
		},
		gen4: {
			desc: "Impide que el objetivo se cambie. Puede cambiarse igualmente si lleva Muda Concha o usa Relevo, Ida y Vuelta. Si el objetivo deja el campo con Relevo, su reemplazo sigue atrapado. El efecto termina si el usuario deja el campo, salvo que use Relevo: en ese caso el objetivo sigue atrapado.", // NEEDS QC
		},
		gen3: {
			desc: "Impide que el objetivo se cambie. Puede cambiarse igualmente si usa Relevo. Si el objetivo deja el campo con Relevo, su reemplazo sigue atrapado. El efecto termina si el usuario deja el campo, salvo que use Relevo: en ese caso el objetivo sigue atrapado.", // NEEDS QC
		},
	},
	meditate: {
		name: "Meditación",
	...
	mindreader: {
		...
		shortDesc: "Su próximo movimiento no fallará contra el objetivo.", // NEEDS QC
		gen4: {
			desc: "Hasta el final del siguiente turno, el objetivo no puede evitar los movimientos del usuario, ni siquiera en medio de un movimiento de dos turnos. Cuando este efecto empieza contra el objetivo, este efecto y el de Fijar Blanco terminan para los demás Pokémon contra ese objetivo. Si el objetivo deja el campo con Relevo, su reemplazo sigue afectado. Si el usuario deja el campo con Relevo, el efecto se reinicia contra el mismo objetivo para su reemplazo. El efecto termina si el usuario o el objetivo dejan el campo.", // NEEDS QC
		},
		gen2: {
			desc: "El siguiente cálculo de precisión contra el objetivo acierta. El objetivo aún evita Terremoto, Fisura y Magnitud si está usando Vuelo. Si el objetivo deja el campo con Relevo, su reemplazo sigue afectado. El efecto termina cuando el objetivo deja el campo o se hace un cálculo de precisión contra él.", // NEEDS QC
			shortDesc: "El próximo movimiento no fallará.", // NEEDS QC
		},
	...
	miracleeye: {
		name: "Gran Ojo",
		// Official flavor text: "Este movimiento no se puede usar, por lo que sería mejor olvidarlo, aunque eso implique que no se pueda recordar posteriormente."
		desc: "Mientras el objetivo siga en combate, su evasión se ignora en las comprobaciones de precisión si es mayor que 0, y los ataques de tipo Psíquico pueden golpearlo aunque sea de tipo Siniestro. Falla si ya está afectado por este efecto o por Profecía o Rastreo.", // NEEDS QC
	...
	mist: {
		...
		gen2: {
			...
			shortDesc: "Mientras esté activo, sus caract. no pueden bajar.", // NEEDS QC
		...
		start: "  ¡Una neblina ha cubierto {TEAM:a}!",
	...
	moonblast: {
		...
		champions: {
			desc: "10% de probabilidad de bajar 1 nivel el Ataque Especial del objetivo.", // NEEDS QC
			shortDesc: "10% de bajar 1 nivel At. Esp. del objetivo.", // NEEDS QC
		},
	},
	moongeistbeam: {
		name: "Rayo Umbrío",
	...
	orderup: {
		name: "Oído Cocina",
		desc: "Si la habilidad Comandar de un Tatsugiri aliado se ha activado, sube 1 nivel el Ataque del usuario si es de Forma Curvada, la Defensa si es de Forma Lánguida o la Velocidad si es de Forma Recta. Ocurre aunque ese Tatsugiri se haya debilitado.", // NEEDS QC
	...
	psychicnoise: {
		name: "Psicorruido",
		desc: "Durante 2 turnos, el objetivo no puede recuperar PS mientras siga en combate. Durante el efecto, no puede usar movimientos curativos ni de drenado, y las habilidades y objetos curativos no lo curan. Si un afectado usa Relevo, su reemplazo tampoco puede recuperar PS. Divide Dolor y la habilidad Regeneración no se ven afectados.", // NEEDS QC
	...
	pursuit: {
		name: "Persecución",
		// Official flavor text: "Este movimiento no se puede usar, por lo que sería mejor olvidarlo, aunque eso implique que no se pueda recordar posteriormente."
		desc: "Si un rival va a cambiarse este turno, lo golpea antes de que deje el campo, aunque no fuera el objetivo original. Si el usuario actúa después de un rival que usa Viraje, Última Palabra, Teletransporte, Ida y Vuelta, Voltiocambio (pero no Relevo), también lo golpea antes de que salga. La potencia se duplica y no se comprueba la precisión contra un rival que se cambia, y el turno del usuario termina; si el rival se debilita, su reemplazo no entra hasta el final del turno.", // NEEDS QC
		...
		gen4: {
			desc: "Si un rival va a cambiarse este turno, lo golpea antes de que deje el campo, aunque no fuera el objetivo original. Si el usuario actúa después de un rival que usa Ida y Vuelta (pero no Relevo), también lo golpea antes de que salga. La potencia se duplica y no se comprueba la precisión contra un rival que se cambia, y el turno del usuario termina; si el rival se debilita, su reemplazo entra de inmediato.", // NEEDS QC
		},
		gen3: {
			desc: "Si el objetivo es un rival y va a cambiarse este turno, lo golpea antes de que deje el campo. La potencia se duplica y no se comprueba la precisión contra un rival que se cambia, y el turno del usuario termina; si el rival se debilita, su reemplazo entra de inmediato.", // NEEDS QC
	...
	ragefist: {
		...
		champions: {
			desc: "La potencia es 50+(X×50), donde X es el número total de veces que el usuario ha sido golpeado por un ataque que causa daño en el combate, aunque no perdiera PS (máximo 6). X vuelve a 0 cuando el usuario deja el campo. Cada golpe de un multigolpe cuenta, pero el daño por confusión no.", // NEEDS QC
			shortDesc: "+50 por golpe recibido (máx. 6). Se reinicia al salir.", // NEEDS QC
		},
	},
	ragepowder: {
		name: "Polvo Ira",
	...
	reflect: {
		...
		start: "  ¡Reflejo ha aumentado la resistencia {TEAM:de} ante los ataques físicos!",
	...
	reversal: {
		...
		shortDesc: "Más potencia cuantos menos PS le queden al usuario.", // NEEDS QC
		gen4: {
			desc: "La potencia depende de X=(PS actuales del usuario×64÷PS máximos del usuario) (redondeado hacia abajo): 20 si X es 43-48, 40 si es 22-42, 80 si es 13-21, 100 si es 6-12, 150 si es 2-5 y 200 si es 0-1.", // NEEDS QC
		},
		gen3: {
			desc: "La potencia depende de X=(PS actuales del usuario×48÷PS máximos del usuario) (redondeado hacia abajo): 20 si X es 33-48, 40 si es 17-32, 80 si es 10-16, 100 si es 5-9, 150 si es 2-4 y 200 si es 0-1.", // NEEDS QC
		},
		gen2: {
			desc: "La potencia depende de X=(PS actuales del usuario×48÷PS máximos del usuario) (redondeado hacia abajo): 20 si X es 33-48, 40 si es 17-32, 80 si es 10-16, 100 si es 5-9, 150 si es 2-4 y 200 si es 0-1. Este movimiento no tiene varianza de daño y no puede ser crítico.", // NEEDS QC
		},
	},
	revivalblessing: {
		name: "Plegaria Vital",
	...
	rockslide: {
		...
		desc: "30% de probabilidad de amedrentar al objetivo.", // NEEDS QC
		shortDesc: "30% de amedrentar a los rivales.", // NEEDS QC
		gen1: {
			desc: "Sin efecto adicional.", // NEEDS QC
			shortDesc: "Sin efecto adicional.", // NEEDS QC
		},
	...
	saltcure: {
		...
		champions: {
			desc: "Inflige al objetivo 1/16 de sus PS máximos (1/8 si es de tipo Acero o Agua, redondeado hacia abajo) al final de cada turno mientras dure el efecto. Termina cuando el objetivo deja el combate.", // NEEDS QC
			shortDesc: "Daña 1/16 por turno; 1/8 a Acero y Agua.", // NEEDS QC
		},
	...
	skyattack: {
		...
		desc: "30% de probabilidad de amedrentar al objetivo. Alta probabilidad de golpe crítico (índice +1). Carga el primer turno y golpea el segundo. Con Hierba Única, ataca en 1 turno.", // NEEDS QC
		shortDesc: "Carga; golpea el turno 2. 30% amedrenta. Crítico alto.", // NEEDS QC
		gen3: {
	...
	snore: {
		...
		desc: "30% de probabilidad de amedrentar al objetivo. Falla si el usuario no está dormido.", // NEEDS QC
		shortDesc: "Debe estar dormido. 30% de amedrentar.", // NEEDS QC
	},
	snowscape: {
		name: "Paisaje Nevado",
	...
	spikes: {
		...
		shortDesc: "Daña al entrar a rivales en el suelo. Máx. 3 capas.", // NEEDS QC
		gen8: {
		...
		end: "  Las púas lanzadas {TEAM:a} han desaparecido.",
	...
	spotlight: {
		name: "Foco",
		// Official flavor text: "Este movimiento no se puede usar, por lo que sería mejor olvidarlo, aunque eso implique que no se pueda recordar posteriormente."
		desc: "Hasta el final del turno, los ataques de un solo objetivo de los rivales del objetivo se redirigen a él, antes de que puedan devolverse con Capa Mágica o la habilidad Espejo Mágico, o atraerse con Pararrayos o Colector. Falla si no es un combate doble o un Battle Royale.", // NEEDS QC
	...
	stealthrock: {
		...
		end: "  Las piedras puntiagudas lanzadas {TEAM:a} han desaparecido.",
	...
	steamroller: {
		...
		// Official flavor text: "Este movimiento no se puede usar, por lo que sería mejor olvidarlo, aunque eso implique que no se pueda recordar posteriormente."
		desc: "30% de probabilidad de amedrentar al objetivo. El daño se duplica y no se comprueba la precisión si el objetivo usó Reducción desde que entró en combate.", // NEEDS QC
		shortDesc: "30% de amedrentar al objetivo.", // NEEDS QC
		gen5: {
			desc: "30% de probabilidad de amedrentar al objetivo. El daño se duplica si el objetivo usó Reducción desde que está en combate.", // NEEDS QC
		},
	...
	stickyweb: {
		...
		shortDesc: "-1 Velocidad a los rivales en el suelo al entrar.", // NEEDS QC
		gen8: {
		...
		start: "  ¡Una red viscosa se extiende a los pies {TEAM:de}!",
		end: "  La red viscosa que rodeaba {TEAM:a} ha desaparecido.",
	...
	stockpile: {
		...
		desc: "Sube 1 nivel la Defensa y la Defensa Especial del usuario y su contador de Reserva aumenta en 1. Falla si el contador es 3. El contador vuelve a 0 al dejar el combate.", // NEEDS QC
	...
	stomp: {
		...
		gen4: {
			desc: "30% de probabilidad de amedrentar al objetivo. La potencia se duplica si el objetivo usó Reducción desde que entró en combate.", // NEEDS QC
		},
		gen3: {
			desc: "30% de probabilidad de amedrentar al objetivo. El daño se duplica si el objetivo usó Reducción desde que está en combate.", // NEEDS QC
		},
		gen2: {
			desc: "30% de probabilidad de amedrentar al objetivo. La potencia se duplica si el objetivo está bajo el efecto de Reducción.", // NEEDS QC
		},
		gen1: {
			desc: "30% de probabilidad de amedrentar al objetivo.", // NEEDS QC
		},
	...
	stuffcheeks: {
		...
		champions: {
			desc: "Falla si el usuario no lleva una baya. Se la come y sube 2 niveles su Defensa. Este efecto no lo impiden las habilidades Zoquete o Nerviosismo ni los efectos de Embargo o Zona Mágica.", // NEEDS QC
			shortDesc: "Falla sin baya. Se la come: +2 Defensa.", // NEEDS QC
		},
	},
	stunspore: {
		name: "Paralizador",
	...
	switcheroo: {
		...
		champions: {
			desc: "El usuario intercambia su objeto con el del objetivo. Falla si ninguno lleva objeto, o si intenta dar o quitar una megapiedra a o de la especie que puede megaevolucionar con ella. El objetivo es inmune si tiene la habilidad Viscosidad.", // NEEDS QC
		},
		gen8: {
	...
	tailwind: {
		...
		start: "  ¡El viento sopla a favor {TEAM:de}!",
		end: "  Ha dejado de soplar el viento que favorecía {TEAM:a}.",
	},
	takedown: {
		name: "Derribo",
	...
	terablast: {
		...
		shortDesc: "Teracristalizado: teratipo; físico si Ataque > At. Esp.", // NEEDS QC
	},
	terastarstorm: {
		name: "Teraclúster",
	...
	thunderfang: {
		...
		desc: "10% de probabilidad de paralizar al objetivo y 10% de amedrentarlo.", // NEEDS QC
		shortDesc: "10% de paralizar. 10% de amedrentar.", // NEEDS QC
	},
	thunderouskick: {
	...
	toxicspikes: {
		...
		end: "  Las púas tóxicas lanzadas {TEAM:a} han desaparecido.",
	},
	toxicthread: {
		name: "Hilo Venenoso",
		...
		champions: {
			desc: "Baja 2 niveles la Velocidad del objetivo y lo envenena.", // NEEDS QC
			shortDesc: "-2 Velocidad del objetivo y lo envenena.", // NEEDS QC
		},
	},
	trailblaze: {
		name: "Abrecaminos",
	...
	transform: {
		...
		gen2: {
			...
			shortDesc: "Copia características, movimientos, tipos y especie.", // NEEDS QC
		},
		gen1: {
	...
	trickroom: {
		...
		gen4: {
			desc: "Durante 5 turnos, los Pokémon con menor Velocidad actúan antes que los de mayor Velocidad, dentro de su nivel de prioridad. Si se usa durante el efecto, este termina.", // NEEDS QC
		},
	},
	triplearrows: {
		name: "Triple Flecha",
		desc: "50% de probabilidad de bajar 1 nivel la Defensa del objetivo, 30% de amedrentarlo y alta probabilidad de golpe crítico (índice +1).", // NEEDS QC
		shortDesc: "Crítico alto. 50% -1 Defensa, 30% amedrenta.", // NEEDS QC
	},
	tripleaxel: {
		name: "Triple Axel",
		...
		shortDesc: "3 golpes; cada uno puede fallar y sube potencia.", // NEEDS QC
	},
	tripledive: {
	...
	twister: {
		...
		desc: "20% de probabilidad de amedrentar al objetivo. La potencia se duplica contra objetivos usando Bote, Vuelo, Caída Libre o bajo el efecto de Caída Libre.", // NEEDS QC
		shortDesc: "20% de amedrentar a los rivales.", // NEEDS QC
		gen4: {
			desc: "20% de probabilidad de amedrentar al objetivo. La potencia se duplica contra objetivos usando Bote o Vuelo.", // NEEDS QC
		},
		gen2: {
			desc: "20% de probabilidad de amedrentar al objetivo. La potencia se duplica contra objetivos usando Vuelo.", // NEEDS QC
			shortDesc: "20% de amedrentar al objetivo.", // NEEDS QC
		},
	},
	upperhand: {
		name: "Palma Rauda",
		desc: "100% de probabilidad de amedrentar al objetivo. Falla si el objetivo no eligió un ataque físico o especial con prioridad alterada mayor que 0 este turno, o si actúa antes que el usuario.", // NEEDS QC
		shortDesc: "100% amedrenta. Falla si el rival no usa prioridad.", // NEEDS QC
	},
	uproar: {
		name: "Alboroto",
