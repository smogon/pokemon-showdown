...
let BattlePokedex = {
	...
	charizard: {
		...
		evoLevel: 36,
		eggGroups: ["Monster", "Dragon"],
		otherFormes: ["charizardmegax", "charizardmegay", "charizardgigantamax"],
	},
	charizardmegax: {
		num: 6,
	...
	butterfree: {
		...
		evoLevel: 10,
		eggGroups: ["Bug"],
		otherFormes: ["butterfreegigantamax"],
	},
	butterfreegigantamax: {
		num: 12,
		species: "Butterfree-Gigantamax",
	...
	pikachu: {
		...
		otherFormes: ["pikachucosplay", "pikachurockstar", "pikachubelle", "pikachupopstar", "pikachuphd", "pikachulibre", "pikachuoriginal", "pikachuhoenn", "pikachusinnoh", "pikachuunova", "pikachukalos", "pikachualola", "pikachupartner", "pikachustarter", "pikachugigantamax"],
	},
	pikachucosplay: {
		num: 25,
	...
	meowth: {
		...
		evos: ["persian"],
		eggGroups: ["Field"],
		otherFormes: ["meowthalola", "meowthgalar", "meowthgigantamax"],
	},
	meowthalola: {
		num: 52,
	...
	gengar: {
		...
		evoType: "trade",
		eggGroups: ["Amorphous"],
		otherFormes: ["gengarmega", "gengargigantamax"],
	},
	gengarmega: {
		num: 94,
		species: "Gengar-Mega",
	...
	kingler: {
		...
		evoLevel: 28,
		eggGroups: ["Water 3"],
		otherFormes: ["kinglergigantamax"],
	},
	kinglergigantamax: {
		num: 99,
		species: "Kingler-Gigantamax",
		baseSpecies: "Kingler",
		forme: "Gigantamax",
		formeLetter: "G",
		types: ["Water"],
	...
	eevee: {
		...
		eggGroups: ["Field"],
		otherFormes: ["eeveestarter", "eeveegigantamax"],
	},
	eeveestarter: {
		num: 133,
	...
	snorlax: {
		...
		eggGroups: ["Monster"],
		canHatch: true,
		otherFormes: ["snorlaxgigantamax"],
	},
	snorlaxgigantamax: {
		num: 143,
		species: "Snorlax-Gigantamax",
		baseSpecies: "Snorlax",
		forme: "Gigantamax",
		formeLetter: "G",
		types: ["Normal"],
	...
	garbodor: {
		...
		evoLevel: 36,
		eggGroups: ["Mineral"],
		otherFormes: ["garbodorgigantamax"],
	},
	garbodorgigantamax: {
		num: 569,
		species: "Garbodor-Gigantamax",
	...
	melmetal: {
		...
		prevo: "meltan",
		eggGroups: ["Undiscovered"],
		otherFormes: ["melmetalgigantamax"],
	},
	melmetalgigantamax: {
		num: 809,
		species: "Melmetal-Gigantamax",
	...
	corviknight: {
		...
		evoLevel: 38,
		eggGroups: ["Flying"],
		otherFormes: ["corviknightgigantamax"],
	},
	corviknightgigantamax: {
		num: 823,
		species: "Corviknight-Gigantamax",
	...
	orbeetle: {
		...
		evoLevel: 30,
		eggGroups: ["Bug"],
		otherFormes: ["orbeetlegigantamax"],
	},
	orbeetlegigantamax: {
		num: 826,
		species: "Orbeetle-Gigantamax",
	...
	coalossal: {
		...
		evoLevel: 34,
		eggGroups: ["Mineral"],
		otherFormes: ["coalossalgigantamax"],
	},
	coalossalgigantamax: {
		num: 839,
		species: "Coalossal-Gigantamax",
	...
	flapple: {
		...
		evoItem: "Sweet Apple",
		eggGroups: ["Grass", "Dragon"],
		otherFormes: ["flapplegigantamax"],
	},
	flapplegigantamax: {
		num: 841,
		species: "Flapple-Gigantamax",
		baseSpecies: "Flapple",
		forme: "Gigantamax",
		formeLetter: "G",
		types: ["Grass", "Dragon"],
	...
	appletun: {
		...
		evoItem: "Tart Apple",
		eggGroups: ["Grass", "Dragon"],
		otherFormes: ["appletungigantamax"],
	},
	appletungigantamax: {
		num: 842,
	...
	sandaconda: {
		...
		evoLevel: 36,
		eggGroups: ["Field", "Dragon"],
		otherFormes: ["sandacondagigantamax"],
	},
	...
	centiskorch: {
		...
		evoLevel: 28,
		eggGroups: ["Bug"],
		otherFormes: ["centiskorchgigantamax"],
	},
	centiskorchgigantamax: {
		num: 851,
		species: "Centiskorch-Gigantamax",
	...
	hatterene: {
		...
		evoLevel: 42,
		eggGroups: ["Fairy"],
		otherFormes: ["hatterenegigantamax"],
	},
	hatterenegigantamax: {
		num: 858,
		species: "Hatterene-Gigantamax",
	...
	grimmsnarl: {
		...
		evoLevel: 42,
		eggGroups: ["Fairy", "Human-Like"],
		otherFormes: ["grimmsnarlgigantamax"],
	},
	grimmsnarlgigantamax: {
		num: 861,
		species: "Grimmsnarl-Gigantamax",
	...
	alcremie: {
		...
		evoItem: "cloversweet",
		eggGroups: ["Fairy", "Amorphous"],
		otherFormes: ["alcremiegigantamax"],
	...
	copperajah: {
		...
		evoLevel: 34,
		eggGroups: ["Field", "Mineral"],
		otherFormes: ["copperajahgigantamax"],
	},
	copperajahgigantamax: {
		num: 879,
		species: "Copperajah-Gigantamax",
	...
	duraludon: {
		...
		otherFormes: ["duraludongigantamax"],
	},
	duraludongigantamax: {
		num: 884,
	...
	eternatus: {
		...
		species: "Eternatus",
		types: ["Poison", "Dragon"],
		baseStats: {hp: 140, atk: 80, def: 95, spa: 145, spd: 95, spe: 130},
		abilities: {0: "Pressure"},
		heightm: 20,
		weightkg: 950,
		color: "Purple",
