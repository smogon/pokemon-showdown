	...
	"substitute": {
		...
		effect: {
			...
			onTryHit: function(target, source, move) {
				...
				if (move.category === 'Status') {
					var SubBlocked = {
						acupressure:1, block:1, embargo:1, entrainment:1, flatter:1, gastroacid:1, grudge:1, healblock:1, leechseed:1, lockon:1, meanlook:1, mindreader:1, nightmare:1, painsplit:1, psychoshift:1, spiderweb:1, sketch:1, swagger:1, switcheroo:1, trick:1, worryseed:1, yawn:1, soak: 1
					};
