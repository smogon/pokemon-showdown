...
let BattleMovedex = {
	...
	"aurawheel": {
		...
		basePower: 110,
		category: "Physical",
		desc: "Has a 100% chance to raise the users Speed by 1 stage. If the user is a Morpeko in Full Belly Mode, this move is Electric type. If the user is a Morpeko in Hangry Mode, this move is Dark type. This move cannot be used successfully unless the user's current form, while considering Transform, is Full Belly or Hangry Mode Morpeko.",
