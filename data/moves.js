...
exports.BattleMovedex = {
	...
	"hail": {
		...
		basePower: 0,
		category: "Status",
		desc: "For 5 turns, the weather becomes Hail. At the end of each turn except the last, all active Pokemon lose 1/16 of their maximum HP, rounded down, unless they are an Ice type, or have the Abilities Ice Body, Magic Guard, Overcoat, or Snow Cloak. Lasts for 8 turns if the user is holding Icy Rock. Fails if the current weather is Hail, Primordial Sea or Desolate Land.",
	...
	"hurricane": {
		...
		basePower: 110,
		category: "Special",
		desc: "Has a 30% chance to confuse the target. This move can hit a target using Bounce, Fly, or Sky Drop. If the weather is rainy (Drizzle, Rain Dance, Primordial Sea), this move does not check accuracy. If the weather is sunny(Sunny Day, Desolate Land), this move's accuracy is 50%.",
		shortDesc: "30% chance to confuse target. Can't miss in rain or heavy rain.",
		id: "hurricane",
		isViable: true,
		name: "Hurricane",
		pp: 10,
	...
	"moonlight": {
		...
		basePower: 0,
		category: "Status",
		desc: "The user restores 1/2 of its maximum HP if no weather conditions are in effect, 2/3 of its maximum HP If the weather is sunny(Sunny Day, Desolate Land), and 1/4 of its maximum HP if the weather is Hail, Rain Dance, Primordial Sea or Sandstorm, all rounded half down.",
	...
	"raindance": {
		...
		basePower: 0,
		category: "Status",
		desc: "For 5 turns, the weather becomes Rain Dance. The damage of Water-type attacks is multiplied by 1.5 and the damage of Fire-type attacks is multiplied by 0.5 during the effect. Lasts for 8 turns if the user is holding Damp Rock. Fails if the current weather is Rain Dance, Primordial Sea or Desolate Land.",
	...
	"solarbeam": {
		...
		basePower: 120,
		category: "Special",
		desc: "This attack charges on the first turn and executes on the second. Power is halved if the weather is Hail, Rain Dance, Primordial Sea or Sandstorm. If the user is holding a Power Herb or the weather is Sunny Day or Desolate Land, the move completes in one turn.",
		shortDesc: "Charges turn 1. Hits turn 2. No charge in sunlight or harsh sunlight.",
		id: "solarbeam",
		name: "Solar Beam",
		pp: 10,
		priority: 0,
	...
	"sunnyday": {
		...
		basePower: 0,
		category: "Status",
		desc: "For 5 turns, the weather becomes Sunny Day. The damage of Fire-type attacks is multiplied by 1.5 and the damage of Water-type attacks is multiplied by 0.5 during the effect. Lasts for 8 turns if the user is holding Heat Rock. Fails if the current weather is Sunny Day, Primordial Sea or Desolate Land.",
	...
	"thunder": {
		...
		basePower: 110,
		category: "Special",
		desc: "Has a 30% chance to paralyze the target. This move can hit a target using Bounce, Fly, or Sky Drop. If the weather is rainy (Drizzle, Rain Dance, Primordial Sea), this move does not check accuracy. If the weather is sunny(Sunny Day, Desolate Land), this move's accuracy is 50%.",
		shortDesc: "30% chance to paralyze target. Can't miss in rain or heavy rain.",
		id: "thunder",
		isViable: true,
		name: "Thunder",
		pp: 10,
	...
	"weatherball": {
		...
		category: "Special",
		desc: "Power doubles during weather effects and this move's type changes to match; Ice type during Hail, Water type during Rain Dance and Primordial Sea, Rock type during Sandstorm, and Fire type during Sunny Day and Desolate Land.",
