...
let BattleFormats = {
	...
	natdex: {
		effectType: 'Rule',
		name: 'NatDex',
		banlist: ['Eevee-Starter', 'Floette-Eternal', 'Magearna-Original', 'Pichu-Spiky-eared', 'Pikachu-Belle', 'Pikachu-Cosplay', 'Pikachu-Libre', 'Pikachu-PhD', 'Pikachu-Pop-Star', 'Pikachu-Rock-Star', 'Pikachu-Starter'],
		onValidateSet(set) {
