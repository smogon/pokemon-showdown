...
export const Moves: {[moveid: string]: MoveData} = {
	...
	afteryou: {
		...
		pp: 15,
		priority: 0,
		flags: {bypasssub: 1, animonally: 1},
		onHit(target) {
	...
	bestow: {
		...
		pp: 15,
		priority: 0,
		flags: {mirror: 1, bypasssub: 1, animonally: 1},
		onHit(target, source, move) {
			if (target.item) {
				return false;
			}
	...
	guardswap: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, bypasssub: 1, animonally: 1},
		onHit(target, source) {
	...
	instruct: {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, bypasssub: 1, animonally: 1},
		onHit(target, source) {
	...
	junglehealing: {
		...
		pp: 10,
		priority: 0,
		flags: {heal: 1, bypasssub: 1, animonally: 1},
		onHit(pokemon) {
	...
	metalsound: {
		...
		pp: 40,
		priority: 0,
		flags: {protect: 1, reflectable: 1, mirror: 1, sound: 1, bypasssub: 1, animonally: 1},
		boosts: {
			spd: -2,
		},
		secondary: null,
	...
	odorsleuth: {
		...
		pp: 40,
		priority: 0,
		flags: {protect: 1, reflectable: 1, mirror: 1, bypasssub: 1, animonally: 1},
		volatileStatus: 'foresight',
		onTryHit(target) {
			if (target.volatiles['miracleeye']) return false;
		},
	...
	roar: {
		...
		pp: 20,
		priority: -6,
		flags: {reflectable: 1, mirror: 1, sound: 1, bypasssub: 1, animonally: 1},
		forceSwitch: true,
		secondary: null,
		target: "normal",
		type: "Normal",
	...
	whirlwind: {
		...
		pp: 20,
		priority: -6,
		flags: {reflectable: 1, mirror: 1, bypasssub: 1, animonally: 1},
		forceSwitch: true,
		secondary: null,
		target: "normal",
		type: "Normal",
