...
export const Moves: {[moveid: string]: MoveData} = {
	...
	beakblast: {
		...
		pp: 15,
		priority: -3,
		flags: {bullet: 1, protect: 1, mefirst: 1},
	...
	blazingtorque: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, encore: 1, mefirst: 1},
		secondary: {
			chance: 30,
			status: 'brn',
		},
	...
	focuspunch: {
		...
		pp: 20,
		priority: -3,
		flags: {contact: 1, protect: 1, punch: 1, mefirst: 1},
		priorityChargeCallback(pokemon) {
	...
	mefirst: {
		...
		pp: 20,
		priority: 0,
		flags: {protect: 1, bypasssub: 1, encore: 1, mefirst: 1},
	...
	sketch: {
		...
		noPPBoosts: true,
		priority: 0,
		flags: {bypasssub: 1, allyanim: 1, encore: 1},
		onHit(target, source) {
	...
	struggle: {
		...
		noPPBoosts: true,
		priority: 0,
		flags: {contact: 1, protect: 1, encore: 1, mefirst: 1},
		noSketch: true,
		onModifyMove(move, pokemon, target) {
			move.type = '???';
