...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	afteryou: {
		...
		pp: 15,
		priority: 0,
		flags: { bypasssub: 1, allyanim: 1, influencing: 1 },
		onHit(target) {
	...
	auroraveil: {
		...
		onTry(source) {
			return ['hail', 'snowscape'].includes(source.effectiveClimateWeather());
		},
		condition: {
			duration: 5,
	...
	courtchange: {
		...
		onHitField(target, source) {
			const sideConditions = [
				'mist', 'lightscreen', 'reflect', 'spikes', 'safeguard', 'tailwind', 'toxicspikes', 'stealthrock', 'waterpledge', 'firepledge', 'grasspledge', 'stickyweb', 'auroraveil', 'luckychant', 'gmaxsteelsurge', 'gmaxcannonade', 'gmaxvinelash', 'gmaxwildfire', 'gmaxvolcalith', 'steelbarbs',
			];
			let success = false;
	...
	encore: {
		...
		pp: 5,
		priority: 0,
		flags: { protect: 1, reflectable: 1, mirror: 1, bypasssub: 1, metronome: 1, failencore: 1, influencing: 1 },
	...
	followme: {
		...
		pp: 20,
		priority: 2,
		flags: { noassist: 1, failcopycat: 1, influencing: 1 },
	...
	helpinghand: {
		...
		pp: 20,
		priority: 5,
		flags: { bypasssub: 1, noassist: 1, failcopycat: 1, influencing: 1 },
	...
	instruct: {
		...
		pp: 15,
		priority: 0,
		flags: { protect: 1, bypasssub: 1, allyanim: 1, failinstruct: 1, influencing: 1 },
		onHit(target, source) {
	...
	mefirst: {
		...
		flags: {
			...
			failcopycat: 1, failmimic: 1, failinstruct: 1, influencing: 1,
		},
	...
	auraprojection: { // tested, works as intended
		num: 10008,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	bearhug: { // tested, works as intended
		num: 10062,
		accuracy: 85,
		basePower: 30,
		category: "Physical",
	...
	bloodmoon: { // tested, works as intended
		num: 10001,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	crystalforce: { // tested, works as intended
		num: 10027,
		accuracy: 80,
		basePower: 120,
		category: "Special",
	...
	/* darkdepletion: { // untested, test which version
		num: 10082,
		accuracy: 100,
		basePower: 70,
		category: "Special",
		...
		/*  onEffectiveness(pokemon, typeMod, target, type) {
			if (pokemon.hasType('Grass', 'Water')) {
				return 2;
			} else if (['Grass', 'Water'].includes(type)) {
				return 1;
			}
		}, * /
		onEffectiveness(typeMod, target, type) {
	...
	daydream: { // tested, works as intended
		num: 10010,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	draconicroar: { // tested, works as intended
		num: 10056,
		accuracy: 100,
		basePower: 90,
		category: "Special",
	...
	dragonforce: { // tested, works as intended
		num: 10011,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	duststorm: { // tested, works as intended
		num: 1003,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	ectoplasma: { // tested, works as intended
		num: 10030,
		accuracy: 80,
		basePower: 120,
		category: "Special",
	...
	/* efflorescence: { // untested
		...
		onHit(target, source, move) {
			this.add('-activate', source, 'move: Efflorescence');
			let success = false;
			const allies = [...target.side.pokemon, ...target.side.allySide?.pokemon || []];
			for (const ally of allies) {
				if (ally !== source && !this.suppressingAbility(ally)) {
	...
	evoboost: { // tested, works as intended
		...
		onTry(source) {
			...
			this.attrLastMove('[still]');
			this.add('-fail', source, 'move: Evoboost');
			this.hint("Only Eevee and Skinka can use this move.");
			return null;
		},
		target: "self",
		type: "Normal",
	},
	excalibur: { // tested, works as intended
		num: 10065,
		accuracy: 100,
		basePower: 120,
		category: "Physical",
	...
	/* ferrospikebarrage: { // tested, works as intended
		num: 10093,
		accuracy: 85,
		basePower: 110,
		category: "Special",
	...
	/* fireglass: { // tested, works as intended
		num: 10092,
		accuracy: 90,
		basePower: 90,
		category: "Physical",
	...
	fluffbuff: { // tested, works as intended
		num: 10070,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	frostkick: { // tested, works as intended
		num: 10051,
		accuracy: 90,
		basePower: 85,
		category: "Physical",
	...
	hiveshriek: { // tested, works as intended
		num: 10028,
		accuracy: 70,
		basePower: 120,
		category: "Special",
	...
	/* hornswongle: { // tested, works as intended
		num: 10104,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	hydraulicjaw: { // tested, works as intended
		num: 10031,
		accuracy: 90,
		basePower: 90,
		category: "Physical",
	...
	ignition: { // tested, works as intended
		num: 10038,
		accuracy: 100,
		basePower: 90,
		category: "Physical",
	...
	kihop: { // tested, works as intended
		num: 10017,
		accuracy: 100,
		basePower: 65,
		category: "Special",
	...
	kindle: { // tested, works as intended
		num: 10036,
		accuracy: 100,
		basePower: 40,
		category: "Physical",
	...
	/* languishingaura: { // untested
		...
		energyWeather: 'haunt',
		onHit(target, source, move) {
			this.add('-activate', source, 'move: Languishing Aura');
			let success = false;
			const allies = [...target.side.pokemon, ...target.side.allySide?.pokemon || []];
			for (const ally of allies) {
				if (ally !== source && !this.suppressingAbility(ally)) {
	...
	lavajet: { // tested, works as intended
		num: 10037,
		accuracy: 100,
		basePower: 40,
		category: "Physical",
	...
	osmosis: { // tested, works as intended
		num: 10042,
		accuracy: 100,
		basePower: 75,
		category: "Special",
	...
	paddle: { // tested, works as intended
		num: 10041,
		accuracy: 100,
		basePower: 40,
		category: "Physical",
	...
	permafrost: { // tested, works as intended
		num: 10052,
		accuracy: 100,
		basePower: 120,
		category: "Physical",
	...
	pollinate: { // tested, works as intended
		num: 10004,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	/* pricklypear: { // untested
		...
		priority: 0,
		flags: { protect: 1, reflectable: 1, mirror: 1 },
		volatileStatus: 'pricklypear',
		condition: {
			onStart(target) {
				this.effectState.stage = 0;
				this.add('-start', target, 'move: Prickly Pear');
			},
			onResidualOrder: 8,
			onResidual(pokemon) {
				const target = this.getAtSlot(pokemon.volatiles['pricklypear'].sourceSlot);
				if (!target || target.fainted || target.hp <= 0) {
					this.debug('Nothing to leech into');
					return;
				}
				...
				const damage = this.damage(this.clampIntRange(pokemon.baseMaxhp / 16, 1) * this.effectState.stage);
				if (damage) {
					this.heal(damage, target, pokemon);
				}
			},
	...
	resilientoil: { // tested, works as intended
		...
		priority: 0,
		flags: { snatch: 1 },
		volatileStatus: 'resilientoil',
		condition: {
			onStart(pokemon) {
				this.add('-start', pokemon, 'Resilient Oil');
			},
			onResidualOrder: 6,
			onResidual(pokemon) {
	...
	sandblast: { // untested
		...
		flags: { protect: 1, mirror: 1, metronome: 1 },
		basePowerCallback(pokemon, target, move) {
			if (['sandstorm', 'duststorm'].includes(target.effectiveIrritantWeather())) {
				return move.basePower * 2;
			}
			return move.basePower;
		},
	...
	/* sandstonesweep: { // untested
		...
		onAfterHit(target, pokemon, move) {
			if (!move.hasSheerForce) {
				...
				for (const condition of sideConditions) {
					if (pokemon.hp && pokemon.side.removeSideCondition(condition)) {
						this.add('-sideend', pokemon.side, this.dex.conditions.get(condition).name, '[from] move: Sandstone Sweep', `[of] ${pokemon}`);
					}
				}
				if (pokemon.hp && pokemon.volatiles['partiallytrapped']) {
					pokemon.removeVolatile('partiallytrapped');
	...
	/* scavenge: { // untested
		...
		onAfterHit(target, source, move) {
			...
			const item = target.getItem();
			if (source.hp && item.isBerry && target.takeItem(source)) {
				this.add('-enditem', target, item.name, '[from] stealeat', '[move] Scavenge', `[of] ${source}`);
				if (this.singleEvent('Eat', item, target.itemState, source, source, move)) {
					this.runEvent('EatItem', source, source, move, item);
					if (item.id === 'leppaberry') target.staleness = 'external';
				}
	...
	shadowfang: { // tested, works as intended
		num: 10077,
		accuracy: 100,
		basePower: 85,
		category: "Physical",
	...
	shadowspit: { // tested, works as intended
		num: 10029,
		accuracy: 100,
		basePower: 40,
		category: "Special",
	...
	shreddingriff: { // tested, works as intended
		num: 10034,
		accuracy: 80,
		basePower: 110,
		category: "Special",
	...
	smogspread: { // tested, works as intended
		num: 10006,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	sprinkle: { // tested, works as intended
		num: 10007,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	stonestorm: { // untested
		...
		flags: { protect: 1, mirror: 1, metronome: 1 },
		onModifyMove(move, pokemon, target) {
			if (target && ['sandstorm', 'duststorm'].includes(target.effectiveIrritantWeather())) {
				move.multihit = 2;
			}
		},
		target: "normal",
	...
	strongwinds: { // tested, works as intended
		num: 10014,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	/* sulphurbeam: { // tested, works as intended
		num: 10107,
		accuracy: 100,
		basePower: 85,
		category: "Special",
	...
	/* sultryspin: { // tested, works as intended
		num: 10086,
		accuracy: 100,
		basePower: 60,
		category: "Physical",
	...
	supercell: { // tested, works as intended
		num: 10012,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	swarmsignal: { // tested, works as intended
		num: 10005,
		accuracy: true,
		basePower: 0,
		category: "Status",
	...
	/* technoplasm: { // untested, does it only have chance to para once?
		num: 10099,
		accuracy: 100,
		basePower: 20,
		category: "Special",
	...
	voltkick: { // tested, works as intended
		num: 10045,
		accuracy: 90,
		basePower: 85,
		category: "Physical",
	...
	whipup: { // tested, works as intended
		num: 10020,
		accuracy: 100,
		basePower: 90,
		category: "Special",
	...
	whirlduel: { // tested, works as intended
		num: 10072,
		accuracy: 90,
		basePower: 80,
		category: "Special",
	...
	/* whiteout: { // tested, works as intended
		num: 10103,
		accuracy: 100,
		basePower: 90,
		category: "Physical",
	...
	whitewand: { // tested, works as intended
		num: 10054,
		accuracy: 85,
		basePower: 0,
		category: "Status",
	...
	/* wildfire: { // tested, works as intended
		num: 10102,
		accuracy: 100,
		basePower: 90,
		category: "Special",
