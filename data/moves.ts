...
export const Moves: {[moveid: string]: MoveData} = {
	...
	assist: {
		...
		pp: 20,
		priority: 0,
		flags: {failencore: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		onHit(target) {
			const moves = [];
			for (const pokemon of target.side.pokemon) {
				...
				for (const moveSlot of pokemon.moveSlots) {
					...
					if (move.flags['assist'] || move.isZ || move.isMax) {
						continue;
					}
					moves.push(moveid);
				}
	...
	beakblast: {
		...
		pp: 15,
		priority: -3,
		flags: {bullet: 1, protect: 1, assist: 1, failmefirst: 1, nosleeptalk: 1, copycat: 1, instruct: 1},
	...
	belch: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, failmefirst: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
	...
	bestow: {
		...
		pp: 15,
		priority: 0,
		flags: {mirror: 1, bypasssub: 1, allyanim: 1, assist: 1, copycat: 1},
		onHit(target, source, move) {
			if (target.item) {
				return false;
			}
	...
	bide: {
		...
		pp: 10,
		priority: 1,
		flags: {contact: 1, protect: 1, nosleeptalk: 1, instruct: 1},
		volatileStatus: 'bide',
		ignoreImmunity: true,
	...
	blazingtorque: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, failencore: 1, failmefirst: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		secondary: {
			chance: 30,
			status: 'brn',
		},
	...
	bounce: {
		...
		pp: 5,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, gravity: 1, distance: 1, nosleeptalk: 1, assist: 1, instruct: 1},
	...
	celebrate: {
		...
		pp: 40,
		priority: 0,
		flags: {nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
	...
	chatter: {
		...
		priority: 0,
		flags: {
			protect: 1, mirror: 1, sound: 1, distance: 1, bypasssub: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1,
		},
		noSketch: true,
		secondary: {
			chance: 100,
	...
	circlethrow: {
		...
		pp: 10,
		priority: -6,
		flags: {contact: 1, protect: 1, mirror: 1, assist: 1, copycat: 1},
		forceSwitch: true,
		target: "normal",
		type: "Fighting",
		contestType: "Cool",
	...
	copycat: {
		...
		onHit(pokemon) {
			...
			if (move.flags['copycat'] || move.isZ || move.isMax) {
				return false;
			}
	...
	counter: {
		...
		pp: 20,
		priority: -5,
		flags: {contact: 1, protect: 1, failmefirst: 1, assist: 1, copycat: 1},
	...
	covet: {
		...
		pp: 25,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, failmefirst: 1, assist: 1, copycat: 1},
	...
	dig: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, nonsky: 1, nosleeptalk: 1, assist: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	dive: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, nonsky: 1, allyanim: 1, nosleeptalk: 1, assist: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	dynamaxcannon: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, failencore: 1, nosleeptalk: 1, parentalbond: 1, copycat: 1, instruct: 1, mimic: 1},
		secondary: null,
		target: "normal",
		type: "Dragon",
	},
	...
	feint: {
		...
		pp: 10,
		priority: 2,
		flags: {mirror: 1, assist: 1, copycat: 1},
		breaksProtect: true,
	...
	focuspunch: {
		...
		pp: 20,
		priority: -3,
		flags: {contact: 1, protect: 1, punch: 1, failmefirst: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1},
		priorityChargeCallback(pokemon) {
	...
	freezeshock: {
		...
		pp: 5,
		priority: 0,
		flags: {charge: 1, protect: 1, mirror: 1, nosleeptalk: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	geomancy: {
		...
		pp: 10,
		priority: 0,
		flags: {charge: 1, nonsky: 1, nosleeptalk: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	holdhands: {
		...
		pp: 40,
		priority: 0,
		flags: {bypasssub: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		secondary: null,
		target: "adjacentAlly",
		type: "Normal",
		zMove: {boost: {atk: 1, def: 1, spa: 1, spd: 1, spe: 1}},
	...
	iceball: {
		...
		pp: 20,
		priority: 0,
		flags: {bullet: 1, contact: 1, protect: 1, mirror: 1, parentalbond: 1, instruct: 1},
		onModifyMove(move, pokemon, target) {
	...
	instruct: {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, bypasssub: 1, allyanim: 1, instruct: 1},
		onHit(target, source) {
	...
	kingsshield: {
		...
		pp: 10,
		priority: 4,
		flags: {assist: 1, copycat: 1, instruct: 1},
		stallingMove: true,
	...
	matblock: {
		...
		pp: 10,
		priority: 0,
		flags: {snatch: 1, nonsky: 1, assist: 1, copycat: 1},
		stallingMove: true,
	...
	mefirst: {
		...
		pp: 20,
		priority: 0,
		flags: {protect: 1, bypasssub: 1, failencore: 1, failmefirst: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
	...
	meteorassault: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, recharge: 1, mirror: 1, instruct: 1},
		self: {
			volatileStatus: 'mustrecharge',
		},
		secondary: null,
	...
	mimic: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, bypasssub: 1, allyanim: 1, failencore: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		onHit(target, source) {
	...
	mirrorcoat: {
		...
		pp: 20,
		priority: -5,
		flags: {protect: 1, failmefirst: 1, assist: 1},
		beforeTurnCallback(pokemon) {
	...
	outrage: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, instruct: 1},
		self: {
	...
	petaldance: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, dance: 1, instruct: 1},
		self: {
			volatileStatus: 'lockedmove',
		},
		onAfterMove(pokemon) {
	...
	phantomforce: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, mirror: 1, nosleeptalk: 1, assist: 1, instruct: 1},
		breaksProtect: true,
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
	...
	ragepowder: {
		...
		pp: 20,
		priority: 2,
		flags: {powder: 1, assist: 1, copycat: 1},
	...
	roar: {
		...
		pp: 20,
		priority: -6,
		flags: {reflectable: 1, mirror: 1, sound: 1, bypasssub: 1, allyanim: 1, assist: 1, copycat: 1},
		forceSwitch: true,
		secondary: null,
		target: "normal",
		type: "Normal",
	...
	rollout: {
		...
		pp: 20,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, parentalbond: 1, instruct: 1},
		onModifyMove(move, pokemon, target) {
	...
	shelltrap: {
		...
		pp: 5,
		priority: -3,
		flags: {protect: 1, failmefirst: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1},
		priorityChargeCallback(pokemon) {
	...
	sketch: {
		...
		noPPBoosts: true,
		priority: 0,
		flags: {bypasssub: 1, allyanim: 1, failencore: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		onHit(target, source) {
	...
	skullbash: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, nosleeptalk: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	skyattack: {
		...
		pp: 5,
		priority: 0,
		flags: {charge: 1, protect: 1, mirror: 1, distance: 1, nosleeptalk: 1, instruct: 1},
		critRatio: 2,
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
	...
	snatch: {
		...
		pp: 10,
		priority: 4,
		flags: {bypasssub: 1, mustpressure: 1, assist: 1, copycat: 1},
	...
	solarblade: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, slicing: 1, nosleeptalk: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	spotlight: {
		...
		pp: 15,
		priority: 3,
		flags: {protect: 1, reflectable: 1, allyanim: 1, assist: 1, copycat: 1},
	...
	struggle: {
		...
		noPPBoosts: true,
		priority: 0,
		flags: {contact: 1, protect: 1, failencore: 1, failmefirst: 1, nosleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		noSketch: true,
		onModifyMove(move, pokemon, target) {
			move.type = '???';
	...
	switcheroo: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, allyanim: 1, assist: 1, copycat: 1},
		onTryImmunity(target) {
	...
	transform: {
		...
		pp: 10,
		priority: 0,
		flags: {allyanim: 1, failencore: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		onHit(target, pokemon) {
	...
	uproar: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, sound: 1, bypasssub: 1, nosleeptalk: 1, instruct: 1},
		self: {
	...
	whirlwind: {
		...
		pp: 20,
		priority: -6,
		flags: {reflectable: 1, mirror: 1, bypasssub: 1, allyanim: 1, wind: 1, assist: 1, copycat: 1},
		forceSwitch: true,
		secondary: null,
		target: "normal",
		type: "Normal",
