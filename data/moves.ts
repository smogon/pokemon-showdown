...
animonally: Animates when used against allies
...
export const Moves: {[moveid: string]: MoveData} = {
	...
	afteryou: {
		...
		pp: 15,
		priority: 0,
		flags: {authentic: 1, animonally: 1},
		onHit(target) {
	...
	babydolleyes: {
		...
		pp: 30,
		priority: 1,
		flags: {protect: 1, reflectable: 1, mirror: 1, animonally: 1},
		boosts: {
			atk: -1,
		},
		secondary: null,
	...
	beatup: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, animonally: 1},
	...
	bestow: {
		...
		pp: 15,
		priority: 0,
		flags: {mirror: 1, authentic: 1, animonally: 1},
		onHit(target, source, move) {
			if (target.item) {
				return false;
			}
	...
	featherdance: {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, reflectable: 1, mirror: 1, animonally: 1, dance: 1},
		boosts: {
			atk: -2,
		},
		secondary: null,
	...
	floralhealing: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, reflectable: 1, heal: 1, animonally: 1},
		onHit(target, source) {
			let success = false;
	...
	grassyglide: {
		...
		pp: 20,
		priority: 0,
		flags: {contact: 1, protect: 1, animonally: 1},
	...
	guardswap: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, authentic: 1, animonally: 1},
		onHit(target, source) {
	...
	healpulse: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, pulse: 1, reflectable: 1, distance: 1, heal: 1, animonally: 1},
		onHit(target, source) {
			let success = false;
	...
	instruct: {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, authentic: 1, animonally: 1},
		onHit(target, source) {
	...
	junglehealing: {
		...
		pp: 10,
		priority: 0,
		flags: {heal: 1, authentic: 1, animonally: 1},
		onHit(pokemon) {
	...
	magicpowder: {
		...
		pp: 20,
		priority: 0,
		flags: {powder: 1, protect: 1, reflectable: 1, mirror: 1, animonally: 1},
		onHit(target) {
	...
	metalsound: {
		...
		pp: 40,
		priority: 0,
		flags: {protect: 1, reflectable: 1, mirror: 1, sound: 1, authentic: 1, animonally: 1},
		boosts: {
			spd: -2,
		},
		secondary: null,
	...
	odorsleuth: {
		...
		pp: 40,
		priority: 0,
		flags: {protect: 1, reflectable: 1, mirror: 1, authentic: 1, animonally: 1},
		volatileStatus: 'foresight',
		onTryHit(target) {
			if (target.volatiles['miracleeye']) return false;
		},
	...
	roar: {
		...
		pp: 20,
		priority: -6,
		flags: {reflectable: 1, mirror: 1, sound: 1, authentic: 1, animonally: 1},
		forceSwitch: true,
		secondary: null,
		target: "normal",
		type: "Normal",
	...
	spotlight: {
		...
		pp: 15,
		priority: 3,
		flags: {protect: 1, reflectable: 1, animonally: 1},
	...
	telekinesis: {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, reflectable: 1, mirror: 1, gravity: 1, animonally: 1},
	...
	whirlwind: {
		...
		pp: 20,
		priority: -6,
		flags: {reflectable: 1, mirror: 1, authentic: 1, animonally: 1},
		forceSwitch: true,
		secondary: null,
		target: "normal",
		type: "Normal",
