...
export const Moves: {[moveid: string]: MoveData} = {
	...
	assist: {
		...
		pp: 20,
		priority: 0,
		flags: {failencore: 1, sleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		onHit(target) {
			const moves = [];
	...
	bide: {
		...
		pp: 10,
		priority: 1,
		flags: {contact: 1, protect: 1, sleeptalk: 1, instruct: 1},
		volatileStatus: 'bide',
		ignoreImmunity: true,
	...
	blazingtorque: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, failencore: 1, mefirst: 1, sleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		secondary: {
			chance: 30,
			status: 'brn',
		},
	...
	bounce: {
		...
		pp: 5,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, gravity: 1, distance: 1, sleeptalk: 1, assist: 1, instruct: 1},
	...
	counter: {
		...
		pp: 20,
		priority: -5,
		flags: {contact: 1, protect: 1, mefirst: 1, assist: 1, copycat: 1},
	...
	covet: {
		...
		pp: 25,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, mefirst: 1, assist: 1, copycat: 1},
	...
	dig: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, nonsky: 1, sleeptalk: 1, assist: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	dive: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, nonsky: 1, allyanim: 1, sleeptalk: 1, assist: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	dynamaxcannon: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, failencore: 1, sleeptalk: 1, parentalbond: 1, copycat: 1, instruct: 1, mimic: 1},
		secondary: null,
		target: "normal",
		type: "Dragon",
	},
	...
	focuspunch: {
		...
		pp: 20,
		priority: -3,
		flags: {contact: 1, protect: 1, punch: 1, mefirst: 1, sleeptalk: 1, assist: 1, copycat: 1, instruct: 1},
		priorityChargeCallback(pokemon) {
	...
	freezeshock: {
		...
		pp: 5,
		priority: 0,
		flags: {charge: 1, protect: 1, mirror: 1, sleeptalk: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	geomancy: {
		...
		pp: 10,
		priority: 0,
		flags: {charge: 1, nonsky: 1, sleeptalk: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	mefirst: {
		...
		pp: 20,
		priority: 0,
		flags: {protect: 1, bypasssub: 1, failencore: 1, mefirst: 1, sleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		onTryHit(target, pokemon) {
			...
			if (move.category === 'Status' || move.flags['mefirst']) return false;
	...
	metalburst: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, mefirst: 1},
		onTry(source) {
			const lastDamagedBy = source.getLastDamagedBy(true);
			if (lastDamagedBy === undefined || !lastDamagedBy.thisTurn) return false;
		},
	...
	mimic: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, bypasssub: 1, allyanim: 1, failencore: 1, sleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		onHit(target, source) {
	...
	mirrorcoat: {
		...
		pp: 20,
		priority: -5,
		flags: {protect: 1, mefirst: 1, assist: 1},
		beforeTurnCallback(pokemon) {
	...
	phantomforce: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, mirror: 1, sleeptalk: 1, assist: 1, instruct: 1},
		breaksProtect: true,
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
	...
	sketch: {
		...
		noPPBoosts: true,
		priority: 0,
		flags: {bypasssub: 1, allyanim: 1, failencore: 1, sleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		onHit(target, source) {
	...
	skullbash: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, sleeptalk: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	skyattack: {
		...
		pp: 5,
		priority: 0,
		flags: {charge: 1, protect: 1, mirror: 1, distance: 1, sleeptalk: 1, instruct: 1},
		critRatio: 2,
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
	...
	sleeptalk: {
		...
		onHit(pokemon) {
			...
			for (const moveSlot of pokemon.moveSlots) {
				...
				if (!moveid) continue;
				const move = this.dex.moves.get(moveid);
				if (move.flags['sleeptalk'] || move.flags['charge'] || (move.isZ && move.basePower !== 1) || move.isMax) {
					continue;
				}
				moves.push(moveid);
			}
	...
	solarblade: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, slicing: 1, sleeptalk: 1, instruct: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	struggle: {
		...
		noPPBoosts: true,
		priority: 0,
		flags: {contact: 1, protect: 1, failencore: 1, mefirst: 1, sleeptalk: 1, assist: 1, copycat: 1, instruct: 1, mimic: 1},
		noSketch: true,
		onModifyMove(move, pokemon, target) {
			move.type = '???';
	...
	uproar: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, sound: 1, bypasssub: 1, sleeptalk: 1, instruct: 1},
		self: {
