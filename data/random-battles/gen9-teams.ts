...
export class RandomTeams {
	...
	randomSets: {[species: string]: RandomTeamsTypes.RandomSpeciesData} = require('./gen9-sets.json');
	randomDoublesSets: {[species: string]: RandomTeamsTypes.RandomSpeciesData} = require('./gen9-doubles-sets.json');
