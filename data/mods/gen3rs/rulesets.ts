export const Rulesets: import('../../../sim/dex-formats').ModdedFormatDataTable = {
	standard: {
		...
		banlist: ['Volbeat + Trick + Baton Pass', 'Seedot + Leech Seed + Quick Attack', 'Nuzleaf + Leech Seed + Quick Attack', 'Shiftry + Leech Seed + Quick Attack', 'Spheal + Curse + Rock Slide', 'Sealeo + Curse + Rock Slide', 'Walrein + Curse + Rock Slide', 'Rhyhorn + Curse + Rock Slide', 'Rhydon + Curse + Rock Slide'],
	},
};
