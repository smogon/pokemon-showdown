export const Moves: {[k: string]: ModdedMoveData} = {
	...
	metronome: {
		inherit: true,
		flags: {noassist: 1, copycat: 1, nosleeptalk: 1, mimic: 1},
		noMetronome: [
	...
	mimic: {
		inherit: true,
		flags: {protect: 1, bypasssub: 1, allyanim: 1, noassist: 1, copycat: 1, failencore: 1, instruct: 1, mimic: 1},
		onHit(target, source) {
	...
	sketch: {
		inherit: true,
		flags: {bypasssub: 1, allyanim: 1, failencore: 1, noassist: 1, copycat: 1, instruct: 1, mimic: 1},
		onHit(target, source) {
	...
	snatch: {
		inherit: true,
		flags: {bypasssub: 1, noassist: 1, copycat: 1},
		condition: {
			duration: 1,
			onStart(pokemon) {
	...
	struggle: {
		inherit: true,
		flags: {contact: 1, protect: 1, failencore: 1, failmefirst: 1, noassist: 1, copycat: 1, instruct: 1, mimic: 1},
		onModifyMove(move) {
			move.type = '???';
		},
	},
