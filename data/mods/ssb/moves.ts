...
export const Moves: {[k: string]: ModdedMoveData} = {
	...
	*/
	...
	fishingforhacks: {
		...
		shortDesc: "Knock off opponent's item & set random hazard.",
	...
	wistfulthinking: {
		...
		basePower: 0,
		category: "Status",
		desc: "Burns the target and switches out. For five turns, Pokemon on the user's side heal 1/16 of their maximum HP per turn.",
		shortDesc: "Burn foe; switch out. Heals user side for 5 turns.",
	...
	croak: {
		...
		shortDesc: "2 random boosts, then attacks. +20 pow/boost.",
		name: "Croak",
		isNonstandard: "Custom",
		gen: 8,
		pp: 10,
	...
	kaboom: {
		...
		basePower: 150,
		category: "Special",
		desc: "This move's Base Power is equal to 70+(80*user's max HP/user's current HP). Sets Sunny Day.",
