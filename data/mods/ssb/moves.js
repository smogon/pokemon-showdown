...
let BattleMovedex = {
	...
	*/
	...
	chaotic: {
		...
		basePower: 70,
		category: "Physical",
		desc: "Before the user attacks, its Attack is increased by one stage. After the user attacks, one of the its stats other than accuracy and evasion is boosted by one stage.",
