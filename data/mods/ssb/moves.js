...
let BattleMovedex = {
	...
	*/
	...
	nekoveil: {
		...
		basePower: 0,
		category: "Status",
		desc: "The user sets up Light Screen, Reflect, and changes the weather to Sunny for 5 turns. The effects of Light Screen and reflect are extended to 8 turns if the user is holding Light Clay, and Sunny Weather remains for 8 turns if the user is holding a Heat Rock.",
	...
	birbtotherescue: {
		...
		basePower: 0,
		category: "Status",
		desc: "Resets the stat stages of all active Pokemon to 0, then lowers the foe's evasion by one stage and removes hazards.",
		shortDesc: "Resets stats; target's evasion: -1; removes hazards.",
		id: "birbtotherescue",
	...
	bringerofdarkness: {
		...
		shortDesc: "50% chance to sleep; sets Spikes; Spe or SpA: +1.",
	...
	"salutethecolonel": {
		...
		shortDesc: "Protects from attack; Contact: Atk: -2; Guard Swap.",
		id: "salutethecolonel",
		isNonstandard: "Custom",
	...
	"llamacide": {
		...
		basePower: 80,
		category: "Physical",
		desc: "This attack has a 40% chance to lower foe's Defense by one stage, and a 10% chance to Freeze it.",
	...
	scavengesu: {
		...
		shortDesc: "Harshly lowers own Atk/SpA; swaps stats with foe.",
		id: "scavengesu",
		name: "/scavenges u",
		isNonstandard: "Custom",
		pp: 5,
	...
	tippingover: {
		...
		shortDesc: "+20 power per boost. Resets non-Stockpile boosts.",
		id: "tippingover",
		name: "Tipping Over",
		isNonstandard: "Custom",
		pp: 10,
	...
	e: {
		...
		basePower: 0,
		category: "Status",
		desc: "Sets Trick Room for 5 turns and raises the user's Attack by one stage.",
	...
	twinweedle: {
		...
		shortDesc: "Hits twice; 20% poisons; heals 30% of dmg dealt.",
		id: "twinweedle",
		isNonstandard: "Custom",
		name: "TwinWeedle",
		pp: 25,
