...
let BattleMovedex = {
	...
	*/
	...
	murkyambush: {
		...
		basePower: 150,
		category: "Physical",
		desc: "This move fails unless a foe uses a contact move on the user before the user can execute the move on the same turn. The foe's move has its secondary effects suppressed and damage halved. If the user survives a hit, it attacks, and the effect ends. This move can affect Flying-type Pokemon.",
		shortDesc: "Prepares for foe's contact move, then retaliates.",
		id: "murkyambush",
		name: "Murky Ambush",
		isNonstandard: "Custom",
		pp: 10,
	...
	flock: {
		...
		accuracy: 100,
		category: "Special",
		desc: "This move supresses the foe's ability and has a 70% chance to boost the user's Special Attack and Speed by one stage.",
	...
	justdance: {
		...
		basePower: 0,
		category: "Status",
		desc: "Uses a random dance move twice in a row and then restores 1/3 of its max HP.",
	...
	superegoinflation: {
		accuracy: true,
		category: "Status",
		desc: "User heals 25% HP. The target's Attack and Special Attack increase by two stages, and the target becomes Taunted.",
	...
	hitandrun: {
		...
		basePower: 70,
		category: "Special",
		desc: "If this move hits, the Pokemon that was hit is affected with Gooey. Gooey causes the affected pokemon to lose 1/6 of its max HP until it switches out. The user switches out.",
	...
	chaotic: {
		...
		shortDesc: "Before attack: Atk +1; then, random stat +1.",
		id: "chaotic",
		name: "Chaotic",
		isNonstandard: "Custom",
		pp: 10,
	...
	ectoplasm: {
		...
		basePower: 95,
		category: "Special",
		desc: "This move's typing is equal to the user's secondary type. Has a 10% chance to lower the user's Special Defense by 1.",
	...
	barfight: {
		...
		basePower: 10,
		category: "Physical",
		desc: "Raises both the user's and the target's Attack by three stages, lowers the Defense of both by three stages, confuses both Pokemon, and has a 100% chance to cause the target to flinch. Only works on your first turn out.",
	...
	omboom: {
		...
		basePower: 110,
		category: "Physical",
		desc: "Has a 50% chance to raise the user's Speed by two stages or 5% chance to raise the user's Attack by one stage.",
	...
	stunner: {
		...
		basePower: 100,
		category: "Physical",
		desc: "Has a 70% chance to raise the user's Attack by one stage. 20% chance to paralyze the foe or cause them to flinch.",
	...
	plurshift: {
		...
		basePower: 120,
		category: "Physical",
		desc: "Has a 10% chance per effect to apply Taunt, confusion, flinch, Heal Block, and/or Focus Energy to the target. Afterwards, the user is switched out for another Pokemon in its party. The selected Pokemon has the user's stat stage changes, confusion, and certain move effects transferred to it. ",
	...
	greed: {
		...
		basePower: 0,
		category: "Status",
		desc: "If there are no stealth rocks on the foe's side of the field, sets Stealth Rocks and one layer of Spikes. Otherwise, it sets two layers of Spikes.",
	...
	ceilingsabsent: {
		...
		basePower: 0,
		category: "Status",
		desc: "Before the turn starts, this Pokemon uses Taunt against the foe. When this move hits, heals the user by 50% of its max HP.",
	...
	glitzerpopping: {
		...
		basePower: 0,
		category: "Status",
		desc: "Uses a random move 2-5 times.  Does not include Z-Moves that have 1 Base Power and Glitzer Popping.",
