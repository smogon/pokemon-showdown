...
export const Moves: import('../../../sim/dex-moves').ModdedMoveDataTable = {
	...
	aeroblast: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, distance: 1, metronome: 1, wind: 1, snatch: 1,},
		critRatio: 2,
		secondary: null,
		target: "any",
		type: "Flying",
	...
	aromatherapy: {
		...
		pp: 5,
		priority: 0,
		flags: {snatch: 1, distance: 1, metronome: 1, wind: 1,},
		onHit(target, source, move) {
	...
	bloodmoon: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1, cantusetwice: 1, light: 1,},
		secondary: null,
		target: "normal",
		type: "Normal",
	},
	...
	bravebird: {
		...
		pp: 15,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, distance: 1, metronome: 1, wing: 1,},
		recoil: [33, 100],
		secondary: null,
		target: "any",
		type: "Flying",
	...
	brine: {
		...
		condition: {
			...
			onEnd(pokemon) {
				this.add('-end', pokemon, 'Brine');
			},
		},
		secondary: {
			chance: 100,
			volatileStatus: 'brine',
		},
		target: "normal",
		type: "Water",
		contestType: "Tough",
	...
	bulletpunch: {
		...
		pp: 30,
		priority: 1,
		flags: {contact: 1, protect: 1, mirror: 1, punch: 1, metronome: 1, bullet: 1,},
		secondary: null,
		target: "normal",
		type: "Steel",
		contestType: "Tough",
	...
	confuseray: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, reflectable: 1, mirror: 1, metronome: 1, beam: 1,},
		volatileStatus: 'confusion',
		secondary: null,
		target: "normal",
		type: "Ghost",
	...
	doomdesire: {
		...
		pp: 5,
		priority: 0,
		flags: {metronome: 1, protect:1, cantusetwice: 1, light: 1,},
		secondary: null,
		target: "normal",
		type: "Steel",
		contestType: "Beautiful",
	...
	eeriespell: {
		...
		secondary: {
			...
			onHit(target) {
				...
				const ppDeducted = target.deductPP(move.id, 5);
	...
	eternabeam: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, cantusetwice: 1, light: 1,},
		secondary: null,
		target: "normal",
		type: "Dragon",
	},
	...
	featherdance: {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, snatch: 1, mirror: 1, dance: 1, metronome: 1},
		boosts: {
			spa: 1,
			spe: 1,
		},
	...
	flameburst: {
		...
		pp: 15,
		priority: 0,
		flags: {mirror: 1, metronome: 1, bypasssub: 1, light: 1,},
		onHit(target, source, move) {
	...
	frenzyplant: {
		...
		pp: 5,
		priority: 0,
		flags: {charge: 1, protect: 1, mirror: 1, nonsky: 1, metronome: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	heatwave: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1, wind: 1, pulse: 1,},
		secondary: {
			chance: 10,
			status: 'brn',
		},
	...
	hornleech: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, heal: 1, metronome: 1, head: 1,},
		drain: [1, 2],
		secondary: null,
		target: "normal",
		type: "Grass",
	...
	hyperdrill: {
		...
		pp: 5,
		priority: 0,
		flags: {contact: 1, mirror: 1, slicing: 1, tail: 1,},
		willCrit: true,
		secondary: null,
		target: "normal",
		type: "Normal",
	...
	megakick: {
		...
		hasCrashDamage: true,
		onMoveFail(target, source, move) {
			this.damage(source.baseMaxhp / 2, source, source, this.dex.conditions.get('Mega Kick'));
		},
		secondary: null,
		target: "normal",
		type: "Normal",
	...
	mindblown: {
		...
		pp: 5,
		priority: 0,
		flags: {protect: 1, mirror: 1, bullet: 1, light: 1,},
	...
	oblivionwing: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, distance: 1, heal: 1, metronome: 1, wing: 1,},
		drain: [3, 4],
		secondary: null,
		target: "any",
		type: "Flying",
	...
	odorsleuth: {
		...
		pp: 40,
		priority: 0,
		flags: {protect: 1, mirror: 1, bypasssub: 1, allyanim: 1, metronome: 1, contact: 1,},
		secondary: null,
		target: "normal",
		type: "Ground",
		zMove: {boost: {atk: 1}},
	...
	prismaticlaser: {
		...
		onAfterMove(pokemon, target, move) {
			if (move.mindBlownRecoil && !move.multihit) {
				const hpBeforeRecoil = pokemon.hp;
				this.damage(Math.round(pokemon.maxhp / 4), pokemon, pokemon, this.dex.conditions.get('Prismatic Laser'), true);
				if (pokemon.hp <= pokemon.maxhp / 4 && hpBeforeRecoil > pokemon.maxhp / 4) {
					this.runEvent('EmergencyExit', pokemon, pokemon);
				}
			}
	...
	quiverdance: {
		...
		pp: 20,
		priority: 0,
		flags: {snatch: 1, dance: 1, metronome: 1, wing: 1,},
		boosts: {
			spa: 1,
			spd: 1,
			spe: 1,
	...
	seismictoss: {
		...
		pp: 20,
		priority: 0,
		flags: {contact: 1, protect: 1, mirror: 1, nonsky: 1, metronome: 1, noparentalbond: 1},
		secondary: null,
		target: "normal",
		type: "Fighting",
		maxMove: {basePower: 75},
	...
	shedtail: {
		...
		onTryHit(source) {
			...
			if (source.hp <= Math.ceil(source.maxhp / 1.1)) {
				this.add('-fail', source, 'move: Shed Tail', '[weak]');
				return this.NOT_FAIL;
			}
		},
		onHit(target) {
			this.directDamage(Math.ceil(target.maxhp / 1.1));
		},
		self: {
			onHit(source) {
				source.skipBeforeSwitchOutEventFlag = true;
	...
	skullbash: {
		...
		pp: 10,
		priority: 0,
		flags: {contact: 1, charge: 1, protect: 1, mirror: 1, metronome: 1, nosleeptalk: 1, failinstruct: 1, head: 1},
		onTryMove(attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	sonicboom: {
		...
		pp: 20,
		priority: 0,
		flags: {protect: 1, mirror: 1, metronome: 1, sound: 1, bullet: 1},
		secondary: null,
		target: "normal",
		type: "Normal",
		contestType: "Cool",
	...
	telekinesis: {
		...
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1, gravity: 1, allyanim: 1, metronome: 1},
		recoil: [1, 3],
		secondary: null,
		target: "normal",
		type: "Psychic",
	...
	thousandarrows: {
		...
		pp: 10,
		priority: 0,
		flags: {protect: 1, mirror: 1, nonsky: 1, bullet: 1,},
		onEffectiveness(typeMod, target, type, move) {
	...
	toxicspikes: {
		...
		condition: {
			...
			onEntryHazard(pokemon) {
				...
				} else if (pokemon.hasType('Steel') || pokemon.hasItem('heavydutyboots') || pokemon.hasAbility("Oblivious")) {
					return;
