...
export const Scripts: ModdedBattleScriptsData = {
	...
	field: {
		setClimateWeather(
			...
			const prevWeather = this.climateWeather;
			const prevWeatherState = this.climateWeatherState;
			...
			if (!this.battle.singleEvent('FieldStart', status, this.climateWeatherState, this, source, sourceEffect)) {
				this.climateWeather = prevWeather;
				this.climateWeatherState = prevWeatherState;
				return false;
