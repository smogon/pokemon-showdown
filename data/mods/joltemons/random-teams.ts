		...
		if (abilities[1]) {
			...
			do {
				...
				if (['Cloud Nine', 'Innards Out', 'Insomnia', 'Misty Surge', 'Quick Feet', 'Steadfast', 'Steam Engine', 'Weak Armor', 'Defeatist'].includes(ability)) {
					...
					rejectAbility = (!hasMove['raindance'] && (hasAbility['Intimidate'] || (hasAbility['Lightning Rod'] && !counter.setupType) ||
						hasAbility['Rock Head'] || hasAbility['Slush Rush'] || hasAbility['Light Power'] || hasAbility['Water Absorb']));
