export const Pokedex: {[k: string]: ModdedSpeciesData} = {
	...
	eevee: {
		...
		weightkg: 6.5,
		color: "Brown",
		evos: ["Vaporeon", "Jolteon", "Flareon", "Espeon", "Umbreon", "Leafeon", "Glaceon", "Sylveon", "Enigmeon"],
		eggGroups: ["Field"],
	...
	marill: {
		...
		formeOrder: ["Marill", "Marill-Kaskade"],
		canHatch: true,
	},
	marillkaskade: {
		num: 183,
	...
	abomasnow: {
		...
		formeOrder: ["Abomasnow", "Abomasnow-Mega", "Abomasnow-Lowland"],
	},
	abomasnowmega: {
		num: 460,
		name: "Abomasnow-Mega",
	...
	// new swse stuff is in base folder, except for new evos!
	enigmeon: {
		num: 2048,
		name: "Enigmeon",
		types: ["Normal"],
