...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standard: {
		...
		ruleset: [
			'Obtainable', 'Team Preview', '+Past', 'Sleep Clause Mod', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod',
		],
	},
	standardnext: {
		effectType: 'ValidatorRule',
