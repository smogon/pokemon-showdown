export const Scripts: ModdedBattleScriptsData = {
	...
	calculatePP(move, ppUps) {
		// https://github.com/smogon/pokemon-showdown/pull/11844
		return move.noPPBoosts ? move.pp : (move.pp / 5 + 1) * 4;
	},
	actions: {
		canMegaEvo(pokemon: Pokemon) {
			// https://github.com/smogon/pokemon-showdown/pull/11509
	...
	pokemon: {
		// Don't revert Mega Evolutions when fainting
	...
	queue: {
		// https://github.com/smogon/pokemon-showdown/pull/11340
		orders: {
			// TODO
			team: 1,
			start: 2,
