...
export const Moves: import('../../../sim/dex-moves').ModdedMoveDataTable = {
	...
	counter: {
		...
		beforeTurnCallback: Inherit.NONE,
		onTry: Inherit.NONE,
		condition: {},
		priority: -1,
	},
	...
	encore: {
		...
		condition: {
			...
			onResidualOrder: 13,
			onResidualSubOrder: Inherit.NONE,
		},
	},
	endure: {
		inherit: true,
	...
	lockon: {
		...
		condition: {
			inherit: true,
			onSourceInvulnerability: Inherit.NONE,
		},
	},
	lowkick: {
		inherit: true,
		accuracy: 90,
		basePower: 50,
		basePowerCallback: Inherit.NONE,
		secondary: {
			chance: 30,
