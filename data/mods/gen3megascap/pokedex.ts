...
export const Pokedex: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	...
	venomothmega: { num: 49, name: "Venomoth-Mega", baseSpecies: "Venomoth", forme: "Mega", types: ["Bug", "Poison"], baseStats: { hp: 85, atk: 110, def: 80, spa: 70, spd: 80, spe: 120 }, abilities: { 0: "Merciless" }, heightm: 1.5, weightkg: 12.5, color: "Purple", eggGroups: ["Bug"], requiredItem: "Venomite", gen: 3, isNonstandard: null },
	...
	corsolamega: { num: 222, name: "Corsola-Mega", baseSpecies: "Corsola", forme: "Mega", types: ["Water", "Psychic"], baseStats: { hp: 90, atk: 70, def: 115, spa: 120, spd: 115, spe: 30 }, abilities: { 0: "Natural Cure" }, heightm: 0.6, weightkg: 5, color: "Pink", eggGroups: ["Water 1", "Water 3"], requiredItem: "Corsolite", gen: 3, isNonstandard: null },
	...
	volbeatmega: { num: 313, name: "Volbeat-Mega", baseSpecies: "Volbeat", forme: "Mega", types: ["Bug", "Electric"], baseStats: { hp: 85, atk: 65, def: 75, spa: 90, spd: 90, spe: 125 }, abilities: { 0: "Polar Switch" }, heightm: 0.7, weightkg: 17.7, color: "Gray", eggGroups: ["Bug", "Human-Like"], requiredItem: "Volbeatite", gen: 3, isNonstandard: null },
	...
	parasectmega: { inherit: true, gen: 3, isNonstandard: null, baseStats: { hp: 90, atk: 135, def: 100, spa: 50, spd: 100, spe: 30 }, abilities: { 0: "Regenerator" } },
