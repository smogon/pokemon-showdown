...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standard: {
		...
		ruleset: [
			'Obtainable', 'Team Preview', 'Sleep Clause Mod', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Evasion Items Clause', 'Evasion Moves Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod', 'Overflow Stat Mod',
			'Min Source Gen = 9',
		],
	},
	standardnext: {
