...
export const Rulesets: import('../sim/dex-formats').FormatDataTable = {
	...
	nuevometapokedex: {
		...
		onValidateSet(set, format) {
			...
			"Chikorita", "Bayleef", "Meganium", "Cyndaquil", "Quilava", "Typhlosion", "Typhlosion-Hisui", "Totodile", "Croconaw", "Feraligatr", "Sentret", "Furret", "Furrip", "Furrum", "Furrful", "Hoothoot", "Noctowl", "Noceadowl", "Ledyba", "Ledian", "Ledstar", "Spinarak", "Ariados", "Crobat", "Chinchou", "Lanturn", "Pichu", "Pichu-Spiky-Eared", "Cleffa", "Igglybuff", "Togepi", "Togetic", "Natu", "Xatu", "Xatu", "Disdowoodion", "Sunfulwer", "Quagsire", "Quagsire-Feudal", "Slowking", "Slowking-Feudal", "Wungsparce"
			];
