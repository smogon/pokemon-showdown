...
export const Rulesets: import('../sim/dex-formats').FormatDataTable = {
	...
	kantopokedex: {
		...
		onValidateSet(set, format) {
			const hoennDex = [
				"Bulbasaur", "Ivysaur", "Venusaur", "Charmander", "Charmeleon", "Charizard", "Squirtle", "Wartortle", "Blastoise", "Caterpie", "Metapod", "Butterfree", "Weedle", "Kakuna", "Beedrill", "Pidgey", "Pidgeotto", "Pidgeot", "Rattata", "Raticate", "Raticate-Alola", "Spearow", "Fearow", "Fearill", "Ekans", "Arbok", "P"
			];
