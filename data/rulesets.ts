...
export const Rulesets: import('../sim/dex-formats').FormatDataTable = {
	...
	nuevometapokedex: {
		...
		onValidateSet(set, format) {
			...
			"Chikorita", "Bayleef", "Meganium", "Cyndaquil", "Quilava", "Typhlosion", "Typhlosion-Hisui", "Totodile", "Croconaw", "Feraligatr", "Sentret", "Furret", "Furrip", "Furrum", "Furrful", "Hoothoot", "Noctowl", "Noceadowl", "Ledyba", "Ledian", "Ledstar", "Spinarak", "Ariados", "Crobat", "Chinchou", "Lanturn", "Pichu", "Pichu-Spiky-Eared", "Cleffa", "Igglybuff", "Togepi", "Togetic", "Natu", "Xatu", "Xatu-Totem", "Mareep", "Flaaffy", "Ampharos", "Bellosom", "Marill", "Azumarill", "Sudowoodo", "Disdowoodion", "Politoed", "Hoppip", "Skiploom", "Jumpluff", "Aipom", "Sunkern", "Sunflora", "Sunfulwer", "Yanma", "Wooper", "Wooper-Paldea", "Quagsire", "Quagsire-Feudal", "Espeon", "Umbreon", "Murkrow", "Slowking", "Slowking-Feudal", "Slowking-Galar", "Misdreavus", "Unown", "Wobbuffet", "Giragarig", "Pineco", "Forretress", "Dunsparce", "Wungsparce", "Wungsparce-Feudal", "Gligar", "Steelix", "Snubbull", "Grandbull", "Grandbull-Feudal", "Qwilfish", "Qwilfish-Feudal", "Qwilfish-Hisui", "Scizor", "Shuckle", "Heracross", "Sneasle", "Sneasle-Hisui", "Teddiursa", "Ursaring", "Ursaring-Feudal", "Slugma", "Magcargo", "Slastma", "Swinub", "Piloswine", "Corsola", "Corsola-Galar", "Crowthsola", "Remoraid", "Octillery", "Octank", "Delibird",
