	...
	spikemuthcupgbu: {
		...
		onValidateSet(set, format) {
			...
			!tundraDex.includes(species.baseSpecies) && !tundraDex.includes(species.name)
				...
				return [`${species.baseSpecies} is not in the Galar, Isle of Armor, or Crown Tundra Pokédex.`];
			}
		},
	},
	standarddoubles: {
