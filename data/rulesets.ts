...
export const Rulesets: {[k: string]: FormatData} = {
	...
	"eventmovesclause": {
		...
		banlist: [
						...
						'Alakazam + Foresight',
						'Ariados + Growth',
						'Azumarill + Dizzy Punch', 'Azumarill + Hydro Pump', 'Azumarill + Scary Face',
						'Bayleef + Petal Dance',
						'Bellossom + Leech Seed',
						'Bellsprout + Lovely Kiss', 'Bellsprout + Sweet Kiss',
						'Blastoise + Zap Cannon',
						'Blissey + Sweet Scent',
						'Bulbasaur + Ancient Power',
						'Chansey + Sweet Scent',
						'Charizard + Crunch',
						'Charmander + Crunch',
						'Charmeleon + Crunch',
						...
						'Clefable + Scary Face', 'Clefable + Petal Dance', 'Clefable + Swift',
						'Clefairy + Scary Face', 'Clefairy + Petal Dance', 'Clefairy + Swift',
						'Cleffa + Petal Dance', 'Cleffa + Swift', 'Cleffa + Scary Face',
						'Crobat + Flail',
						'Croconaw + Submission',
						'Cubone + Fury Cutter',
						'Cyndaquil + Double Edge',
						'Delibird + Pay Day', 'Delibird + Spikes',
						'Dewgong + Flail',
						'Dodrio + Low Kick',
						'Doduo + Low Kick',
						'Donphan + Encore', 'Donphan + Absorb',
						'Dragonair + Hydro Pump',
						'Dragonite + Hydro Pump',
						'Dratini + Hydro Pump',
						'Drowzee + Amnesia',
						'Dunsparce + Fury Attack', 'Dunsparce + Horn Drill',
						'Eevee + Growth',
						'Electabuzz + Pursuit',
						'Electrode + Agility',
						'Elekid + Pursuit',
						'Espeon + Growth',
						'Exeggcute + Sweet Scent', 'Exeggutor + Sweet Scent',
						'Farfetch\'d + Fury Cutter',
						'Fearow + Pay Day', 'Fearow + Sonic Boom',
						...
						'Golduck + Tri Attack', 'Golduck + Petal Dance',
						'Golem + Rapid Spin',
						'Granbull + Lovely Kiss',
						'Graveler + Rapid Spin',
						'Gyarados + Bubble', 'Gyarados + Reversal',
						...
						'Horsea + Haze',
						'Hypno + Amnesia',
						'Igglybuff + Petal Dance', 'Igglybuff + Mimic', 'Igglybuff + Scary Face',
						'Ivysaur + Ancient Power',
						'Jigglypuff + Petal Dance', 'Jigglypuff + Scary Face',
						'Jolteon + Growth',
						'Jumpluff + Agility',
						'Jynx + Petal Dance',
						'Kabuto + Rock Throw',
						...
						'Lapras + Bite', 'Lapras + Future Sight',
						'Larvitar + Rage',
						'Ledian + Barrier',
						'Ledyba + Barrier',
						'Lickitung + Double Slap',
						'Machamp + False Swipe', 'Machamp + Thrash',
						'Machoke + False Swipe', 'Machoke + Thrash',
						'Machop + False Swipe', 'Machop + Thrash',
						'Magby + Faint Attack',
						'Magikarp + Dragon Rage', 'Magikarp + Bubble', 'Magikarp + Reversal',
						'Magmar + Faint Attack',
						'Magnemite + Agility',
						'Magneton + Agility',
						'Mantine + Gust',
						'Marill + Dizzy Punch', 'Marill + Hydro Pump', 'Marill + Scary Face',
						'Marowak + Fury Cutter',
						...
						'Murkrow + Beat Up',
						'Natu + Safeguard',
						'Nidoking + Lovely Kiss', 'Nidoking + Morning Sun', 'Nidoking + Sweet Kiss',
						'Nidoqueen + Lovely Kiss', 'Nidoqueen + Moonlight', 'Nidoqueen + Sweet Kiss',
						'Nidoran-F + Lovely Kiss', 'Nidoran-F + Moonlight', 'Nidoran-F + Sweet Kiss',
						'Nidoran-M + Lovely Kiss', 'Nidoran-M + Morning Sun', 'Nidoran-M + Sweet Kiss',
						'Nidorina + Lovely Kiss', 'Nidorina + Moonlight', 'Nidorina + Sweet Kiss', 
						'Nidorino + Lovely Kiss', 'Nidorino + Morning Sun', 'Nidorino + Sweet Kiss',
						'Noctowl + Night Shade',
						'Octillery + Amnesia', 'Octillery + Mist',
						'Oddish + Leech Seed',
						'Omanyte + Rock Throw',
						'Omastar + Rock Throw',
						'Onix + Sharpen',
						'Paras + Synthesis',
						'Parasect + Synthesis',
						'Phanpy + Encore', 'Phanpy + Absorb',
						'Pichu + Petal Dance', 'Pichu + Sing', 'Pichu + Scary Face',
						'Pikachu + Fly', 'Pikachu + Scary Face', 'Pikachu + Petal Dance', 'Pikachu + Sing',
						'Piloswine + Whirlwind',
						'Pineco + Substitute',
						'Pinsir + Rock Throw',
						'Politoed + Growth', 'Politoed + Lovely Kiss', 'Politoed + Sweet Kiss',
						'Poliwag + Growth', 'Poliwag + Lovely Kiss', 'Poliwag + Sweet Kiss',
						'Poliwhirl + Growth', 'Poliwhirl + Lovely Kiss', 'Poliwhirl + Sweet Kiss',
						'Poliwrath + Growth', 'Poliwrath + Lovely Kiss', 'Poliwrath + Sweet Kiss',
						'Ponyta + Low Kick',
						'Porygon + Barrier',
						'Porygon2 + Barrier',
						'Psyduck + Petal Dance', 'Psyduck + Tri Attack',
						'Pupitar + Rage',
						'Quagsire + Scary Face', 'Quagsire + Belly Drum',
						'Quilava + Double Edge',
						'Qwilfish + Double Edge',
						'Raichu + Fly', 'Raichu + Scary Face', 'Raichu + Petal Dance', 'Raichu + Sing',
						'Rapidash + Pay Day', 'Rapidash + Low Kick',
						'Remoraid + Amnesia', 'Remoraid + Mist',
						'Scizor + Sonic Boom',
						'Scyther + Sonic Boom',
						'Seadra + Haze',
						...
						'Skiploom + Agility',
						'Smoochum + move: Metronome', 'Smoochum + Petal Dance',
						'Sneasel + Moonlight',
						'Snorlax + Lovely Kiss', 'Snorlax + Splash', 'Snorlax + Sweet Kiss',
						...
						'Vaporeon + Growth',
						'Venusaur + Ancient Power',
						'Victreebel + Lovely Kiss', 'Victreebel + Sweet Kiss',
						'Vileplume + Leech Seed',
						'Voltorb + Agility',
						'Wartortle + Zap Cannon',
						'Weepinbell + Lovely Kiss', 'Weepinbell + Sweet Kiss',
						'Wigglytuff + Scary Face', 'Wigglytuff + Petal Dance',
						'Wobbuffet + Mimic',
						'Wooper + Belly Drum', 'Wooper + Scary Face',
						'Xatu + Safeguard',
						'Yanma + Steel Wing', 'Yanma + Sweet Kiss',
						'Zubat + Flail',
		],
		onBegin() {
			this.add('rule', 'Event Moves Clause: Event moves are banned');
		},
	},
	cuplevellimit: {
			effectType: 'ValidatorRule',
