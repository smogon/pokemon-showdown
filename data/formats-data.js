...
exports.BattleFormatsData = {
	...
	exeggutoralola: {
		...
		randomDoubleBattleMoves: ["dracometoer", "leafstorm", "protect", "flamethrower", "trickroom", "woodhammer", "dragonhammer", "protect"],
		tier: "New",
	},
	cubone: {
	...
	silvally: {
		...
		randomDoubleBattleMoves: ["protect", "doubledge", "uturn", "crunch", "icebeam", "flamethrower", "partingshot"],
		tier: "New",
	},
	silvallybug: {
		randomBattleMoves: ["flamethrower", "icebeam", "thunderbolt", "uturn"],
		randomDoubleBattleMoves: ["protect", "uturn", "flamethrower", "icebeam", "thunderbolt"],
		requiredItem: "Bug Memory",
		tier: "New",
	},
	silvallydark: {
		randomBattleMoves: ["multiattack", "swordsdance", "flamecharge", "ironhead"],
		randomDoubleBattleMoves: ["protect", "multiattack", "icebeam", "partingshot", "uturn"],
	...
	silvallydragon: {
		...
		randomDoubleBattleMoves: ["dracometeor", "icebeam", "flamethrower", "partingshot", "uturn"],
		requiredItem: "Dragon Memory",
		tier: "New",
	},
	silvallyelectric: {
		randomBattleMoves: ["multiattack", "flamethrower", "icebeam", "partingshot", "toxic"],
		randomDoubleBattleMoves: ["thunderbolt", "icebeam", "uturn", "partingshot"],
