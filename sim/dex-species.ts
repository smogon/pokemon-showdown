...
type SpeciesTag = "Mythical" | "Restricted Legendary" | "Sub-Legendary" | "Paradox" | "Insurgence" | "Plan of Attack" | "Uranium";
...
export class Species extends BasicEffect implements Readonly<BasicEffect & SpeciesFormatsData> {
	...
	constructor(data: AnyObject) {
		...
		this.isMega = !!(this.forme && ['Mega', 'Mega-X', 'Mega-Y', 'Mega-M', 'Mega-F', 'Mega-Fire', 'Mega-Five'].includes(this.forme)) || undefined;
