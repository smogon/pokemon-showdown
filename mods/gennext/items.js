exports.BattleItems = {
	...
	"stick": {
		...
		onFoeBasePower: function(basePower, attacker, defender, move) {
			var GossamerWingUsers = {"Butterfree":1, "Masquerain":1, "Beautifly":1, "Mothim":1, "Vivillon":1, "Lilligant":1};
		...
		onDamage: function(damage, defender, attacker, effect) {
			var GossamerWingUsers = {"Butterfree":1, "Masquerain":1, "Beautifly":1, "Vivillon":1, "Mothim":1};
			if (GossamerWingUsers[defender.template.species]) {
