...
exports.BattleFormatsData = {
	...
	jirachi: {
		...
		eventPokemon: [
			...
			{"generation": 3, "level": 5, "shiny": true, "nature": "Bashful", "abilities":["serenegrace"], "moves":["wish", "confusion", "rest"]},
			{"generation": 3, "level": 5, "shiny": true, "nature": "Careful", "abilities":["serenegrace"], "moves":["wish", "confusion", "rest"]},
			{"generation": 3, "level": 5, "shiny": true, "nature": "Docile", "abilities":["serenegrace"], "moves":["wish", "confusion", "rest"]},
			{"generation": 3, "level": 5, "shiny": true, "nature": "Hasty", "abilities":["serenegrace"], "moves":["wish", "confusion", "rest"]},
			{"generation": 3, "level": 5, "shiny": true, "nature": "Jolly", "abilities":["serenegrace"], "moves":["wish", "confusion", "rest"]},
			{"generation": 3, "level": 5, "shiny": true, "nature": "Lonely", "abilities":["serenegrace"], "moves":["wish", "confusion", "rest"]},
			{"generation": 3, "level": 5, "shiny": true, "nature": "Naughty", "abilities":["serenegrace"], "moves":["wish", "confusion", "rest"]},
			{"generation": 3, "level": 5, "shiny": true, "nature": "Serious", "abilities":["serenegrace"], "moves":["wish", "confusion", "rest"]},
			{"generation": 3, "level": 5, "shiny": true, "nature": "Timid", "abilities":["serenegrace"], "moves":["wish", "confusion", "rest"]},
