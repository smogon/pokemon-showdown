...
exports.BattleScripts = {
	init: function () {
		...
		this.modData('Learnsets', 'absol').learnset.partingshot = ['7T'];
		...
		this.modData('Learnsets', 'reuniclus').learnset.voltswitch = ['7T'];
		this.modData('Pokedex', 'audinomega').abilities['0'] = 'Simple';
		this.modData('Learnsets', 'ampharos').learnset.wish = ['7T'];
		this.modData('Pokedex', 'absolmega').types = ['Dark', 'Fairy'];
		this.modData('Learnsets', 'pangoro').learnset.suckerpunch = ['7T'];
		...
		this.modData('Learnsets', 'mantine').learnset.roost = ['7T'];
		this.modData('Learnsets', 'pidgeot').learnset.focusblast = ['7T'];
		...
		this.modData('Learnsets', 'bronzong').learnset.recover = ['7T'];
		this.modData('Learnsets', 'sandslash').learnset.thousandarrows = ['7T'];
		this.modData('Movedex', 'thousandarrows').isUnreleased = false;
		this.modData('Learnsets', 'braviary').learnset.extremespeed = ['7T'];
		...
		this.modData('Learnsets', 'krookodile').learnset.dragondance = ['7T'];
		...
		this.modData('Learnsets', 'banette').learnset.drainpunch = ['7T'];
