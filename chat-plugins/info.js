...
exports.commands = {
	...
	roomhelp: function (target, room, user) {
		...
		this.sendReplyBox(
			"<details>" +
				"<summary>Room Auth Commands:</summary>" +
				"Room drivers (%) can use:<br />" +
				"- /warn OR /k <em>username</em>: warn a user and show the Pok&eacute;mon Showdown rules</p><br />" +
			...
			"<details>" +
				...
				"<br />" +
				"More detailed help can be found <a href=\"https://www.smogon.com/forums/threads/3570628/#post-6777489\">here</a><br />" +
				"</div>" +
			"</details>"
		);
	},
