...
exports.commands = {
	...
	dexsearchhelp: [
		...
		"Types can be searched for by either having the type precede 'type' or just using the type itself as a paramater, e.g., both 'fire type' and 'fire' show all Fire types; however, using 'psychic' as a parameter will show all Pok\u00e9mon that learn the move Psychic and not Psychic types.",
		...
		"Searching for a Pok\u00e9mon with both egg group and type paramaters can be differentiated by adding the suffix 'group' onto the egg group parameter, e.g., seaching for 'grass, grass group' will show all Grass types in the Grass egg group.",
