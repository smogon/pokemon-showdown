...
exports.commands = {
	...
	pollhelp: ["/poll allows rooms to run their own polls. These polls are limited to one poll at a time per room.",
				...
				"/poll htmlcreate [question], [option1], [option2], [...] - Creates a poll, with HTML allowed in the question and options. Each option can be on a separate line when the command is being sent. Requires: # & ~",
