...
export const translations: TranslationCatalog = {
	...
	"User '{TARGETUSER}' not found.": "L'utilisateur {TARGETUSER}' n'a pas été trouvé.",
	"User \"{TARGETUSER}\" not found.": "L'utilisateur \"{TARGETUSER}\" n'a pas été trouvé.",
	"Refresh": "Rafraîchir",
	"Action": "Action",
	...
	"Your status is too long; it must be under {MAX} characters.": "Ton statut est trop long ; il doit être en dessous de {MAX} caractères.",
	...
	"You are {LOCKTYPE} and can't talk in chat. {EXPIRATION}": "Tu es {LOCKTYPE} et ne peux pas parler dans le chat. {EXPIRATION}",
	// TRANSLATORS: your lock
	"Get help with this": "Reçois de l'aide avec ceci",
	...
	"Because moderated chat is set, you must be of rank {GROUP} or higher to speak in this room.": "À cause du modchat, tu dois être {GROUP} ou plus pour parler dans cette room.",
	...
	"This room has slow-chat enabled. You can only talk once every {SECONDS} seconds.": "Cette room a le slowchat activé. Tu ne peux envoyer un message que toutes les {SECONDS} secondes.",
