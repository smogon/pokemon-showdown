...
export const translations: TranslationCatalog = {
	...
	", because you have the same IP as {USER}.": ", ya que tienes la misma IP de {USER}.",
	...
	"And {COUNT} more tickets.": "Y {COUNT} tickets más.",
	...
	"Expires": "Expira",
	"Logs": "Logs",
	"And {COUNT} more ticket bans.": "Y {COUNT} ticket bans más.",
	...
	"You need to choose a username before doing this.": "Tú necesitas elegir un nombre de usuario antes de hacer esto.",
	...
	"Due to high load, you are limited to creating {MAX} tickets every hour.": "Debido a la alta demanda, estás limitado a crear {MAX} tickets cada hora.",
	...
	"Hi! What seems to be the problem? Tell us about any people involved, and if this happened in a specific place on the site.": "¡Hola! ¿Cuál parece ser el problema? Cuéntanos sobre cualquier persona involucrada y en dónde sucedió.",
	...
	" Or if {USER} is not the user you want to report, please tell us the name of the user who you want to report.": "O si {USER} no es el usuario que deseas reportar, por favor indícanos el nombre del usuario que deseas reportar.",
	...
	"{TARGETUSER} does not have an open ticket.": "{TARGETUSER} no tiene un ticket abierto.",
	"You closed {USER}'s ticket.": "Tú cerraste el ticket de {USER}.",
	"The reason is too long. It cannot exceed 300 characters.": "La razón es demasiado extensa. No puede exceder los 300 caracteres.",
	"{TARGETUSER} is not ticket banned.": "{TARGETUSER} no tiene prohibido crear tickets.",
	"{TARGETUSER}'s ticket ban is already expired.": "La prohibición de {TARGETUSER} para crear tickets ha expirado.",
	...
	"If someone is harassing you in private messages (PMs), click the button below and a global staff member will take a look. If you are being harassed in a chatroom, please ask a room staff member to handle it.": null, // NEEDS TRANSLATION
	"If someone is harassing you in a battle, click the button below and a global staff member will take a look. If you are being harassed in a chatroom, please ask a room staff member to handle it.": null, // NEEDS TRANSLATION
	"If you must use a proxy / VPN to access Pokemon Showdown (e.g. your school blocks the site normally), you will only be able to battle, not chat. When you go home, you will be unlocked and able to freely chat again.": null, // NEEDS TRANSLATION
	"If you are certain that you are not currently using a proxy / VPN, please continue and open a ticket. Please explain in detail how you are connecting to Pokemon Showdown.": null, // NEEDS TRANSLATION
	"If the semilock does not go away, you can try asking a global staff member for help.": null, // NEEDS TRANSLATION
	"If you don't have an autoconfirmed account, you will need to contact a global staff member to appeal your semilock.": null, // NEEDS TRANSLATION
	"Ticket Bans": null, // NEEDS TRANSLATION
	"Queued Tickets": null, // NEEDS TRANSLATION
	" (Have you looked at https://{ROOT}/pages/proxyhelp?)": null, // NEEDS TRANSLATION
	"Someone is hacking or cheating in my battle": null, // NEEDS TRANSLATION
	"I'm locked because I have the same IP as someone I don't recognize.": null, // NEEDS TRANSLATION
	"I'm locked because someone in my home was punished.": null, // NEEDS TRANSLATION
	"I'm locked because someone misused my device or account.": null, // NEEDS TRANSLATION
	"I am using mobile data.": null, // NEEDS TRANSLATION
	"I am at a public place (school, library, workplace, etc) or was locked in one.": null, // NEEDS TRANSLATION
	"I want to know how long is left on my lock.": null, // NEEDS TRANSLATION
	"I want to know why I was locked.": null, // NEEDS TRANSLATION
	"The other user started it.": null, // NEEDS TRANSLATION
