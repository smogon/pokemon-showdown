...
export const translations: TranslationCatalog = {
	...
	", because you have the same IP as {USER}.": ", omdat je hetzelfde IP hebt als $(ticket.banned}.",
	...
	"And {COUNT} more tickets.": "En {COUNT} more tickets.",
	...
	"Expires": "Verloopt",
	"Logs": "Logs",
	"And {COUNT} more ticket bans.": "En {COUNT} meer ticketverbanningen.",
	...
	"You need to choose a username before doing this.": "Je moet een gebruikersnaam kiezen voordat je dit doet.",
	...
	"Due to high load, you are limited to creating {MAX} tickets every hour.": "Door overvloed ben je gelimiteerd tot het maken van {MAX} per uur.",
	...
	"Hi! What seems to be the problem? Tell us about any people involved, and if this happened in a specific place on the site.": "Hoi! Wat is het probleem? Vertel ons over welke personen zijn betrokken,\n en of dit plaats vond in een specieke plek op de website.",
	...
	" Or if {USER} is not the user you want to report, please tell us the name of the user who you want to report.": "Of als {USER} niet de gebruiker is die je wilde rapporteren, zeg ons dan alsjeblieft de naam van de gebruiker die je wel wilde rapporteren.",
	"Help Ticket": "Hulp Ticket",
	"Issue": "Probleem",
	"A Global Staff member will be with you shortly.": "Een Globaal Personeelslid zal snel bij je zijn.",
	"{TARGETUSER} does not have an open ticket.": "{TARGETUSER} heeft geen openstaande ticket.",
	"You closed {USER}'s ticket.": "Je hebt {USER}'s gesloten.",
	...
	"{TARGETUSER} is not ticket banned.": "{TARGETUSER} is niet verbannen van tickets.",
	"{TARGETUSER}'s ticket ban is already expired.": "{TARGETUSER} ticket verbanning is al verlopen.",
