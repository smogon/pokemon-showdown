...
export const translations: TranslationCatalog = {
	...
	", because you have the same IP as {USER}.": "，因为你和{USER}用了相同的IP。",
	...
	"I want to appeal a mute/roomban/blacklist": null, // NEEDS TRANSLATION
	"Something else": "其他",
	...
	"Creator": "创建者",
	"Ticket Type": "请求类别",
	"Language": null, // NEEDS TRANSLATION
	"Claimed by": "处理者",
	"And {COUNT} more tickets.": "还有其他{COUNT}条请求",
	...
	"Expires": "到期时间",
	"Logs": "记录",
	"And {COUNT} more ticket bans.": "还有其它{COUNT}个ticket ban",
	"Ticket List": "请求的列表",
	"Banned": "被封禁",
	...
	"You need to choose a username before doing this.": "你需要先取个用户名才能请求帮助。",
	...
	"Due to high load, you are limited to creating {MAX} tickets every hour.": "如果频繁发出请求的话会造成我们的工作量过大，所以你每小时只能发{MAX}个请求",
	...
	"Hi! What seems to be the problem? Tell us about any people involved, and if this happened in a specific place on the site.": "你好！你遇到了什么样的问题？请告诉我们这个问题发生的地点和有关人员。",
	"Hi! Please click the button below to give global staff permission to check PMs.": "你好！请点这个按钮来许可全服管理来查看你的私聊记录。",
	" Or if {USER} is not the user you want to report, please tell us the name of the user who you want to report.": "如果{USER}不是你想举报的人，请告诉我们你其实想举报谁。",
	"Help Ticket": "帮助请求",
	"Issue": "问题",
	"A Global Staff member will be with you shortly.": "全服管理很快就来了。",
	"{TARGETUSER} does not have an open ticket.": "{TARGETUSER}没有待处理的请求。",
	"You closed {USER}'s ticket.": "你关闭了{USER}的请求。",
	"The reason is too long. It cannot exceed 300 characters.": "这个理由太长了，字符数不能超过300。",
	"{TARGETUSER} is not ticket banned.": "{TARGETUSER}没有被禁止发布帮助请求。",
	"{TARGETUSER}'s ticket ban is already expired.": "禁止 {TARGETUSER}发布请求的状态已经过期了。",
