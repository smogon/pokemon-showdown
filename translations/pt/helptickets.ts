...
export const translations: TranslationCatalog = {
	...
	", because you have the same IP as {USER}.": ", porque você tem o mesmo IP de {USER}.",
	...
	"And {COUNT} more tickets.": "E {COUNT} outros pedidos",
	...
	"Expires": "Expira",
	"Logs": "Logs",
	"And {COUNT} more ticket bans.": "E {COUNT} outros banimentos de pedidos de ajuda.",
	...
	"You need to choose a username before doing this.": "Você precisa escolher um nome de usuário antes de fazer isso.",
	...
	"Due to high load, you are limited to creating {MAX} tickets every hour.": "Devido à alta demanda, você só pode criar {MAX} pedidos de ajuda por hora.",
	...
	"Hi! What seems to be the problem? Tell us about any people involved, and if this happened in a specific place on the site.": "Oi! Qual parece ser o problema? Conte-nos sobre quaisquer pessoas envolvidas, \n e se aconteceu em um local específico do site.",
	...
	" Or if {USER} is not the user you want to report, please tell us the name of the user who you want to report.": " Ou se {USER} não for o usuário que você quer reportar, conte-nos o nome do usuário que você quer reportar.",
	...
	"{TARGETUSER} does not have an open ticket.": "{TARGETUSER} não tem um pedido de ajuda aberto.",
	"You closed {USER}'s ticket.": "Você encerrou o pedido de ajuda de {USER}.",
	"The reason is too long. It cannot exceed 300 characters.": "O motivo é muito longo. Não é possível exceder 300 caracteres.",
	"{TARGETUSER} is not ticket banned.": "{TARGETUSER} não está banido de pedidos de ajuda.",
	"{TARGETUSER}'s ticket ban is already expired.": "O banimento de pedidos de ajuda de {TARGETUSER} já expirou.",
