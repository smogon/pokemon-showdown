...
export const translations: TranslationCatalog = {
	...
	"- /warn OR /k <em>username</em>: warn a user and show the Pok&eacute;mon Showdown rules": "- /warn 或 /k <em>用戶名</em>: 警告用戶並顯示Pokémon Showdown的規則",
	...
	"- !showimage <em>[url], [width], [height]</em>: show an image to the room": "- !showimage <em>[url], [寬度], [高度]</em>: 在房內顯示圖片",
	...
	"Your status is too long; it must be under {MAX} characters.": "您的狀態太長了;它必須低於{MAX}個字符.",
	...
	"You are {LOCKTYPE} and can't talk in chat. {EXPIRATION}": "您被{LOCKTYPE}封鎖，因此不能發言。{EXPIRATION}",
	// TRANSLATORS: your lock
	"Get help with this": "關於被封鎖提問，請求幫助",
	...
	"Because moderated chat is set, you must be of rank {GROUP} or higher to speak in this room.": "房間管控，{GROUP}權限以上的用戶才能發言",
	"Your message can't be blank.": "發言時不能留空白",
	"Your message is too long: ": "您的句子太長了",
	"Your message contains banned characters.": "發言內容包含了禁止詞匯",
	"This room has slow-chat enabled. You can only talk once every {SECONDS} seconds.": "限速聊天，每{SECONDS}秒鐘才能發言",
