...
export const translations: Translations = {
	...
	strings: {
		...
		"A user is autoconfirmed when they have won at least one rated battle and have been registered for one week or longer. In order to prevent spamming and trolling, most chatrooms only allow autoconfirmed users to chat. If you are not autoconfirmed, you can politely PM a staff member (staff have %, @, or # in front of their username) in the room you would like to chat and ask them to disable modchat. However, staff are not obligated to disable modchat.": "Een gebruiker is autoconfirmed wanneer hij minstens één beoordeeld gevecht heeft gewonnen en één week of langer is geregistreerd. Om spammen en trollen te voorkomen, laten de meeste chatrooms alleen autoconfirmed gebruikers toe om te chatten. Als je niet autoconfirmed bent, kun je beleefd een PM sturen naar een stafflid (staff hebben %, @, of # voor hun gebruikersnaam) in de kamer waar je wilt chatten en vragen om modchat uit te schakelen. Echter, staff zijn niet verplicht om modchat uit te schakelen.",
