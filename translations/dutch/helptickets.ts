...
export const translations: Translations = {
	strings: {
		...
		'Please save the replay of the battle and provide a link to it in this chat, so we can see the harassment even if the battle expires. You can save the replay by clicking on the "Upload and share replay" button once the battle has ended.': 'Bewaar alsjeblieft de replay van het gevecht en geef een link naar deze in deze chat, zodat we de intimidatie kunnen zien, zelfs als het gevecht verloopt. Je kunt de replay opslaan door op de knop "Upload en deel replay" te klikken zodra het gevecht is afgelopen.',
		"Make sure you have provided the correct username, and if its meaning or why it is offensive is not obvious, please explain why it should not be allowed.": "Zorg ervoor dat je de juiste gebruikersnaam hebt opgegeven, en als de betekenis ervan of waarom het ongepast is niet duidelijk is, leg dan alsjeblieft uit waarom het niet toegestaan zou moeten zijn.",
		...
		"Please clearly explain why you should be unlocked and we will review it as soon as possible.": "Leg alsjeblieft duidelijk uit waarom je vrijgelaten zou moeten worden en we zullen het zo snel mogelijk beoordelen.",
