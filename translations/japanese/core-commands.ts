...
export const translations: Translations = {
	strings: {
		...
		"You can only do this in unrated non-tour battles.": "これはトーナメントでなくかつladderが有効ではないバトルでのみ有効です。",
		...
		"This command does not support specifying multiple users": "このコマンドでは複数のユーザーを指定することはできません",
		...
		"Battles are now hidden (except to staff) in your trainer card.": "あなたのトレーナーカードでバトルはスタッフ以外には見えなくなりました",
		"Battles are now visible in your trainer card.": "あなたのトレーナーカードでバトルが見られるようになりました。",
