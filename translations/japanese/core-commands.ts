...
export const translations: Translations = {
	strings: {
		...
		"You already have the temporary symbol '${group}'.": "あなたはすでに一時的なランク である'${group}'になっています。",
		...
		"${user.name} consents to sharing battle team and choices with ${targetUser.name}.": "${user.name}は${targetUser.name}はバトルチームや技の選択を共有することに同意します。",
