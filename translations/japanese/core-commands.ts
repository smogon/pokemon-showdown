...
export const translations: Translations = {
	strings: {
		...
		"Player must be set to \"p1\" or \"p2\", not \"${target}\".": "プレイヤーは\"p1\"か\"p2\"に設定しなければなりません。\"${target}\"ではありません。",
		"User ${name} not found.": "ユーザー ${name} は見つかりませんでした。",
		"User ${name} must be in the battle room already.": "ユーザー\"${name}\"はすでにバトル部屋に入室しています。",
		"This room already has a player in slot ${target}.": "スロット${name}にはすでにユーザーがいます。",
		"${targetUser.name} is already a player in this battle.": "\"${targetUser.name}\"はすでにプレイヤーになっています。",
		...
		"Forcetimer is now ON: All battles will be timed. (set by ${user.name})": "タイマーがオンになりました。すべてのバトルが強制的にタイマーで計測されます。",
