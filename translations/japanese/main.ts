...
export const translations: Translations = {
	...
	strings: {
		...
		"<strong>globalban</strong> - Globally bans (makes them unable to connect and play games) for a week.": "<strong>globalban</strong> - 1週間全てのチャット部屋とバトルからBANされます。",

		"<strong>Room drivers (%)</strong> can use:": "<strong>ドライバー(%)</strong> コマンド:",
		"- /warn OR /k <em>username</em>: warn a user and show the Pok&eacute;mon Showdown rules": "- /warn また /k <em>ユーザー名</em>: ユーザーが警告され、当サイトのルールのウィンドウが表示されます。",
		...
		'- For more information, you can read our <a href="https://${Config.routes.root}/privacy">full privacy policy.</a>': '詳しくは、<a href="https://${Config.routes.root}/privacy">プライバシーポリシー</a>をご覧ください。',
	},
};
