...
export const translations: TranslationCatalog = {
	...
	"User '{TARGETUSER}' not found.": "ユーザー名'{TARGETUSER}'は見つかりませんでした。",
	"User \"{TARGETUSER}\" not found.": "ユーザー \"{TARGETUSER}\"は見つかりませんでした。",
	"Refresh": "再読み込み",
	"Action": "操作",
	...
	"% <strong>Global Driver</strong> - Like Voice, and they can lock users and check for alts": "<strong>グローバルドライバー</strong>(%): ボイスに似ているが上記に加えてユーザーをロックしたり、他に使っているアカウントを確認することができる。",
	...
	"- !showimage <em>[url], [width], [height]</em>: show an image to the room": "- !showimage <em>[url], [width], [height]</em>: チャット部屋に画像を表示します。",
	...
	"Your status is too long; it must be under {MAX} characters.": "ステータスが長すぎます。 {MAX} 文字以内のステータスを設定してください。",
	...
	"You are {LOCKTYPE} and can't talk in chat. {EXPIRATION}": "{LOCKTYPE} されているため、チャットすることはできません。ロック期限: {EXPIRATION}",
	...
	"Because moderated chat is set, you must be of rank {GROUP} or higher to speak in this room.": "このチャット部屋はモデレートチャットが設定されているため、{GROUP} 以上のユーザーしかチャットすることができません。",
	...
	"This room has slow-chat enabled. You can only talk once every {SECONDS} seconds.": "このチャット部屋はスローチャットが設定されているため、 {SECONDS} 秒以内に複数のメッセージを送ることができません。",
	...
	"You are {LOCKTYPE} and can only private message members of the global moderation team. {EXPIRATION}": "{LOCKTYPE}状態のためプライベートメッセージを送信できるのはグローバルスタッフのみに制限されています。{EXPIRATION}",
	"The user \"{TARGETUSER}\" is locked and cannot be PMed.": "\"{TARGETUSER}\"はロックされているためプライベートメッセージを送信することができません。",
	"On this server, you must be of rank {GROUP} or higher to PM users.": "このサーバーでは、プライベートメッセージを送信するには{GROUP}以上である必要があります。",
	"This user is blocking private messages right now.": "このユーザーは現在プライベートメッセージをブロックしています。",
	"This {GROUP} is too busy to answer private messages right now. Please contact a different staff member.": "{GROUP} は現在多忙のためプライベートメッセージに反応することができません。他のスタッフに話してみてください。",
	...
	'- For more information, you can read our <a href="https://{ROOT}/privacy">full privacy policy.</a>': '詳しくは、<a href="https://{ROOT}/privacy-ja">プライバシーポリシー</a>をご覧ください。',
