...
export const translations: TranslationCatalog = {
	...
	"User '{TARGETUSER}' not found.": "Nutzer '{TARGETUSER}' wurde nicht gefunden.",
	"User \"{TARGETUSER}\" not found.": "Nutzer \"{TARGETUSER}\" wurde nicht gefunden.",
	...
	"% <strong>Global Driver</strong> - Like Voice, and they can lock users and check for alts": "% <strong>Global Driver</strong> - Oben genanntes, und sie können Nutzer sperren sowie alternative Accounts einsehen.",
	...
	"- !showimage <em>[url], [width], [height]</em>: show an image to the room": "- !showimage <em>[url], [Breite], [Höhe]</em>: Zeigt ein Bild im Raum",
	...
	"Your status is too long; it must be under {MAX} characters.": "Dein Status ist zu lang; er muss kürzer als {MAX} Zeichen sein.",
	...
	"You are {LOCKTYPE} and can't talk in chat. {EXPIRATION}": "Du bist {LOCKTYPE} und kannst im Chat nicht schreiben. {EXPIRATION}",
	...
	"Because moderated chat is set, you must be of rank {GROUP} or higher to speak in this room.": "Da der moderierte Chat aktiviert ist, muss dein Account über den Rang {GROUP} oder höher verfügen, um in diesem Raum zu sprechen.",
	...
	"This room has slow-chat enabled. You can only talk once every {SECONDS} seconds.": "In diesem Raum ist der Slowchat aktiviert. Du kannst nur einmal jede {SECONDS} Sekunden eine Nachricht abschicken.",
	...
	"You are {LOCKTYPE} and can only private message members of the global moderation team. {EXPIRATION}": "Du bist {LOCKTYPE} und kannst nur noch private Nachrichten an globale Staffmitglieder versenden. {EXPIRATION}",
	"The user \"{TARGETUSER}\" is locked and cannot be PMed.": "Der User \"{TARGETUSER}\" ist gesperrt und kann nicht privat angeschrieben werden.",
	"On this server, you must be of rank {GROUP} or higher to PM users.": "Auf diesem Server musst du über den Rang {GROUP} oder höher verfügen, um private Nachrichten an User zu versenden.",
	"This user is blocking private messages right now.": "Dieser User blockiert gerade private Nachrichten.",
	"This {GROUP} is too busy to answer private messages right now. Please contact a different staff member.": "Dieser {GROUP} ist gerade zu beschäftigt, um auf private Nachrichten zu antworten. Bitte wende dich an ein anderes Staff-Mitglied.",
