...
export const translations: TranslationCatalog = {
	...
	", because you have the same IP as {USER}.": ", da du die selbe IP wie {USER} hast.",
	...
	"And {COUNT} more tickets.": "Und {COUNT} weitere Tickets",
	...
	"Expires": "Läuft aus",
	"Logs": "Logs",
	"And {COUNT} more ticket bans.": "Und {COUNT} weitere Ticket-Banns.",
	...
	"You need to choose a username before doing this.": "Du musst einen Nutzernamen auswählen, bevor du dies tust.",
	...
	"Due to high load, you are limited to creating {MAX} tickets every hour.": "Da im Moment viel los ist, kannst du derzeit nur {MAX} Tickets pro Stunde erstellen.",
	...
	"Hi! What seems to be the problem? Tell us about any people involved, and if this happened in a specific place on the site.": "Hallo! Um welches Problem handelt es sich? Nenne uns alle Nutzer, welche beteiligt waren,\n und ob es sich an einem bestimmten Ort auf der Seite zugetragen hat.",
	...
	" Or if {USER} is not the user you want to report, please tell us the name of the user who you want to report.": " Falls aber {USER} nicht jener User ist, den du melden möchtest, dann nenne uns bitte den Namen des Users, den du melden möchtest. ",
	"Help Ticket": "Help-Ticket",
	"Issue": "Problem",
	"A Global Staff member will be with you shortly.": "Ein globales Staffmitglied wird gleich da sein.",
	"{TARGETUSER} does not have an open ticket.": "{TARGETUSER} besitzt kein aktives Ticket.",
	"You closed {USER}'s ticket.": "Du hast {USER}'s Ticket geschlossen.",
	"The reason is too long. It cannot exceed 300 characters.": "Der Grund ist zu lang. Dieser darf keine 300 Zeichen überschreiten.",
	"{TARGETUSER} is not ticket banned.": "{TARGETUSER} ist nicht davon ausgeschlossen, Tickets zu erstellen.",
	"{TARGETUSER}'s ticket ban is already expired.": "{TARGETUSER}'s Ticket-Bann ist bereits abgelaufen.",
