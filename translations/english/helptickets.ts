...
export const translations: Translations = {
	strings: {
		...
		"If someone is harassing you in private messages (PMs), click the button below and a global staff member will take a look. If you are being harassed in a chatroom, please ask a room staff member to handle it.": "",
		" If it's a minor issue, consider using <code>/ignore [username]</code> instead.": "",
		"If someone is harassing you in a battle, click the button below and a global staff member will take a look. If you are being harassed in a chatroom, please ask a room staff member to handle it.": "",
		...
		"If the semilock does not go away, you can try asking a global staff member for help.": "",
		"If you don't have an autoconfirmed account, you will need to contact a global staff member to appeal your semilock.": "",
