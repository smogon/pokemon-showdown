...
export const translations: Translations = {
	...
	strings: {
		...
		"You are ${lockType} and can only private message members of the global moderation team. ${lockExpiration}": "Estás ${lockType} y solo puedes enviar mensajes privados al equipo de modreación global. ${lockExpiration}",
		...
		"You are blocking challenges right now.": "Estás bloqueando challenges en este momento",
		...
		"You are now blocking challenges, except from staff and ${rank}.": "Desde ahora estás bloqueando challenges, excepto de staff y {rank}.",
		"You are now blocking challenges, except from staff and ${status} users.": "Desde ahora estás bloqueando challenges, excepto de staff y usuarios ${status}.",
		...
		"- We log PMs so you can report them - staff can't look at them without permission unless there's a law enforcement reason.": "- Guardamos PMs para que puedas reportarlos - el staff no puede verlos sin permiso, excepto que haya razones relacionadas al cumplimiento de la ley.",
		"- We log IPs to enforce bans and mutes.": "- Guardamos IPs para aplicar bans y mutes",
		"- We use cookies to save your login info and teams, and for Google Analytics and AdSense.": "Usamos cookies para guardar tu información de login y equipos, así como para Google Analytics y AdSense",
