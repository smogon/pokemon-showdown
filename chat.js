...
Chat.getDataMoveHTML = function (move) {
	...
	buf += `<a data-entry="move|${move.name}"><span class="col movenamecol"><a href="https://pokemonshowdown.com/dex/moves/${move.name}</a>${move.name}</span> `;
...
Chat.getDataAbilityHTML = function (ability) {
	...
	let buf = `<ul class="utilichart"><li class="result">`;
	buf += `<a data-entry="ability|${ability.name}"><span class="col namecol"><a href="https://pokemonshowdown.com/dex/abilities/${ability.name}</a>${ability.name}</span> `;
...
Chat.getDataItemHTML = function (item) {
	...
	let buf = `<ul class="utilichart"><li class="result">`;
	buf += `<a data-entry="item|${item.name}"><span class="col itemiconcol"><psicon item="${item.id}"></span> <span class="col namecol"><a href="https://pokemonshowdown.com/dex/items/${item.name}</a>${item.name}</span> `;
