		...
		startRaw: function(i) {
			...
			for (var i in round) {
				if (!round[i][1]) {
						...
						html += "<font color=\"green\">" + clean(p1n) + " has received a bye!</font><br />";
				}
				else {
					var p1n = tour.username(round[i][0]);
...
var cmds = {
	...
	tour: function(target, room, user, connection) {
		...
		if (target === 'bucks') {
			...
			'3 Players.......... 1 Buck<br>' +
			'4 Players.......... 2 Bucks<br>' +
			'5 Players.......... 3 Bucks<br>' +
			'6 Players.......... 4 Bucks<br>' +
			'7-14 Players..... 5 Bucks<br>' +
			'15 and beyond.. 10 Bucks');
			return;
		}
	...
	viewround: function(target, room, user, connection) {
		...
		for (var i in r) {
			if (!r[i][1]) {
				...
				html += "<font color=\"green\">" + clean(byer) + " has received a bye.</font><br />";
			}
			else {
				if (r[i][2] == undefined) {
					//haven't started
