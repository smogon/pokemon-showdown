...
function parseCommandLocal(user, cmd, target, room, socket, message) {
	...
	case 'b':
		...
		targetUser.emit('message', user.name+' has banned you.  If you feel that your banning was unjustified you can appeal the ban <a href="http://www.smogon.com/forums/announcement.php?f=126&a=204" target="_blank">here.</a> '+targets[1]);
		var alts = targetUser.getAlts();
