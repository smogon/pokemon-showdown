...
exports.commands = {
	...
	help: function (target, room, user) {
		...
		if (target === 'help' || target === 'h' || target === '?' || target === 'commands') {
			...
			this.sendReply("INFORMATIONAL COMMANDS: /data, /dexsearch, /movesearch, /itemsearch, /groups, /faq, /rules, /intro, /formatshelp, /othermetas, /learn, /veekun, /analysis, /calc (replace / with ! to broadcast. Broadcasting requires: + % @ * # & ~)");
