...
exports.commands = {
	...
	hidetexthelp: [
		...
		"/hidealtstext OR /hidealttext OR /hidetextalts [username] - Removes a locked or banned user's messages, and their alternate account's messages from the chat (includes users banned from the room).  Requires: % (global only), @ * # & ~",
	],
