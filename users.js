	...
	updateGroup(registered) {
		...
		if (this.autoconfirmed && this.semilocked) {
			if (this.semilocked.startsWith('#sharedip')) {
				...
				this.popup(`You are locked because someone using your IP has spammed/hacked other websites. This usually means you're either using a proxy in a country where other people commonly hack, or you have a virus on your computer that's spamming websites.`);
