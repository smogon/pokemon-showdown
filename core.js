...
var core = exports.core = {
	...
	shop: function (showDisplay) {
		var shop = [
			...
			['Fix', 'Buy the ability to alter your current custom avatar. (Don\'t buy if you don\'t have a custom avatar. If you have a custom avatar and would like to apply it to other usernames, contact the admin "wolf" and don\'t buy this.)', 15],
