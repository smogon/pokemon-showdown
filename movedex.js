exports.BattleMovedex = {
	...
	"Acid": {
		...
		shortDesc: "10% chance to lower Sp. Defense 1.",
		id: "Acid",
		name: "Acid",
		pp: 30,
		priority: 0,
	...
	"Acrobatics": {
		...
		shortDesc: "Doubles in power if user has no held item.",
		id: "Acrobatics",
		name: "Acrobatics",
		pp: 15,
		isViable: true,
	...
	"Acupressure": {
		...
		shortDesc: "Boosts a random stat 2.",
		id: "Acupressure",
		name: "Acupressure",
		pp: 30,
	...
	"AfterYou": {
		...
		shortDesc: "The target will attack immediately after the user in the same turn.",
		id: "AfterYou",
		name: "After You",
		pp: 15,
		priority: 0,
	...
	"AirSlash": {
		...
		shortDesc: "30% chance to flinch opponent.",
		id: "AirSlash",
		name: "Air Slash",
		pp: 20,
		isViable: true,
	...
	"AllySwitch": {
		...
		shortDesc: "Switches position with another allied Pokemon",
		id: "AllySwitch",
		name: "Ally Switch",
		pp: 15,
		priority: 1,
	...
	"Assurance": {
		...
		shortDesc: "Base Power doubles if foe is damaged this turn.",
		id: "Assurance",
		name: "Assurance",
		pp: 10,
		isContact: true,
	...
	"AuroraBeam": {
		...
		shortDesc: "10% chance to lower opponent's Attack by 1.",
		id: "AuroraBeam",
		name: "Aurora Beam",
		pp: 20,
		priority: 0,
	...
	"Avalanche": {
		...
		shortDesc: "Double in power if user is damaged by the target.",
		id: "Avalanche",
		name: "Avalanche",
		pp: 10,
		isViable: true,
	...
	"BatonPass": {
		...
		shortDesc: "User switches, passing on stat changes and more.",
		id: "BatonPass",
		name: "Baton Pass",
		pp: 40,
		isViable: true,
	...
	"BeatUp": {
		...
		shortDesc: "All healthy pokemon aid in damaging the target.",
		id: "BeatUp",
		name: "Beat Up",
		pp: 10,
		priority: 0,
	...
	"Bide": {
		...
		shortDesc: "Charges for 2 turns, returning double the damage received.",
		id: "Bide",
		name: "Bide",
		pp: 10,
		isContact: true,
	...
	"Bind": {
		...
		shortDesc: "Traps and damages over multiple turns.",
		id: "Bind",
		name: "Bind",
		pp: 20,
		isContact: true,
	...
	"BlazeKick": {
		...
		shortDesc: "Has a high critical hit rate. 10% chance to burn the target.",
		id: "BlazeKick",
		name: "Blaze Kick",
		pp: 10,
		isViable: true,
	...
	"BlueFlare": {
		...
		shortDesc: "20% chance to burn opponent.",
		id: "BlueFlare",
		name: "Blue Flare",
		pp: 5,
		isViable: true,
	...
	"BodySlam": {
		...
		shortDesc: "30% chance to paralyze opponent.",
		id: "BodySlam",
		name: "Body Slam",
		pp: 15,
		isViable: true,
	...
	"BoltStrike": {
		...
		shortDesc: "20% chance to paralyze opponent.",
		id: "BoltStrike",
		name: "Bolt Strike",
		pp: 5,
		isViable: true,
	...
	"BoneClub": {
		...
		shortDesc: "10% chance to flinch opponent.",
		id: "BoneClub",
		name: "Bone Club",
		pp: 20,
		priority: 0,
	...
	"Bounce": {
		...
		shortDesc: "Bounces up, then down the next turn. 30% paralyze.",
		id: "Bounce",
		name: "Bounce",
		pp: 5,
		isViable: true,
	...
	"Brine": {
		...
		shortDesc: "Base power doubles if foe's HP is 50% or less.",
		id: "Brine",
		name: "Brine",
		pp: 10,
		priority: 0,
	...
	"Bubble": {
		...
		shortDesc: "10% chance to lower opponent's Speed by 1.",
		id: "Bubble",
		name: "Bubble",
		pp: 30,
		priority: 0,
	...
	"BugBuzz": {
		...
		category: "Special",
		desc: "Has a 10% chance to lower the target's Special Defense by 1 stage.",
		shortDesc: "10% chance to lower opponent's Sp. Defense by 1.",
		id: "BugBuzz",
		name: "Bug Buzz",
		pp: 10,
		isViable: true,
	...
	"Confusion": {
		...
		shortDesc: "10% chance to confuse opponent.",
		id: "Confusion",
		name: "Confusion",
		pp: 25,
		priority: 0,
	...
	"Conversion": {
		...
		shortDesc: "Changes user's type to same as one of user's moves",
		id: "Conversion",
		name: "Conversion",
		pp: 30,
		priority: 0,
	...
	"Counter": {
		...
		shortDesc: "If hit by a physical attack, returns double damage.",
		id: "Counter",
		name: "Counter",
		pp: 20,
		isViable: true,
	...
	"Covet": {
		...
		shortDesc: "Steals target's item.",
		id: "Covet",
		name: "Covet",
		pp: 40,
		isContact: true,
	...
	"CrossPoison": {
		...
		shortDesc: "Has a high critical hit rate. 10% chance to poison.",
		id: "CrossPoison",
		name: "Cross Poison",
		pp: 20,
		isViable: true,
	...
	"CrushGrip": {
		...
		shortDesc: "Base power depends on the foe's remaining HP",
		id: "CrushGrip",
		name: "Crush Grip",
		pp: 5,
		isContact: true,
	...
	"DarkPulse": {
		...
		shortDesc: "20% chance to flinch the opponent.",
		id: "DarkPulse",
		name: "Dark Pulse",
		pp: 15,
		isViable: true,
	...
	"DestinyBond": {
		...
		shortDesc: "If the user faints, the foe faints.",
		id: "DestinyBond",
		name: "Destiny Bond",
		pp: 5,
		isViable: true,
	...
	"Detect": {
		...
		shortDesc: "Prevents most moves from working on the user that turn.",
		id: "Detect",
		name: "Detect",
		pp: 5,
		isViable: true,
	...
	"Dig": {
		...
		shortDesc: "Digs underground the first turn and strikes next turn.",
		id: "Dig",
		name: "Dig",
		pp: 10,
		isContact: true,
	...
	"Disable": {
		...
		shortDesc: "Prevents the last move being used for 4-7 turns.",
		id: "Disable",
		name: "Disable",
		pp: 20,
		isBounceable: true,
	...
	"Discharge": {
		...
		category: "Special",
		desc: "Has a 30% chance to paralyze the target.",
		shortDesc: "30% chance to paralyze the opponent.",
		id: "Discharge",
		name: "Discharge",
		pp: 15,
		isViable: true,
	...
	"Dive": {
		...
		shortDesc: "Dive underwater the first turn and strikes next turn.",
		id: "Dive",
		name: "Dive",
		pp: 10,
		isContact: true,
	...
	"DizzyPunch": {
		...
		shortDesc: "20% chance to confuse opponent.",
		id: "DizzyPunch",
		name: "Dizzy Punch",
		pp: 10,
		isContact: true,
	...
	"DoubleTeam": {
		...
		shortDesc: "Boosts evasion by 1 stage.",
		id: "DoubleTeam",
		name: "Double Team",
		pp: 15,
		priority: 0,
	...
	"DragonRage": {
		...
		shortDesc: "Always does 40 hp damage.",
		id: "DragonRage",
		name: "Dragon Rage",
		pp: 10,
		priority: 0,
	...
	"DreamEater": {
		...
		shortDesc: "Leeches 50% of the damage dealt. Sleeping only.",
		id: "DreamEater",
		name: "Dream Eater",
		pp: 15,
		priority: 0,
	...
	"DrillPeck": {
		...
		category: "Physical",
		desc: "Deals damage with no additional effect.",
		shortDesc: "No addiotional Effect.",
		id: "DrillPeck",
		name: "Drill Peck",
		pp: 20,
		isViable: true,
	...
	"Earthquake": {
		...
		shortDesc: "Hits Pokemon using Dig with double Base Power.",
		id: "Earthquake",
		name: "Earthquake",
		pp: 10,
		isViable: true,
	...
	"EchoedVoice": {
		...
		shortDesc: "Power increases when used consecuitively.",
		id: "EchoedVoice",
		name: "Echoed Voice",
		pp: 15,
		priority: 0,
	...
	"ElectroBall": {
		...
		category: "Special",
		desc: null,
		shortDesc: "Inflicts more damage the faster the user is then target.",
		id: "ElectroBall",
		name: "Electro Ball",
		pp: 10,
		isViable: true,
	...
	"Embargo": {
		...
		shortDesc: "Item use is prevented for five turns.",
		id: "Embargo",
		name: "Embargo",
		pp: 15,
		priority: 0,
	...
	"Encore": {
		...
		shortDesc: "Causes the target to repeat its last move for 3 turns.",
		id: "Encore",
		name: "Encore",
		pp: 5,
		isViable: true,
	...
	"Endeavor": {
		...
		shortDesc: "Lowers target's HP to the user's HP.",
		id: "Endeavor",
		name: "Endeavor",
		pp: 5,
		isViable: true,
	...
	"Facade": {
		...
		shortDesc: "Has 140 power when user is inflicted by a status effect.",
		id: "Facade",
		name: "Facade",
		pp: 20,
		isViable: true,
	...
	"FieryDance": {
		...
		shortDesc: "50% chance to Boosts user's Sp. Attack by 1.",
		id: "FieryDance",
		name: "Fiery Dance",
		pp: 10,
		isViable: true,
	...
	"FinalGambit": {
		...
		shortDesc: "Damages User and Target for User's Remaining HP.",
		id: "FinalGambit",
		name: "Final Gambit",
		pp: 5,
		isContact: true,
	...
	"FireBlast": {
		...
		category: "Special",
		desc: "Has a 10% chance to burn the target.",
		shortDesc: "10% chance to burn opponent.",
		id: "FireBlast",
		name: "Fire Blast",
		pp: 5,
		isViable: true,
	...
	"FireFang": {
		...
		shortDesc: "10% chance to burn opponent. 10% chance to flinch opponent.",
		id: "FireFang",
		name: "Fire Fang",
		pp: 15,
		isViable: true,
	...
	"FirePunch": {
		...
		category: "Physical",
		desc: "Has a 10% chance to burn the target.",
		shortDesc: "10% chance to burn target.",
		id: "FirePunch",
		name: "Fire Punch",
		pp: 15,
		isViable: true,
	...
	"Fissure": {
		...
		shortDesc: "Will OHKO the target.",
		id: "Fissure",
		name: "Fissure",
		pp: 5,
		priority: 0,
	...
	"FlameWheel": {
		...
		shortDesc: "10% chance to burn opponent. Thaws the user.",
		id: "FlameWheel",
		name: "Flame Wheel",
		pp: 25,
		isContact: true,
	...
	"Fling": {
		...
		shortDesc: "Throws the user's hold item at the foe. Power Varies.",
		id: "Fling",
		name: "Fling",
		pp: 10,
		priority: 0,
	...
	"Fly": {
		...
		shortDesc: "Flies up on the first turn, then strikes the next turn.",
		id: "Fly",
		name: "Fly",
		pp: 15,
		isContact: true,
	...
	"FoulPlay": {
		...
		shortDesc: "Uses the target's Attack stat in damage calculation.",
		id: "FoulPlay",
		name: "Foul Play",
		pp: 15,
		isViable: true,
	...
	"Frustration": {
		...
		shortDesc: "Max 102 BP at minimum Happiness.",
		id: "Frustration",
		name: "Frustration",
		pp: 20,
		isViable: true,
	...
	"FuryCutter": {
		...
		shortDesc: "Power doubles with each hit. Max 160 BP",
		id: "FuryCutter",
		name: "Fury Cutter",
		pp: 20,
		isContact: true,
	...
	"Glaciate": {
		...
		shortDesc: "Lowers opponent's Speed by 1.",
		id: "Glaciate",
		name: "Glaciate",
		pp: 10,
		priority: 0,
	...
	"Gravity": {
		...
		shortDesc: "For 5 turns, negates Ground immunities. No Fly/Jumping.",
		id: "Gravity",
		name: "Gravity",
		pp: 5,
		isViable: true,
	...
	"GuardSplit": {
		...
		shortDesc: "Averages Defense and Sp. Defense of the user and target.",
		id: "GuardSplit",
		name: "Guard Split",
		pp: 10,
		priority: 0,
	...
	"GuardSwap": {
		...
		shortDesc: "Swaps user's Defense/Sp. Defense stages with target.",
		id: "GuardSwap",
		name: "Guard Swap",
		pp: 10,
		priority: 0,
	...
	"GyroBall": {
		...
		shortDesc: "Deals more damage the slower the user is.",
		id: "GyroBall",
		name: "Gyro Ball",
		pp: 5,
		isViable: true,
	...
	"HeatCrash": {
		...
		shortDesc: "Deals damage based on how heavy the user is.",
		id: "HeatCrash",
		name: "Heat Crash",
		pp: 10,
		isViable: true,
	...
	"HelpingHand": {
		...
		shortDesc: "Increases Base Power of ally's moves 50%",
		id: "HelpingHand",
		name: "Helping Hand",
		pp: 20,
		priority: 5,
	...
	"Hex": {
		...
		shortDesc: "Base Power doubles if target has a status ailment.",
		id: "Hex",
		name: "Hex",
		pp: 10,
		priority: 0,
	...
	"IceBurn": {
		...
		shortDesc: "Hits the turn after being used. 30% chance burn.",
		id: "IceBurn",
		name: "Ice Burn",
		pp: 5,
		priority: 0,
	...
	"IceFang": {
		...
		shortDesc: "10% chance flinch. 10% chance freeze.",
		id: "IceFang",
		name: "Ice Fang",
		pp: 15,
		isViable: true,
	...
	"Imprison": {
		...
		shortDesc: "No opponent can use any of the user's moves.",
		id: "Imprison",
		name: "Imprison",
		pp: 10,
		priority: 0,
	...
	"Ingrain": {
		...
		shortDesc: "Heals the user 1/16 max HP per turn. Traps User.",
		id: "Ingrain",
		name: "Ingrain",
		pp: 20,
		isViable: true,
	...
	"IronTail": {
		...
		shortDesc: "10% chance to lower opponent's Defense 1 stage.",
		id: "IronTail",
		name: "Iron Tail",
		pp: 15,
		isViable: true,
	...
	"LastResort": {
		...
		shortDesc: "Can only be used if all other moves have been used once.",
		id: "LastResort",
		name: "Last Resort",
		pp: 5,
		isContact: true,
	...
	"LeafTornado": {
		...
		shortDesc: "30% chance to lower target's accuracy by 1.",
		id: "LeafTornado",
		name: "Leaf Tornado",
		pp: 10,
		priority: 0,
	...
	"LeechSeed": {
		...
		shortDesc: "Leeches 1/8th opponents HP every turn.",
		id: "LeechSeed",
		name: "Leech Seed",
		pp: 10,
		isViable: true,
	...
	"Leer": {
		...
		shortDesc: "Lowers opponent's Defense one stage.",
		id: "Leer",
		name: "Leer",
		pp: 30,
		priority: 0,
	...
	"LightScreen": {
		...
		shortDesc: "Doubles your team's Special Defense for 5 turns.",
		id: "LightScreen",
		name: "Light Screen",
		pp: 30,
		isViable: true,
	...
	"Lock-On": {
		...
		shortDesc: "The next move will not miss.",
		id: "Lock-On",
		name: "Lock-On",
		pp: 5,
		priority: 0,
	...
	"LowKick": {
		...
		category: "Physical",
		desc: "Base power increases as the target's weight increases.",
		shortDesc: "Damage is based on opponent's weight.",
		id: "LowKick",
		name: "Low Kick",
		pp: 20,
		isViable: true,
	...
	"LunarDance": {
		...
		shortDesc: "Faints the user, but the replacement is healed fully.",
		id: "LunarDance",
		name: "Lunar Dance",
		pp: 10,
		isViable: true,
	...
	"LusterPurge": {
		...
		shortDesc: "50% chance to lower the target's Sp. Defense by 1.",
		id: "LusterPurge",
		name: "Luster Purge",
		pp: 5,
		priority: 0,
	...
	"MagnetRise": {
		...
		shortDesc: "User becomes immune to Ground moves for 5 turns.",
		id: "MagnetRise",
		name: "Magnet Rise",
		pp: 10,
		isViable: true,
	...
	"Magnitude": {
		...
		shortDesc: "Has variable damage. Double Base Power against Dig.",
		id: "Magnitude",
		name: "Magnitude",
		pp: 30,
		priority: 0,
	...
	"MindReader": {
		...
		shortDesc: "The next move will always hit.",
		id: "MindReader",
		name: "Mind Reader",
		pp: 5,
		priority: 0,
	...
	"MirrorCoat": {
		...
		shortDesc: "If hit by a special attack, returns double damage.",
		id: "MirrorCoat",
		name: "Mirror Coat",
		pp: 20,
		isViable: true,
	...
	"MistBall": {
		...
		shortDesc: "50% chance to lower target's Sp. Attack by 1.",
		id: "MistBall",
		name: "Mist Ball",
		pp: 5,
		priority: 0,
	...
	"MudShot": {
		...
		category: "Special",
		desc: "Lowers the target's Speed by 1 stage.",
		shortDesc: "Lower's target's Speed by 1.",
		id: "MudShot",
		name: "Mud Shot",
		pp: 15,
		priority: 0,
	...
	"MuddyWater": {
		...
		category: "Special",
		desc: "Lowers the target's Accuracy by 1 stage.",
		shortDesc: "30% chance to Lowers target's accuracy by 1.",
		id: "MuddyWater",
		name: "Muddy Water",
		pp: 10,
		isViable: true,
	...
	"NightDaze": {
		...
		shortDesc: "40% chance to lower target's accuracy by 1.",
		id: "NightDaze",
		name: "Night Daze",
		pp: 10,
		isViable: true,
	...
	"Nightmare": {
		...
		shortDesc: "Cuts 1/4 of the sleeping target's max HP per turn.",
		id: "Nightmare",
		name: "Nightmare",
		pp: 15,
		priority: 0,
	...
	"Octazooka": {
		...
		shortDesc: "50% chance to lower target's accuracy by 1.",
		id: "Octazooka",
		name: "Octazooka",
		pp: 10,
		priority: 0,
	...
	"Outrage": {
		...
		shortDesc: "Lasts 2-3 turns and will confuse the user after.",
		id: "Outrage",
		name: "Outrage",
		pp: 15,
		isViable: true,
	...
	"Payback": {
		...
		shortDesc: "Base Power doubles if the target goes first.",
		id: "Payback",
		name: "Payback",
		pp: 10,
		isViable: true,
	...
	"PetalDance": {
		...
		category: "Special",
		desc: "The user attacks uncontrollably for 2-3 turns and then gets confused.",
		shortDesc: "Lasts 2-3 turns and will confuse the user afterward.",
		id: "PetalDance",
		name: "Petal Dance",
		pp: 10,
		isViable: true,
	...
	"PowerSwap": {
		...
		shortDesc: "Switches Attack and Sp. Attack modifiers with target.",
		id: "PowerSwap",
		name: "Power Swap",
		pp: 10,
		priority: 0,
	...
	"PowerTrick": {
		...
		shortDesc: "Switches attack and defense stats.",
		id: "PowerTrick",
		name: "Power Trick",
		pp: 10,
		priority: 0,
	...
	"Present": {
		...
		shortDesc: "Does damage, or heals opponent for 80 HP.",
		id: "Present",
		name: "Present",
		pp: 15,
		priority: 0,
	...
	"Psyshock": {
		...
		shortDesc: "Damage is based on opponent's Defense stat.",
		id: "Psyshock",
		name: "Psyshock",
		pp: 10,
		isViable: true,
	...
	"Psywave": {
		...
		shortDesc: "Deals random damage equal to .5-1.5x user's level.",
		id: "Psywave",
		name: "Psywave",
		pp: 15,
		priority: 0,
	...
	"Punishment": {
		...
		category: "Physical",
		desc: null,
		shortDesc: "Does more damage to foes with stat boosts.",
		id: "Punishment",
		name: "Punishment",
		pp: 5,
		priority: 0,
	...
	"Pursuit": {
		...
		shortDesc: "Doubles Base Power if opponent is switching.",
		id: "Pursuit",
		name: "Pursuit",
		pp: 20,
		isViable: true,
	...
	"RapidSpin": {
		...
		shortDesc: "Removes Leech Seed and all foreign entry hazards.",
		id: "RapidSpin",
		name: "Rapid Spin",
		pp: 40,
		isViable: true,
	...
	"RazorShell": {
		...
		shortDesc: "50% chance to lower opponent's defense by 1.",
		id: "RazorShell",
		name: "Razor Shell",
		pp: 10,
		isViable: true,
	...
	"RazorWind": {
		...
		shortDesc: "Charges up one turn, attacks the next. High Crit.",
		id: "RazorWind",
		name: "Razor Wind",
		pp: 10,
		priority: 0,
	...
	"Reflect": {
		...
		shortDesc: "Lowers damage from physical attacks to the team.",
		id: "Reflect",
		name: "Reflect",
		pp: 20,
		isViable: true,
	...
	"RelicSong": {
		...
		shortDesc: "10% chance to cause sleep. Switches Meloetta formes.",
		id: "RelicSong",
		name: "Relic Song",
		pp: 10,
		isViable: true,
	...
	"Rest": {
		...
		shortDesc: "User restores all HP and sleeps for 2 turn",
		id: "Rest",
		name: "Rest",
		pp: 10,
		isViable: true,
	...
	"Retaliate": {
		...
		category: "Physical",
		desc: null,
		shortDesc: "Power doubles if the user's teammate fainted.",
		id: "Retaliate",
		name: "Retaliate",
		pp: 5,
		priority: 0,
	...
	"Return": {
		...
		shortDesc: "Max 102 BP at max user's happiness.",
		id: "Return",
		name: "Return",
		pp: 20,
		isViable: true,
	...
	"RolePlay": {
		...
		shortDesc: "Copies the foe's ability, overwriting the user's.",
		id: "RolePlay",
		name: "Role Play",
		pp: 10,
		priority: 0,
	...
	"Round": {
		...
		shortDesc: "Power doubles if a teammate uses Round in same turn.",
		id: "Round",
		name: "Round",
		pp: 15,
		priority: 0,
	...
	"SacredSword": {
		...
		shortDesc: "Ignores opponent's stat changes.",
		id: "SacredSword",
		name: "Sacred Sword",
		pp: 20,
		isViable: true,
	...
	"Safeguard": {
		...
		shortDesc: "Protects team from status conditions for 5 turns.",
		id: "Safeguard",
		name: "Safeguard",
		pp: 25,
		priority: 0,
	...
	"SandTomb": {
		...
		category: "Physical",
		desc: "Traps the target for 5-6 turns, causing damage equal to 1/16 of its max HP each turn; this trapped effect can be broken by Rapid Spin. The target can still switch out if it is holding Shed Shell or uses Baton Pass or U-Turn.",
		shortDesc: "Traps and damages over 4-5 turns.",
		id: "SandTomb",
		name: "Sand Tomb",
		pp: 15,
		priority: 0,
	...
	"Scald": {
		...
		category: "Special",
		desc: "Has a 30% chance to burn the target.",
		shortDesc: "30% chance to burn the opponent. Thaws the user.",
		id: "Scald",
		name: "Scald",
		pp: 15,
		isViable: true,
	...
	"Screech": {
		...
		shortDesc: "Lowers opponent's Defense by 2.",
		id: "Screech",
		name: "Screech",
		pp: 40,
		priority: 0,
	...
	"SecretPower": {
		...
		shortDesc: "Effect varies with terain.",
		id: "SecretPower",
		name: "Secret Power",
		pp: 20,
		priority: 0,
	...
	"SecretSword": {
		...
		defensiveCategory: "Physical",
		desc: "Inflicts damage based on the target's Defense, not Special Defense.",
		shortDesc: "Uses opponent's Defense stat in damage calculation.",
		id: "SecretSword",
		name: "Secret Sword",
		pp: 10,
		isViable: true,
	...
	"SeedFlare": {
		...
		shortDesc: "40% chance to lower opponent's Sp. Defense by 2.",
		id: "SeedFlare",
		name: "Seed Flare",
		pp: 5,
		isViable: true,
	...
	"ShadowForce": {
		...
		shortDesc: "User disappears, then strikes on the second turn.",
		id: "ShadowForce",
		name: "Shadow Force",
		pp: 5,
		isViable: true,
	...
	"ShellSmash": {
		...
		shortDesc: "Boosts Atk, Sp. Atk and Speed by 2. Def. Sp. Def drops 1.",
		id: "ShellSmash",
		name: "Shell Smash",
		pp: 15,
		isViable: true,
	...
	"SimpleBeam": {
		...
		category: "Status",
		desc: null,
		shortDesc: "Changes the foe's ability to Simple.",
		id: "SimpleBeam",
		name: "Simple Beam",
		pp: 15,
		priority: 0,
	...
	"Sketch": {
		...
		shortDesc: "Permanently copies the last move used by the target.",
		id: "Sketch",
		name: "Sketch",
		pp: 1,
		priority: 0,
	...
	"SkullBash": {
		...
		shortDesc: "Boosts Def. by 1 turn one only. Attacks turn 2.",
		id: "SkullBash",
		name: "Skull Bash",
		pp: 15,
		isContact: true,
	...
	"SkyAttack": {
		...
		shortDesc: "Hits turn after being used. 30% chance to flinch.",
		id: "SkyAttack",
		name: "Sky Attack",
		pp: 5,
		priority: 0,
	...
	"SkyDrop": {
		...
		shortDesc: "User and target untarget/uncontrol turn 1. Dmg on 2.",
		id: "SkyDrop",
		name: "Sky Drop",
		pp: 10,
		priority: 0,
	...
	"SleepTalk": {
		...
		shortDesc: "Uses a random move only while user is sleeping.",
		id: "SleepTalk",
		name: "Sleep Talk",
		pp: 10,
		isViable: true,
	...
	"SmackDown": {
		...
		category: "Physical",
		desc: null,
		shortDesc: "Removes ground type immunity.",
		id: "SmackDown",
		name: "Smack Down",
		pp: 15,
		priority: 0,
	...
	"SmellingSalt": {
		...
		shortDesc: "120 BP if target is paralyzed, but cures paralysis.",
		id: "SmellingSalt",
		name: "SmellingSalt",
		pp: 10,
		isContact: true,
	...
	"Snarl": {
		...
		shortDesc: "Lowers target's Sp. Attack by 1.",
		id: "Snarl",
		name: "Snarl",
		pp: 15,
		priority: 0,
	...
	"Snore": {
		...
		shortDesc: "30% chance to flinch the target. Only usable asleep.",
		id: "Snore",
		name: "Snore",
		pp: 15,
		priority: 0,
	...
	"Spikes": {
		...
		shortDesc: "Causes damage to the enemy when they switch. Max 3.",
		id: "Spikes",
		name: "Spikes",
		pp: 20,
		isViable: true,
	...
	"Spite": {
		...
		shortDesc: "Lowers the PP of the move used last by 4.",
		id: "Spite",
		name: "Spite",
		pp: 10,
		priority: 0,
	...
	"Splash": {
		...
		shortDesc: "Does absolutely nothing (Or does it?)",
		id: "Splash",
		name: "Splash",
		pp: 40,
		priority: 0,
	...
	"StealthRock": {
		...
		shortDesc: "Causes damage to the enemy whenever they switch.",
		id: "StealthRock",
		name: "Stealth Rock",
		pp: 20,
		isViable: true,
	...
	"Stockpile": {
		...
		shortDesc: "Boosts Def. and Sp. Def. by 1. Setup for Spitup/Swallow.",
		id: "Stockpile",
		name: "Stockpile",
		pp: 20,
		isViable: true,
	...
	"StoredPower": {
		...
		shortDesc: "Deals more damage the more stat boosts on user.",
		id: "StoredPower",
		name: "Stored Power",
		pp: 10,
		isViable: true,
	...
	"StormThrow": {
		...
		category: "Physical",
		desc: "Always results in a critical hit.",
		shortDesc: "Always results in a critial hit.",
		id: "StormThrow",
		name: "Storm Throw",
		pp: 10,
		isViable: true,
	...
	"StruggleBug": {
		...
		category: "Special",
		desc: "Has a 100% chance to lower the target's Special Attack by one level.",
		shortDesc: "Lower's target's Sp. Attack by 1.",
		id: "StruggleBug",
		name: "Struggle Bug",
		pp: 20,
		priority: 0,
	...
	"Surf": {
		...
		shortDesc: "Double damage to pokemon using Dive.",
		id: "Surf",
		name: "Surf",
		pp: 15,
		isViable: true,
	...
	"Switcheroo": {
		...
		shortDesc: "Switches items with opponent.",
		id: "Switcheroo",
		name: "Switcheroo",
		pp: 10,
		isViable: true,
	...
	"Synchronoise": {
		...
		basePower: 70,
		category: "Special",
		desc: "Hits any Pok̩mon that shares a type with the user.",
		shortDesc: "Only damages opponents of the same type as the user.",
		id: "Synchronoise",
		name: "Synchronoise",
		pp: 15,
		priority: 0,
	...
	"TailWhip": {
		...
		category: "Status",
		desc: "Lowers the target's Defense by 1 stage.",
		shortDesc: "Lowers opponent's Defense by 1.",
		id: "TailWhip",
		name: "Tail Whip",
		pp: 30,
		priority: 0,
	...
	"Taunt": {
		...
		shortDesc: "For 3 turns, opponent can only use attacking moves.",
		id: "Taunt",
		name: "Taunt",
		pp: 20,
		isViable: true,
	...
	"TechnoBlast": {
		...
		shortDesc: "Type will change depending on the type of Drive.",
		id: "TechnoBlast",
		name: "Techno Blast",
		pp: 5,
		priority: 0,
	...
	"Telekinesis": {
		...
		shortDesc: "For 3 turns, target takes all hits/is ground immune.",
		id: "Telekinesis",
		name: "Telekinesis",
		pp: 15,
		priority: -7,
	...
	"Thief": {
		...
		shortDesc: "Steals the pokemon's held item.",
		id: "Thief",
		name: "Thief",
		pp: 10,
		isContact: true,
	...
	"ThunderFang": {
		...
		shortDesc: "10% paralyze, 10% flinch opponent.",
		id: "ThunderFang",
		name: "Thunder Fang",
		pp: 15,
		isViable: true,
	...
	"ThunderPunch": {
		...
		shortDesc: "10% chance to paralyze opponent.",
		id: "ThunderPunch",
		name: "ThunderPunch",
		pp: 15,
		isViable: true,
	...
	"Torment": {
		...
		shortDesc: "Forces the opponent to constantly change moves.",
		id: "Torment",
		name: "Torment",
		pp: 15,
		isViable: true,
	...
	"Toxic": {
		...
		shortDesc: "Badly poisons the opponent.",
		id: "Toxic",
		name: "Toxic",
		pp: 10,
		isViable: true,
	...
	"ToxicSpikes": {
		...
		shortDesc: "Poisons opponents as they switch in. 2 Stacks maximum.",
		id: "ToxicSpikes",
		name: "Toxic Spikes",
		pp: 20,
		isViable: true,
	...
	"TripleKick": {
		...
		shortDesc: "Hits 3 times with Base Power increasing for each hit.",
		id: "TripleKick",
		name: "Triple Kick",
		pp: 10,
		isContact: true,
	...
	"U-turn": {
		...
		shortDesc: "Forces user to switch.",
		id: "U-turn",
		name: "U-turn",
		pp: 20,
		isViable: true,
	...
	"Uproar": {
		...
		shortDesc: "For 3 turns, pokemon cannot be sleep.",
		id: "Uproar",
		name: "Uproar",
		pp: 10,
		priority: 0,
	...
	"V-create": {
		...
		shortDesc: "Losers user's Defense, Sp. Defense and Speed by 1.",
		id: "V-create",
		name: "V-create",
		pp: 5,
		isViable: true,
	...
	"Venoshock": {
		...
		shortDesc: "Hits poisoned Pokemon with double Base Power",
		id: "Venoshock",
		name: "Venoshock",
		pp: 10,
		priority: 0,
	...
	"VoltTackle": {
		...
		shortDesc: "1/3 recoil. 10% chance to paralyze opponent.",
		id: "VoltTackle",
		name: "Volt Tackle",
		pp: 15,
		isViable: true,
	...
	"Wake-UpSlap": {
		...
		shortDesc: "Double power if opponent is asleep. Wakes opponent.",
		id: "Wake-UpSlap",
		name: "Wake-Up Slap",
		pp: 10,
		isContact: true,
	...
	"WorrySeed": {
		...
		shortDesc: "Changes the foe's ability to Insomnia.",
		id: "WorrySeed",
		name: "Worry Seed",
		pp: 10,
		priority: 0,
	...
	"WringOut": {
		...
		category: "Special",
		desc: "Base power decreases as the target's HP decreases.",
		shortDesc: "Base power decreases as the target's HP decreases.",
		id: "WringOut",
		name: "Wring Out",
		pp: 5,
		isContact: true,
	...
	"ZenHeadbutt": {
		...
		category: "Physical",
		desc: "Has a 20% chance to make the target flinch.",
		shortDesc: "20% chance to flinch opponent.",
		id: "ZenHeadbutt",
		name: "Zen Headbutt",
		pp: 15,
		isViable: true,
	...
	"PaleoWave": {
		...
		shortDesc: "20% chance of lowering target's Attack.",
		id: "PaleoWave",
		name: "Paleo Wave",
		pp: 15,
		isViable: true,
	...
	"ShadowStrike": {
		...
		shortDesc: "50% chance of lowering target's Defense.",
		id: "ShadowStrike",
		name: "ShadowStrike",
		pp: 10,
		isViable: true,
	...
	"Magikarp'sRevenge": {
		...
		shortDesc: "Does Awesome first turn. Can't move second turn.",
