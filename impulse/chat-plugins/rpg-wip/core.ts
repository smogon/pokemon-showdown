...
import { generateMenuHTML, generateProfileHTML, generateBuyHTML,
		  generateSellMenuHTML, generateSellConfirmHTML, generateExploreHTML,
		  generateRunHTML, generateHealHTML, generateResetHTML,
		  generateUnstuckHTML, generateSharedBattlePokemonInfo, generatePokemonInfoHTML,
		  generateSingleBattleHTML, generateDoubleBattleHTML, generateBattleHTML,
		  generateWelcomeHTML, generateStarterSelectionHTML, generatePokemonSummaryHTML,
		  generateEggMoveSelectionHTML, generateInventoryHTML, generateShopHTML,
		  generatePCHTML, generateCatchMenuHTML, generateCatchTargetHTML,
		  generateSwitchMenuHTML, generateVictoryHTML, generateTrainerVictoryHTML,
		  generateDefeatHTML, generateFaintSwitchHTML, generateMoveLearnHTML,
		  generateGiveItemPokemonSelectionHTML, generatePivotSwitchHTML, generateFieldEffectHTML,
		  generateMoveSelectionHTML,
		  TERA_BUTTON_STYLE } from './html';
