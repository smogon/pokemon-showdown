...
export function generateMenuHTML(player: PlayerData): string {
	const { getBadgeCount } = require('./helpers');
	const badgeCount = getBadgeCount(player);
	return `<div class="infobox"><h2>RPG Menu - ${player.name}</h2><p><strong>Location:</strong> ${player.location} | <strong>Money:</strong> ₽${player.money} | <strong>Badges:</strong> ${badgeCount}/8</p><p>What would you like to do?</p><p><button name="send" value="/rpg profile" class="button">👤 Profile</button><button name="send" value="/rpg party" class="button">⚡ Party</button><button name="send" value="/rpg battle" class="button">⚔️ Battle</button><button name="send" value="/rpg explore" class="button">🗺️ Explore</button></p><p><button name="send" value="/rpg quests" class="button">📋 Quests</button><button name="send" value="/rpg npcs" class="button">💬 NPCs</button><button name="send" value="/rpg items" class="button">🎒 Items</button><button name="send" value="/rpg pc" class="button">💻 Pokemon PC</button></p><p><button name="send" value="/rpg pokedex" class="button">📖 Pokédex</button><button name="send" value="/rpg badges" class="button">🏆 Badges</button><button name="send" value="/rpg travel" class="button">🗺️ Travel</button><button name="send" value="/rpg achievements" class="button">🏅 Achievements</button></p></div>`;
}
