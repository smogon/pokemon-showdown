...
* - Battle Logs are now rendered INSIDE the Battle UI container.
*/
...
export function generateBattleHTML(
	...
	// --- 1. Generate Logs (Events + History) ---
	...
	// Combine logs to pass into battlefield
	const combinedLogHTML = newEventsHTML + historyLogHTML;
	...
	// Pass combined logs to the battlefield generator
	const battlefieldHTML = generateBattlefield(battle, targetSelection, combinedLogHTML);
	...
	return '<div class="infobox">' +
		headerHTML +
		battlefieldHTML +
		// Note: Logs are now inside battlefieldHTML
		actionPanelHTML +
		'</div>';
}
...
function generateBattlefield(
	...
	// --- Log Container (Absolutely Positioned at Bottom) ---
	// Using inline styles to enforce positioning since CSS file is separate
	html += `<div style="position: absolute; bottom: 0; left: 0; width: 100%; z-index: 10;">${logHTML}</div>`;
