...
import { type ShopItem } from './pokerogue-types';
...
export const SHOP_ITEMS: Record<string, ShopItem> = {
	...
	potion: { id: 'potion', name: 'Potion', description: 'Restores 50% HP to one of your Pokémon.', cost: 60, healHp: 50 },
	maxpotion: { id: 'maxpotion', name: 'Max Potion', description: 'Fully restores HP to one of your Pokémon.', cost: 120, healHp: 100 },
	...
	metronome: { id: 'metronome', name: 'Metronome', description: 'Boosts a move used consecutively - ~20% per use up to 2x power.', cost: 80, heldItem: 'metronome' },
