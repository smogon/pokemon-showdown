	...
	pokemontcg: {
		...
		help() {
			...
			const helpList = [
				...
				{ cmd: "/tcg collection [user], [page]", desc: "View your (or another user's) card collection, automatically sorted by highest points.<br><b>Examples:</b> <code>/tcg collection</code> (Your cards), <code>/tcg collection princeskygit</code> (View their collection), <code>/tcg collection 2</code> (Your page 2), <code>/tcg collection princeskygit, 2</code> (Their page 2)." },
				{ cmd: "/tcg set [setId]", desc: "Display information about a specific TCG set." },
				{ cmd: "/tcg search [Pokemon Name], [Set ID], [Rarity], [Page]", desc: "Search for cards using smart keywords separated by commas.<br><b>Examples:</b> <code>/tcg search Charizard</code> (All Charizards), <code>/tcg search swsh2</code> (All cards from set swsh2), <code>/tcg search Charizard, swsh2, rare</code> (Rare Charizards from swsh2), <code>/tcg search pikachu, 2</code> (Page 2 of Pikachu cards)." },
