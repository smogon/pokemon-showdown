...
var commands = exports.commands = {
	...
	msg: function (target, room, user, connection) {
		...
		if (!targetUser || !targetUser.connected) {
			if (targetUser && !targetUser.connected) {
				this.popupReply("User " + this.targetUsername + " is offline. Try using /tell to send them an offline message.");
			} else {
				this.popupReply("User "  + this.targetUsername + " not found. Did you misspell their name? If they are offline, try using /tell to send them an offline message.");
			}
