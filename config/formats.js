...
let Formats = [
	...
	},
	{
		...
		banlist: [
			'Alcremie-Gmax', 'Appletun-Gmax', 'Charizard-Gmax + Solar Power', 'Coalossal-Gmax', 'Copperajah-Gmax', 'Duraludon-Gmax',
			'Flapple-Gmax', 'Garbodor-Gmax', 'Gengar-Gmax', 'Grimmsnarl-Gmax', 'Hatterene-Gmax', 'Kingler-Gmax', 'Lapras-Gmax',
			'Machamp-Gmax', 'Melmetal-Gmax', 'Orbeetle-Gmax', 'Raichu-Alola', 'Slowpoke-Galar', 'Toxtricity-Gmax', 'Weezing-Base',
		],
		minSourceGen: 8,
	},
	{
	...
	},
	{
		...
		banlist: [
			'Dracovish', 'Eternatus', 'Kyurem-Black', 'Kyurem-White', 'Lunala', 'Marshadow', 'Mewtwo', 'Necrozma-Dawn-Wings',
