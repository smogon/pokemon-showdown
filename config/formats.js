...
let Formats = [
	...
	{
		name: "[Gen 7] Pokémon Revelation",
		desc: `Based on a Pokémon Essentials fan game of the same name.`,
	...
	{
		name: "[Gen 7] The Pokémon Land Gang",
	...
	},
	{
		...
		debug: true,
		maxLevel: 9999,
		onBegin() { this.trunc = n => Math.trunc(n); this.add('raw|FREE-FOR-ALL!');},
		defaultLevel: 100,
		teamLength: {
			validate: [1, 24],
			battle: 24,
