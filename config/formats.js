...
let Formats = [
	...
	},
	{
		...
		banlist: [
			...
			'Arena Trap', 'Huge Power', 'Imposter', 'Innards Out', 'Magic Bounce', 'Magic Guard', 'Mold Breaker',
			'Moody', 'Neutralizing Gas', 'Regenerator', 'Shadow Tag', 'Trace', 'Water Bubble', 'Baton Pass',
		],
