...
let Formats = [
	...
	},
	{
		...
		mod: 'roulettemons',
		ruleset: ['Standard NatDex', 'Dynamax Clause', 'Sleep Clause Mod', 'Species Clause', 'Moody Clause', 'Evasion Moves Clause', 'Swagger Clause', 'Baton Pass Clause', 'OHKO Clause', '-Past', '-Unobtainable'],
		banlist: ['All Pokemon'],
		unbanlist: [
