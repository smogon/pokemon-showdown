...
let Formats = [
	...
	},
	{
		...
		banlist: [
			...
			'Kingler-Gmax', 'Lapras-Gmax', 'Linoone-Base', 'Machamp-Gmax', 'Ninetales-Alola', 'Orbeetle-Gmax',
			'Ponyta-Base', 'Rapidash-Base', 'Slowpoke-Galar', 'Stunfisk-Base', 'Toxtricity-Gmax', 'Vulpix-Alola',
			'Zigzagoon-Base',
		],
		minSourceGen: 8,
	},
