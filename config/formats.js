...
let Formats = [
	...
	},
	{
		...
		ruleset: ['Pokemon', 'Standard GBU'],
		banlist: ['Aegislash', 'Azumarill', 'Blaziken', 'Breloom', 'Celesteela', 'Charizard', 'Cloyster', 'Dragonite',
					 'Excadrill', 'Ferrothorn', 'Garchomp', 'Gengar', 'Gliscor', 'Greninja', 'Gyarados', 'Heatran',
					 'Hippowdon', 'Hydreigon', 'Kangaskhan', 'Kartana', 'Landorus', 'Lucario', 'Mamoswine', 'Mawile',
					 'Metagross', 'Mimikyu', 'Naganadel', 'Porygon2', 'Rotom', 'Salamence', 'Scizor', 'Serperior', 'Skarmory',
					 'Snorlax', 'Tapu Fini', 'Tapu Koko', 'Tapu Lele', 'Thundurus', 'Toxapex', 'Tyranitar', 'Venusaur',
					 'Volcarona', 'Zapdos'],
	},
	{
