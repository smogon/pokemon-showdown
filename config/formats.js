...
let Formats = [
	...
	},
	{
		...
		ruleset: ['[Gen 5] NU'],
		banlist: [
			'Alomomola', 'Altaria', 'Ampharos', 'Armaldo', 'Basculin', 'Bastiodon', 'Braviary', 'Cacturne', 'Camerupt', 'Carracosta',
			'Charizard', 'Combusken', 'Cradily', 'Ditto', 'Drifblim', 'Eelektross', 'Electabuzz', 'Electrode', 'Exeggutor', 'Floatzel',
			'Garbodor', 'Gardevoir', 'Gigalith', 'Golbat', 'Golem', 'Golurk', 'Gorebyss', 'Gurdurr', 'Haunter', 'Jynx', 'Kadabra',
			'Kangaskhan', 'Lapras', 'Lickilicky', 'Liepard', 'Linoone', 'Ludicolo', 'Mandibuzz', 'Metang', 'Miltank', 'Misdreavus',
			'Musharna', 'Ninjask', 'Piloswine', 'Pinsir', 'Primeape', 'Probopass', 'Regice', 'Regirock', 'Roselia', 'Rotom-Fan',
			'Rotom-Frost', 'Samurott', 'Sawk', 'Sawsbuck', 'Scolipede', 'Seismitoad', 'Serperior', 'Skuntank', 'Swellow', 'Tangela',
			'Tauros', 'Torkoal', 'Wartortle', 'Weezing', 'Zangoose',
		],
	},
	{
		name: "[Gen 5] LC",
