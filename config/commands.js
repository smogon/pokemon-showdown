...
var commands = exports.commands = {
	...
	groups: function (target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox(
			"  <b>Peasant</b> - They support Parukia by acting as our regular users, those who are mandatory for succcess<br />" +
	...
	rules: function (target, room, user) {
		if (!target) {
			...
			this.sendReplyBox("Please follow the rules:" +
				...
				"<br>- <a href=\"http://pokemonshowdown.com/rules\">" + (room.rulesLink ? "Global rules" : "Rules") + "</a>"); 
			return;
		}
