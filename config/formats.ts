...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Noivern', 'Obstagoon', 'Pangoro', 'Perrserker', 'Rillaboom', 'Tapu Bulu', 'Tapu Lele', 'Urshifu', 'Urshifu-Rapid-Strike',
		...
		restricted: [
			...
			'Pure Power', 'Simple', 'Speed Boost', 'Stakeout', 'Stench', 'Tinted Lens', 'Unburden', 'Water Bubble',
		],
	},
