...
export const Formats: FormatList = [
	...
	},
	{
		...
		unbanlist: [
			...
			'Pinsir-Mega', 'Pixie Plate', 'Plasma Fists', 'Play Rough', 'Poison Gas', 'Poison Heal', 'Poison Point', 'Poison Puppeteer',
	...
	},
	{
		...
		unbanlist: [
			...
			'Poison Point', 'Poison Puppeteer', 'Poison Touch', 'Poisonium Z', 'Pollen Puff', 'Poltergeist', 'Population Bomb', 'Porygon-Z',
