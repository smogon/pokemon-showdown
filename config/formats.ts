...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		restricted: [
			...
			'Poison Gas', 'Poison Powder', 'Protect', 'Roar', 'Silk Trap', 'Spiky Shield', 'Sleep Talk', 'Shell Smash', 'Skill Swap', 'Stun Spore', 'Substitute', 'Supersonic',
			'Swagger', 'Sweet Kiss', 'Switcheroo', 'Swords Dance', 'Tail Glow', 'Tailwind', 'Taunt', 'Teeter Dance', 'Teleport', 'Thunder Wave', 'Toxic', 'Toxic Thread', 'Trick',
