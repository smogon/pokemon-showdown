...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: [
			'Cyclizar', 'Dondozo', 'Flutter Mane', 'Iron Bundle', 'Koraidon', 'Miraidon', 'Slaking', 'Arena Trap', 'Comatose', 'Imposter', 'Moody',
			'Pure Power', 'Shadow Tag', 'Speed Boost', 'Damp Rock', 'King\'s Rock', 'Baton Pass', 'Last Respects', 'Revival Blessing', 'Shell Smash', 'Spore',
		],
	},
	{
		name: "[Gen 9] Camomons",
