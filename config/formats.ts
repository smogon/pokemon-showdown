...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		unbanlist: ['Baton Pass + Psych Up', 'Baton Pass + Heart Swap', 'Baton Pass + Guard Swap', 'Baton Pass + Power Swap', 'Baton Pass + Contrary', 'Baton Pass + Copycat', 'Baton Pass + Covet', 'Baton Pass + Skill Swap', 'Baton Pass + Thief', 'Baton Pass + move:metronome', 'Baton Pass + Snatch', 'Baton Pass + Switcheroo', 'Baton Pass + Trick', 'Baton Pass + Bug Bite', 'Baton Pass + Pluck', 'Baton Pass + Role Play', 'Baton Pass + Pickpocket', 'Baton Pass + Pickup', 'Baton Pass + Trace', 'Baton Pass + Mimic', 'Baton Pass + Sketch'],
	},
	{
		name: "[Gen 4] OU",
		mod: 'gen4',
		...
		unbanlist: ['Baton Pass + Focus Energy', 'Baton Pass + Power Swap', 'Baton Pass + Lansat Berry', 'Baton Pass + Anger Point', 'Baton Pass + Download', 'Baton Pass + Motor Drive', 'Baton Pass + Steadfast', 'Baton Pass + Copycat', 'Baton Pass + Covet', 'Baton Pass + move:metronome', 'Baton Pass + Role Play', 'Baton Pass + Skill Swap', 'Baton Pass + Snatch', 'Baton Pass + Switcheroo', 'Baton Pass + Trick', 'Baton Pass + Thief', 'Baton Pass + Bug Bite', 'Baton Pass + Pluck', 'Baton Pass + Trace', 'Baton Pass + Mimic', 'Baton Pass + Sketch'],
	},
	{
		name: "[Gen 3] OU",
		mod: 'gen3',
		...
		unbanlist: ['Baton Pass + Ancient Power', 'Baton Pass + Psych Up', 'Baton Pass + Meteor Mash', 'Baton Pass + Skull Bash', 'Baton Pass + Rage', 'Baton Pass + Silver Wind', 'Baton Pass + Focus Energy', 'Baton Pass + Metal Claw', 'Baton Pass + Steel Wing', 'Baton Pass + Lansat Berry', 'Baton Pass + Covet', 'Baton Pass + move:metronome', 'Baton Pass + Role Play', 'Baton Pass + Skill Swap', 'Baton Pass + Snatch', 'Baton Pass + Trick', 'Baton Pass + Thief', 'Baton Pass + Trace', 'Baton Pass + Mimic', 'Baton Pass + Sketch'],
	},
	{
		name: "[Gen 2] OU",
		mod: 'gen2',
	...
	},
	{
		...
		banlist: ['Uber', 'OU', 'UUBL', 'UU', 'RUBL', 'RU', 'NUBL', 'NU', 'PUBL', 'Baton Pass + Stockpile', 'Baton Pass + Lightning Rod', 'Baton Pass + Charge'],
		unbanlist: ['Baton Pass + Assist', 'Baton Pass + Psych Up', 'Baton Pass + Covet', 'Baton Pass + move:metronome', 'Baton Pass + Role Play', 'Baton Pass + Skill Swap', 'Baton Pass + Snatch', 'Baton Pass + Trick', 'Baton Pass + Thief', 'Baton Pass + Trace', 'Baton Pass + Mimic', 'Baton Pass + Sketch'],
	},
	{
		name: "[Gen 3] LC",
		mod: 'gen3',
	...
	},
	{
		...
		unbanlist: ['Baton Pass + Focus Energy', 'Baton Pass + Lansat Berry', 'Baton Pass + Covet', 'Baton Pass + move:metronome', 'Baton Pass + Role Play', 'Baton Pass + Skill Swap', 'Baton Pass + Snatch', 'Baton Pass + Trick', 'Baton Pass + Thief', 'Baton Pass + Trace', 'Baton Pass + Mimic', 'Baton Pass + Sketch'],
	},
	{
		name: "[Gen 3] ADV 200",
		mod: 'gen3rs',
