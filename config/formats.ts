...
export const Formats: FormatList = [
	...
	},
	{
		...
		ruleset: ['[Gen 9] LC'],
		banlist: [
			'Bramblin', 'Crabrawler', 'Diglett', 'Drifloon', 'Foongus', 'Fuecoco', 'Glimmet', 'Gothita', 'Greavard', 'Larvesta',
	...
	},
	{
		...
		banlist: [
			...
			'Neutralizing Gas', 'Parental Bond', 'Pure Power', 'Shadow Tag', 'Stakeout', 'Water Bubble', 'Wonder Guard', 'Gengarite', 'Berserk Gene', 'Belly Drum',
