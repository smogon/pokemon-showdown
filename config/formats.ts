...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: ['All Pokemon', 'Past', 'Arena Trap', 'Moody', 'Shadow Tag', 'Baton Pass', 'Bright Powder', 'Lax Incense', 'King\'s Rock',
			'Razor Fang', 'Kangaskhanite', 'Medichamite', 'Kommonium Z'],
		unbanlist: ["Absol", "Absol-Mega", "Appletun", "Articuno", "Aurorus", "Basculin", "Beartic", "Bisharp", "Calyrex", "Camerupt", "Camerupt-Mega", "Celesteela", "Cloyster", "Crawdaunt",
			"Cursola", "Dedenne", "Delibird", "Eelektross", "Espeon", "Flapple", "Flareon", "Flygon", "Galvantula", "Girafarig", "Glaceon", "Goodra", "Gourgeist", "Grimmsnarl", "Guzzlord",
			"Heliolisk", "Hitmonchan", "Hitmonlee", "Hitmontop", "Incineroar", "Indeedee", "Jolteon", "Kangaskhan", "Kommo-o", "Lanturn", "Leafeon", "Leavanny", "Ludicolo", "Lunatone",
			"Luvdisc", "Machamp", "Mandibuzz", "Medicham", "Nihilego", "Palossand", "Pidgeot", "Pidgeot-Mega", "Probopass", "Pyroar", "Sawk", "Sceptile", "Sceptile-Mega", "Scolipede",
			"Shiftry", "Simisage", "Slowbro", "Slowbro-Mega", "Slowking", "Swoobat", "Sylveon", "Tapu Bulu", "Tapu Fini", "Tauros", "Typhlosion", "Umbreon", "Ursaring", "Vaporeon",
			"Whiscash", "Wishiwashi", "Zebstrika", "Absolite", "Pidgeotite", "Sceptilite", "Cameruptite", "Slowbronite"],
	},
	{
		name: "[Gen 6] NEXT OU",
		threads: [
