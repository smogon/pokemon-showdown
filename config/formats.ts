...
export const Formats: FormatList = [
	...
	},
	{
		...
		unbanlist: ["Eternatus-Eternamax", "10,000,000 Volt Thunderbolt", "Arena Trap", "Custap Berry", "Aguav Berry",
			"Rayquaza-Mega", "Accelerock", "Comatose", "Assault Vest", "Mewtwo-Mega-Y", "Aeroblast", "Contrary", "Choice Band",
			"Mewtwo-Mega-X", "Air Slash", "Fluffy", "Choice Scarf", "Groudon-Primal", "Anchor Shot", "Fur Coat", "Choice Specs",
			"Kyogre-Primal", "Apple Acid", "Gorilla Tactics", "Expert Belt", "Necrozma-Ultra", "Aqua Step", "Huge Power",
			"Figy Berry", "Zygarde-Complete", "Armor Cannon", "Ice Scales", "Focus Sash", "Zamazenta-Crowned", "Aromatherapy",
			"Illusion", "Heavy-Duty Boots", "Zacian-Crowned", "Astral Barrage", "Imposter", "Iapapa Berry", "Diancie-Mega",
			"Attack Order", "Innards Out", "Leftovers", "Kyurem-Black", "Aura Sphere", "Intrepid Sword", "Life Orb",
			"Kyurem-White", "Axe Kick", "Libero", "Mago Berry", "Garchomp-Mega", "Baddy Bad", "Magic Bounce", "Mental Herb",
			"Latios-Mega", "Baneful Bunker", "Moody", "Rocky Helmet", "Latias-Mega", "Baton Pass", "Neutralizing Gas",
			"Salac Berry", "Metagross-Mega", "Beak Blast", "Parental Bond", "Wiki Berry", "Salamence-Mega", "Behemoth Bash",
			"Poison Heal", "Air Balloon", "Tyranitar-Mega", "Behemoth Blade", "Protean", "Fist Plate", "Eternatus", "Belly Drum",
			"Pure Power", "Dread Plate", "Calyrex-Shadow", "Bitter Blade", "Shadow Tag", "Blunder Policy", "Calyrex-Ice",
			"Bitter Malice", "Bright Powder", "Necrozma-Dawn-Wings", "Blazing Torque", "Speed Boost", "Flame Plate",
			"Necrozma-Dusk-Mane", "Bleakwind Storm", "Stakeout", "Chesto Berry", "Lunala", "Blizzard", "Unburden",
			"Chilan Berry", "Solgaleo", "Blue Flare", "Water Bubble", "Clear Amulet", "Hoopa-Unbound", "Body Press",
			"Wonder Guard", "Covert Cloak", "Yveltal", "Body Slam", "Adaptability", "Eject Pack", "Xerneas", "Bolt Beak",
			...
			"Clanging Scales", "Orichalcum Pulse", "Quick Claw", "Regigigas", "Clangorous Soul", "Well-Baked Body",
			"Razor Claw", "Groudon", "Clangorous Soulblaze", "Levitate", "Red Card", "Kyogre", "Close Combat", "Scope Lens",
			"Slaking", "Coil", "Magic Guard", "Silk Scarf", "Zamazenta", "Collision Course", "Unaware", "Insect Plate",
			"Zacian", "Combat Torque", "Multiscale", "Sky Plate", "Kyurem", "Core Enforcer", "Prankster", "Sitrus Berry",
			"Palafin-Hero", "Corrosive Gas", "Triage", "Earth Plate", "Greninja-Ash", "Cosmic Power", "Purifying Salt",
			"Spooky Plate", "Gyarados-Mega", "Cotton Guard", "Regenerator", "Throat Spray", "Swampert-Mega", "Court Change",
			"Serene Grace", "Mind Plate", "Charizard-Mega-Y", "Crabhammer", "Shadow Shield", "Weakness Policy",
			"Charizard-Mega-X", "Dark Pulse", "Turboblaze", "White Herb", "Aggron-Mega", "Darkest Lariat", "Teravolt",
			"Wide Lens", "Blaziken-Mega", "Defend Order", "Sheer Force", "Wise Glasses", "Sceptile-Mega", "Defog", "Simple",
			"Mirror Herb", "Blastoise-Mega", "Diamond Storm", "Sword of Ruin", "Leppa Berry", "Lucario-Mega", "Dire Claw",
			"Tablets of Ruin", "Normalium Z", "Venusaur-Mega", "Disable", "Tinted Lens", "Waterium Z", "Wishiwashi-School",
			"Discharge", "Tough Claws", "Firium Z", "Gallade-Mega", "Doom Desire", "Vessel of Ruin", "Grassium Z",
			"Gardevoir-Mega", "Double Iron Bash", "Soul-Heart", "Buginium Z", "Aerodactyl-Mega", "Draco Meteor", "Volt Absorb",
			"Fightinium Z", "Steelix-Mega", "Dragon Ascent", "Lightning Rod", "Ghostium Z", "Ampharos-Mega", "Dragon Dance",
			"Water Absorb", "Fairium Z", "Baxcalibur", "Dragon Darts", "Sap Sipper", "Poisonium Z", "Zarude", "Dragon Energy",
			"Storm Drain", "Darkinium Z", "Dragapult", "Dragon Hammer", "Intimidate", "Dragonium Z", "Melmetal",
			"Dragon Pulse", "Rough Skin", "Electrium Z", "Zeraora", "Dragon Tail", "Iron Barbs", "Groundium Z", "Marshadow",
			"Drain Punch", "Misty Surge", "Icium Z", "Magearna", "Drill Peck", "Earth Eater", "Rockium Z", "Necrozma",
			"Drum Beating", "Compound Eyes", "Psychium Z", "Kommo-o", "Dynamax Cannon", "Download", "Steelium Z", "Volcanion",
			"Earth Power", "Analytic", "Flyinium Z", "Hoopa", "Earthquake", "Berserk", "Pixie Plate", "Diancie", "Eerie Spell",
			"Supreme Overlord", "Splintered Stormshards", "Zygarde", "Electro Drift", "Dry Skin", "Splishy Splash",
			"Goodra-Hisui", "Encore", "Shield Dust", "Spore", "Goodra", "Energy Ball", "Anticipation", "Springtide Storm",
			"Genesect", "Eruption", "Forewarn", "Stealth Rock", "Meloetta-Pirouette", "Esper Wing", "Mold Breaker",
			"Steam Eruption", "Meloetta", "Expanding Force", "Sandsear Storm", "Sticky Web", "Landorus-Therian", "Explosion",
			"Sappy Seed", "Stoked Sparksurfer", "Landorus", "Extreme Evoboost", "Scald", "Stone Axe", "Hydreigon",
			"Extreme Speed", "Searing Shot", "Stone Edge", "Victini", "Fake Out", "Searing Sunraze Smash", "Stored Power",
			"Shaymin-Sky", "Fiery Wrath", "Secret Sword", "Storm Throw", "Shaymin", "Fire Blast", "Seed Flare", "Strange Steam",
			"Darkrai", "Fire Lash", "Seismic Toss", "Strength Sap", "Manaphy", "First Impression", "Shadow Ball",
			"Sucker Punch", "Heatran", "Fishious Rend", "Shadow Bone", "Sunsteel Strike", "Garchomp", "Flame Charge",
			"Shadow Sneak", "Super Fang", "Deoxys-Speed", "Flamethrower", "Shadow Strike", "Superpower", "Deoxys-Defense",
			"Flare Blitz", "Shed Tail", "Surf", "Deoxys-Attack", "Flash Cannon", "Shell Side Arm", "Surging Strikes", "Deoxys",
			"Fleur Cannon", "Shell Smash", "Swords Dance", "Jirachi", "Flip Turn", "Shift Gear", "Synthesis", "Latios",
			"Floaty Fall", "Silk Trap", "Tail Glow", "Latias", "Flower Trick", "Sinister Arrow Raid", "Taunt", "Metagross",
			"Focus Blast", "Sizzly Slide", "Techno Blast", "Salamence", "Foul Play", "Slack Off", "Teleport", "Celebi",
			"Freeze-Dry", "Sleep Powder", "Tera Blast", "Tyranitar", "Freezing Glare", "Sludge Bomb", "Thousand Arrows",
			"Houndoom-Mega", "Freezy Frost", "Sludge Wave", "Thousand Waves", "Heracross-Mega", "Frost Breath", "Snarl",
			"Thunder", "Scizor-Mega", "Fusion Bolt", "Snipe Shot", "Thunder Cage", "Mew", "Fusion Flare", "Soft-Boiled",
			"Thunder Wave", "Dragonite", "Future Sight", "Soul-Stealing 7-Star Strike", "Thunderbolt", "Pinsir-Mega",
			"G-Max Cannonade", "Spacial Rend", "Thunderous Kick", "Gengar-Mega", "Sparkly Swirl", "Tidy Up", "Alakazam-Mega",
			"Spectral Thief", "Torch Song", "Abomasnow-Mega", "Spikes", "Toxic", "Iron Valiant", "G-Max Resonance",
			"Spiky Shield", "Toxic Spikes", "Roaring Moon", "G-Max Steelsurge", "Spin Out", "Tri Attack", "Altaria-Mega",
			"G-Max Stonesurge", "Spirit Break", "Triple Arrows", "Kangaskhan-Mega", "G-Max Sweetness", "Spirit Shackle",
			"Triple Axel", "Slowbro-Mega", "G-Max Vine Lash", "U-turn", "Enamorus-Therian", "G-Max Volcalith", "Power Trip",
			"V-create", "Enamorus", "G-Max Wildfire", "Power Whip", "Victory Dance", "Spectrier", "G-Max Wind Rage",
			"Precipice Blades", "Volt Switch", "Glastrier", "Gear Grind", "Psychic", "Volt Tackle", "Regidrago",
			"Genesis Supernova", "Psychic Fangs", "Water Shuriken", "Regieleki", "Geomancy", "Psycho Boost", "Water Spout",
			"Keldeo-Resolute", "Giga Drain", "Psyshield Bash", "Waterfall", "Keldeo", "Gigaton Hammer", "Psystrike", "Wave Crash",
			"Thundurus-Therian", "Glacial Lance", "Pulverizing Pancake", "Wicked Blow", "Thundurus", "Glaive Rush", "Pursuit",
			"Wicked Torque", "Tornadus-Therian", "Glare", "Pyro Ball", "Wild Charge", "Tornadus", "Glitzy Glow", "Quiver Dance",
			"Wildbolt Storm", "Virizion", "Grav Apple", "Rage Fist", "Will-O-Wisp", "Terrakion", "Raging Bull", "Wish", "Cobalion",
			"Guardian of Alola", "Raging Fury", "Wood Hammer", "Cresselia", "Gunk Shot", "Rapid Spin", "Yawn", "Azelf",
			"Hammer Arm", "Recover", "Zing Zap", "Mesprit", "Haze", "Reflect", "Zippy Zap", "Uxie", "Head Charge", "Rest",
			"Max Guard", "Lopunny-Mega", "Head Smash", "Revelation Dance", "Megahorn", "Registeel", "Headlong Rush",
			"Revival Blessing", "Memento", "Regice", "Heal Bell", "Roost", "Menacing Moonraze Maelstrom", "Regirock",
			"Heal Order", "Ruination", "Meteor Beam", "Glalie-Mega", "Healing Wish", "Sacred Fire", "Meteor Mash", "Suicune",
			"Heart Swap", "Sacred Sword", "Milk Drink", "Entei", "Heat Crash", "Salt Cure", "Minimize", "Raikou", "Heat Wave",
			"Armarouge", "Misty Explosion", "Moltres-Galar", "High Horsepower", "Wyrdeer", "Moonblast", "Moltres",
			"High Jump Kick", "Centiskorch", "Moongeist Beam", "Zapdos-Galar", "Horn Leech", "Sylveon", "Moonlight", "Zapdos",
			"Hurricane", "Dusknoir", "Morning Sun", "Articuno-Galar", "Hyper Drill", "Probopass", "Mortal Spin", "Articuno",
			"Ice Beam", "Glaceon", "Mountain Gale", "Pidgeot-Mega", "Ice Hammer", "Leafeon", "Mystical Fire", "Manectric-Mega",
			"Ice Shard", "Hippowdon", "Mystical Power", "Chi-Yu", "Ice Spinner", "Lucario", "Nasty Plot", "Ting-Lu", "Iron Head",
			"Torterra", "Nature's Madness", "Chien-Pao", "Jet Punch", "Umbreon", "Night Daze", "Wo-Chien", "Judgment", "Espeon",
			"Night Shade", "Iron Thorns", "King's Shield", "Meganium", "No Retreat", "Iron Moth", "Knock Off", "Flareon",
			"Noxious Torque", "Iron Jugulis", "Last Respects", "Jolteon", "Nuzzle", "Iron Hands", "Lava Plume", "Vaporeon",
			"Oblivion Wing", "Iron Bundle", "Leaf Blade", "Cloyster", "Obstruct", "Iron Treads", "Leaf Storm", "Venusaur",
			"Oceanic Operetta", "Sandy Shocks", "Leech Life", "Cinderace", "Octolock", "Slither Wing", "Leech Seed", "Rillaboom",
			"Origin Pulse", "Flutter Mane", "Let's Snuggle Forever", "Golisopod", "Outrage", "Brute Bonnet", "Light of Ruin",
			"Primarina", "Overdrive", "Scream Tail", "Light Screen", "Incineroar", "Overheat", "Great Tusk",
			"Light That Burns the Sky", "Decidueye-Hisui", "Parting Shot", "Blacephalon", "Liquidation", "Decidueye",
			"Photon Geyser", "Stakataka", "Lovely Kiss", "Greninja", "Guzzlord", "Low Kick", "Chesnaught", "Plasma Fists",
			"Kartana", "Lumina Crash", "Mamoswine", "Play Rough", "Celesteela", "Lunar Blessing", "Empoleon", "Pollen Puff",
			"Xurkitree", "Lunar Dance", "Walrein", "Poltergeist", "Pheromosa", "Lunge", "Aggron", "Population Bomb", "Buzzwole",
			"Mach Punch", "Blaziken", "Power Gem", "Nihilego", "Magical Torque", "Sceptile", "Naganadel", "Tapu Fini",
			"Magma Storm", "Feraligatr", "Haxorus", "Tapu Bulu", "Make It Rain", "Exeggutor-Alola", "Darmanitan-Galar-Zen",
			"Tapu Lele", "Malicious Moonsault", "Exeggutor", "Darmanitan-Zen", "Tapu Koko", "Porygon-Z", "Blastoise", "Magmortar",
			"Silvally", "Tangrowth", "Samurott-Hisui", "Skeledirge", "Archeops", "Rhyperior", "Samurott", "Meowscarada",
			"Absol-Mega", "Magnezone", "Emboar", "Basculegion-F", "Camerupt-Mega", "Swampert", "Serperior", "Basculegion",
			"Sharpedo-Mega", "Crobat", "Glimmora", "Inteleon", "Banette-Mega", "Lapras", "Ceruledge", "Annihilape",
			"Arcanine-Hisui", "Type: Null", "Electivire", "Duraludon", "Arcanine", "Delphox", "Milotic", "Noivern", "Florges",
			"Infernape", "Blissey", "Vanilluxe", "Gholdengo", "Typhlosion-Hisui", "Kingdra", "Dondozo", "Kingambit", "Typhlosion",
			"Snorlax", "Quaquaval", "Ursaluna", "Charizard", "Gyarados", "Togekiss", "Urshifu-Rapid-Strike", "Gogoat",
			"Audino-Mega", "Volcarona", "Urshifu", "Acid Spray", "Defiant", "Competitive", "Flame Body", "Effect Spore", "Gooey",
			"Moxie", "Perish Body", "Stamina", "Thick Fat", "Anger Shell", "Opportunist", "Barb Barrage", "Protect",
			"Walking Wake", "Hydro Steam", "Iron Leaves", "Psyblade"],
	},
