...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Zamazenta-Base', 'Zoroark-Hisui', 'Arena Trap', 'Comatose', 'Contrary', 'Embody Aspect (Hearthflame)', 'Embody Aspect (Teal)',
			...
			'Speed Boost', 'Stakeout', 'Unburden', 'Water Bubble', 'Wonder Guard', 'King\'s Rock', 'Baton Pass', 'Last Respects', 'Revival Blessing',
			'Shed Tail',
		],
	},
	{
