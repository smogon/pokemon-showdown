...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: ['Chi-Yu', 'Chien-Pao', 'Cloyster', 'Espathra', 'Flutter Mane', 'Houndstone', 'Iron Bundle', 'Koraidon', 'Miraidon', 'Palafin', 'Riolu', 'Weavile', 'Arena Trap', 'Moody', 'Serene Grace', 'Shadow Tag', 'Covert Cloak', 'Baton Pass', 'Fake Out'],
	...
	},
	{
		...
		banlist: ['Annihilape', 'Chi-Yu', 'Chien-Pao', 'Espathra', 'Flutter Mane', 'Houndstone', 'Iron Bundle', 'Koraidon', 'Miraidon', 'Palafin', 'Arena Trap', 'Moody', 'Shadow Tag', 'Booster Energy', 'King\'s Rock', 'Baton Pass'],
		onSwitchIn(pokemon) {
			if (this.turn === 0) {
