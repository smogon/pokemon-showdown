...
export const Formats: FormatList = [
	...
	},
	{
		...
		unbanlist: [
			...
			'Detect', 'Dialga', 'Dialga-Origin', 'Diamond Storm', 'Diancie', 'Diancie-Mega', 'Dire Claw', 'Disable', 'Dondozo',
	...
	},
	{
		...
		unbanlist: [
			...
			'Tapu Fini', 'Tapu Koko', 'Tapu Lele', 'Taunt', 'Techno Blast', 'Teleport', 'Tera Blast', 'Tera Starstorm',
