...
If you really want to host, you will have to do [port-forwading][3]
...
If you truly want to host the client yourself, there is [a repository for the Pokémon Showdown Client][4]. It's not recommended for beginners, though.

  [1]: http://nodejs.org/
  [2]: https://github.com/joyent/node/pull/5016
  [3]: http://en.wikipedia.org/wiki/Port_forwarding
  [4]: https://github.com/Zarel/Pokemon-Showdown-Client
