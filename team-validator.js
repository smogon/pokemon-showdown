...
class Validator {
	...
	checkLearnset(move, template, lsetData) {
		...
		do {
			...
			// STABmons hack
			if (ruleTable.has('ignorestabmoves') && !(moveid in {'acupressure':1, 'bellydrum':1, 'chatter':1, 'geomancy':1, 'lovelykiss':1, 'shellsmash':1, 'shiftgear':1, 'thousandarrows':1}) && !move.isZ) {
