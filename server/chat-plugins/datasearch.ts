...
export const commands: Chat.ChatCommands = {
	...
	movesearchhelp() {
		this.sendReplyBox(
			...
			`- Valid flags are: allyanim, bypasssub (bypasses Substitute), bite, bullet, charge, contact, dance, defrost, distance (can target any Pokemon in Triples), encore, futuremove, gravity, heal, highcrit, instruct, mefirst, mimic, mirror (reflected by Mirror Move), mustpressure, multihit, nonsky, ohko, parentalbond, pivot, pledgecombo, powder, priority, protect, pulse, punch, recharge, recovery, reflectable, secondary, sleeptalk, slicing, snatch, sound, and wind.<br/>` +
