...
exports.commands = {
	...
	scavengershelp(target, room, user) {
		...
		const staffCommands = [
			...
			"- /scav addhint <em>[question number], [value]</em> - adds a hint to a question in the current scavenger hunt. Only the host(s) can add a hint. Can only be used after 10 minutes have passed since the start of the hunt.",
