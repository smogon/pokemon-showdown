...
global.Punishments?.addRoomPunishmentType('MAFIAGAMEBAN', 'banned from playing mafia games');
global.Punishments?.addRoomPunishmentType('MAFIAHOSTBAN', 'banned from hosting mafia games');
