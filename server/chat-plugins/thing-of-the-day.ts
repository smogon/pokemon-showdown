...
otds.set('vgotd', new OtdHandler('vgotd', 'Video Game', rooms.videogames, VGOTDS_FILE, ['game', 'nominator', 'link', 'quote', 'image', 'time'], ['Video Game', 'Nominator', 'Link', 'Quote', 'Image', 'Timestamp']));
