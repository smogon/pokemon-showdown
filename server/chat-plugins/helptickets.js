...
function notifyStaff(upper = false) {
	...
	if (hiddenTicketCount > 1) {
		...
		buf = buf.slice(0, fourthTicketIndex) + `<a class="button${notifying}" margin="4px;" href="/view-help-tickets">and ${hiddenTicketCount} more Help ticket${Chat.plural(hiddenTicketCount)} (${hiddenTicketUnclaimedCount} unclaimed)</a>`;
	}
