 ...
 */
 ...
 function subRender(child: preact.ComponentChild, opts?: {isTrusted?: boolean, replaceLinebreaks?: boolean}): preact.VNode {
	 switch (typeof child) {
	 case 'string':
 ...
 export class FormatText extends preact.Component<{isTrusted?: boolean, replaceLinebreaks?: boolean}> {
	 render() {
		 if (Array.isArray(this.props.children)) {
			 ...
			 return subRender(this.props.children, {isTrusted: this.props.isTrusted, replaceLinebreaks: this.props.replaceLinebreaks});
		 }
	 }
 }
