...
const PLAYER_SYMBOL: ServerGroup = '\u2606';
const HOST_SYMBOL: ServerGroup = '\u2605';
...
function setOfflineGroup(name: string, group: ServerGroup, forceTrusted: boolean) {
...
export class User extends Chat.MessageContext {
	 ...
	 */
	setGroup(group: ServerGroup, forceTrusted = false) {
