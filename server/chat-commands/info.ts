...
export const commands: Chat.ChatCommands = {
	...
	smogintro(target, room, user) {
		if (!this.runBroadcast()) return;
		this.sendReplyBox(
			`Welcome to Smogon's official simulator! The <a href="https://www.smogon.com/forums/forums/intro_hub">Smogon Info / Intro Hub</a> can help you get integrated into the community.<br />` +
