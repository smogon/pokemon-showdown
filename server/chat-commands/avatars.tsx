...
const OFFICIAL_AVATARS_BRUMIRAGE = new Set([
	...
	'elaine', 'gloria', 'gloria-dojo', 'gordie', 'hop', 'irida', 'kabu', 'klara', 'koga-lgpe', 'leon', 'leon-tower',
	...
	'raihan', 'rei', 'rose', 'sabi', 'sanqua', 'shauna', 'shielbert', 'sonia', 'sonia-professor', 'sordward',
