...
export const commands: ChatCommands = {
	...
	autojoin(target, room, user, connection) {
		...
		if (targets.length > 16 || connection.inRooms.size > 1) {
			connection.popup("To prevent DoS attacks, you can only use /autojoin for 16 or fewer rooms, when you haven't joined any rooms yet. Please use /join for each room separately.");
		}
