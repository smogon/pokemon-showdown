...
export const commands: Chat.ChatCommands = {
	...
	help(target, room, user) {
		...
		if (!target) {
			...
			this.sendReply(`${this.tr`DATA COMMANDS`}: /data, /dexsearch, /movesearch, /itemsearch, /weathergy, /learn, /statcalc, /effectiveness, /weakness, /coverage, /randommove, /randompokemon ${broadcastMsg}`);
